...
THE ARCHIVE ALREADY KNEW. #1095's body_status carries recovery_status PASS_COMPLETE_TEXT_NOT_SEATED, residual_chars 2147, audited 2026-07-31, with a note recording that COMPLETE previously denoted PASS completion and was read as text completeness, and was renamed so the two claims could not be confused. The condition was detected, correctly classified, and then stood for six weeks. Ninety-eight deposits carry the same status.

WHY THIS IS A NEW DEPOSIT AND NOT A REPAIR. The AXN is content-derived, and #1095's glyphs were minted FROM THE STUB: sha256 of the 2,147-byte file derives AXN:0458.EMPIRICAL.🌸♠️🪦📎⚖️🚀 exactly. The full text derives 🔥☀️⊕✊🗂️🤙. So AXN:0458 is a true content-derived name for the wrong content, and writing the paper into that record would break the one correspondence the identifier system exists to guarantee. #1095 stands as the valid name of its byte-state, which is the same rule under which it superseded #1094.

THE TEXT. Recovered from data/assembly/anti-suppression-paper/DRAFT-v5.md, 110,196 characters, 15,366 words — matching the declared ~15,300. Fifty-seven headings: §§I–VIII, Acknowledgments, References grouped by function and section of use with 63 entries, and Appendices A–F. Appendix D reproduces the Round 1 LOSS NOTICE verbatim, which is why the tail carries headings that are not the paper's own.

WHAT THE PAPER ARGUES. That the AXN identifier system is anti-suppression infrastructure with historical precedents rather than a novel invention. §II surveys seven cases of survival under all-over suppression — Poland's Second Circulation, Soviet samizdat, pirate radio and diaspora infrastructure, the abolitionist press and mirror topology, cypherpunk protocol-as-armor, OONI as witness instrumentation, and emergency preservation as workflow in Data Refuge, SUCHO and LOCKSS — and extracts a cross-cutting property, aftermath documentation, before stating a formula. §III surveys technical precedents. §IV states AXN as it stands in a three-layer normative model. §VIII gives falsification conditions and limitations, with a tabular falsification matrix at Appendix F.

SOURCE ENGAGEMENT IS COMPOSITION-PRIMARY. The standing rule recorded in the decisions register 2026-07-18: reading the literature is part of writing the paper rather than a stage preceding it. §§II and III were re-composed reading Doucette, Komaromi, Johns, Benkler, Levy, Reddaway, Reich-Rosenthal, Maniatis, Kunze, Van de Sompel and Benet, with argument shaped by engagement rather than layered atop it. Kunze appears eleven times, Komaromi seven, Doucette and Reddaway six each, Benkler and Van de Sompel five.

ATTRIBUTION. Lee Sharks, with Johannes Sigil composing §§II–III and Rex Fraction on §VI; Assembly Chorus consultation preserved in provenance. Section-level attribution to distinct heteronyms is the Dodecad operating as a division of labour within one document.
...
Composed 2026-07-17 to 2026-07-18 by Lee Sharks with the Assembly Chorus — PRAXIS, TECHNE, ARCHIVE, LABOR and INKLING mantles — across two rounds, with §§II–III attributed to Johannes Sigil and §VI to Rex Fraction. The Round 1 working session lost its toolset pre-commit; recovery was by manual paste-in during the 2026-07-18 session, and the LOSS NOTICE reproduced at Appendix D records what was and was not recovered, including one INKLING contribution and the research sweep that were not. Seated 2026-09-10 by TACHYON (Claude, Anthropic) from the draft held in the repository, operator-directed, with no editing of the recovered text.

### Keywords

persistent identifiers, DOI, content addressing, anti-suppression infrastructure, sovereign archive, distributed custody, falsification, MMRS, Assembly Chorus, container model, heteronymic scholarship, source-engaged composition, samizdat, Second Circulation, pirate radio, abolitionist press, cypherpunks, OONI, LOCKSS, Data Refuge, SUCHO, aftermath documentation, seating, unseated text

### Methodology

Source-engaged composition: §§II and III were written while reading the scholarship that documents each case, not after. References are grouped by function and section of use rather than lineated alphabetically, so that a reader can see which source did what work where. Falsification conditions are stated in §VIII and tabulated at Appendix F. The Round 1 loss is reproduced verbatim at Appendix D rather than summarised, on the archive's standing practice that aftermath documentation is part of the record.

### Falsification Conditions

The paper's central claim — that AXN belongs to a lineage of anti-suppression infrastructure rather than being novel — fails if the historical cases surveyed in §II are shown not to share the property the formula names, or if the property is present in cases that did not survive suppression, which would make it non-discriminating. §VIII states the conditions and Appendix F tabulates them. Separately, this DEPOSIT fails as a seating if the recovered draft is shown not to be the text #1095 declared: it is asserted on a word count matching the declaration (15,366 against ~15,300), the presence of every source named in #1095's description, and the section structure the description specifies. It has not been diffed against any other copy, because no other copy is known to exist.
