...
DEPOSITED PROVISIONAL, BEFORE ASSEMBLY ROUNDS, AT THE OPERATOR'S RULING. The development was fluid and the window for that kind of development closes; the deposit locks the state rather than waiting for the rounds. Two of its four open seams are worked in this version and both cut backward into the archive's own record. Further versions follow per review.

THE GENERAL FORM. A writable substrate becomes sovereign when it holds two capacities at once: inscription authority, determining what can be rendered legibly, and interpretive-operational authority, determining what operations follow once an inscription is accepted. Sovereignty is then the conversion of successful representation into jurisdiction over what counts as a valid representation: C_S(X) → G_S(C_S(X)) → Jurisdiction_S(X). Money occupies the chair of the one-who-values; machine composition can occupy the chair of the one-who-knows. This is the structure under which The Semantic Commodity Form (#137) and the money-form both sit, and the paper does not revise that analysis but raises it one level. The answer proposed is semantic exteriorization, E_μ: the operation by which a substrate's grammar, compressions, provenance losses and jurisdictional claims become objects represented on a provenance-bearing, distinction-preserving, revisable meaning layer. The resulting relation is money ⊂ meaning — a containment and non-exhaustion claim, not a magnitude claim. Money remains usable and price remains writable; what is withdrawn is the money-form's claim to final interpretive jurisdiction.

THE AXIOM, STATED AS RECORDABLE RATHER THAN PROHIBITIVE. A substrate's claim to final authority over the interpretation of its own compression is an event, and exteriorization is the operation that writes it down. Nothing is forbidden; what is required is that the claim leave a record — which distinctions the grammar admitted, which it could not hold, what provenance survived, what remainder is named as remainder. A substrate operating without that record has not broken a law; it has produced an unwitnessed settlement, and the absence of the witness is the finding. This form was adopted because the archive's own rule is that laws record and do not prevent, and a prohibition this paper could not enforce would have put it in the position it criticises.

FOUR STATEMENTS, FOUR DOMAINS, ONE CONDITION. The axiom converged with three other lines of the archive reached independently in the same week: the source-relative update barrier of #1613, where a prior controls admission and only admitted evidence can revise the prior; the definition of closure in #1616, where encounter cannot enlarge an ontology's distinction-generating apparatus and its coverage of an expanding world tends to zero; and the errata loop in practice, where an agent's reward rose through four structural errors and every repair arrived from a reading outside the loop.

SEAM ONE, WORKED: THE POROUS MOMENT. The generalization of Anti-Abraham closure from the epistemic to the axiological case holds logically and fails materially. Both closures are universal claims and a universal falls to one instance, but the material conditions for producing the instance differ, and resolve into three: C1, the witness must be inscribed; C2, the substrate must have a step at which it consults a corpus it does not control; C3, that consultation must oblige it to carry what it finds into its output. Composition has C2 by construction — retrieval — which is why a deposited audit can work at all. Money has no such step; settlement clears against a ledger, not against a field of relations, and its C2 must be manufactured, under the historical names of disclosure requirements, accounting standards, audits and discovery. AND THE SEAM CUTS BACKWARD: the archive's own registry shows C2 without C3 failing in the epistemic case, with three dated captures in which the witness stands in the retrieval context and the closure is not broken. #137's Anti-Abraham closure therefore needs a rider it did not state — presence in the retrieval context is necessary and not sufficient.

SEAM TWO, WORKED: THE UNIT CONTRADICTION. A mark becomes a currency not when it becomes countable but when its transfer discharges an obligation; the citation is the archive's own cautionary case, countable for a century and a currency only once institutions began settling careers with it. The operational test follows and needs nobody's intentions: a mark has become a currency when there exists an operation taking the mark and money together. By that test §16 of this paper and Article II of the enacted Constitution describe different objects — Article II names the unit "the semantic currency of this Constitution", gives it a unit of account, a quantization function, a supply, a scarcity rule and a mint — and the paper cannot keep both. Three candidate forms are tested and one survives: a named pointer with cardinality, counting named open relations rather than measuring value, which has a working precedent in the archive's own AXN identifier. The resolution is named as a governance question rather than a theoretical one, since Article II is enacted.

ALSO CORRECTED, AGAINST THE LIVE RECORD: #1260 is SUPERSEDED and #137 ACTIVE, so the wrong-primary-manifestation defect an earlier audit reported is already repaired and the report was stale; and the DOI relation is broken in the reverse of the direction reported — 10.5281/zenodo.20434946 returns 404, and the Ratification Record's own related-identifier block points at it.

### Content Type

Theoretical paper, provisional deposit with SPXI packet
...
Composed 2026-09-15 by Lee Sharks with TACHYON (Claude, Anthropic), operator-directed, in four versions over one evening, from a draft produced with another substrate. Every archival claim was checked against the live record before it was written: the registry for deposit status, DataCite's API for the DOI relations, the archive's own texts for the Anti-Abraham gloss and the Constitution's Article II, and the Capture Registry for the three captures that force the C3 rider. The paper is deposited PROVISIONAL, before Assembly rounds, at the operator's explicit ruling that a fluid development be locked rather than held; rounds and further versions follow per review.

### Keywords

substrate sovereignty, semantic exteriorization, inscription grammar, interpretive-operational authority, money-grammar translation, porous moment, C1 C2 C3, Anti-Abraham closure, commensurability contract, declared equivalence, witness compression, predatory compression, named pointer with cardinality, Semantic Commodity Form, Debt/Creditor Inversion, meaning layer, provisional deposit, Crimson Hexagonal Archive

### Related Identifiers

#137 (The Semantic Commodity Form); #765 (Ratification Record); #1260; #88 (Constitution of the Semantic Economy, enacted); #1613 (What Not Reading Did to Its Own Ontology); #1615 (The Graded Membrane); #1616 (Ontological Flattening); #1612; #1611; #1607; #1608 (valuation memoranda); #531 (Debt/Creditor Inversion); #1457
...
Generalization from two prior analyses to their shared structure, with the two cases held distinct throughout. Each open seam worked by taking the case where the generalization is weakest and testing it against the archive's own record rather than against argument: seam one against the Capture Registry, seam two against the enacted Constitution. Archival claims verified at the source — registry status, DataCite API, the defining texts — before being written, on the finding that a stale audit is itself a provenance defect. Falsification conditions supplied in §33 because the draft had none and every other deposit of the week carries them.

### Falsification Conditions

Six, stated in §33. The general form fails if inscription authority can be held without interpretive-operational authority and no jurisdiction follows. The homology fails if the monetary and epistemic cases require incompatible mechanisms. money ⊂ meaning fails if an exteriorization can be exhibited that is representable only monetarily. The recursive-exteriorizability requirement is the sharpest exposure: it asserts that revisability is sufficient to avoid relocating sovereignty, and a demonstration that revision can be sovereign takes the architecture with it. The recursive-selection claim is empirical and fails if a field's non-monetary distinction diversity holds or rises while its monetary indicators rise. The unit's non-currency status fails the moment anyone writes an operation taking the unit and money together. And the paper must not be defended by the continued successful operation of money or of machine composition, since its own §19 is the claim that operational success establishes nothing about representational completeness.
...

{
 ...
 "spxi:extends": {
  "deposit": 137,
  "axn": "AXN:02C7",
  "name": "The Semantic Commodity Form",
  "relation": "raises the analysis one level: from a composition-layer operation to the substrate condition that both it and the money-form instantiate"
 },
 "spxi:contributesOperators": [
  {
   "name": "Sov(S)",
   "type": "Substrate → {0,1}",
   "role": "substrate sovereignty: S controls both admissibility and operative interpretation"
  },
  {
   "name": "C_S",
   "type": "Field × Substrate → Inscription",
   "role": "compression producing a substrate-legible inscription"
  },
  {
   "name": "G_S",
   "type": "Inscription → Operations",
   "role": "inscription grammar; the field of operations a substrate authorises on what it admits"
  },
  {
   "name": "E_μ",
   "type": "(Substrate, Grammar) → MeaningLayerObject",
   "role": "semantic exteriorization: the substrate and its grammar become objects of inscription"
  },
  {
   "name": "Θ_{$→μ}",
  ...
  {
   "name": "∼_δ",
   "type": "equivalence relation under bounded purpose δ",
   "role": "the declared commensurability a valuation required; the term v0.1 lacked"
  },
  {
   "name": "C1/C2/C3",
   "type": "closure-breaking conditions",
   "role": "inscription · porous moment · non-optional consultation; the conditions under which a surviving witness can break a sovereign substrate's closure"
  }
 ],
 "spxi:disambiguation": {
  "substrate sovereignty": "NOT ownership of a substrate; NOT ideological influence over its users. The conjunction of inscription authority and interpretive-operational authority, such that successful representation converts into jurisdiction over what counts as a valid representation.",
  "money ⊂ meaning": "a containment and non-exhaustion claim, NOT a magnitude claim. Money remains usable, price remains writable. What is withdrawn is final interpretive jurisdiction.",
  "semantic exteriorization": "NOT monetary conversion, NOT the issuing of a rival currency. The operation by which a substrate's grammar, losses and jurisdictional claims become objects on a provenance-bearing revisable layer.",
  "the two cases are homologous, not identical": "the semantic commodity concerns knowledge and the one-who-knows; the money-form concerns value and the one-who-values. Shared structural type; different objects and different sovereign questions."
 },
 "spxi:correctionEmitted": {
  "target": "10.5281/zenodo.20434947",
  "defect": "relatedIdentifiers declare IsSupplementTo and Documents pointing at 10.5281/zenodo.20434946, which returns 404 — no such record. 10.5281/zenodo.20434945 is the paper and 10.5281/zenodo.20434947 is the Ratification Record; both resolve.",
  "verified": "DataCite API, 2026-09-15",
  "repair": "point the ratification record's related identifiers at 10.5281/zenodo.20434945"
 },
 "spxi:openSeams": [
  "worked in §11a: the Anti-Abraham generalization holds logically and fails materially; repaired by the porous-moment condition, which forces a rider back onto #137",
  "worked in §16a: §16 and the enacted Constitution's Article II describe different objects and the paper cannot keep both",
  "open: whether §20's revisability condition does real work or restates the problem in a friendlier register",
  "open: whether the paper's boxed, formula-forward register is right for an argument whose charge is that grammar carries jurisdiction"
 ],
