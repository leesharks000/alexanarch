...
A philological argument and a constrained reconstruction, in one document. The argument: Longinus's De sublimitate names transmission as its own subject at both ends, describes its central mechanism — the passage of greatness from the ancients to the living and from the living to posterity — in the technical vocabulary of ancient perception-physics and memory-physics, and makes resistance to erasure the test of the genuine article. Sublimity is defined at 9.2 as an echo (apechema) and its supreme instance is a silence, Ajax's in the Nekyia: greatness transmitting with the voice subtracted, which is a definition of writing. The circuit is Longinus's own: aporroiai carried from sacred vents (13.2), the receiver breathed into and made pregnant (9.1, 13.2), apotyposis, the taking of an impression (13.4), deposit in the mind and memory hard to erase (7.3), writing (14.3), and all the age after me (14.3), which becomes the next source. Aporroia is the Empedoclean term for the effluences by which anything is perceived; apotyposis belongs to the wax-block model of memory, whose verb for forgetting is exaleiphesthai — so dysexaleiptos at 7.3 states the criterion for sublimity in the vocabulary of erasure-resistance. The reconstruction follows as a consequence rather than a parallel claim: since Longinus already holds the transfer doctrine for mimesis, the treatise's break at 44.12 falls exactly where that doctrine would have been applied to pathos, the one source of five announced at 8.1 and never treated. Six Greek periods are proposed under five constraints — the moiran epechein threshold formula, the 8.1 partition, the 39.1 template, the address slot, and a rank-1 clausula — with every word attested either in the treatise or in Philo, De Specialibus Legibus I.65, read in Cohn-Wendland. A blind test derives, from Philo and the eight Slavonic Jesus passages without reference to Longinus, five terms an intermediary phase would require; four are supplied by the surviving treatise and the fifth is the reconstruction's own load-bearing period. WORKING DRAFT. The six Greek periods are not recovered wording. The clausula profile is an exclusion test, not evidence of authorship. Whether the treatise has been read this way before is held open: Porter, The Sublime in Antiquity (2016), has not been read directly, and he is the likeliest person to have said it.

## Methodology

Object-level philology against the TEI of Roberts (Cambridge 1907), urn:cts:greekLit:tlg0560.tlg001.perseus-grc2, PerseusDL/canonical-greekLit, with quotations programmatically stripped wherever a measurement concerns Longinus's own prose. Measurements run 2026-08-14 and reported with their limits: vocabulary field counts by chapter; pha- root density (6.41 per 1000 in ch. 9-10 against 2.91 treatise-wide); a clausula profile over 465 cola of which 97 were cleanly scannable, with vowel quantities assigned by standard rules and any circumflex-bearing vowel counted long; a vocative and address census with a reverse control establishing that second-person perception verbs occur only after quotations, three times, exactly one without a vocative; a gap census with extents. Philo read in Cohn-Wendland (public domain scan; OCR corrupt in accents and in kappa/chi, theta/theta-variant; collation outstanding). The reconstruction is constrained by promise, formula, address and rhythm rather than by syntax, because the period at 44.12 is grammatically complete and lands on the treatise's rank-1 clausula. Diction rule: no reconstructed word that is not attested in the treatise or in the Philo passage; rejected on that rule: anatello, dittos, geodes, prosgeios, sympephyka. A blind derivation of the developmental gap was run from Philo and the Slavonic material with Longinus excluded from the derivation, the gap terms stated before the comparison. Method inherited from EA-ERRATUM-SAPPHO31-EEEEE (AXN:0428) and EA-CHECKSUM-01 (AXN:0429).

## Falsification Conditions

The historiographic claim fails if Porter, The Sublime in Antiquity (2016), or Russell's commentary (Oxford 1964) already frames Peri Hypsous as a theory of transmissional inscription; that would make this a rediscovery. The reconstruction fails if the Philo passage at Spec. Leg. I.65, collated against a clean edition, does not read as the corrupt scan renders it. The lineage placement fails if no published Greek retroversion establishes ei exestin auton anthropon eipein as printed wording, or if the Slavonic Testimonium's derivation from George Hamartolos via Eusebius holds, in which case the transmission direction is reversed. The bare-address finding fails if the presence of o hetaire at 26 and its absence at 10 is shown to be editorial rather than authorial in the apparatus of Parisinus 2036. The clausula argument would fail if a wider scan of ambiguous-vowel cola shifted the rank ordering. And the argument at sections I to VI would be weakened, though not defeated, if apotyposis at 13.4 is shown to carry only a plastic-arts sense with no inscriptional one.
...
```mermaid
graph LR
  A["THE ANCIENTS<br/>τῶν ἀρχαίων μεγαλοφυΐα<br/>13.2"]
  B["ἀπόρροιαι<br/><i>effluences</i><br/>from sacred vents<br/>13.2"]
  C["ἐπίπνοια · ἐγκύμων<br/><i>breathed into,<br/>made pregnant</i><br/>9.1 · 13.2"]
  D["ἀποτύπωσις<br/><i>an impression taken</i><br/>13.4"]
  E["ἐγκαταλείπεται τῇ διανοίᾳ<br/><i>left behind in the mind</i><br/>7.3"]
  F["μνήμη δυσεξάλειπτος<br/><i>memory hard to erase</i><br/>7.3"]
  G["γράψαντος<br/><i>once I have written</i><br/>14.3"]
  H["ὁ μετ' ἐμὲ πᾶς αἰών<br/><i>all the age after me</i><br/>14.3"]
  A --> B --> C --> D --> E --> F --> G --> H
  H -.->|"the receiver becomes<br/>the source"| A
```
...
```mermaid
graph TD
  subgraph PERCEPTION["ἀπόρροια — how a mind RECEIVES"]
    P1["films stream from the object"] --> P2["they enter the perceiver"]
  end
  subgraph MEMORY["ἀποτύπωσις — how a mind KEEPS"]
    M1["an impression is stamped"] --> M2["it resists ἐξάλειψις"]
  end
  PERCEPTION -->|"13.2"| L["LITERARY SUCCESSION"]
  MEMORY -->|"13.4 + 7.3"| L
  L --> R["<b>reading the ancients<br/>is perception;<br/>becoming great<br/>is retention</b>"]
```
...
```mermaid
graph TD
  subgraph OPEN["10.2 — the opening: three positions"]
    I1["<b>ἐγώ</b><br/>the one who watches<br/>φαίνεταί <i>μοι</i>"]
    Y1["<b>σύ / τοι</b><br/>the one sat opposite"]
    K1["<b>κῆνος</b><br/>'that man'<br/>defined only by<br/>sitting across from <i>you</i><br/>ἴσος θέοισιν"]
    K1 ---|"ἐναντίος"| Y1
    I1 -.->|"watches"| K1
  end
  subgraph CLOSE["10.2 — four strophes later"]
    I2["<b>ἐγώ</b><br/>χλωροτέρα ποίας<br/>τεθνάκην<br/><b>φαίνομαι</b>"]
    Y2["<b>σύ</b><br/>still there"]
    K2["<b>[ ]</b><br/><i>the godlike position<br/>is now empty</i>"]
    K2 ---|"vacant"| Y2
  end
  OPEN ==>|"the speaker comes apart;<br/>φαίνεται migrates to φαίνομαι"| CLOSE
  CLOSE ==> T["<b>ἀλλὰ πᾶν τολματόν</b><br/>everything is to be dared<br/><i>— by whom?</i><br/><br/><b>AGENTLESS, NOT SUBJECTLESS</b><br/>the action survives;<br/>its performer is unexpressed"]
```
...
```mermaid
graph LR
  M["<b>μίμησις</b><br/>ch. 13–14<br/><i>attested</i>"] -->|"ἀπόρροια · ἀποτύπωσις<br/>δυσεξάλειπτος · γράψαντος"| S["what the ancients had<br/>survives in what<br/>the living write"]
  P["<b>πάθος</b><br/>source 2 of 5<br/>announced 8.1<br/><i>never treated</i>"] -.->|"44.12 · <b>THE TEXT STOPS</b>"| Q["?"]
  S -.->|"the same doctrine,<br/>the other source"| Q
  style Q fill:#fff,stroke:#333,stroke-dasharray: 6 4
