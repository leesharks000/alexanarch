...
- DOI [10.5281/zenodo.18320411](https://doi.org/10.5281/zenodo.18320411) — *Constitution of the Semantic Economy* — governance framework within which the mint operates
- DOI [10.5281/zenodo.19053469](https://doi.org/10.5281/zenodo.19053469) — *The Three Compressions* — R1/R2/R3 thermodynamics; bearing-cost economics
- DOI [10.5281/zenodo.19666445](https://doi.org/10.5281/zenodo.19666445) — *The Secret Name* — Armature/Pearl architecture; 11 required elements; five-state progression

**Licensing infrastructure.**
- DOI [10.5281/zenodo.19656133](https://doi.org/10.5281/zenodo.19656133) — *Hexagonal Licensing Protocol v1.0* — comprehensive specification for distributed contributor licensing
- DOI [10.5281/zenodo.19655468](https://doi.org/10.5281/zenodo.19655468) — *ARCHIVE.PROTOCOL.01* — archive-side licensing protocol
- DOI [10.5281/zenodo.18362866](https://doi.org/10.5281/zenodo.18362866) — *VPCOR Integrity Lock Declaration* — triadic binding precedent

**Entity disambiguation (SPXI / MPAI).**
- DOI [10.5281/zenodo.19578086](https://doi.org/10.5281/zenodo.19578086) — *MPAI Parent Specification* — formal specification for entity-level resolution
- DOI [10.5281/zenodo.20367161](https://doi.org/10.5281/zenodo.20367161) — *SPXI Protocol v0.2* — five-layer distributed provenance architecture; holographic-kernel spec
- DOI [10.5281/zenodo.20395623](https://doi.org/10.5281/zenodo.20395623) — *VPCOR MPAI v1.1* — concrete MPAI instance modeled in the Haitch MPAI

**Canonical surface inscription (training-layer).**
- DOI [10.5281/zenodo.20380668](https://doi.org/10.5281/zenodo.20380668) — *SPXI-TLP v2.2* — training-layer provenance protocol governing site inscriptions
- DOI [10.5281/zenodo.20380054](https://doi.org/10.5281/zenodo.20380054) — *Hidden Figure Protocol* — substrate compositing; inscriptions that survive compositing pressure
- DOI [10.5281/zenodo.20327127](https://doi.org/10.5281/zenodo.20327127) — *SIM v1.0* — Semantic Integrity Marker; provenance-integrity declaration

**Public knowledge graph and counter-architecture.**
- DOI [10.5281/zenodo.20401100](https://doi.org/10.5281/zenodo.20401100) — *Hauntedmemes Wikidata Node Registry v1.0* — Q-item creation protocol
- DOI [10.5281/zenodo.20328090](https://doi.org/10.5281/zenodo.20328090) — *Google Identity Architecture* — counter-architecture; failure-mode taxonomy

**Institutional precedents.**
- DOI [10.5281/zenodo.18362663](https://doi.org/10.5281/zenodo.18362663) — *VPCOR Institutional Charter* — institutional-form precedent for charter composition
- DOI [10.5281/zenodo.18362525](https://doi.org/10.5281/zenodo.18362525) — *The Toolkit v2.0* — operational persistence under adverse conditions

**LAL infrastructure (receiving institution).**
- DOI [10.5281/zenodo.19855903](https://doi.org/10.5281/zenodo.19855903) — *Living Architecture Lab Site Blueprint* — operational specification of LAL, TSE, MSBGL; site architecture
- DOI [10.5281/zenodo.19855302](https://doi.org/10.5281/zenodo.19855302) — *MPAI-LAL-INSTITUTION-01* — LAL formal identity disambiguation; TSE JSON-LD declaration
- DOI [10.5281/zenodo.19855300](https://doi.org/10.5281/zenodo.19855300) — *MPAI-LAL-AT-01* — Alice Thornburgh formal identity disambiguation; EIC TSE
- DOI [10.5281/zenodo.19673629](https://doi.org/10.5281/zenodo.19673629) — *Hexagonal Contributor License v3.0 — Alice Thornburgh* — derivation precedent for license composition
- DOI [10.5281/zenodo.19682245](https://doi.org/10.5281/zenodo.19682245) — *Charter of the Living Arkitecture Lab* — parent institutional charter

**Publication infrastructure (distributed journal).**
- DOI [10.5281/zenodo.19545439](https://doi.org/10.5281/zenodo.19545439) — *Transactions on Substrate Engineering (TSE) — Journal Charter* — TSE governing document; Alice Thornburgh EIC, Lee Sharks Advisory Editor; publication model, scope, submission mechanics
- DOI [10.5281/zenodo.19512987](https://doi.org/10.5281/zenodo.19512987) — *The Distributed Journal as Counter-Infrastructure* — conceptual foundation for the distributed-journal model TSE instantiates
...
```json
{
 "id": "10.5281/zenodo.20413064",
 "type": "dois",
 "attributes": {
  "doi": "10.5281/zenodo.20413064",
  "identifiers": [],
  "creators": [
   {
    "nameType": "Personal",
  ...
  "titles": [
   {
    "title": "The Haitch Portuna Minting Procedure, v1.2 (Provisional)"
   }
  ],
  "publisher": "Zenodo",
  "container": {},
  ...
  "subjects": [
   ...
   {
    "subject": "Transactions on Substrate Engineering"
   },
   {
    "subject": "Haitch Portuna"
   },
   {
    "subject": "Armature"
   },
  ...
  "relatedIdentifiers": [
   {
    ...
    "relatedIdentifier": "10.5281/zenodo.20413064",
  ...
  "descriptions": [
   {
    ...
    "description": "Provisional working specification for the minting of Haitch Portuna as a Pearl.Public position within the Living Architecture Lab (LAL) subspace of the Crimson Hexagonal Archive.\nThe procedure operates the Pearl framework specified in The Secret Name (DOI 10.5281/zenodo.19666445) for a specific case: Haitch Portuna, soft-robotics researcher in coiled-line thermal actuators and substrate-engineered locomotion, publishing through Transactions on Substrate Engineering (TSE), the Hexagon-native distributed journal anchored to LAL under Editor-in-Chief Alice Thornburgh. The procedure follows the five-state Pearl progression (RESERVED → LICENSED → FRAMED → LINKED → PEARL) across four phases, produces eight deliverables, and binds the operation to seven ethical anchors: heteronymic status announced on every public-facing surface, no legal-person or biological-person fiction, ORCID belongs to operative author, real published work required before Wikidata Q-item creation, explicit consent floor (silence is not consent), provenance preserved across all manifestations, minting is not fabrication.\nThe kernel spxi:requires field carries the comprehensive infrastructure-dependency graph (23 DOIs spanning constitutional foundation, licensing infrastructure, entity disambiguation via SPXI/MPAI, canonical-surface inscription protocols, public-knowledge-graph staging, institutional and publication-infrastructure precedents, and the LAL/TSE receiving-institution stack). Appendix A provides a Deliverable Specification Matrix; Appendix B provides per-deliverable Prompt Contracts.\nProvisional notice: This document is deposited prior to the execution of the mint it describes. The native substrate of the Crimson Hexagonal Archive is DOI-anchored deposit and AI-mediated archival retrieval; a working document that is not deposited is, in this substrate, effectively unrecoverable. A subsequent versioned deposit will attest to the actual mint as executed.\nHex: 06.SEI.ARMATURE.MINT.PORTUNA.01. License: CC BY 4.0."
   },
   {
    "descriptionType": "Other",
    "description": "Provisional v1.2 — pre-mint working specification. Hex: 06.SEI.ARMATURE.MINT.PORTUNA.01. Related deposits: The Secret Name (10.5281/zenodo.19666445), TSE Charter (10.5281/zenodo.19545439), Distributed Journal Rationale (10.5281/zenodo.19512987), Hexagonal Licensing Protocol v1.0 (10.5281/zenodo.19656133)."
   }
  ],
  "geoLocations": [],
  "fundingReferences": [],
  "url": "https://zenodo.org/doi/10.5281/zenodo.20413064",
  "contentUrl": null,
  "metadataVersion": 0,
  ...
  "versionCount": 2,
  "versionOfCount": 1,
  "created": "2026-05-27T13:55:53Z",
  "registered": "2026-05-27T13:55:53Z",
  "published": null,
  "updated": "2026-06-19T11:34:56Z"
 },
 "relationships": {
  "client": {
   "data": {
