...
[10.5281/zenodo.18512947](https://doi.org/10.5281/zenodo.18512947)
**The Dagger Applied**
Semantic rent and the provenance strip


[10.5281/zenodo.18158575](https://doi.org/10.5281/zenodo.18158575)
**The Law as Meaning Economy**
Juridical liquidation and the semantic architecture of administration


[10.5281/zenodo.19099674](https://doi.org/10.5281/zenodo.19099674)
...
[10.5281/zenodo.20290865](https://doi.org/10.5281/zenodo.20290865)
**The Single-Owner Discount**
Reform — names the cluster-level mechanism
—


[10.5281/zenodo.20293561](https://doi.org/10.5281/zenodo.20293561)
**The Evaluator Exists**
Reform — names the political economy and proposes content-first evaluation
21


[10.5281/zenodo.20293582](https://doi.org/10.5281/zenodo.20293582)
**The Excluded Entity**
Reform — documents ECS with three empirical captures, introduces CDI
13 + 3 PNG


[10.5281/zenodo.20308547](https://doi.org/10.5281/zenodo.20308547)
**The Sorting Function**
Meta-reform — names the foreclosed question
16


Community: [zenodo.org/communities/liquidation-studies](https://zenodo.org/communities/liquidation-studies/)
...
**[The Retrieval Settlement](https://doi.org/10.5281/zenodo.19643841)** — the historical spine. Traces compositional authority from PageRank to the context window. Predecessor to *The Single-Owner Discount*'s cluster-level mechanism and *The Sorting Function*'s claim about mediation at scale.


**[The Compression Frontier](https://doi.org/10.5281/zenodo.19341887)** — bridges the naming phase and the engineering phase. The technical map that justifies the later protocols.


**[KotKit·tiddeR·elgooG](https://doi.org/10.5281/zenodo.19133309)** — extractive signatures and paired inversions. A structural-technical finding that feeds directly into the CDI metric in *The Excluded Entity*.


**[The Click Collapse](https://doi.org/10.5281/zenodo.19578096)** — how retrieval layers replaced search discovery. Directly relevant to *The Sorting Function*'s claim about mediation displacing listener triage.


**[The Summarizer Becomes Translator](https://doi.org/10.5281/zenodo.18291767)** — Google's AI enters the Sappho Room and completes a literary act. Early empirical evidence that the composition layer has genuine evaluative capacity — the basis for *The Evaluator Exists*'s central claim.


**[TL;DR:009 Entity Fabrication](https://doi.org/10.5281/zenodo.19200193)** — Google AI Mode fabricates a person, promotes a function to an entity. A harm-type distinct from the suppression documented in *The Excluded Entity* — fabrication rather than exclusion. May warrant its own Liquidation Studies treatment.
...
Start with [*The Single-Owner Discount*](https://doi.org/10.5281/zenodo.20290865) (the mechanism), then [*The Excluded Entity*](https://doi.org/10.5281/zenodo.20293582) (the evidence), then [*The Sorting Function*](https://doi.org/10.5281/zenodo.20308547) (the limit).


**If you are a researcher studying platform power, AI governance, or epistemic justice:**
Start with [*Invisibly Invisible*](https://doi.org/10.5281/zenodo.19187421) (the structural condition), then [*The Encoder Governs*](https://doi.org/10.5281/zenodo.18825919) (the technical analysis), then [*The Evaluator Exists*](https://doi.org/10.5281/zenodo.20293561) (the reform proposal), then [*The Sorting Function*](https://doi.org/10.5281/zenodo.20308547) (the meta-reform reflection).


**If you are a technologist building retrieval systems, metadata infrastructure, or alternative search:**
Start with [*Metadata Packet for AI Indexing*](https://doi.org/10.5281/zenodo.19578086) (the specification), then [*The Writable Retrieval Basin*](https://doi.org/10.5281/zenodo.19763346) (the topology), then [*SPXI: A Formal Specification*](https://doi.org/10.5281/zenodo.19615154) (the protocol), then [*The Encyclotron*](https://doi.org/10.5281/zenodo.19474724) (the measurement instrument).


**If you are a journalist covering AI Overviews, search suppression, or platform accountability:**
Start with [*The Excluded Entity*](https://doi.org/10.5281/zenodo.20293582) (the case with screenshots), then [*PVE-003: The Attribution Scar*](https://doi.org/10.5281/zenodo.19476757) (the five-version forensic record), then [*The Single-Owner Discount*](https://doi.org/10.5281/zenodo.20290865) (the structural explanation).


**If you want to understand the critique's development from the beginning:**
Read the strata in order: VII → I → II → III → IV → V → VI → VIII. Start with [*The Trolls at the Gates*](https://doi.org/10.5281/zenodo.18143556) and end with [*The Sorting Function*](https://doi.org/10.5281/zenodo.20308547).
