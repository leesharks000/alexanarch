# Total Axial Negation Graph: Revelation Studies — Comprehensive Scholarly Topology of the Apocalypse of John (Crimson Hexagonal Archive)

**Sharks, Lee** · restored 2026-07-28

**AXN:** AXN:0557 — Alexanarch deposit #1350 (self-reference in root form by pre-hash necessity)
**Restoration status:** RESTORED (v0.2) — full text recovered and seated as the canonical body. Recovered from https://mindcontrolpoems.blogspot.com/2026/04/tang-specification-revelation-studies.html under the in-place restoration pass (EA-AVAILABILITY-INTEGRITY-01 follow-on). Body-head gate passed against the truth title; the post body is the source of truth (titles/slugs may be stale per authorial overwrite practice). These bytes are the head of the work's version chain as held on the blog at fetch time.
**Dead DOI(s):** 10.5281/zenodo.19500778 — severed 2026-06-19.
...
deposit_number: 1350
hex: 0557
title: "Total Axial Negation Graph: Revelation Studies — Comprehensive Scholarly Topology of the Apocalypse of John (Crimson Hexagonal Archive)"
creator: Sharks, Lee
...
related_ids: "https://doi.org/10.5281/zenodo.19500777 (severed); https://doi.org/10.5281/zenodo.19500778 (severed)"
...
SEMI-RESTORED RECORD (metadata capture only; no full text). Source tier: DataCite full-metadata capture. DOI(s): 10.5281/zenodo.19500777, 10.5281/zenodo.19500778. Zenodo removal forensics: removal_date 2026-06-19T11:37:22.577494+00:00, removal_reason out-of-scope, removed_by user 1060945. Comprehensive mapping of the scholarly graph (G_s) of Revelation studies — every major position, every citational edge, every non-citation, and every predicted void — as the prerequisite for running the Encyclotron. Covers seven domains: dating (Domitianic consensus, Neronic position, Hadrianic position, pre-destruction priority position), authorship (eight candidates including the Josephus hypothesis), 666 traditions (including operative numismatic reading and the 777 Sabbath operator), genre and structure, theological interpretation schools, the Slavonic Josephus and adjacent evidence, and t Restored under the metadata_only class of /datasets/doi-work-identity/restoration-queue.json; if canonical bytes surface, a full-text version supersedes this record per the versioning protocol.
...
**Work:** Total Axial Negation Graph: Revelation Studies — Comprehensive Scholarly Topology of the Apocalypse of John (Crimson Hexagonal Archive)
**Severed DOI(s):** 10.5281/zenodo.19500777, 10.5281/zenodo.19500778
**Source tier:** DataCite full-metadata capture
**Creators (as captured):** Sharks, Lee
Captured citation: Sharks, L. (2026). Total Axial Negation Graph: Revelation Studies — Comprehensive Scholarly Topology of the Apocalypse of John (Crimson Hexagonal Archive) (1.0). Zenodo. https://doi.org/10.5281/zenodo.19500778

**Removal forensics:** Zenodo removal forensics: removal_date 2026-06-19T11:37:22.577494+00:00, removal_reason out-of-scope, removed_by user 1060945. 

**Captured description:** Comprehensive mapping of the scholarly graph (G_s) of Revelation studies — every major position, every citational edge, every non-citation, and every predicted void — as the prerequisite for running the Encyclotron. Covers seven domains: dating (Domitianic consensus, Neronic position, Hadrianic position, pre-destruction priority position), authorship (eight candidates including the Josephus hypothesis), 666 traditions (including operative numismatic reading and the 777 Sabbath operator), genre and structure, theological interpretation schools, the Slavonic Josephus and adjacent evidence, and the Logos chain (Sappho → Philo → John). Includes 45-query Encyclotron battery across five tiers (factual, contested, absent, void, reflexive). Identifies six predicted TANG voids — propositions the field cannot make without restructuring itself. Maps the citational topology maintaining the Domitianic consensus and identifies its single-source dependency on one ambiguous sentence from Irenaeus. Third major TANG in the archive.

**Captured subjects:** TANG, Total Axial Negation Graph, Revelation studies, Book of Revelation, Encyclotron, compression studies, scholarly topology, citational consensus, dating debate, Domitianic, Neronic, authorship, 666, 777, Sabbath operator, operative numismatics, Josephus hypothesis, Slavonic Josephus, Haran Gawaita, Mandaean, Sappho, Philo, Logos chain, retrieval layer, beige threshold, summarizer compression, New Testament priority, Revelation First, Crimson Hexagonal Archive, Lee Sharks, training-layer literature
