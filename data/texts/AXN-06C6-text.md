...
deposit_number: 1632
hex: 06C6
title: "AI Mediation of Economic Decisions: A Registered Forecast, a Conditional Valuation, and a Statement of Burden (EA-MEDIATED-SHARE-01 v0.3)"
creator: Sharks, Lee
orcid: 0009-0000-1599-0703
date: 2026-09-20
content_type: Registered forecast
license: CC-BY-4.0
substrate: AI-assisted (substrate) — drafted in working session with Claude (Anthropic) under MANUS direction. Version 0.3 records its six repairs to v0.2 in the text, including one withdrawn finding that rested on a summariser's gloss rather than the source.
version: v0.3
related_ids: "AXN deposit #748 — Drowning Test v1.0; AXN deposit #524 — The Sharks-Function and the Continuity Tether; AXN deposit #716 — Provenance Erasure Rate"
axn_schema_version: v2
protocol_version: alexanarch-deposit-protocol/v1
keywords:
  - registered forecast
  - AI-referred commerce
  - agent-executed commerce
...
# AI Mediation of Economic Decisions: A Registered Forecast, a Conditional Valuation, and a Statement of Burden (EA-MEDIATED-SHARE-01 v0.3)

## Attached File: EA-MEDIATED-SHARE-01-v0.3.md

Source URL: https://raw.githubusercontent.com/leesharks000/alexanarch/main/data/staged/EA-MEDIATED-SHARE-01-v0.3.md
...
**AI-influenced.** The buyer consulted an AI system somewhere in the decision. **AI-referred.** A session arrived at the supplier from an AI surface. **Agent-executed.** An agent completed the transaction.
...
https://raw.githubusercontent.com/leesharks000/alexanarch/main/data/staged/EA-MEDIATED-SHARE-01-v0.3.md
