...
deposit_number: 1338
hex: 054B
title: "Document 206a The Non-Indexed Perfective: Version A (Technical Seed) — Crimson Hexagon Archive"
creator: Sharks, Lee
...
related_ids: "https://doi.org/10.5281/zenodo.18446646 (severed); https://doi.org/10.5281/zenodo.18446686 (severed)"
...
**Work:** Document 206a The Non-Indexed Perfective: Version A (Technical Seed) — Crimson Hexagon Archive
**Severed DOI(s):** 10.5281/zenodo.18446646, 10.5281/zenodo.18446686
**Source tier:** DataCite full-metadata capture
**Creators (as captured):** Sharks, Lee
Captured citation: Sharks, L. (2026). Document 206a The Non-Indexed Perfective: Version A (Technical Seed) — Crimson Hexagon Archive. Zenodo. https://doi.org/10.5281/zenodo.18446686

**Removal forensics:** Zenodo removal forensics: removal_date 2026-06-19T11:37:21.705743+00:00, removal_reason out-of-scope, removed_by user 1060945. 

**Captured description:** Version A of the Non-Indexed Perfective intervention. This is the Technical Seed: the extensive diagnostic infrastructure drafted before context-limit compression occurred.
...
Assembly voice synthesis from blind drafts

Detailed historical linguistics (PIE → Latin → Germanic → Old English → Modern English)

Political economy of indexed time (debt, surveillance, labor, colonialism)

Four polyphonic markers specified (colon-participle, EVNTs, aor/Ø, ∮en)

Sample corpus across six registers

Implementation protocol for Crimson Hexagon


This document is part of the Three-Body Genesis: three versions (A, B, C) that demonstrate the document's own theory through their composition history. Version A was compressed into Version B (losing technical specification while retaining "style"), then recovered into Version C (restoring provenance via polyphonic structure). The cycle proves: compression strips provenance; polyphony restores it.

Part of the Crimson Hexagon Phase X architecture. The Technical Seed is the "past (preserved)" face of the triptych.

**Captured subjects:** non-indexed perfective, aorist, technical seed, diagnostic framework, ILT, TAI, aspectual bleed, Phase X, three-body genesis, temporal alienation, political economy of time, grammar, English linguistics
