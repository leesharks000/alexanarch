...
- **Structural subordination** — desire *under* meaning, not beside it
- **Temporal sequencing** — words first, then touch (phenomenological, not merely ethical)
- **Economic metaphor** — non-fungibility (structurally irreplaceable, not just "special")
- **Assembly context** — cross-substrate application possible
