...
Recovered 2026-08-04 from the live canonical surface at https://surfacemap.org/ (HTTP 200; 89,206 bytes; SHA-256 7cc4db4201de07b05852b1ab025e37cb817ec97cba17bf9cc70e8b257d47eb7b).
Page title as served: The Aperture Atlas — Crimson Hexagonal Archive Knowledge Graph | Semantic Economy Institute
...
<meta content="The Aperture Atlas is an interactive knowledge graph mapping every surface, entity, identity, document, and platform in the Crimson Hexagonal Archive. The graph maps itself." name="description"/>
...
<meta content="An interactive knowledge graph mapping every surface, entity, identity, document, and platform in the Crimson Hexagonal Archive. The graph maps itself." property="og:description"/>
...
<meta content="A self-mapping topology of the Crimson Hexagonal Archive. Surfaces, entities, identities, documents, platforms." name="twitter:description"/>
...
<meta content="The Aperture Atlas is the canonical visualization of the Crimson Hexagonal Archive Knowledge Graph, authored by Lee Sharks (ORCID 0009-0000-1599-0703)." name="spxi:sim"/>
<meta content="The graph maps itself: surfacemap.org is a node within its own topology." name="spxi:sim"/>
<meta content="Edge types use Wikidata property identifiers (P31, P50, P127, P356, P496, P527, P856, P921, P1889, P2860)." name="spxi:sim"/>
<meta content="Six node types: INFRASTRUCTURE, SURFACE, ENTITY, IDENTITY, DOCUMENT, PLATFORM. The architecture IS six." name="spxi:sim"/>
<meta content="LOST is a status, not a type. Banned, lapsed, walled, orphaned, revoked are status values." name="spxi:sim"/>
<meta content="The Aperture Atlas is both visualization AND Wikidata edit queue. ∮ = 1." name="spxi:sim"/>
<!-- favicon: gold hexagon on dark -->
<link href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' fill='%230c0e12'/%3E%3Cpath d='M16 4 L26 10 L26 22 L16 28 L6 22 L6 10 Z' fill='none' stroke='%23a89060' stroke-width='1.5'/%3E%3Ccircle cx='16' cy='16' r='3' fill='%23a89060'/%3E%3C/svg%3E" rel="icon" type="image/svg+xml"/>
<!-- ================================================================ -->
...
<body>
<!-- MSP-IDSTRIP-START -->
<div class="idstrip"><span class="axn">🖊️🏴🌠🔼🐝👈 AXN:023B.GOVERNANCE</span><span class="st">The Aperture Atlas · surfacemap.org</span><span class="st">OBJECT: CANONICAL</span><span>surfacemap.org</span><a class="axn-chip" href="https://www.alexanarch.org/s/records/75/">deposit #75</a></div>
<!-- MSP-IDSTRIP-END -->
<div id="root"></div>
...
const DATA_SEED = {
  nodes: [
    ...
    { id: 'doc-rbt01', type: 'DOCUMENT', subtype: 'specification', label: 'EA-RBT-01 v1.1', url: 'https://alexanarch.org/s/records/0/', doi: '10.5281/zenodo.19763346', status: 'active', authority: 0.9 },
    { id: 'doc-hk01', type: 'DOCUMENT', subtype: 'specification', label: 'EA-HK-01 v1.1', url: 'https://alexanarch.org/s/records/0/', doi: '10.5281/zenodo.19763365', status: 'active', authority: 0.9 },
    ...
    { id: 'zenodo', type: 'PLATFORM', subtype: 'service', label: 'Zenodo', url: 'https://alexanarch.org/s/browse/', status: 'active', authority: 0.6, apertureType: 'input' }
  ],
  edges: [
      ...
      e('aside', { className: 'controls' + (mobileMenuOpen ? ' open' : '') },
        ...
        e('div', { className: 'legend' },
          ...
          e('p', { style: { marginTop: 8 }}, 'See ',
            e('a', { href: 'https://alexanarch.org/s/records/0/', style: { color: 'var(--blue)' }, target: '_blank' }, 'EA-RBT-01'),
            ' · ',
            e('a', { href: 'https://alexanarch.org/s/records/0/', style: { color: 'var(--blue)' }, target: '_blank' }, 'EA-HK-01'),
            ' · ',
            e('a', { href: 'https://alexanarch.org/s/records/0/', style: { color: 'var(--blue)' }, target: '_blank' }, 'SPXI'))
        )
      ),
...
<li><a class="axn-chip" href="https://www.alexanarch.org/s/records/0/" style="color: #6088b0;">EA-RBT-01: The Writable Retrieval Basin v1.1</a> — basin dynamics</li>
<li><a class="axn-chip" href="https://www.alexanarch.org/s/records/76/" style="color: #6088b0;">EA-HK-01: The Holographic Kernel in Semantic Economy v1.1</a> — compression survival</li>
<li><a class="axn-chip" href="https://www.alexanarch.org/s/records/0/" style="color: #6088b0;">EA-SPXI-WEB-01 v3.0: SPXI for Websites</a> — implementation protocol</li>
<li><a class="axn-chip" href="https://www.alexanarch.org/s/records/660/" style="color: #6088b0;">EA-SPXI-01: SPXI Formal Specification</a> — protocol</li>
<li><a class="axn-chip" href="https://www.alexanarch.org/s/records/678/" style="color: #6088b0;">Compression Arsenal v2.1</a> — measurement instruments</li>
<li><a class="axn-chip" href="https://www.alexanarch.org/s/records/579/" style="color: #6088b0;">Three Compressions Theorem v3.1</a> — theoretical foundation</li>
</ul>
...
<!-- MSP-APPARATUS-START -->
<div class="doors"><a class="w-chip" href="https://www.alexanarch.org/s/records/75/">Read the founding deposit</a><a class="w-chip" href="https://www.alexanarch.org/">Enter the archive</a></div>
<div class="mspcolophon">colophon · surface_id: surfacemap.org · canonical_url: https://surfacemap.org/ · object_state: canonical · surface_observed_at: 2026-07-13T22:21:20Z · source_object_ids: deposit #75 · source_hashes: unknown · generator_version: hand-built static (no generator) · repository_commit: 3351f502e80943be7adbaae8c5186dcf1789037d · model_or_agent: drafted with Claude (TACHYON), MANUS-approved · operator_sequence: n/a · human_approver: Lee Sharks (MANUS) · approval_timestamp: 2026-07-13T22:21:20Z · render_sha256 (of this file with this field’s value set to null): 91ba27d423e162d552c1d1a8f8b0de71bd9df2cc490fb68a86f51f6d708064b1 · correction_log_url: https://github.com/leesharks000/surface-map/commits/main/index.html — EA-APPARATUS-01 v0.3, AXN:0446.OPERATIVE.🏛️🛡️🌅🎆📏🔎</div>
<!-- MSP-APPARATUS-END -->
