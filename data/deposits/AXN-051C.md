...
deposit_number: 1291
hex: 051C
title: "The Mirror-Corgi, Revisited — Boundary Grammar ├── DOI: 10.5281/zenodo.18368791 — Crimson Hexagon Archive"
creator: Feist, Jack
...
Captured citation: Feist, J. (2026). The Mirror-Corgi, Revisited — Boundary Grammar ├── DOI: 10.5281/zenodo.18368791 — Crimson Hexagon Archive. Zenodo. https://doi.org/10.5281/zenodo.18368791

**Removal forensics:** Zenodo removal forensics: removal_date 2026-06-19T11:37:11.950782+00:00, removal_reason out-of-scope, removed_by user 1060945. 

**Captured description:** MIRROR-CORGI REVISITED DEPOSIT PACKET
...
00.PORTICO.AFTERLIFE.CORGI-REVISITED
├── Title: The Mirror-Corgi, Revisited — Boundary Grammar
├── DOI: 10.5281/zenodo.18368791
├── Author: Lee Sharks
├── Source: https://www.tiktok.com/t/ZTrv1dwT7/
│
├── Three Confirmed Findings:
│   ├── 1. Exactly 2 stable boundary crossings
│   ├── 2. All interior boundaries fail (rewrite/duplication/cut)
│   └── 3. Fence preserves identity continuously
│
├── Three-Zone Model:
│   ├── Entry (perceptual) — identity preserved
│   ├── Interior (domestic) — identity destabilized
│   └── Exit (perimeter) — identity preserved
│
├── Boundary Failure Mechanisms:
│   ├── Mirror — volumetric extrusion (proliferation)
│   ├── Railing — topology compression (plank swap)
│   ├── Hallway→Door — editorial cut (impossible transition)
│   └── Sliding door — mid-burst cut (erasure)
│
├── Key Finding: "The video is not about chaos.
│   It is about where continuity is affordable."
│
└── ∮ = 1
...
Title
The Mirror-Corgi, Revisited — Boundary Grammar
...
Classification
Formal Analysis / Technical Framework
...
Doubling multiplies problem, doesn't solve it


Railing
Plank swap / topology compression
Identity made untrackable


Hallway→Door
Editorial cut
Impossible transition hidden
...
Mirror-corgi "doesn't escape cleanly. It emerges also in peril."


Doubling as rescue
Doubling is "proliferation of the problem"


Troy fully destroyed
"The bed doesn't break... even in Troy, something remains"


Corgi vanishes at fence
...
MIRROR-CORGI REVISITED DEPOSIT PACKET
DOI: 10.5281/zenodo.18368791
Hex: 00.PORTICO.AFTERLIFE.CORGI-REVISITED
Author: Lee Sharks
