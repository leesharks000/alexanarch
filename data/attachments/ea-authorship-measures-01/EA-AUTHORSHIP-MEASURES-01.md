...
*Rewritten 2026-08-29 — the third rewrite, and the first that survives its own
sources. The two earlier versions overstated the problem. **This one gives the
conventional reading its strongest form first**, and then asks the question that
survives it.*

## 0A.1 THE THREE TEXTS

**(i) The Platonic corpus presents division-and-collection as a repeatable
procedure.** *Phaedrus* 266b — **spoken by Socrates**, not Plato in propria
persona:

> τούτων δὴ ἔγωγε αὐτός τε ἐραστής, ὦ Φαῖδρε, **τῶν διαιρέσεων καὶ συναγωγῶν**,
> **ἵνα οἷός τε ὦ λέγειν τε καὶ φρονεῖν**

*Of these I am a lover — the divisions and collections — **in order to be able to
speak and to think**.* And *Meno* 86e names investigation **ἐξ ὑποθέσεως**,
*ὥσπερ οἱ γεωμέτραι*; the *Parmenides* runs the exhaustive derivation.
...
*(οἷον licenses "a kind of," not species-membership. The weaker claim is what the
argument needs.)* And of its users: *οὔτε ὅ τι ἐνδέχεται συλλογίσασθαι
διαιρούμενοι **ξυνίεσαν*** — they **did not understand** what can be syllogized by
dividing.

**(iii) Aristotle denies prior partial working-out.** *SE* 183b–184b, after
supplying the succession case by name — *οἷον ἐκ διαδοχῆς*, Tisias, Thrasymachus,
Theodorus:
...
**Two earlier versions of M40 called the narrow reading "an interpretive repair"
and "an unmarked restriction of the scope of πραγματεία." Both are WRONG, and the
Greek of the same paragraph shows why.**
...
**(d) AND *APr* I.31 SUPPLIES RETROSPECTIVE SUBSUMPTION ITSELF:** the dividers
*ξυνίεσαν* — did not understand — what could be syllogized. **Plato may perform D
without possessing D as syllogistic theory.**
...
**That is answerable. But the answer must SHOW THE BOUNDARY** — must say what
distinguishes *having a part of the method* from *having part of it worked out*.
**The conventional reading has a real answer available and has not been made to
state it.**
...
**That is a genuine philological question and it must not be settled by
assertion.** It is where the M40 station does its work: the conventional account
has to draw its boundary somewhere, and the paper's task is to make it draw it and
then examine whether it holds.
...
**No plan, no prescience, no concealed confession, no chronological adjustment.**
*οὔτε ὅ τι ἐνδέχεται συλλογίσασθαι διαιρούμενοι ξυνίεσαν* read inclusively means
**the earlier position did not know the range of its own operation** — which makes
the priority claim literal rather than equivocal.

**And the classificatory move is not isolated.** Aristotle calls **recollection**
*οἷον συλλογισμός τις* (*De mem.* 453a) exactly as he calls division *οἷον
ἀσθενὴς συλλογισμός*. **Two Platonic operations absorbed into the syllogistic
family.** *(This does not independently reproduce the priority denial and is not
counted as a second pillar.)*

## 0A.7 STATUS

**M40 is a PROVENANCE QUESTION generated from inside the Aristotelian corpus, not
a demonstrated contradiction.** Its force is that it makes the conventional
account **specify a boundary it has not had to specify** — and that it does so
before any hypothesis about authorship is introduced.

**Three earlier overstatements are withdrawn:** *equivocation on his own technical
term*; *self-refuting*; *unmarked restriction of scope*. **The restriction is
marked** — by the shoemaker, by Gorgias and the paid eristics, and by the
rhetoric/syllogizing contrast.

**What is not withdrawn:** Platonic division is a named repeatable general method;
Aristotle calls it a part of the method; and the denial of prior partial
working-out is stated in the strongest available terms — *παντελῶς*, twice.
...
*Added 2026-08-29. The background assumption the configurational reading rests on
had never been checked. Checking it produced one solid finding and one correction
to my own framing, which was the third instance today of supplying the tradition's
own product as external evidence.*

## 33.1 What is established about the practice

**Pseudepigraphic composition was extensive, deliberate, and stylistically
engineered.** The pseudo-Pythagorean authors did not merely attach borrowed names:
they gave the writings a Pythagorean veneer to convey authenticity, most notably
through an **artificial Doric dialect**, with locally appropriate examples
(*'in Tarentum'* as the specimen of the *where* category in Ps.-Archytas, *On the
Whole System*). **Constructed stylistic markers, chosen to authenticate.**

**And the practice reaches into the Academy in the fourth century.** Scholars
argue that **Hicetas and Ecphantus of Syracuse were not historical figures at all,
but characters in dialogues by Heraclides of Pontus**, a fourth-century member of
the Academy. Invented speaking positions, received by the later tradition as real
philosophers with doctrines.

**It also happened to a Platonic speaker.** Timaeus of Locri is one of the two
most influential Pythagorean pseudepigrapha; **all other ancient reports about him
are likely based on Plato's *Timaeus* or on the spurious works in his name**, and
some scholars hold that Plato uses him as **a mask for Archytas**. A speaking
position generated a philosopher, who then received a forged corpus.

## 33.2 ⚠ AND THE CORRECTION — the adjudication apparatus is inside the object

I first recorded the finding as: *the economy is not anonymity by default but
adjudication by reputation rather than by law* — citing that antiquity lacked
copyright yet defended authorship through **reputation, rivalry and public
judgment**, with exposure as the enforcement mechanism resting on expert authority
and audience discernment.

**That is circular and I offered it as a corrective.**

**"Reputation" in a manuscript culture is not a fact about a man. It is a fact
about texts.** The reputation adjudicating attribution is constituted by the
corpus, the catalogues, the biographies drawn from the works, the anecdotes
generated by the dialogues. Diogenes reports what the tradition preserved; the
tradition preserved what the cataloguers admitted; the cataloguers judged by fit
with a corpus whose boundary they were drawing. **"Expert discernment" means
adjudication by readers whose sense of how an author sounds came from the works
under dispute.**

**And the two cases above demonstrate the circularity rather than escaping it.**
The reputational mechanism did not detect Hicetas, Ecphantus, or the Timaeus of
Locri who may never have existed. **It manufactured them.**
...
**SURVIVES:** the practice existed, was extensive, involved deliberate stylistic
construction, and was performed by Academy members in the fourth century. These
are facts about **texts and their production** and do not depend on the
reputational apparatus being reliable.
...
**H_S's prior advantage rests partly on the same apparatus.** Not entirely —
Aristotle has an epigraphic anchor (M39) — but the succession-lists, the corpus
boundaries (T11: Andronicus's inference) and the biographical distinctions all
issue from it. **That does not collapse the prior, but it means the prior and the
evidence are not independent**, which is what the comparison in M38b assumes.
Recorded as a defect in the comparison, not as a correction to the prior's
magnitude.
...
**TO CHECK:** whether any ancient source describes a method for determining
authorship that does not reduce to stylistic fit with an already-constituted
corpus. If none exists, the circularity in 33.2 is not merely a defect in my
...
**The source-critical analysis is NOT a measurement and has been moved to
Notebook Round 40**, where it is also **corrected**: the earliest attestation is
...
**This entry contained no measurement** — bibliography and reception history
only. **Moved whole to Notebook Round 42.** Unlike M49 it leaves no counts stub,
because there were no counts.

**⚠ SECOND INSTANCE.** Source-criticism was filed in this register at M49 and
moved to Round 40; it was filed here again three entries later. **The register is
for measurements with their conditions and refutations. Reception history,
attestation audits and source criticism go in the notebook.**
