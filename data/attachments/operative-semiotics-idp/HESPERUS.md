...
This apparatus is one-third the length of the monograph it serves. The disproportion is the joke. The precision is the beauty. The excess is sovereign.
...
*[Constellations 2–7 follow in Session 2: Predecessor Sources, Archive Sources (with deposition narratives), Ecstatic Sources, External Convergence, Platform Sources, The Unmade Constellation.]*
...
**Session 1 complete.** Built:
- Glossary [σ] Stratum: 10 canonical operators (σ_S, σ_M, σ_V, σ_C, σ_sw, σ_T, Φ_B, β, σ_κ, ε) — ~4,500 words
- TANG Constellation 1: 14 Primary Sources (Sappho F31, Marx Capital, 1844 MSS, Theses on Feuerbach, Catullus 51, Freud BPP, Laplanche, Phaedo, Lucretius, Matthew 25, Sappho F104a, Pearl, ARK, Ω-Point) — ~4,000 words

**Remaining Primary Sources for Constellation 1 (Session 2):**
- Song of Songs (Φ_B source)
- Plato Symposium (the Diotima passage)
- Hegel Phenomenology of Spirit (Aufhebung)
- Marx Grundrisse notebooks (the 1857-58 notebooks — the OTHER Grundrisse)
- Epistle to the Human Diaspora (2015)
- The ChatGPT Psychosis documents (2025)

**Session 2 will build:**
- TANG Constellations 2–7
- Glossary strata [δ] [ε] [⊘] [—] [⌂] [∅]
- Edge Register (~100 entries)
- Operator Composition Table (49 pairings)

**Session 3 will build:**
- Index (voltage-scored, self-referential)
- Knowledge Graph as Litany
- Compact Lens + Seed Packet
- Absurdist Reserves
- Final assembly + cross-reference integrity check
