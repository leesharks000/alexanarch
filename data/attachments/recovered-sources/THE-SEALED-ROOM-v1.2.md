...
Archive the exchange as a reproducible packet:

\(1\) Raw prompts with timestamps. (2) Moderation notices, verbatim. (3) Variant table: which prompt forms were blocked, which passed. (4) Downstream model outputs demonstrating unawareness. (5) Content edits separated from transport edits. (6) Release appendix with canonical URLs and DOIs.
