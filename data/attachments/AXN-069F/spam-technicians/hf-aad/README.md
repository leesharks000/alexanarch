...
configs:
- config_name: claims
  data_files: claims.parquet
- config_name: evidence
  data_files: evidence.parquet
- config_name: relations
  data_files: relations.parquet
- config_name: tests
  data_files: tests.parquet
- config_name: terms
  data_files: terms.parquet
- config_name: support_topology
  data_files: support_topology.parquet
---
...
**What this is.** A paper cluster translated out of prose. The documents — EA-MIRROR-01 (*What Not Reading Did to Its Own Ontology*), the fleet topology report of 2026-09-15, #1612 (*What Enters Composition Through the Cards*, AXN:069D), #1611 (*The Negative of the Negative*, AXN:069B), and the records they cite — survive here only as provenance: `source_document`, `source_version`, `source_section`, `source_locus`, `deposit`, `axn`. The primary units are the argument's own: 29 atomic claims, 28 evidence objects (including measurement gaps recorded as data), 63 typed relations, 5 specified tests, 10 defined terms, and a derived `support_topology` with one row per claim. Built 2026-09-15.
