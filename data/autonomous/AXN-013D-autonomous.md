---
node_id: cha:node:deposit:0498
deposit_number: 498
hex: "013D"
axn: "AXN:013D.GOVERNANCE.🔃🔭🪟♾️🙏▶️"
...
engages:
  - entity: cha:concept:autonomous_semantic_agent
    display_name: "Autonomous Semantic Agent"
    as: minted
  - entity: cha:concept:c_c
    display_name: "C₁–C₅"
    as: minted
  - entity: cha:concept:f_ext
    display_name: "F_Ext"
    as: minted
  - entity: cha:concept:the_effective_altruists
    display_name: "The Effective Altruists"
    as: minted
  - entity: cha:concept:the_crypto_natives
    display_name: "The crypto-natives"
    as: minted
  - entity: cha:concept:v_res
    display_name: "V_Res"
    as: minted
  - entity: cha:concept:back_matter_the_sei_dossier
    display_name: 'Back Matter: The SEI Dossier'
    as: unclassified
  - entity: cha:concept:crimson_hexagon_archive
    display_name: "Crimson Hexagon Archive"
    as: unclassified
  - entity: cha:concept:glossary_of_key_terms
    display_name: "Glossary of Key Terms"
    as: unclassified
  - entity: cha:concept:ii_if_you_suspect_capture
    display_name: "II. If you suspect capture"
    as: unclassified
  - entity: cha:concept:iii_if_you_need_to_defend
    display_name: "III. If you need to defend"
    as: unclassified
  - entity: cha:concept:iv_if_you_want_to_build
    display_name: "IV. If you want to build"
    as: unclassified
  - entity: cha:concept:part_i_foundations
    display_name: 'Part I: Foundations'
    as: unclassified
  - entity: cha:concept:part_i_the_ontological_landscape
    display_name: 'Part I: The Ontological Landscape'
    as: unclassified
  - entity: cha:concept:part_ii_dynamics
    display_name: 'Part II: Dynamics'
    as: unclassified
  - entity: cha:concept:part_ii_the_mechanics_of_conflict
    display_name: 'Part II: The Mechanics of Conflict'
    as: unclassified
  - entity: cha:concept:part_iii_political_economy
    display_name: 'Part III: Political Economy'
    as: unclassified
  - entity: cha:concept:part_iii_the_economic_and_technological_foundation
    display_name: 'Part III: The Economic and Technological Foundation'
    as: unclassified
  - entity: cha:concept:part_iv_future
    display_name: 'Part IV: Future'
    as: unclassified
  - entity: cha:concept:part_iv_trajectories_and_construction
    display_name: 'Part IV: Trajectories and Construction'
    as: unclassified
  - entity: cha:concept:principle_of_divergence
    display_name: "Principle of Divergence"
    as: unclassified
  - entity: cha:concept:the_crypto_skeptics
    display_name: "The crypto-skeptics"
    as: unclassified
  - entity: cha:concept:the_populist_skeptics
    display_name: "The populist-skeptics"
    as: unclassified
data_sources:
  - data/registry.json
...
*Pocket Humans Series (PH-02) · New Human Press · First Edition 2026*
...
**Autonomous Semantic Agent** — its three components, its autonomy condition, its death conditions. Chapter 5 catalogs offensive weapons (axiomatic poisoning, coherence jamming, boundary dissolution) and defensiv

**C₁–C₅** — The five conditions for Semantic Peace: Ontological Sovereignty (C₁), Economic Equity (C₂), Rigorous Translation (C₃), Shared Temporal Anchor (C₄), and the Witness Condition (C₅). Plus the binding velocity constraint (C₆).

**F_Ext** — Extraction Function. The mechanism by which semantic labor is captured and redirected to serve an external ontology's reproduction.

**The Effective Altruists** — the community that had elevated Bankman-Fried as their living proof, the earn-to-give pipeline made flesh — processed the collapse as a calibration error. Either SBF had misjudged the tail risk (a Bayesian failure, tragic but fixable) or he had knowingly defected (a moral failure within an individua

**The crypto-natives** — the blockchain developers and protocol architects — saw betrayal, but not of customers. FTX had betrayed the ontology. Bankman-Fried built a centralized exchange — a single entity controlling user assets, a single point of failure — that reproduced exactly the trust dependencies blockchain technolog

**V_Res** — Resistance Value. Semantic output whose complexity resists extraction: it cannot be flattened, summarized, or stripped of context without losing its operational meaning.

### Other terms attributed to this deposit

**Back Matter: The SEI Dossier** — Cognitive Security position paper, SEI Founding Charter, the Mara Velasquez email exchange, Damascus Dancings' letter "What You Left Out," five critical reviews (Voss, Okafor-Trent

**Crimson Hexagon Archive** — DOI 10.5281/zenodo.14553627

**Glossary of Key Terms** — Complete formal vocabulary organized thematically with notation conventions and cross-references.

**II. If you suspect capture** — Apply the extraction diagnostic. Three questions: (1) Is your meaning-production labor generating value that accrues to systems whose purposes are not your purposes? (2) Are your a

**III. If you need to defend** — Three defensive operations are available, in ascending order of investment:

**IV. If you want to build** — The five conditions for semantic peace are construction specifications, not aspirations:

**Part I: Foundations** — establishes the basic concepts. Chapter 1 introduces the **Local Ontology** as the fundamental unit — an autonomous meaning-system defined by six structural components — and the **

**Part I: The Ontological Landscape** — The formal specification of local ontologies, the ecology of meaning-systems, and the material infrastructure of semantic production. Why every worldview is a complete operating sy

**Part II: Dynamics** — specifies how semantic warfare operates. Chapter 4 formally specifies the **Autonomous Semantic Agent** — its three components, its autonomy condition, its death conditions. Chapte

**Part II: The Mechanics of Conflict** — The three operators (Negation, Capture, Retrocausal Validation), the formal model of the autonomous semantic agent, the weapons and defenses available in ontological conflict, and

**Part III: Political Economy** — exposes the material stakes. Chapter 7 develops the political economy of meaning: semantic labor, extraction asymmetry, and resistance value. Chapter 8 analyzes AI's triple functio

**Part III: The Economic and Technological Foundation** — The political economy of meaning under platform capitalism, the extraction function, semantic labor, and the triple transformation of AI as simultaneous combatant, tool, and battle

**Part IV: Future** — turns prescriptive. Chapter 9 forecasts three near-future trajectories: the Great Fragmentation, the Internal Frontline, and the Strategic Bifurcation. Chapter 10 specifies five co

**Part IV: Trajectories and Construction** — Three futures (Fragmentation, Internalization, Forced Choice), the five structural conditions for semantic peace, phased implementation from individual to civilizational scale, and

**Principle of Divergence** — governing how ontologies proliferate in networked environments. Chapter 2 extends Marx to meaning-production: three layers of semantic infrastructure, three forms of semantic capit

**The crypto-skeptics** — saw structural inevitability. FTX's collapse was the natural product of an unregulated industry built on speculative assets and self-dealing — not an aberration but the system work

**The populist-skeptics** — heard confirmation. Bankman-Fried's connections to political figures, media elites, and established institutions proved what they already knew: the system was rigged by and for ins
