---
node_id: cha:node:deposit:0432
deposit_number: 432
hex: "00F5"
axn: "AXN:00F5.EMPIRICAL.♊🌄🧡🔵✊▲"
...
engages:
  - entity: cha:concept:aspectual_bleed_ab
    display_name: "Aspectual Bleed (AB)"
    as: minted
  - entity: cha:concept:african_american_english_aspectual_markers
    display_name: "African American English aspectual markers"
    as: revised
  - entity: cha:concept:aorist_stem
    display_name: "Aorist stem"
    as: unclassified
  - entity: cha:concept:chronometric_drag_cd
    display_name: "Chronometric Drag (CD)"
    as: unclassified
  - entity: cha:concept:indexical_leakage_test_ilt
    display_name: "Indexical Leakage Test (ILT)"
    as: unclassified
  - entity: cha:concept:irish_english_i_am_after_eating
    display_name: 'Irish English "I am after eating"'
    as: unclassified
  - entity: cha:concept:linguistic_analysis
    display_name: "Linguistic analysis"
    as: unclassified
  - entity: cha:concept:loss_of_verbal_prefixes
    display_name: "Loss of verbal prefixes"
    as: unclassified
  - entity: cha:concept:perfect_stem
    display_name: "Perfect stem"
    as: unclassified
  - entity: cha:concept:present_stem
    display_name: "Present stem"
    as: unclassified
  - entity: cha:concept:rise_of_periphrastic_forms
    display_name: "Rise of periphrastic forms"
    as: unclassified
  - entity: cha:concept:scottish_english_constructions
    display_name: "Scottish English constructions"
    as: unclassified
  - entity: cha:concept:temporal_autonomy_index_tai
    display_name: "Temporal Autonomy Index (TAI)"
    as: unclassified
  - entity: cha:concept:temporal_indexing_becomes_mandatory
    display_name: "Temporal indexing becomes mandatory"
    as: unclassified
  - entity: cha:concept:the_diagnostics_specified
    display_name: 'The diagnostics: specified'
    as: unclassified
  - entity: cha:concept:the_history_traced
    display_name: 'The history: traced'
    as: unclassified
  - entity: cha:concept:the_limitation_diagnosed
    display_name: 'The limitation: diagnosed'
    as: unclassified
  - entity: cha:concept:the_markers_instantiated
    display_name: 'The markers: instantiated'
    as: unclassified
  - entity: cha:concept:the_seeding_begun
    display_name: 'The seeding: begun'
    as: unclassified
data_sources:
  - data/registry.json
...
**Loss of verbal prefixes**: French had no equivalent system. In contact, the OE prefixes withered. By Middle English, *ge-* survives only as the past participle marker (*y-loved*), losing its aspectual function.

- 


**Rise of periphrastic forms**: The French pattern of auxiliary + participle reinforced the English perfect (*have done*) and created new periphrastic futures (*will do*) and progressives (*be doing*).

- 


**Temporal indexing becomes mandatory**: The simplified verb system required explicit temporal adverbials or contextual anchoring to convey what aspect had previously conveyed.
...
Languages with aorist: lower CD (aspect carries temporal information).
English: higher CD (adverbials compensate for aspectual poverty).
...
**The diagnostics: specified.**
**The markers: instantiated.**
**The seeding: begun.**
...
Chronos is clock time, calendar time, indexed time.
Kairos is the moment that is not *a* moment on the timeline but the completion of all timelines.
...
*Self-contained lexicon for:  The Non-Indexed Perfective: A Citational Intervention Phase X: Temporal Alienation in English and the Construction of G*

### Minted (coined from nothing in this deposit)

**Aspectual Bleed (AB)** — For translation studies: take a corpus of Greek texts with high aorist frequency. Compare multiple English translations. Measure variance in tense/aspect choices for identical Gree
...
**Chronometric Drag (CD)** — Count temporal adverbials per 1000 words in comparable texts across languages with vs. without grammaticalized aorist.

**Indexical Leakage Test (ILT)** — Present speakers with minimal sentences about past events:

**Irish English "I am after eating"** — perfective meaning through prepositional construction. Stigmatized as non-standard. (See Filppula, *The Grammar of Irish English*, 1999.)

**Linguistic analysis** — The colon functions here as what might be called an **aspectual boundary marker**—analogous to the "boundary tone" in phonology (see Pierrehumbert and Hirschberg, "The Meaning of I

**Loss of verbal prefixes** — French had no equivalent system. In contact, the OE prefixes withered. By Middle English, *ge-* survives only as the past participle marker (*y-loved*), losing its aspectual functi
...
**Temporal Autonomy Index (TAI)** — TAI = (closure confidence + non-demandingness) – (timestamp pressure + repair pressure + recency inference)

**Temporal indexing becomes mandatory** — The simplified verb system required explicit temporal adverbials or contextual anchoring to convey what aspect had previously conveyed.

**The diagnostics: specified** — **The markers: instantiated.**

**The history: traced** — **The political economy: exposed.**

**The limitation: diagnosed** — **The history: traced.**

**The markers: instantiated** — **The seeding: begun.**

**The seeding: begun** — These statements perform their content. The colon-participle form is the non-indexed perfective in operation. Reading them, you have encountered it. Considering them, you have gran
