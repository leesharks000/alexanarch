---
node_id: cha:node:deposit:0396
deposit_number: 396
hex: "00CD"
axn: "AXN:00CD.STRUCTURAL.🪝🟣⏳🌖▲⚫"
title: 'James 2 as Structural Judgment: The Exclusion of Belief, Intent, and Identity from the Salvation Equation Faith Without '
...
engages:
  - entity: cha:concept:faith_without_works
    display_name: "Faith-without-works"
    as: unclassified
  - entity: cha:concept:identity_lock
    display_name: "Identity-Lock"
    as: unclassified
  - entity: cha:concept:john_9_s_we_see_authorities
    display_name: 'John 9''s "We see" authorities'
    as: unclassified
  - entity: cha:concept:matthew_25_s_lord_lord_speakers
    display_name: 'Matthew 25''s "Lord, Lord" speakers'
    as: unclassified
data_sources:
  - data/registry.json
...
- Correct belief (monotheism) is shared by demons
- Demons are paradigmatically damned
- Therefore correct belief does not distinguish saved from damned
- Therefore correct belief is not probative
...
*Self-contained lexicon for: James 2 as Structural Judgment: The Exclusion of Belief, Intent, and Identity from the Salvation Equation Faith Without *

### Other terms attributed to this deposit

**Faith-without-works** — Substituting category-membership (believer) for enacted response

**Identity-Lock** — the mechanism by which ID prevents recognition of failure:
