---
node_id: cha:node:deposit:0605
deposit_number: 605
hex: "01C0"
axn: "AXN:01C0.GENERATIVE.📎🔅🟤🕐🏛️👁️‍🗨️"
title: "APOCALYPTIC PHILOSOPHY Deleuze and Guattari and the Return of Vision"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:conceptual_visual_unity
    display_name: "Conceptual-visual unity"
    as: unclassified
  - entity: cha:concept:exemplification
    display_name: "Exemplification"
    as: unclassified
  - entity: cha:concept:internal_precision
    display_name: "Internal precision"
    as: unclassified
  - entity: cha:concept:operative_function
    display_name: "Operative function"
    as: unclassified
  - entity: cha:concept:plane_of_immanence
    display_name: "Plane of Immanence"
    as: unclassified
  - entity: cha:concept:repetition_with_variation
    display_name: "Repetition with variation"
    as: unclassified
  - entity: cha:concept:resistance_to_paraphrase
    display_name: "Resistance to paraphrase"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: APOCALYPTIC PHILOSOPHY Deleuze and Guattari and the Return of Vision*

### Other terms attributed to this deposit

**Conceptual-visual unity** — The image is the concept. Face of lion, face of ox, face of eagle, face of man — these are not symbols requiring translation into a separate conceptual register. The seeing *is* th

**Exemplification** — Historical, scientific, artistic, and ethological examples show the concept at work — from metallurgy to music to wolf packs.

**Internal precision** — The vision is highly specific. Four faces, four wings, wheels within wheels, eyes on the rims. Not vague mysticism but detailed architecture.

**Operative function** — The vision reorganizes perception. After seeing the four living creatures, Ezekiel's relationship to divine presence, political authority, and prophetic vocation is permanently alt

**Plane of Immanence** — Not argued for — posited as the ground on which concepts are created. "The plane of immanence is not a concept that is or can be thought but rather the image of thought, the image
