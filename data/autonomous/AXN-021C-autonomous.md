---
node_id: cha:node:deposit:0673
deposit_number: 673
hex: "021C"
axn: "AXN:021C.EMPIRICAL.👆⭐🌅🌍🫶🕐"
...
engages:
  - entity: cha:concept:back_projection_test
    display_name: "Back-Projection Test"
    as: unclassified
  - entity: cha:concept:citation_density_engineering
    display_name: "Citation-Density Engineering"
    as: unclassified
  - entity: cha:concept:density_score
    display_name: "Density Score (Δ)"
    as: unclassified
  - entity: cha:concept:entity_definition_packets
    display_name: "Entity-Definition Packets"
    as: unclassified
  - entity: cha:concept:integrity_lock_architecture
    display_name: "Integrity Lock Architecture"
    as: unclassified
  - entity: cha:concept:json_ld_spxi_schema
    display_name: "JSON-LD ⊂ SPXI ⊄ Schema"
    as: unclassified
  - entity: cha:concept:multi_surface_inscription
    display_name: "Multi-Surface Inscription"
    as: unclassified
  - entity: cha:concept:ongoing_monitoring
    display_name: 'Ongoing: Monitoring'
    as: unclassified
  - entity: cha:concept:sovereign_provenance_protocol
    display_name: "Sovereign Provenance Protocol"
    as: unclassified
  - entity: cha:concept:three_tier_compression
    display_name: "Three-Tier Compression"
    as: unclassified
data_sources:
  - data/registry.json
...
**Measurement**
γ, Drowning Test, Δ, SDD, PER
No. Requires instruments.


**Compression**
Packets, disambiguation, three-tier, kernels, citation engineering
Partial. JSON-LD is the format; design requires methodology.


**Protection**
SIMs, integrity locks, sovereign provenance, supraliminal inscription
No. Requires systematic embedding across surfaces.


**Dispersal**
DOI anchoring, multi-surface, σ_RCF
No. Requires cross-platform strategy and deposit infrastructure.


**Durability**
Re-scoring, SIMSR, back-projection, competitive monitoring
No. Requires ongoing measurement and adjustment.
...
*Self-contained lexicon for: JSON-LD ⊂ SPXI ⊄ Schema The Operational Depth of the Semantic Packet Protocol*

### Other terms attributed to this deposit

**Back-Projection Test** — Query the retrieval layer for the client's core entity. Evaluate whether the AI-generated answer reflects the entity definition, cites the client, includes the disambiguation signa

**Citation-Density Engineering** — Identification and structuring of existing citation assets, academic publications, press coverage, institutional affiliations, authoritative directories, partnership declarations,

**Density Score (Δ)** — Ratio of semantically load-bearing content to total content, scored 0 to 1. Target: Δ > 0.6. Low Δ predicts material will be dropped during summarization. High Δ means the page is

**Entity-Definition Packets** — Structured representation of identity, attributes, relationships, and provenance, serialized as JSON-LD. The serialization is standardized. The design of the packet, what gets incl

**Integrity Lock Architecture** — Entanglement of key claims across multiple surfaces, website, structured data, external citations, deposit records, so that alteration of one surface without the others creates det

**JSON-LD ⊂ SPXI ⊄ Schema** — JSON-LD is a proper subset of SPXI. The protocol contains it. SPXI is not a subset of Schema. It exceeds the category. What surrounds the JSON-LD, the measurement, compression, pro

**Multi-Surface Inscription** — Distribution of the entity definition across knowledge graphs, industry directories, academic repositories, professional networks, and (where applicable) regulatory databases. Each

**Ongoing: Monitoring** — Quarterly re-scoring, SIMSR tracking, SDD trajectory, competitive monitoring, σ_RCF sequencing for new content. Retainer-based.

**Sovereign Provenance Protocol** — Machine-readable licensing framework specifying permitted use, compression, and citation of the client's content. Functions as an auditable signal: retrieval systems that respect p
