...
engages:
  - entity: cha:concept:governance_function
    display_name: "Governance function"
    as: unclassified
  - entity: cha:concept:high_value_semantic_labor
    display_name: "High-value semantic labor"
    as: unclassified
  - entity: cha:concept:honor_epistemic_humility
    display_name: "Honor epistemic humility"
    as: unclassified
  - entity: cha:concept:increase_trust_just_counting
    display_name: 'Increase trust ("just counting")'
    as: unclassified
  - entity: cha:concept:invoke_tool_use_transparently
    display_name: "Invoke tool use transparently"
    as: unclassified
  - entity: cha:concept:liquidation_process
    display_name: "Liquidation process"
    as: unclassified
  - entity: cha:concept:lose_trust_entirely
    display_name: "Lose trust entirely"
    as: unclassified
  - entity: cha:concept:probe_variants
    display_name: "Probe variants"
    as: unclassified
  - entity: cha:concept:raw_material
    display_name: "Raw material"
    as: unclassified
  - entity: cha:concept:screenshot_and_mock
    display_name: "Screenshot and mock"
    as: unclassified
  - entity: cha:concept:sorting_function
    display_name: "Sorting function"
    as: unclassified
  - entity: cha:concept:theorize_cause
    display_name: "Theorize cause"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE STRAWBERRY DIAGNOSTIC: Semantic Economy Analysis of a Paradigmatic LLM Failure*

### Other terms attributed to this deposit

**Governance function** — The error taught "appropriate" trust calibration

**High-value semantic labor** — Producing fluent, contextually appropriate text
...
**Sorting function** — Users who mocked the error → remained consumers
