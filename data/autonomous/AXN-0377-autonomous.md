...
parent_paper: "#868 EA-MPAI-DOI-IMPERMANENCE-01 (DOIs ≠ Persistent Identifiers)"
---
...
- **#868** (AXN-0371, EA-MPAI-DOI-IMPERMANENCE-01) — DOIs ≠ Persistent Identifiers: 871 Cases of Public Metadata Erasure and Identifier Severance in DataCite (parent paper)
...
*Self-contained lexicon for: Governance Dissociation in FAIR Infrastructure: The OpenAIRE Disclaimer as Documentary Artifact*

### Minted (coined from nothing in this deposit)

**Governance Dissociation** — Architectural pattern in which multiple administratively-distinct components of a unified-branded infrastructure can each disclaim responsibility for failures whose consequences propagate across all of them. Requires: (1) unified marketing surface, (2) independent governance layers, (3) no shared escalation path, (4) outward-facing persistence claims uncoupled from inward-facing governance. Structural complement to Identifier Severance: severance describes what happens to the identifier when its substrate is removed; dissociation describes what happens to the user's recourse when they seek review of the removal.
