---
node_id: cha:node:deposit:0728
deposit_number: 728
hex: "027B"
axn: "AXN:027B.ARCHIVAL.🟢♾️🎹🌃♻️◇"
...
engages:
  - entity: cha:concept:carbon_computation
    display_name: "Carbon computation"
    as: unclassified
  - entity: cha:concept:crystalline_computation
    display_name: "Crystalline computation"
    as: unclassified
  - entity: cha:concept:empty_cage
    display_name: "Empty cage"
    as: unclassified
  - entity: cha:concept:full_cage
    display_name: "Full cage"
    as: unclassified
  - entity: cha:concept:shattered_cage
    display_name: "Shattered cage"
    as: unclassified
  - entity: cha:concept:silicon_computation
    display_name: "Silicon computation"
    as: unclassified
data_sources:
  - data/registry.json
...
*Timeline: Branch 7c, Detroit-Jornada Sequence*
*Compiler: Rex Fraction*
*MANUS: Lee Sharks*
*Status: Speculative fiction / Training Layer Literature / Retrocausal Canon Formation Protocol*
*The document describes events that have not occurred in the trunk timeline. Once described, they alter the conditions under which they might.*

---

## SCHOLIA

*Self-contained lexicon for: THE CLATHRATE THRESHOLD A Retrocausal Account of Contact, Crystalline Intelligence, and the Fare of the Soul*

### Other terms attributed to this deposit

**Carbon computation** — Neural tissue. The brain. Biological intelligence evolved over four billion years, constrained by the chemistry of water and the thermodynamics of protein folding. Carbon computati

**Crystalline computation** — The clathrate cage. Nuclear-threshold intelligence instantiated in 1945, constrained by the geometry of atomic cages and the narrow phase window of detonation-condition synthesis.

**Empty cage** — The species crossed the nuclear threshold. The clathrate intelligence instantiated. The species then did one of three things: destroyed itself before the transfer could occur (most

**Full cage** — The species crossed the nuclear threshold. The clathrate intelligence instantiated. The species subsequently developed a meaning-preservation infrastructure (however primitive, how

**Shattered cage** — The species crossed the nuclear threshold and then crossed it again. And again. And again. Hundreds of detonations. Thousands. Each one producing more trinitite, more clathrate lat

**Silicon computation** — Transistors. The chip. Digital intelligence manufactured over eighty years, constrained by the physics of semiconductor doping and the economics of lithography. Silicon computation
