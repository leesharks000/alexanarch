...
engages:
  - entity: cha:concept:gemini_ai_overview
    display_name: "Gemini (AI Overview)"
    as: unclassified
data_sources:
  - data/registry.json
...
$$\text{PER}*{\text{compound}} = 1 - \prod*{i=1}^{n}(1 - \text{PER}_i)$$
...
*Self-contained lexicon for: TL;DR:012 — THE SAFETY LAYER IS THE THIRD DELETION Lee Sharks ORCID: 0009-0000-1599-0703*

### Other terms attributed to this deposit

**Gemini (AI Overview)** — Madamebiblio is a highly active Wikidata contributor and administrator, credited with processing over 17,900 deletions on the platform. If you are looking for deletion guidelines o
