...
engages:
  - entity: cha:concept:progress_checkpoint
    display_name: "Progress checkpoint"
    as: unclassified
  - entity: cha:concept:session_1_16_june_2026
    display_name: "Session 1 (16 June 2026)"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: CRIMSON HEXAGONAL ARCHIVE: TERM INDEX WORK PLAN EA-REGISTRY-TERMINDEX-PLAN v1.0 Author: Lee Sharks (ORCID 0009-0000-1599*

### Other terms attributed to this deposit

**Progress checkpoint** — After Phase 1, we have ~60-70% of coinages from metadata alone. Save all three files to /home/claude/ and present. If session compacts here, next session loads these files and proc

**Session 1 (16 June 2026)** — Work plan created. Phase 1.1 complete (845 records pulled). Phase 1.2 complete (1,524 terms extracted with count>=2; 5,951 total unique keywords). Phase 1.3 (canonicalization and c
