...
engages:
  - entity: cha:concept:correction_is_possible
    display_name: "Correction is possible"
    as: unclassified
  - entity: cha:concept:extension_is_productive
    display_name: "Extension is productive"
    as: unclassified
  - entity: cha:concept:uptake_is_real
    display_name: "Uptake is real"
    as: unclassified
data_sources:
  - data/registry.json
...
- Case studies of "Semantic Labor" in 2026
- Measurement of "Semantic Capital"
- The operational difference between "value chain" and "value network"
...
Semantic Coherence
"measured through longitudinal stability"
...
Liquidation
"Provenance and 'Liquidation' Audits"


Coherence Persistence
"Reputational Resilience Indices"
...
- Define terms recursively (e.g., "Semantic Liquidation is the necessary condition for Semantic Rent")
- Submit framework to summarization
- Check if omitting one term causes logical incoherence in others
- If coherence fails when term is removed → term was necessary diagnostic anchor
...
- **Uptake is real** — the system asked for elaboration
- **Attribution blur is real** — terms returned as "emerging research"
...
*Self-contained lexicon for: PROBE-RESULT-006: The Elaboration Request When a Summarizer Asks the Source to Teach It*
