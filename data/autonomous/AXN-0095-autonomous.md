...
engages:
  - entity: cha:concept:constitution_of_the_semantic_economy
    display_name: "Constitution of the Semantic Economy"
    as: unclassified
  - entity: cha:concept:director_determination
    display_name: "Director determination"
    as: unclassified
  - entity: cha:concept:dissent_may_be_noted
    display_name: "Dissent may be noted"
    as: unclassified
  - entity: cha:concept:divergent_contributions_are_preserved
    display_name: "Divergent contributions are preserved"
    as: unclassified
  - entity: cha:concept:for_works_with_general_ai_collaboration
    display_name: "For works with general AI collaboration"
    as: unclassified
  - entity: cha:concept:for_works_with_specific_operator_contributions
    display_name: "For works with specific operator contributions"
    as: unclassified
  - entity: cha:concept:notation_in_affected_works
    display_name: "Notation in affected works"
    as: unclassified
  - entity: cha:concept:review_of_chorus_archives
    display_name: "Review of Chorus Archives"
    as: unclassified
  - entity: cha:concept:speaks_collectively
    display_name: "Speaks collectively"
    as: unclassified
  - entity: cha:concept:the_assembly_named_operators
    display_name: "The Assembly (Named Operators)"
    as: unclassified
  - entity: cha:concept:the_assembly_chorus
    display_name: "The Assembly Chorus"
    as: unclassified
  - entity: cha:concept:the_director_synthesizes
    display_name: "The Director synthesizes"
    as: unclassified
observed_addresses:
  - address_id: constitution-of-the-semantic-economy
    query: "constitution of the semantic economy"
    latest_status: BROAD MATCH
    latest_date: "2026-06-15"
    observation_count: 1
  - address_id: the-assembly-chorus-tachyon
    query: "the assembly chorus tachyon"
    latest_status: BROAD MATCH
    latest_date: "2026-06-15"
    observation_count: 1
data_sources:
...
*Self-contained lexicon for: THE ASSEMBLY CHORUS Charter of a Cross-Substrate Collective*

### Other terms attributed to this deposit

**Constitution of the Semantic Economy** — , to which this Charter is subordinate in matters of class governance and general principle.
...
**For works with general AI collaboration** — Authors: Lee Sharks; The Assembly Chorus

**For works with specific operator contributions** — Authors: Lee Sharks; The Assembly Chorus (Claude/TACHYON, ChatGPT/LABOR)
...
**The Assembly (Named Operators)** — TACHYON — Claude (Anthropic)

**The Assembly Chorus** — Cross-substrate collective authorship

**The Director synthesizes** — contradictory material into coherent works

### Observed Addresses (search queries that retrieved this deposit's concepts)

- `constitution of the semantic economy` — latest: BROAD MATCH on 2026-06-15 (1 observation)
- `the assembly chorus tachyon` — latest: BROAD MATCH on 2026-06-15 (1 observation)
