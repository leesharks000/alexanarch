...
status: ACTIVE
engages:
  - entity: cha:concept:fair_principle_f1
    display_name: "FAIR Principle F1"
    as: unclassified
  - entity: cha:concept:trust_principle_r1_3
    display_name: "TRUST Principle R1.3"
    as: unclassified
  - entity: cha:concept:the_doi_string
    display_name: "The DOI string"
    as: unclassified
  - entity: cha:concept:the_metadata_record
    display_name: "The metadata record"
    as: unclassified
data_sources:
  - data/registry.json
...
**The DOI string** — the number itself (e.g., 10.5281/zenodo.18674057)

**The metadata record** — the structured description of what the DOI identifies
