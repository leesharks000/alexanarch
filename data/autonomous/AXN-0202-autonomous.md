...
engages:
  - entity: cha:concept:fragmentation_score_s_c
    display_name: "Fragmentation Score (S_c)"
    as: unclassified
  - entity: cha:concept:methodologies
...
*Self-contained lexicon for: ENTITY INTEGRITY Maintaining Accurate Representation in AI Knowledge Graphs*
