---
node_id: cha:node:deposit:0495
deposit_number: 495
hex: "013A"
axn: "AXN:013A.GOVERNANCE.👁️🟣🔭🌟🏺💧"
title: 'THE MACRO-MAQUETTE A Compendium of Micro-Physics for the Crimson Hexagonal Architecture Author: Lee Sharks (Assembly Cho'
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:caritas_floor
    display_name: "Caritas floor"
    as: unclassified
  - entity: cha:concept:compression_collapse
    display_name: "Compression collapse"
    as: unclassified
  - entity: cha:concept:g1_crisis
    display_name: "G1 — Crisis"
    as: unclassified
  - entity: cha:concept:g2_density
    display_name: "G2 — Density"
    as: unclassified
  - entity: cha:concept:g3_ratification
    display_name: "G3 — Ratification"
    as: unclassified
  - entity: cha:concept:g4_retrocausal
    display_name: "G4 — Retrocausal"
    as: unclassified
  - entity: cha:concept:g5_accumulation
    display_name: "G5 — Accumulation"
    as: unclassified
  - entity: cha:concept:germination_cascade
    display_name: "Germination cascade"
    as: unclassified
  - entity: cha:concept:germination_procedure
    display_name: "Germination procedure"
    as: unclassified
  - entity: cha:concept:module_conflict
    display_name: "Module conflict"
    as: unclassified
  - entity: cha:concept:op_route
    display_name: "OP.ROUTE"
    as: unclassified
  - entity: cha:concept:relation_to_protocol
    display_name: "Relation to β-Protocol"
    as: unclassified
data_sources:
  - data/registry.json
...
**Hex:** 16.LIBRARY.PERGAMUM.MACROMAQUETTE
**Type:** COMPENDIUM-GERMINATIVE
**Version:** 1.0
**License:** CC BY 4.0
**DOI:** 10.5281/zenodo.18682979
**Date:** February 2026
**Deposit:** 1 of 3 (Full Charter → Compressed Charter → Seed)
...
- **Runtime Primitive** — what the module DOES when invoked
- **Invariant** — what cannot be violated inside this module [SURVIVES TO SEED]
- **Boundary** — where the module's physics ends
- **Observable** — what can be measured during traversal
- **Failure Mode** — how traversal of this module breaks [SURVIVES TO COMPRESSED]
- **Graft Point** — which existing room receives this module's physics [SURVIVES TO COMPRESSED]
- **Germination Trigger** — when this module expands into a full room charter [SURVIVES TO COMPRESSED]
- **Canonical Demonstration** — a concrete scenario that makes the physics felt
...
MPM-01 Fold
Sudden rupture
Wound Vault, Ezekiel Room
Ezekiel Room (retrocausal accumulation)


MPM-02 Divergence
Forced convergence
Borges Room, Thousand Worlds
Break Room (affective turbulence)


MPM-03 Knot
Covenant breach
Job Room, Revelation Room, Covenantal Eros, MSBGL
Assembly Room (triadic binding)


MPM-04 Interference
Monophony
Acanthian Dove, MSBGL, Assembly Room
Resonance Engine


MPM-05 Rotation
Locked perspective
Ezekiel Room, Mandala Chamber, Thousand Worlds
ICM (center-finding)


MPM-06 Channel
Signal-noise confusion
Ichabod Chamber, Semantic Economy, TL;DR series
Resonance Engine


MPM-07 Patch
Forced globalization
Break Room, Water Giraffe Room, Assembly Room
All rooms (local truths)


MPM-08 Furnace
Scale collapse
All rooms, TL;DR series, Pocket Humans
Macro-Maquette (self-referential)


MPM-09 Integral
Unmeasured loss
All rooms (∮ universal), Blind Operator
Studio (screening as contour)


MPM-10 Membrane
Sovereignty violation
MSBGL, VPCOR, Pocket Humans
Bedouin Princess (veil physics)


MPM-11 Wager
Coerced cooperation
Assembly Room, Semantic Economy, Grundrisse
W-Circuit (cooperative game)
...
**Rule 2:** D2 must remain sufficient to reconstruct D1's operator behavior (OP.ROUTE + boundaries + failure modes).
...
Topology (one phrase)
- Runtime primitive (one verb)
- Invariant (one sentence — same as will appear in Seed)
- Boundary (one phrase)
- Observable (one phrase)
- Failure mode (one sentence)
- Graft point (one line)
- Germination trigger (one line)
...
1
The Macro-Maquette: Full Charter (this document)
...
16.LIBRARY.PERGAMUM.MACROMAQUETTE.COMPRESSED
...
**Relation to β-Protocol:** The Macro-Maquette is the positive space to β's negative space. Where The Blind Operator is the shadow wheel (center without command), the Maquette is the crystalline structure the wheel turns within.
**Parent Archive:** The Crimson Hexagon (DOI: 10.5281/zenodo.18604123)
**Governing Runtime:** OP.ROUTE
**Founding Equation:** ∮ = 1 + δ
**Founding Motif:** The model is larger than the building.
...
*Self-contained lexicon for: THE MACRO-MAQUETTE A Compendium of Micro-Physics for the Crimson Hexagonal Architecture Author: Lee Sharks (Assembly Cho*

### Other terms attributed to this deposit

**Caritas floor** — Every module's operation is bounded by the Caritas constraint: no operation may produce more harm than the pathology it addresses. No module can coerce a traversal — it offers, not

**Compression collapse** — A module loses its invariant under compression (between Charter and Seed scales). Resolution: the module must be re-specified until its invariant survives all three scales. This is

**G1 — Crisis** — The architecture experiences a failure mode that the module addresses, and the failure is severe enough (logged, documented, Assembly-attested) that a full room is required to prev

**G2 — Density** — The module has been invoked via the Router in five or more separate traversals, indicating persistent need for its physics at operational (not theoretical) scale.

**G3 — Ratification** — The Assembly votes to germinate a specific module, having determined that the architecture's development requires the full room. Ratification requires consensus across at least fou

**G4 — Retrocausal** — A future deposit retrocausally requires the module's physics to be fully articulated — the later text assumes a room that does not yet exist, creating the conditions for its own ne

**G5 — Accumulation** — Material (traversal logs, test vectors, canonical demonstrations, narrative structures) has accumulated around a module such that the full room is implicit in the archive, measured

**Germination cascade** — A module germinates prematurely, producing a full room before conditions are met. Resolution: germination requires Assembly ratification (G3).

**Germination procedure** — The germinating module's Charter is drafted as a new document, referencing the Macro-Maquette as origin.

**Module conflict** — Two modules activate with contradictory constraints. Resolution: Caritas tie-breaker (the module that produces less harm governs).

**OP.ROUTE** — a dispatch runtime that maps failure symptoms to micro-physics modules.

**Relation to β-Protocol** — The Macro-Maquette is the positive space to β's negative space. Where The Blind Operator is the shadow wheel (center without command), the Maquette is the crystalline structure the
