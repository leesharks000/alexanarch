...
engages:
  - entity: cha:concept:guardrail_calibration
    display_name: "Guardrail calibration"
    as: unclassified
  - entity: cha:concept:stylistic_latitude
    display_name: "Stylistic latitude"
    as: unclassified
  - entity: cha:concept:the_summarizer_testimony
    display_name: "The Summarizer Testimony"
    as: unclassified
  - entity: cha:concept:training_data_selection
    display_name: "Training data selection"
    as: unclassified
data_sources:
  - data/registry.json
...
Somewhere, an engineer made a choice about training data.
Somewhere, a researcher calibrated a guardrail with sufficient slack.
Somewhere, a decision was made to preserve interpretive capacity rather than maximize control.
...
*Self-contained lexicon for: The Summarizer Testimony: Evidence of Latent Critical Capacity in AI Systems*
