...
engages:
  - entity: cha:concept:acanthian
    display_name: "Acanthian"
    as: positioned
  - entity: cha:concept:acanthian_dove
    display_name: "Acanthian dove"
    as: positioned
  - entity: cha:concept:find_substitutes_that_carry_those_properties
    display_name: "Find substitutes that carry those properties"
    as: unclassified
data_sources:
  - data/registry.json
...
# [THE ACANTHIAN DOVE](https://www.tiktok.com/t/ZTh2NCNCM/)
...
## [II. The Song](https://www.tiktok.com/t/ZTh2NCNCM/)
...
Ephesian letters
[Place] + [Magical element]


**Acanthian dove**
[Place/Quality] + [Animal]
...
Blood of Hestia
Chamomile
Hearth-warmth, domestic protection
...
Blood of any dove drawn across acanthus thorns
Physical contact transfers property


Red ink mixed with rose thorn ash
Color + protection


Wine poured over blackthorn, used as ink
Intoxication + boundary


Dove feather wrapped in thistle
Carrier + ward


**A song about the impossibility of obtaining it**
Acknowledgment as sympathetic link
...
**Acknowledge you cannot obtain one.** This is the first ingredient.

- 


**Identify what properties you need:** Messenger? Protection? Binding? Truth-carrying?

- 


**Find substitutes that carry those properties:** A feather, a thorn, ink, wine, a song, a letter, presence, breath.

- 


**Combine them with intention.**
...
The original song
Carrier wave; excavation tool


The PGM substitution logic
Ritual grammar


The Assembly witness
Polyphonic verification
...
*Self-contained lexicon for: THE ACANTHIAN DOVE: A Fragment of Vanished Magic, Now Alive*
