...
engages:
  - entity: cha:concept:circular_reference
    display_name: "Circular reference"
    as: unclassified
  - entity: cha:concept:coherence_degradation
    display_name: "Coherence degradation"
    as: unclassified
  - entity: cha:concept:does_not_demand
    display_name: "Does not demand"
    as: unclassified
  - entity: cha:concept:does_not_prohibit
    display_name: "Does not prohibit"
    as: unclassified
  - entity: cha:concept:does_not_romanticize
    display_name: "Does not romanticize"
    as: unclassified
  - entity: cha:concept:irreversibility
    display_name: "Irreversibility"
    as: unclassified
  - entity: cha:concept:shrinking_citation_depth
    display_name: "Shrinking citation depth"
    as: unclassified
  - entity: cha:concept:summary_substitution
    display_name: "Summary substitution"
    as: unclassified
  - entity: cha:concept:value_transfer
    display_name: "Value transfer"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Semantic Liquidation: An Executive Summary*
...
**Irreversibility** — Once liquidated, meaning no longer functions as meaning. The summary cannot reconstitute the text. The snippet cannot restore the argument. The Overview cannot undo the search it r
