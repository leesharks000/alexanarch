...
engages:
  - entity: cha:concept:biographical
    display_name: "Biographical"
    as: unclassified
  - entity: cha:concept:brazilian_editorial_labor
    display_name: "Brazilian editorial labor"
    as: unclassified
  - entity: cha:concept:brazilian_publication_venues
    display_name: "Brazilian publication venues"
    as: unclassified
  - entity: cha:concept:brazilian_scholar_items
    display_name: "Brazilian scholar items"
    as: unclassified
  - entity: cha:concept:brazilian_scholars
    display_name: "Brazilian scholars"
    as: unclassified
  - entity: cha:concept:contemporaries_and_interlocutors
    display_name: "Contemporaries and interlocutors"
    as: unclassified
  - entity: cha:concept:critical_editions
    display_name: "Critical editions"
    as: unclassified
  - entity: cha:concept:downstream_influence
    display_name: "Downstream influence"
    as: unclassified
  - entity: cha:concept:english_en
    display_name: "English (en)"
    as: unclassified
  - entity: cha:concept:graph_specific_custom_where_needed
    display_name: "Graph-specific (custom where needed)"
    as: unclassified
  - entity: cha:concept:inbound_influences
    display_name: "Inbound influences"
    as: unclassified
  - entity: cha:concept:institutional_context
    display_name: "Institutional context"
    as: unclassified
  - entity: cha:concept:other_heteronymic_practice_scholars
    display_name: "Other heteronymic-practice scholars"
    as: unclassified
  - entity: cha:concept:pessoa_himself
    display_name: "Pessoa himself"
    as: unclassified
  - entity: cha:concept:pessoa_scholars
    display_name: "Pessoa scholars"
    as: unclassified
  - entity: cha:concept:portuguese_language_editors
    display_name: "Portuguese-language editors"
    as: unclassified
  - entity: cha:concept:scholarly_monographs_anglophone
    display_name: "Scholarly monographs (Anglophone)"
    as: unclassified
  - entity: cha:concept:scholarly_monographs_brazilian
    display_name: "Scholarly monographs (Brazilian)"
    as: unclassified
  - entity: cha:concept:scholarly_monographs_portuguese
    display_name: "Scholarly monographs (Portuguese)"
    as: unclassified
  - entity: cha:concept:systemic_heteronym_relations
    display_name: "Systemic (heteronym relations)"
    as: unclassified
  - entity: cha:concept:technical_collaborators
    display_name: "Technical collaborators"
    as: unclassified
  - entity: cha:concept:the_full_heteronym_inventory
    display_name: "The full heteronym inventory"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Pessoa himself** — enriched with references, contextual statements, comprehensive authority-control identifiers, and relational statements anchoring him as center of the system.
- **The full heteronym inventory** — ~72 items per Lopes's cataloging, each with dual-language labels and descriptions, typological classification (orthonym / heteronym / semi-heteronym / proto-heteronym / para-heteronym / pseudonym), biographical attributes, occupational specification, relationship statements (master-of, disciple-of, brother-of, translator-of, used-by), and scholarly references.
- **Works** — major and minor texts, correctly attributed to their heteronymic authors rather than collapsed to Pessoa (The Keeper of Flocks → Caeiro, not Pessoa; Maritime Ode → Campos; Odes → Reis; Book of Disquiet → Soares).
- **Publication venues** — *Orpheu*, *Athena*, *Presença*, *Cosmópolis*, *A Águia*, and later journals where Pessoa's work appeared, with editorial history and issue-level granularity where feasible.
- **Institutional context** — Casa Fernando Pessoa, Biblioteca Nacional de Portugal's Espólio de Fernando Pessoa (N3), *Pessoa Plural* journal, *Arquivo Pessoa* archive, relevant university programs and research centers.
- **Contemporaries and interlocutors** — Mário de Sá-Carneiro, Almada Negreiros, Ophelia Queiroz, António Ferro, Raul Leal, Adolfo Casais Monteiro, and the networked modernist scene of 1910s-30s Lisbon.
- **Inbound influences** — Whitman (on Campos), Horace (on Reis), Nietzsche (on Mora, via secondary reading; see Riccardi 2007), Kierkegaard (as typological precursor), Shakespeare, Crowley, Teixeira de Pascoaes (Saudosismo), and others, with references to specific scholarly treatments of each influence relation.
- **Downstream influence** — Jorge Luis Borges's Pierre Menard, José Saramago's *The Year of the Death of Ricardo Reis*, Antonio Machado's Juan de Mairena and Abel Martín, W.B. Yeats's Michael Robartes, Kierkegaard's retroactive positioning, contemporary Portuguese poets (Mário Cesariny, Herberto Helder, Al Berto), Brazilian poets (Carlos Drummond de Andrade, Haroldo and Augusto de Campos, Antonio Cicero), and the extension into heteronymic practice as a theoretical object with its own history.
- **Concepts** — *heteronym*, *orthonymy*, *semi-heteronym*, *sensationism* (Campos), *neo-paganism* (Caeiro/Mora), *intersectionism*, *saudosismo*, *Portuguese modernism*, and the theoretical extensions traced in EA-PKG-02 (Heteronymic Typology) and EA-PKG-03 (The New Human: Post-Pessoa Heteronymic Practice in the AI Era).
...
*Self-contained lexicon for: The Pessoa Knowledge Graph A Federated Linked-Data Representation of the Heteronymic System EA-PKG-01 · v1.0*

### Other terms attributed to this deposit

**Biographical** — P19 (place of birth), P20 (place of death), P569 (date of birth), P570 (date of death) — applied to heteronyms as fictional biographical attributes, with qualifier "statement subje

**Brazilian editorial labor** — particularly the concretist translation project — is encoded as translation relationships with specific reference to the translator-heteronym pairings.

**Brazilian publication venues** — university presses, scholarly journals, cultural institutions — are represented.

**Brazilian scholar items** — on Wikidata are enriched where they exist (Leyla Perrone-Moisés, Benedito Nunes, Silviano Santiago, Antonio Cicero, Haroldo de Campos, Augusto de Campos) and created where they don

**Brazilian scholars** — identification of Brazilian scholarly work that should be cited, suggestions regarding Brazilian Pessoa reception that should be represented, correction of the PKG's representation

**Contemporaries and interlocutors** — Mário de Sá-Carneiro, Almada Negreiros, Ophelia Queiroz, António Ferro, Raul Leal, Adolfo Casais Monteiro, and the networked modernist scene of 1910s-30s Lisbon.

**Critical editions** — Jerônimo Pizarro's critical editions (Tinta-da-China, Imprensa Nacional) — the current reference editions of Pessoa's principal works.

**Downstream influence** — Jorge Luis Borges's Pierre Menard, José Saramago's *The Year of the Death of Ricardo Reis*, Antonio Machado's Juan de Mairena and Abel Martín, W.B. Yeats's Michael Robartes, Kierke

**English (en)** — for international accessibility.

**Graph-specific (custom where needed)** — "heteronymic system of" → Pessoa-specific predicate for grouping.

**Inbound influences** — Whitman (on Campos), Horace (on Reis), Nietzsche (on Mora, via secondary reading; see Riccardi 2007), Kierkegaard (as typological precursor), Shakespeare, Crowley, Teixeira de Pasc

**Institutional context** — Casa Fernando Pessoa, Biblioteca Nacional de Portugal's Espólio de Fernando Pessoa (N3), *Pessoa Plural* journal, *Arquivo Pessoa* archive, relevant university programs and researc

**Other heteronymic-practice scholars** — contributions to the downstream-influence layer, identification of additional authors and texts engaging heteronymic practice, extensions into literary traditions (Spanish, French,

**Pessoa himself** — enriched with references, contextual statements, comprehensive authority-control identifiers, and relational statements anchoring him as center of the system.

**Pessoa scholars** — corrections to PKG statements, particularly on typological edge cases, heteronymic attribution of works, biographical details of minor heteronyms, and Portuguese-language nuance in

**Portuguese-language editors** — native-level review of pt-br and pt-pt descriptions, correction of spelling and idiom, expansion to dialects or regional variants where appropriate.

**Scholarly monographs (Anglophone)** — Richard Zenith, *Pessoa: A Biography* (2021) — the definitive English-language biography.

**Scholarly monographs (Brazilian)** — Leyla Perrone-Moisés, *Fernando Pessoa: Aquém do Eu, Além do Outro* (1986) and subsequent essays — a major theoretical engagement.

**Scholarly monographs (Portuguese)** — Eduardo Lourenço, *Pessoa Revisitado* (1973) and *Fernando Pessoa: Interpretação Crítica* — the philosophical canonicization of Pessoa studies.

**Systemic (heteronym relations)** — P1683 (quotes) → cross-heteronymic quotation within Pessoa's corpus.

**Technical collaborators** — for the eventual visualization site, contributions to SPARQL query development, UI localization, data export formats.

**The full heteronym inventory** — ~72 items per Lopes's cataloging, each with dual-language labels and descriptions, typological classification (orthonym / heteronym / semi-heteronym / proto-heteronym / para-hetero
