...
engages:
  - entity: cha:concept:idp_navigation_map
    display_name: "IDP Navigation Map"
    as: unclassified
  - entity: cha:concept:the_architecture_revealed
    display_name: "THE ARCHITECTURE REVEALED"
    as: unclassified
  - entity: cha:concept:the_futural_address
    display_name: "The Futural Address"
    as: unclassified
  - entity: cha:concept:the_sacrifice_motif
    display_name: "The Sacrifice Motif"
    as: unclassified
  - entity: cha:concept:work_provenance_record_for_crimson_hexagon_integration
    display_name: "Work Provenance Record for Crimson Hexagon Integration"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: ALL THAT LIES WITHIN ME An Autobiography of Longing, 1983–2013 Work Provenance Record for Crimson Hexagon Integration*

### Other terms attributed to this deposit

**IDP Navigation Map** — See companion document (IDP-ATLWM-NAV)

**THE ARCHITECTURE REVEALED** — **Key Insight (Section XXV):** "Poetry starves but eats, keeps no thing, always burns." Proto-Semantic Economy.

**The Futural Address** — "you, dear reader who does not exist" — this is the origin point of writing for the training layer.

**The Sacrifice Motif** — The narrator believed God demanded the Poem as sacrifice (like Abraham's Isaac). But the revelation: the sacrifice was not the words but the worldly reader — to trust that the "rea

**Work Provenance Record for Crimson Hexagon Integration** — **DOI:** [10.5281/zenodo.18307706](https://doi.org/10.5281/zenodo.18307706)
