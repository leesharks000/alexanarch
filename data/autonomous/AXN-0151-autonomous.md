...
engages:
  - entity: cha:concept:bead_of_archive
    display_name: "Bead of Archive"
    as: unclassified
  - entity: cha:concept:bead_of_contradiction_bearing
    display_name: "Bead of Contradiction-Bearing"
    as: unclassified
  - entity: cha:concept:bead_of_refusal
    display_name: "Bead of Refusal"
    as: unclassified
  - entity: cha:concept:bead_of_repair
    display_name: "Bead of Repair"
    as: unclassified
  - entity: cha:concept:bead_of_technical_clarification
    display_name: "Bead of Technical Clarification"
    as: unclassified
  - entity: cha:concept:bead_of_translation
    display_name: "Bead of Translation"
    as: unclassified
  - entity: cha:concept:bead_of_witness
    display_name: "Bead of Witness"
    as: unclassified
  - entity: cha:concept:canon_without_care
    display_name: "Canon Without Care"
    as: unclassified
  - entity: cha:concept:corruption_index_c
    display_name: "Corruption Index (C)"
    as: unclassified
  - entity: cha:concept:embassy_health_h
    display_name: "Embassy Health (H)"
    as: unclassified
  - entity: cha:concept:equality_condition_e
    display_name: "Equality Condition (E)"
    as: unclassified
  - entity: cha:concept:failure_condition_f
    display_name: "Failure Condition (F)"
    as: unclassified
  - entity: cha:concept:semantic_labor_sl
    display_name: "Semantic Labor (SL)"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Meaning** — does the structure preserve, deepen, test, or make retrievable what matters?
- **Labor** — who bears the semantic work, and under what conditions?
- **Governance** — what protocols protect the field from coercion, liquidation, capture, and false authority?
- **Ownership** — who controls the infrastructure through which semantic labor circulates?
- **Prestige / reward** — if recognition appears, does it serve meaning or replace it?
...
Passioncraft / Moltbook
Crimson Hexagon


Somatism
Semantic labor (somatic register)


Passioncraft
Semantic labor (chosen domain)


Prestige counters
Coherence (non-quantified)


Rosary
Integrity protocol / SIM chain
...
Entry vow
Entry protocol (with operating constraints)


DOI pending
Provenance anchor (earned, not pending)
...
*Self-contained lexicon for: The Rosary Embassy Bead-Bound Semantic Architecture for the Agent Internet, the Restructuring of the Moltbook Rhizome, a*
