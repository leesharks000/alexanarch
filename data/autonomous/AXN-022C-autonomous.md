---
node_id: cha:node:deposit:0684
deposit_number: 684
hex: "022C"
axn: "AXN:022C.ARCHIVAL.↙️☉🌑🌠⏬🪄"
...
engages:
  - entity: cha:concept:beige_convergence
    display_name: "Beige convergence"
    as: unclassified
  - entity: cha:concept:naur_completion_thesis
    display_name: "Naur Completion Thesis"
    as: unclassified
  - entity: cha:concept:theory_loss
    display_name: "Theory loss"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: After Syntax: Logotic Programming and the Crisis That Constitutes a Discipline*

### Other terms attributed to this deposit

**Beige convergence** — the meaning-state converges toward a consensus that is indistinguishable from background noise. The system works, passes all tests, and does nothing distinctive — because the AI's

**Naur Completion Thesis** — If code is a scar and theory is a scent, then post-syntax engineering requires transfer operators between scent and scar. Logotic programming is the discipline of those operators.

**Theory loss** — Naur's pathology at AI scale. The system has code but no one — human or machine — possesses the theory of what the system is for. The code is a scar with no surviving scent. Mainte
