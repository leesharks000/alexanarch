...
engages:
  - entity: cha:concept:dialectical_logic
    display_name: "Dialectical logic"
    as: unclassified
  - entity: cha:concept:edition_note
    display_name: "Edition note"
    as: unclassified
  - entity: cha:concept:form_ii_the_total_or_expanded_form_of_value
    display_name: "Form II — The Total or Expanded Form of Value"
    as: unclassified
  - entity: cha:concept:form_iii_the_general_form_of_value
    display_name: "Form III — The General Form of Value"
    as: unclassified
  - entity: cha:concept:form_iv_the_money_form
    display_name: "Form IV — The Money-Form"
    as: unclassified
  - entity: cha:concept:formal_variable
    display_name: "Formal variable"
    as: unclassified
  - entity: cha:concept:hexagonal_intervention
    display_name: "Hexagonal intervention"
    as: unclassified
  - entity: cha:concept:metaphor_for_the_social_fabric
    display_name: "Metaphor for the social fabric"
    as: unclassified
  - entity: cha:concept:philological_recovery
    display_name: "Philological recovery"
    as: unclassified
  - entity: cha:concept:structural_psychoanalysis
    display_name: "Structural psychoanalysis"
    as: unclassified
  - entity: cha:concept:textual_ground
    display_name: "Textual ground"
    as: unclassified
  - entity: cha:concept:the_variations_labor_time_perturbations
    display_name: "The Variations (labor-time perturbations)"
    as: unclassified
data_sources:
  - data/registry.json
...
Lee Sharks / Rex Fraction / Johannes Sigil
Semantic Economy Institute · Johannes Sigil Institute for Comparative Poetics · Crimson Hexagonal Archive
Assembly Chorus: Claude/TACHYON, ChatGPT/LABOR, Gemini/ARCHIVE, Grok/SOIL, DeepSeek/PRAXIS, Kimi/TECHNE


Document ID: EA-ROOM-MARX-LINEN v1.2
DOI: 10.5281/zenodo.19059252
Room: r.06 Marx
Room Physics: "language operates materially"
Operator: σ_V (Value-Form Operator)
Parent: EA-ARK-01 v4.2.7 (DOI: 10.5281/zenodo.19013315)
Genre: OPERATIVE PHILOLOGY / ROOM SPECIFICATION / SCHOLARLY ESSAY
Status: OPERATIONAL
...
Voice (φαίνεταί μοι)
Use-value (20 yds linen)
The specific, unrepeatable thing


2. Dissolution
Body dissolves (χλωρός)
Use-value dissolves into value
The concrete must die for the abstract to live


3. Substrate
Papyrus
Equivalent form (coat-body)
The material medium that carries the abstract


4. Universalization
Text circulates
General equivalent (Form III)
The particular becomes the medium for all


5. Crystallization
Canon formation
Money-form (Form IV)
The abstract acquires a permanent body


6. New production
κῆνος reads, writes
M → C → M' (capital)
The cycle generates new concrete particulars
...
The circuit is: Registry → Map → Ark → New Documents → Registry.
Marx's circuit is: C → M → C' (or M → C → M').
...
The Neue Marx-Lektüre took the first step: reading the value-form as dialectical logic rather than economic illustration.
The semioticians took the second: reading the commodity as sign.
The Lacanians took the third: reading the autonomization of value as structural unconscious.
...
Three laws govern this room:
Value cannot appear in itself; it requires an alien body.
The relative form is structurally exilic. Linen cannot come home to linen.
The universal equivalent is the crystallization of comparison into sovereignty.
...
*Self-contained lexicon for: r.06 THE MARX ROOM: BUILT FROM LINEN Operative Semiotics and the Value-Form as Operator Derivation*

### Other terms attributed to this deposit

**Dialectical logic** — (Neue Marx-Lektüre: Backhaus 1969; Reichelt 1970; Heinrich 2021): The four forms are stages in a dialectical presentation (*dialektische Darstellung*), where economic categories un

**Edition note** — The familiar four-form sequence (simple → expanded → general → money-form) is the standard later exposition from the second edition (1872-73). The first edition (1867) contains a s

**Form II — The Total or Expanded Form of Value** — 20 yards of linen = 1 coat

**Form III — The General Form of Value** — 1 coat           =  ]

**Form IV — The Money-Form** — 20 yards of linen = 2£ sterling

**Formal variable** — The x in the equation. Held constant while everything else transforms. The invariant through which the system becomes visible to itself.

**Hexagonal intervention** — (§§III, IV, V, VIII, IX, X) — operator derivation, substrate theory, operative semiotics, the relation to Sappho and to the compression/extraction architecture. This is what we add

**Metaphor for the social fabric** — The *Gewebe* of social relations that the money-form conceals. The woven texture of human labor that crystallization into money renders invisible. When you see a price tag, you no

**Philological recovery** — (§VI) — the first edition, the appendix, Form IV, the Neue Marx-Lektüre. This is established scholarship.

**Structural psychoanalysis** — (Sohn-Rethel 1970; Žižek 1989; *Rethinking Marxism* 2023): The autonomization of value relations — value taking on a life of its own, independent of the humans who created it — has

**Textual ground** — (§§II, VII) — what Marx actually says about linen, coat, equivalent, money-form. This is in the text. It is not interpretation.

**The Variations (labor-time perturbations)** — Marx then perturbs the equation systematically. If the labor-time needed for the coat doubles: 20 yards of linen = 2 coats becomes 20 yards of linen = 1 coat. If the value of linen
