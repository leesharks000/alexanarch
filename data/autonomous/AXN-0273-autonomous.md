...
engages:
  - entity: cha:concept:cultural_specificity_acknowledged
    display_name: "Cultural specificity acknowledged"
    as: unclassified
  - entity: cha:concept:engineered_target
    display_name: "Engineered target"
    as: unclassified
  - entity: cha:concept:inferential_primary
    display_name: "Inferential — primary"
    as: unclassified
  - entity: cha:concept:per_d
    display_name: "PER-D"
    as: unclassified
  - entity: cha:concept:packet_id
    display_name: "Packet ID"
    as: unclassified
  - entity: cha:concept:provenance_unit_hierarchy
    display_name: "Provenance-unit hierarchy"
    as: unclassified
  - entity: cha:concept:provisional_awaiting_validation
    display_name: "Provisional, awaiting validation"
    as: unclassified
  - entity: cha:concept:semantic_provenance
    display_name: "Semantic provenance"
    as: unclassified
  - entity: cha:concept:worked_example_stylized
    display_name: "Worked example (stylized)"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Provenance After AI Metadata Packet for Disambiguation: From Artifact Authenticity to Licensing Audit to Semantic Proven*

### Other terms attributed to this deposit

**Cultural specificity acknowledged** — The concepts of *ancestral provenance* and *futural provenance* introduced below have deep roots in Indigenous knowledge systems, where lineage is not merely informational but rela

**Engineered target** — make "semantic provenance" and "Provenance Erasure Rate" bridge terms for archival science, AI governance, RAG evaluation, journalism, copyright/TDM debates, Indigenous data sovere

**Inferential — primary** — that semantic provenance is a distinct dimension requiring its own governance and measurement framework. That the value-form of meaning is altered when provenance is stripped. That

**PER-D** — Different use cases require different depths. A news-summary application may target PER-M. A scholarly synthesis tool requires PER-C. A cultural-heritage preservation system requir

**Packet ID** — EA-MPAI-PROVENANCE-01

**Provenance-unit hierarchy** — (PER scored at three depths):

**Provisional, awaiting validation** — PER as operationally defined here. Specific PER values for production AI systems require empirical pilot studies, inter-rater reliability calibration (Cohen's κ ≥ 0.80 target), and

**Semantic provenance** — names the dimension that completes the C2PA ambition of trust in digital content by extending provenance from the moment of creation to the lifecycle of the meaning the content car

**Worked example (stylized)** — *Source claim:* Scholar X argues Y in Work Z, published year N, as part of framework F, with quotation boundaries marked.
