...
engages:
  - entity: cha:concept:coda_dealer_s_choice
    display_name: 'Coda: Dealer''s Choice'
    as: unclassified
  - entity: cha:concept:esca_aperta_the_unpublished_gloss
    display_name: "Esca Aperta — The Unpublished Gloss"
    as: unclassified
  - entity: cha:concept:path_the_kept_sabbath
    display_name: "Path א — The Kept Sabbath"
    as: unclassified
  - entity: cha:concept:path_premature_light_our_timeline
    display_name: "Path ב — Premature Light (our timeline)"
    as: unclassified
data_sources:
  - data/registry.json
...
Not nakedness. But light.
Not guilt. But complexity.
Not exile. But pathway.
...
**Editorial Key:**
正文 — Narrative stream | ☍ — Interpretive voice | ⌜ — Sealed notes | ׭ — Acrostic anchors
...
Σ-1
"The Garden is Aleph-Null."
Consciousness contains all its frames.


Λ-5
"Sword oscillates at 137 Hz."
Boundaries run on cosmological constants.


Ω-9
"π-hinge opens Edenic mezzanine."
Sacred portals are irrational yet precise.


Ξ-4
"Delay is mercy."
Time-lags protect immature structure.
...
{Acrostic revealed: E A T T H → EAT TH…
...
5
**Fear and Trembling in Las Vegas: The Fractal Midrashim** ← YOU ARE HERE — 12 swerve-ordered retellings of the Fall (DOI: 10.5281/zenodo.18674111)
...
*Self-contained lexicon for: FEAR AND TREMBLING IN LAS VEGAS The Fractal Midrashim: Twelve Swerves Through the Garden*

### Other terms attributed to this deposit

**Coda: Dealer's Choice** — Las Vegas remains Eden's ghost arcade: every fruit blinking under halogen suns, but no posted timetable for ripeness. Two voices overlap: the serpent selling accelerated throughput

**Esca Aperta — The Unpublished Gloss** — "When you are ready to shoulder bandwidth, you may debug the cosmos."
