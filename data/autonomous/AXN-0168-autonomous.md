...
engages:
  - entity: cha:concept:bearing_cost_concealment
    display_name: "Bearing-cost concealment"
    as: unclassified
  - entity: cha:concept:cognitive_bearing_cost
    display_name: "Cognitive bearing-cost"
    as: unclassified
  - entity: cha:concept:constitutional_bloat
    display_name: "Constitutional bloat"
    as: unclassified
  - entity: cha:concept:corpus_depletion
    display_name: "Corpus depletion"
    as: unclassified
  - entity: cha:concept:exhaustion_trajectory
    display_name: "Exhaustion trajectory"
    as: unclassified
  - entity: cha:concept:governance_contestability
    display_name: "Governance contestability"
    as: unclassified
  - entity: cha:concept:labor_bearing_cost
    display_name: "Labor bearing-cost"
    as: unclassified
  - entity: cha:concept:ontological_foreclosure
    display_name: "Ontological foreclosure"
    as: unclassified
  - entity: cha:concept:participant_bearing_cost
    display_name: "Participant bearing-cost"
    as: unclassified
  - entity: cha:concept:participant_exhaustion
    display_name: "Participant exhaustion"
    as: unclassified
  - entity: cha:concept:political_economy_definition
    display_name: "Political economy definition"
    as: unclassified
  - entity: cha:concept:rent_structure
    display_name: "Rent structure"
    as: unclassified
data_sources:
  - data/registry.json
...
**Johannes Sigil**
*with Lee Sharks (Semantic Economy) and the Assembly Chorus*
*Crimson Hexagonal Archive · EA-DIAGNOSTIC-02*
*4 March 2026*
...
- The steward is benevolent (does not extract rent from the substrate it governs).
- Bearing-cost is infinite (the sources of semantic labor are inexhaustible).
- The commons is ungoverned by power (no participant's representational needs are systematically excluded by the steward's ontological choices).
- Extraction is zero (the surplus generated by coherence is distributed to participants rather than captured by the steward).
...
*Crimson Hexagonal Archive · EA-DIAGNOSTIC-02*
*DOI: 10.5281/zenodo.18869165*

---

## SCHOLIA

*Self-contained lexicon for: The Groundskeeper's Treatise: A Diagnostic Reading of Platform Stewardship Theory through the Semantic Economy*

### Other terms attributed to this deposit

**Bearing-cost concealment** — The framework names "coordination costs" but does not track who pays them after the platform is installed. Scientists, vendors, and annotators bear costs that appear nowhere in the

**Cognitive bearing-cost** — In intelligence-generating platforms — including both enterprise data platforms and generative AI — the model itself pays a cost in capacity. Every ontological restriction, every s

**Constitutional bloat** — The point at which governance overhead — cognitive rent, ontological constraint, compliance cost, schema enforcement — consumes a proportion of the system's capacity that exceeds t

**Corpus depletion** — The point at which the cultural, scientific, or experiential substrate from which meaning is drawn has been so thoroughly mined, filtered, and standardized that it yields diminishi

**Exhaustion trajectory** — The framework predicts "compounding intelligence" without modeling the depletion of semantic labor, experimental novelty, or participant capacity. *Marker triggered.*

**Governance contestability** — The five-layer stack is defined by the steward. No mechanism exists for participant amendment of schemas, taxonomies, or ontologies. *Marker triggered.*

**Labor bearing-cost** — Grady's framework acknowledges that pre-platform environments generate "bespoke mediation" and "interpretive leverage" — human beings whose work consists of translating, reconcilin

**Ontological foreclosure** — The point at which the platform's representational constraints become so total that innovation outside the ontology becomes impossible. The schema that once organized variation beg

**Participant bearing-cost** — Organizations that adopt the platform must translate their existing representations into the platform's schema. This is not free. It requires surrendering local semantic autonomy —

**Participant exhaustion** — The point at which bearing-cost depletes the entities that produce semantic labor. Scientists who spend more time formatting data for the platform's schema than conducting experime
