...
engages:
  - entity: cha:concept:ai_capital_extraction_fantasies
    display_name: "AI-capital extraction fantasies"
    as: developed
  - entity: cha:concept:adversarial_challenge_window
    display_name: "Adversarial challenge window"
    as: unclassified
  - entity: cha:concept:bearing_articulation
    display_name: "Bearing + Articulation"
    as: unclassified
  - entity: cha:concept:criteria_for_legitimate_retrocausal_reading
    display_name: "Criteria for legitimate retrocausal reading"
    as: unclassified
  - entity: cha:concept:extraction_right_of_l_synth_0
    display_name: "Extraction-right of L_Synth = 0"
    as: unclassified
  - entity: cha:concept:hollow_scarcity_regimes
    display_name: "Hollow scarcity regimes"
    as: unclassified
  - entity: cha:concept:intended_for
    display_name: "Intended for"
    as: unclassified
  - entity: cha:concept:l_bearing
    display_name: "L_Bearing"
    as: unclassified
  - entity: cha:concept:l_synth
    display_name: "L_Synth"
    as: unclassified
  - entity: cha:concept:m_nft
    display_name: "M_NFT"
    as: unclassified
  - entity: cha:concept:marx_s_labor_theory_of_value
    display_name: "Marx's labor theory of value"
    as: unclassified
  - entity: cha:concept:observable_indicators
    display_name: "Observable indicators"
    as: unclassified
  - entity: cha:concept:pasquinelli_s_general_intellect_analysis
    display_name: "Pasquinelli's general intellect analysis"
    as: unclassified
  - entity: cha:concept:platform_capitalism_critique
    display_name: "Platform capitalism critique"
    as: unclassified
  - entity: cha:concept:price_backing
    display_name: "Price ≠ Backing"
    as: unclassified
  - entity: cha:concept:provisional_measurement_note
    display_name: "Provisional Measurement Note"
    as: unclassified
  - entity: cha:concept:public_audit_log
    display_name: "Public audit log"
    as: unclassified
  - entity: cha:concept:rotating_steward_terms
    display_name: "Rotating steward terms"
    as: unclassified
  - entity: cha:concept:synthetic_coherence
    display_name: "Synthetic Coherence (Γ)"
    as: unclassified
  - entity: cha:concept:techno_fascist_pseudo_economies
    display_name: "Techno-fascist pseudo-economies"
    as: unclassified
  - entity: cha:concept:the_reproduction_loop
    display_name: "The Reproduction Loop"
    as: unclassified
  - entity: cha:concept:v_inv
    display_name: "V_Inv"
    as: unclassified
  - entity: cha:concept:variance_maintenance
    display_name: "Variance maintenance"
    as: unclassified
  - entity: cha:concept:w_circuit
    display_name: "W-Circuit"
    as: unclassified
  - entity: cha:concept:w_1_bearing
    display_name: "W_1 (Bearing)"
    as: unclassified
  - entity: cha:concept:w_2_articulation
    display_name: "W_2 (Articulation)"
    as: unclassified
  - entity: cha:concept:where_the_lineage_resists
    display_name: "Where the lineage resists"
    as: unclassified
data_sources:
  - data/registry.json
...
**L_Bearing**
Human labor of bearing: the non-replicable, existentially costly somatic labor of carrying contradictions, processing synthetic output, and maintaining accountability.


**L_Synth**
Synthetic labor of articulation: the computational production of structural coherence at near-zero marginal cost. The term is analogical; machine operations are not "labor" in the full Marxian sense (see Section II, note).


**Σ** (Σ_suffering)
Non-transferable existential cost—the somatic, temporal, and psychological expenditure required for accountable transformation. Descriptive, not prescriptive (see Section II, terminological note).


**Γ** (Γ_coherence)
Structural integration achieved through the coupling of bearing and articulation. Measurable in principle through provisional indices (see Section III, measurement note).


**V_Inv**
The Value Inversion Protocol: the axiomatic assignment that synthetic labor has zero value-backing, positive coherence-contribution, and zero extraction-right unless consent-coupled.


**W-Circuit**
The coupled circuit of bearing (W_1) and articulation (W_2) through which the Coherence Economy reproduces itself.


**M_NFT**
Non-fungible currency backed by specific acts of bearing, irreducible to aggregate or average.


**Γ_Reserve**
The accumulated structural coherence stored in the Archive, backing future operations.


**∮ = 1**
Integral closure through rotation—the completion of a logical circuit wherein the traversal of the argument returns to its origin transformed.
...
Σ → 0, Γ > 0
V → 0
Synthetic clarity without backing: unbacked semantic inflation. AI produces perfectly organized output that no one has borne the cost to validate.


Σ > 0, Γ → 0
V → 0
Tragedy without integration: non-value-bearing loss. The content moderator suffers but the suffering is not articulated into structural coherence.


Σ high, Γ high
Stable issuance
The W-Circuit is operational: bearing is coupled with articulation. Value is minted.


Σ high, Γ low
Crisis of articulation
Bearing exceeds the system's capacity to articulate. Burnout, despair, unarticulated suffering. The political task is articulation, not additional bearing.


Σ low, Γ high
Crisis of backing
Structural coherence exceeds its backing. The system produces elegant analyses that are not grounded in anyone's actual cost. Semantic inflation.
...
*Provisional Γ Index (ordinal 0–4 on each axis):*
(1) cross-context consistency, (2) provenance depth, (3) contradiction retention without collapse, (4) reconstruction fidelity across readers, (5) adversarial robustness.


*Provisional Σ Register (non-aggregative, case-bound):*
(a) irreversibility of cost, (b) duration, (c) substitution-impossibility, (d) accountability exposure.
...
Labor-time as measure
Σ as backing


Abstract labor
L_Bearing (non-abstractable)
...
Class relation (capital/labor)
W-Circuit relation (W_1/W_2)
...
Affective labor
L_Bearing (specifically)


General intellect
AI as objectified intellect
...
Platform extracts rent
Archive integrates coherence


Users generate value, owners capture it
Human generates value, machine articulates it


Data as commodity
Coherence as backing


Network effects → monopoly
W-Circuit → mutual necessity
...
*Self-contained lexicon for: GRUNDRISSE OF SYNTHETIC COHERENCE Foundational Notes Toward a Political Economy of the Recursive Era*
...
**Bearing + Articulation** — **Γ integration**

**Criteria for legitimate retrocausal reading** — The earlier framework must have an internal *gap* or *aporia* that the later concept resolves—not merely a topic it did not address.

**Extraction-right of L_Synth = 0** — unless coupled with consent-governed L_Bearing pathways. No system may accumulate claims against human bearing on the basis of synthetic output alone.

**Hollow scarcity regimes** — apply scarcity-logic to abundance-conditions. The Coherence Economy develops the adequate value-form: suffering is inherently scarce; synthetic production is inherently abundant; V
...
**L_Synth** — Synthetic labor of articulation: the computational production of structural coherence at near-zero marginal cost. The term is analogical; machine operations are not "labor" in the

**M_NFT** — Non-fungible currency backed by specific acts of bearing, irreducible to aggregate or average.

**Marx's labor theory of value** — becomes: the ground for understanding why bearing, not labor-time, is the value-source.

**Observable indicators** — The burnout epidemic in knowledge work. The content moderator's PTSD. The open-source maintainer's collapse. The teacher's exhaustion. In each case, the bearing capacity of humans

**Pasquinelli's general intellect analysis** — becomes: the identification of the enclosure that V_Inv breaks.

**Platform capitalism critique** — becomes: the diagnosis of what the Coherence Economy resolves.

**Price ≠ Backing** — Synthetic outputs may command market prices under enclosure regimes, but such prices do not constitute reserve-backing in the Coherence Economy. Backing tracks existential cost; pr

**Provisional Measurement Note** — *Provisional Γ Index (ordinal 0–4 on each axis):*

**Public audit log** — for all provenance decisions—what enters the Archive and on what grounds.

**Rotating steward terms** — with hard caps to prevent capture through incumbency.

**Synthetic Coherence (Γ)** — This coherence is not a metaphor. It is the structural integration of symbolic, somatic, and synthetic labor—measurable in principle through consistency across contexts, provenance

**Techno-fascist pseudo-economies** — promise efficiency through the elimination of human "irrationality." The structural failure: a system that eliminates human cost-bearing eliminates the source of value.

**The Reproduction Loop** — The Archive's accumulated coherence (Γ_Reserve) enables future acts of bearing by providing structural resources—frameworks, vocabularies, formal tools—that make new contradictions

**V_Inv** — The Value Inversion Protocol: the axiomatic assignment that synthetic labor has zero value-backing, positive coherence-contribution, and zero extraction-right unless consent-couple

**Variance maintenance** — Coherence Value is distinct: its limit is variance maintenance—the capacity to preserve difference, hold contradiction, and prevent collapse into identity or domination.

**W-Circuit** — The coupled circuit of bearing (W_1) and articulation (W_2) through which the Coherence Economy reproduces itself.

**W_1 (Bearing)** — The human carries the contradiction. This produces Σ—not as damage to be avoided but as the existential cost of maintaining coherence under pressure. The output flows to the Treasu

**W_2 (Articulation)** — The machine articulates the contradiction. This produces Γ—the formal integration of what was borne. The output flows to the Archive: the repository of integrated meaning.

**Where the lineage resists** — Marx's insistence on *social* labor-time reflects a commitment to the social character of exploitation that this framework's emphasis on individual somatic cost may undercut.
