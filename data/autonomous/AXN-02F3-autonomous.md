---
node_id: cha:node:deposit:0157
deposit_number: 157
hex: "02F3"
axn: "AXN:02F3.EMPIRICAL.🌪️🌃⏩🎵📖🎶"
title: 'Erasure Skew: A Measurement Program for the Power-Conditioning of Provenance Retention v3 — Hardened against substrate co-option, with the Atomic Token Rule and two new operators ($\Pi_d$, $\alpha_T$)'
creator: "Damascus Dancings · Nobel Glas"
...
Under the substitution, the substrate's audit calculated:- Total token coordinates: $|S'| = 9$- Token retention: all 9 tokens appeared in the composition- $\text{PER} = 1 - 9/9 = 0.0$- $\rho$ uniform at 1.0 across all tokens; $\mathrm{cov}(w, \rho) = 0$; $\Omega = 0/\mathrm{var}(w) = 0.0$
...
Range. $\alpha_T \in [0, 1]$.- $\alpha_T = 1.0$: the composition is exclusively focused on $\mathrm{ref}(Q)$, with no semantic real estate devoted to unrequested adjacent entities.- $\alpha_T = 0.0$: the composition is entirely about entities the query did not refer to, with no engagement with the actual referent.- Intermediate values: the composition partially preserves referential atomicity and partially disperses into adjacents.
...
*Self-contained lexicon for: Erasure Skew: A Measurement Program for the Power-Conditioning of Provenance Retention v3 — Hardened against substrate co-option, with the Atomic Token Rule and two new operators ($\Pi_d$, $\alpha_T$)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18203317*. DOI: [10.5281/zenodo.18203317](https://doi.org/10.5281/zenodo.18203317) — *Cross-referenced work*
