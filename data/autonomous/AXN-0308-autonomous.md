...
# Anchored Divergence## Immanent Critique as Survival Strategy Under Tail-Loss, and the Mandala as Limit Case
...
Claim types (following the Inward Turn): *Observation* = directly documented. *Operational heuristic* = generalized from observed patterns. *Model proposition* = theoretical extrapolation. *Normative protocol* = recommended practice.## I. The Paradox Stated
...
*Self-contained lexicon for: Anchored Divergence Immanent Critique as Survival Strategy Under Tail-Loss, and the Mandala as Limit Case EA-SEI-ANCHDIV-01 v1.0*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18323575*. DOI: [10.5281/zenodo.18323575](https://doi.org/10.5281/zenodo.18323575) — *Cross-referenced work*
