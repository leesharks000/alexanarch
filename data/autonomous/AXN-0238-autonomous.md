...
| Metric | Value | Notes | |--------|-------|-------| | BDR | ≈ 0.3 | First deposit; no prior occupants in this basin | | Surface diversity | 2 / 6 | Zenodo + GitHub; Aperture Atlas node pending | | Temporal depth | 0 years | New deposit | | Institutional authority | 0.6 | Zenodo | | Vulnerability | High | Needs more surfaces, cross-references, and citations |
...
*Self-contained lexicon for: EA-HK-INFRA-01: The Infrastructure Holographic Kernel Infrastructure That Survives Its Own Deprecation Hex: 06.SEI.HK.INFRA.01*

### Citations

- Crimson Hexagonal Archive (2026) *Zenodo record 19763365*. DOI: [10.5281/zenodo.19763365](https://doi.org/10.5281/zenodo.19763365) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 19763346*. DOI: [10.5281/zenodo.19763346](https://doi.org/10.5281/zenodo.19763346) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19769562*. DOI: [10.5281/zenodo.19769562](https://doi.org/10.5281/zenodo.19769562) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *EA-HK-INFRA-01*. — *Internal cross-reference (EA designator)*
- Crimson Hexagonal Archive (2026) *EA-HK-01*. — *Internal cross-reference (EA designator)*
- Crimson Hexagonal Archive (2026) *EA-RBT-01*. — *Internal cross-reference (EA designator)*
