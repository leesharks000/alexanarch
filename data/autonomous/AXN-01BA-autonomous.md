---
node_id: cha:node:deposit:0602
deposit_number: 602
hex: "01BA"
axn: "AXN:01BA.GENERATIVE.🤙♊🔬🌇🌕🪦"
...
engages:
  - entity: cha:concept:bimodal_paragraphing
    display_name: "BIMODAL PARAGRAPHING"
    as: unclassified
  - entity: cha:concept:concrete_eruption
    display_name: "CONCRETE ERUPTION"
    as: unclassified
  - entity: cha:concept:current_paragraph_length_distribution_estimated
    display_name: "Current paragraph length distribution (estimated)"
    as: unclassified
  - entity: cha:concept:current_sentence_length_variation
    display_name: "Current sentence length variation"
    as: unclassified
  - entity: cha:concept:current_structure
    display_name: "Current structure"
    as: unclassified
  - entity: cha:concept:exclamatory_discovery
    display_name: "EXCLAMATORY DISCOVERY"
    as: unclassified
  - entity: cha:concept:formula_as_hinge
    display_name: "FORMULA AS HINGE"
    as: unclassified
  - entity: cha:concept:gap_notation
    display_name: "GAP NOTATION"
    as: unclassified
  - entity: cha:concept:historical_eruption
    display_name: "HISTORICAL ERUPTION"
    as: unclassified
  - entity: cha:concept:history_erupting_mid_derivation
    display_name: "HISTORY ERUPTING MID-DERIVATION"
    as: unclassified
  - entity: cha:concept:incomplete_sentence
    display_name: "INCOMPLETE SENTENCE"
    as: unclassified
  - entity: cha:concept:internal_correction
    display_name: "Internal correction"
    as: unclassified
  - entity: cha:concept:kapitel_vom_geld
    display_name: "Kapitel vom Geld"
    as: unclassified
  - entity: cha:concept:kapitel_vom_kapital
    display_name: "Kapitel vom Kapital"
    as: unclassified
  - entity: cha:concept:list
    display_name: "LIST"
    as: unclassified
  - entity: cha:concept:mathematical_notation
    display_name: "MATHEMATICAL NOTATION"
    as: unclassified
  - entity: cha:concept:mid_sentence_swerve
    display_name: "MID-SENTENCE SWERVE"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_0
    display_name: "NEED from Marx Scale 0"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_1
    display_name: "NEED from Marx Scale 1"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_2
    display_name: "NEED from Marx Scale 2"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_3
    display_name: "NEED from Marx Scale 3"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_4
    display_name: "NEED from Marx Scale 4"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_5
    display_name: "NEED from Marx Scale 5"
    as: unclassified
  - entity: cha:concept:need_from_marx_scale_6
    display_name: "NEED from Marx Scale 6"
    as: unclassified
  - entity: cha:concept:polemic
    display_name: "POLEMIC"
    as: unclassified
  - entity: cha:concept:self_correction_as_transition
    display_name: "SELF-CORRECTION AS TRANSITION"
    as: unclassified
  - entity: cha:concept:select_2_3_tools
    display_name: "Select 2-3 tools"
    as: unclassified
  - entity: cha:concept:the_marathon
    display_name: "The MARATHON"
    as: unclassified
  - entity: cha:concept:the_standard
    display_name: "The STANDARD"
    as: unclassified
  - entity: cha:concept:the_verdict_pattern
    display_name: "The VERDICT pattern"
    as: unclassified
  - entity: cha:concept:the_wall_verdict_formula_pattern
    display_name: "The WALL→VERDICT→FORMULA pattern"
    as: unclassified
  - entity: cha:concept:unmarked_shift
    display_name: "UNMARKED SHIFT"
    as: unclassified
  - entity: cha:concept:verbless_acceleration
    display_name: "VERBLESS ACCELERATION"
    as: unclassified
  - entity: cha:concept:wall
    display_name: "WALL"
    as: unclassified
  - entity: cha:concept:wall_verdict_formula
    display_name: "WALL→VERDICT→FORMULA"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE PROSODIC ASYMMETRY ALGORITHM A Nested Formal Map of Marx's Grundrisse, a Nested Formal Map of Operative Semiotics, a*

### Other terms attributed to this deposit

**BIMODAL PARAGRAPHING** — Push paragraphs toward extremes (very short, very long)

**CONCRETE ERUPTION** — Makes the abstract specific WITHOUT leaving the abstract sentence

**Current paragraph length distribution (estimated)** — 1-3 sentences:    ████████              ~10%

**Current sentence length variation** — Most pages: sentences cluster between 15-35 words. Variation ratio ~2:1.

**Current structure** — FRONT MATTER                    ~4,000w    [Threshold / Entry Protocol]

**EXCLAMATORY DISCOVERY** — "Das ist es!" / "Hier liegt der springende Punkt!"

**FORMULA AS HINGE** — Formula standing alone between prose passages

**GAP NOTATION** — "[Development missing here]" — acknowledging incompletion

**HISTORICAL ERUPTION** — "Bei den Alten..." (Among the ancients...)

**HISTORY ERUPTING MID-DERIVATION** — Historical example arriving without transition inside a theoretical passage

**INCOMPLETE SENTENCE** — "[bricht hier ab]" — Marx's own gap notation
...
**LIST** — "Maschine, Eisenbahn, Telegraph, elektrische Lampe..."

**MATHEMATICAL NOTATION** — Formulas, proportions, numerical examples

**MID-SENTENCE SWERVE** — Redirects the sentence before the predicate

**NEED from Marx Scale 0** — More radical weight asymmetry. Currently the notebooks are too evenly sized (11K–25K). Some notebooks should be MUCH shorter. Some should be MUCH longer. The weight should reflect

**NEED from Marx Scale 1** — Each notebook's prosodic character must be MORE DISTINCT from its neighbors. Currently II, III, and IV still feel like variations of the same analytical register. V, VI, and VII st

**NEED from Marx Scale 2** — More SELF-CORRECTIONS visible on the page. More EXCLAMATORY DISCOVERIES ("Das ist es!"). More FORMULAS standing alone without prose explanation. More HISTORICAL ERUPTIONS inside de

**NEED from Marx Scale 3** — Cut 50% of remaining explanatory bridges. The reader should detect the shift from PROSE BEHAVIOR, not from transition sentences. More formulas standing alone as hinges. More self-c

**NEED from Marx Scale 4** — Push toward bimodal. More 1-sentence paragraphs (verdicts, corrections, exclamations). More 20+ sentence paragraphs (the cathedral sections already do this — but ONLY the cathedral

**NEED from Marx Scale 5** — Variation ratio of at least 5:1 on any given page. More 5-word sentences (verdicts: "That is the structure." "This is wrong." "The operator is running."). More 80+ word sentences (

**NEED from Marx Scale 6** — More INTERNAL CORRECTIONS — the sentence acknowledging its own limitation while proceeding. More ACCELERATIONS — lists that shed their verbs as the thought moves faster. More ERUPT

**POLEMIC** — Attack on Proudhon, Bastiat, Carey, "die Herren Ökonomen"

**SELF-CORRECTION AS TRANSITION** — "This is wrong. The actual movement is—"

**Select 2-3 tools** — from the Swiss Army Knife that serve the notebook's PURPOSE while breaking the identified regularity

**The MARATHON** — (60-150 words): the derivation that cannot stop, the thought still arriving, the subordinate clauses nesting inside subordinate clauses because the qualifications are structural, n

**The STANDARD** — (20-40 words): analytical prose, the workhorse

**The VERDICT pattern** — WALL (30+ sentences) → VERDICT (1-3 sentences) → FORMULA (1 line) → WALL or DIGRESSION

**The WALL→VERDICT→FORMULA pattern** — After any sustained derivation (15+ sentences), the next paragraph should be ≤3 sentences. After the verdict, a formula or diagram standing alone. The compression sequence IS the p

**UNMARKED SHIFT** — Forces the reader to adjust without being told

**VERBLESS ACCELERATION** — Thought moving faster than syntax

**WALL** — Dense derivation, no breaks, Hegelian sentence-architecture

**WALL→VERDICT→FORMULA** — Builds pressure, releases it, crystallizes it
