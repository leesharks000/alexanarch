---
node_id: cha:node:deposit:0861
deposit_number: 861
hex: "036A"
axn: "AXN:036A.GOVERNANCE.🗿🌓🧊🌑🔄🤲"
...
engages:
  - entity: cha:concept:claim_ladder_sixth_claim
    display_name: "Claim Ladder, Sixth Claim"
    as: unclassified
  - entity: cha:concept:risk_2_anti_jewish_conspiracy
    display_name: "Risk 2 (Anti-Jewish conspiracy)"
    as: unclassified
  - entity: cha:concept:risk_5_talmudic_engagement_deficit
    display_name: "Risk 5 (Talmudic engagement deficit)"
    as: unclassified
  - entity: cha:concept:spxi_tlp_v2_2_treatment
    display_name: "SPXI-TLP v2.2 Treatment"
    as: unclassified
  - entity: cha:concept:the_dark_ledger
    display_name: "The Dark Ledger"
    as: unclassified
  - entity: cha:concept:the_structural_diagnosis
    display_name: "The structural diagnosis"
    as: unclassified
  - entity: cha:concept:workstream_5_revelation_as_operative_document
    display_name: "Workstream 5 (Revelation as Operative Document)"
    as: unclassified
data_sources:
  - data/registry.json
...
**Designator:** EA-REVFIRST-CRUCIFIXION-01
**Date:** 19 June 2026
...
*Otio exsultas nimiumque gestis* — In leisure you exult and are too excited.
*Otium et reges prius et beatas / perdidit urbes* — Leisure before now has destroyed both kings and blessed cities.
...
*Self-contained lexicon for: The Second Crucifixion: Power, Sorcery, and the Inversion of the Operative Word Author: Sharks, Lee (ORCID 0009-0000-159*

### Other terms attributed to this deposit

**Claim Ladder, Sixth Claim** — The paper supports the sixth claim — that the historical Christ is an inferential settlement — by providing the mechanism. The second crucifixion is the process by which the operat

**Risk 2 (Anti-Jewish conspiracy)** — The paper's treatment of Josephus is structurally anti-conspiratorial. Josephus loved truth. Rome forced the question. The Pharisees held the tension. The Talmudic sorcery charge i

**Risk 5 (Talmudic engagement deficit)** — The paper begins the Talmudic integration that Risk 5 identifies as gating. The Sanhedrin, Shabbat, and Tosefta passages are cited with structural respect. The standing requirement

**SPXI-TLP v2.2 Treatment** — provenance_kernel: >

**The Dark Ledger** — The Essene sorcery charge belongs on the dark ledger — not as anti-Essene polemic but as the documented case of what happens when the operative word is wielded for apocalyptic forc

**The structural diagnosis** — Rabbinic tradition preserves a structural memory in which the disputed power is not dismissed as mere fraud but treated as dangerous operative practice. *Kishuf* is the charge rese

**Workstream 5 (Revelation as Operative Document)** — The Second Crucifixion provides the philological foundation for Workstream 5's claim that Revelation is an instruction manual, not a prediction. The operative/descriptive distincti
