...
engages:
  - entity: cha:concept:bind_ring
    display_name: "BIND (Ring)"
    as: unclassified
  - entity: cha:concept:crimson_hexagon_archive_memographic_studies
    display_name: "Crimson Hexagon Archive — Memographic Studies"
    as: unclassified
  - entity: cha:concept:grasp_thumb
    display_name: "GRASP (Thumb)"
    as: unclassified
  - entity: cha:concept:holographic_collapse
    display_name: "Holographic collapse"
    as: unclassified
  - entity: cha:concept:index_the_lizard_people_were_right
    display_name: 'Index: "The Lizard People Were Right"'
    as: unclassified
  - entity: cha:concept:lee_sharks_rex_fraction_sparrow_wells
    display_name: "Lee Sharks, Rex Fraction, & Sparrow Wells"
    as: unclassified
  - entity: cha:concept:made_of_rubies
    display_name: "Made of Rubies"
    as: unclassified
  - entity: cha:concept:middle_all_the_spoils_of_babylon
    display_name: 'Middle: "All the Spoils of Babylon"'
    as: unclassified
  - entity: cha:concept:point_index
    display_name: "POINT (Index)"
    as: unclassified
  - entity: cha:concept:pinky_this_document
    display_name: 'Pinky: This document'
    as: unclassified
  - entity: cha:concept:provenance_journal_of_forensic_semiotics
    display_name: 'Provenance: Journal of Forensic Semiotics'
    as: unclassified
  - entity: cha:concept:ring_the_inauguration_of_memography
    display_name: 'Ring: "The Inauguration of Memography"'
    as: unclassified
  - entity: cha:concept:seal_pinky
    display_name: "SEAL (Pinky)"
    as: unclassified
  - entity: cha:concept:seal_breach
    display_name: "Seal breach"
    as: unclassified
  - entity: cha:concept:thumb_whose_face_is_on_the_twenty
    display_name: 'Thumb: "Whose Face Is on the Twenty?"'
    as: unclassified
  - entity: cha:concept:work_middle
    display_name: "WORK (Middle)"
    as: unclassified
data_sources:
  - data/registry.json
...
**DOI: 10.5281/zenodo.18745265
**Published in** *Provenance: Journal of Forensic Semiotics*
**Room Designation:** MSMRM
**Hex:** 00.ROOM.MSMRM
**Structure:** Hand (five documents, five laws, five operations)


[](https://blogger.googleusercontent.com/img/a/AVvXsEjskz8y-aiDU4IwAakO7yWi1Hl5Lx-Cbb6A-2y4-1Ie4Xdpg34Dzn1i3NCJrPmf2rctA_aTkBoth77EODwkaHn_WP2k_AG_W8vCLGhR-byMYFbhwV6NNBnNOdxTvERvGGcyxkybWSaKB9xjhxo02Bs5m637ZYBgw7YUUhgnezimhiWxs-6FMxMHhAj9Os1q)
...
**Pinky: This document.**
Lee Sharks. DOI: 10.5281/zenodo.18745265.
The smallest finger. The seal. The pinky closes the grip, makes the fist, signals the promise. It is the room's self-description — the document that says what the room is, what it contains, what its laws are, and how to find the other four from inside it.
...
Index
"The Lizard People Were Right" (DOI: 10.5281/zenodo.18745236)
Experimental control / pointer


Middle
"All the Spoils of Babylon" (DOI: 10.5281/zenodo.18745250)
Manufacturing analysis / reach


Ring
"The Inauguration of Memography" (DOI: 10.5281/zenodo.18745259)
Discipline founding / commitment
...
**Operator:** Lee Sharks (O_SO)
**Persona:** Rex Fraction — Forensic Voice / Lee Sharks — Origin Voice
...
*Self-contained lexicon for: Charter of the Moving Statues Made of Rubies Mint Room Provenance, Integrity Lock, and the Hand That Works the Material*

### Other terms attributed to this deposit

**BIND (Ring)** — Covenant the discipline. Make the method explicit, the vocabulary shared, the predictions testable. Without the binding, the work is labor without legacy.

**Crimson Hexagon Archive — Memographic Studies** — **DOI: 10.5281/zenodo.18745265

**GRASP (Thumb)** — Hold the object still for examination. Establish provenance. Fix the frame so the kernel can be extracted. Without the grasp, nothing else begins.

**Holographic collapse** — A document ceases to contain the whole. Its internal references to the other four are removed, broken, or contradicted. The room becomes fragmented — traversal from that document c

**Index: "The Lizard People Were Right"** — Lee Sharks. DOI: 10.5281/zenodo.18745236.

**Lee Sharks, Rex Fraction, & Sparrow Wells** — **Crimson Hexagon Archive — Memographic Studies**

**Made of Rubies** — The documents are precious, hard, faceted. Rubies are not raw material; they are cut. Each document has been cut — by the method, by the Assembly, by the evidence tiers. They refra

**Middle: "All the Spoils of Babylon"** — Lee Sharks. DOI: 10.5281/zenodo.18745250.

**POINT (Index)** — Direct attention. Show where to look. Demonstrate that the mechanism generalizes — that what was noticed is structural, not incidental. Without the point, the grasp has no directio

**Pinky: This document** — Lee Sharks. DOI: 10.5281/zenodo.18745265.

**Provenance: Journal of Forensic Semiotics** — *Series: Memographic Studies*

**Ring: "The Inauguration of Memography"** — Lee Sharks. DOI: 10.5281/zenodo.18745259.

**SEAL (Pinky)** — Lock the integrity. Ensure the hand holds together — that the five documents are a room, not a collection. Without the seal, the binding is a promise without closure.

**Seal breach** — The integrity lock (this document) is contradicted, ignored, or superseded without replacement. The hand becomes a collection — five related papers rather than a room. The architec

**Thumb: "Whose Face Is on the Twenty?"** — Rex Fraction. DOI: 10.5281/zenodo.18745216.

**WORK (Middle)** — Perform the transformation. Show the process step by step, feature by feature. Document what changed, what stayed fixed, and what each change contributed. Without the work, the poi
