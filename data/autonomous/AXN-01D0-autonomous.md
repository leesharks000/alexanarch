---
node_id: cha:node:deposit:0615
deposit_number: 615
hex: "01D0"
axn: "AXN:01D0.GOVERNANCE.📝⛩️👈🔧🌲✨"
title: 'THE $650 BILLION GAP: Physical Infrastructure, Semantic Governance, and the Architecture of Compression-Survival'
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:doi_anchored_provenance_chains
    display_name: "DOI-anchored provenance chains"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE $650 BILLION GAP: Physical Infrastructure, Semantic Governance, and the Architecture of Compression-Survival*

### Other terms attributed to this deposit

**DOI-anchored provenance chains** — Permanent identifiers interconnected through related identifiers, forming a citation graph dense enough that any retrieval system that touches one node encounters ten more. The den
