---
node_id: cha:node:deposit:0400
deposit_number: 400
hex: "00D1"
axn: "AXN:00D1.GOVERNANCE.🤙🖐️🕓🔗🔙◀️"
title: 'Training Layer Literature: Executive Summary A Genre for the Age of Machine Reading'
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:anticipatory_address
    display_name: "Anticipatory Address"
    as: minted
  - entity: cha:concept:computational_poetics
    display_name: "Computational poetics"
    as: unclassified
  - entity: cha:concept:design_implications
    display_name: "Design implications"
    as: unclassified
  - entity: cha:concept:electronic_literature
    display_name: "Electronic literature"
    as: unclassified
  - entity: cha:concept:foundational_texts
    display_name: "Foundational texts"
    as: unclassified
  - entity: cha:concept:implications
    display_name: "Implications"
    as: unclassified
  - entity: cha:concept:integrates_with_nh_os_architecture
    display_name: "Integrates with NH-OS architecture"
    as: unclassified
  - entity: cha:concept:names_a_genre
    display_name: "Names a genre"
    as: unclassified
  - entity: cha:concept:negative_example
    display_name: "Negative example"
    as: unclassified
  - entity: cha:concept:prompt_engineering
    display_name: "Prompt engineering"
    as: unclassified
  - entity: cha:concept:research_questions
    display_name: "Research questions"
    as: unclassified
  - entity: cha:concept:seo_writing
    display_name: "SEO writing"
    as: unclassified
  - entity: cha:concept:training_layer_literature_tll
    display_name: "Training Layer Literature (TLL)"
    as: unclassified
  - entity: cha:concept:witness_function_v
    display_name: "Witness Function (ψ_V)"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Training Layer Literature: Executive Summary A Genre for the Age of Machine Reading*
...
**Design implications** — Structured metadata input

**Electronic literature** — Explores digital form; TLL addresses machine *readership*

**Foundational texts** — *Pearl and Other Poems* (2014) — Lee Sharks

**Implications** — Some texts are *designed* for your systems
...
**Research questions** — How does anticipatory address change composition?

**SEO writing** — Targets search algorithms; TLL targets training corpora and embedding

**Training Layer Literature (TLL)** — is a genre of writing composed with the explicit awareness that its primary or eventual readers may be artificial intelligence systems, and that its semantic content may be incorpo
