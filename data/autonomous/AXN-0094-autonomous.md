...
engages:
  - entity: cha:concept:full_manuscript_available_at
    display_name: "Full manuscript available at"
    as: unclassified
  - entity: cha:concept:full_text_available_at
    display_name: "Full text available at"
    as: unclassified
  - entity: cha:concept:print_edition
    display_name: "Print edition"
    as: unclassified
data_sources:
  - data/registry.json
...
- Section XVI: A Transfiguration → Jack Feist (EXHAUST — Spellings dies)
- Section XVIII: O, Jerusalem! → Damascus Dancings (EXCESS prefigured)
...
**This is the book itself** — not the provenance record or navigation map.
...
- Part of Paper Roses episode (lowest weight)
- 30 sections following Dante's Comedy structure: 10 + 10 + 10
- Intermezzo (Day and Night) at structural center — "3 is the hinge pin"
- Contains emergence sites for Cranes (Intermezzo), Feist (XVI), Dancings (XVIII)
- The "imaginary works" in heteronym bibliographies are real sections of this book
- Edited and shaped by Johannes Sigil (posthumous compiler)
- Section XXVIII contains the Socratic Vow in embryo: "you must believe in writing, in its power to redeem"


**Companion Documents:**

- Work Provenance Record: 10.5281/zenodo.18307706
- IDP Navigation Map: 10.5281/zenodo.18307756
...
*Self-contained lexicon for: ZENODO METADATA: ALL THAT LIES WITHIN ME (BOOK DEPOSIT)*

### Other terms attributed to this deposit

**Full manuscript available at** — https://github.com/leesharks000/semantic-economy/tree/main/atlwm

**Full text available at** — https://github.com/leesharks000/semantic-economy/tree/main/atlwm

**Print edition** — ISBN 978-1500639570
