---
node_id: cha:node:deposit:0044
deposit_number: 44
hex: "01C9"
axn: "AXN:01C9.GOVERNANCE.🌻💎🔙💡🗿🕐"
title: 'THE THOUSAND DOLLAR SHARPIE: IMAGE SERIES AND SHARPIE PHYSICS The Sharpie as Semantic Object'
creator: "Lee Sharks · Rex Fraction · Ayanna Vox"
orcid: "0009-0000-1599-0703"
date: "2026-03-29"
version: "v1.0"
status: ACTIVE
engages:
  - entity: cha:concept:composition_law
    display_name: "Composition law"
    as: unclassified
  - entity: cha:concept:democratic_access_threshold
    display_name: "Democratic access threshold"
    as: unclassified
  - entity: cha:concept:identity_across_states
    display_name: "Identity across states"
    as: unclassified
  - entity: cha:concept:lenticular_multiperspectivality
    display_name: "Lenticular multiperspectivality"
    as: unclassified
  - entity: cha:concept:permanence_symmetry
    display_name: "Permanence symmetry"
    as: unclassified
  - entity: cha:concept:relation_defined_operation
    display_name: "Relation-defined operation"
    as: unclassified
  - entity: cha:concept:self_referential_provenance
    display_name: "Self-referential provenance"
    as: unclassified
  - entity: cha:concept:series_the_thousand_dollar_sharpie_ea_tds
    display_name: 'Series: The Thousand Dollar Sharpie (EA-TDS)'
    as: unclassified
  - entity: cha:concept:sharpiegate_september_2019
    display_name: "Sharpiegate (September 2019)"
    as: unclassified
  - entity: cha:concept:signing_instrument
    display_name: "Signing instrument"
    as: unclassified
  - entity: cha:concept:structural_relationship_the_hand_and_the_triptych
    display_name: "Structural relationship — the hand and the triptych"
    as: unclassified
  - entity: cha:concept:three_holdings_the_triptych
    display_name: "Three holdings (the triptych)"
    as: unclassified
  - entity: cha:concept:water_resistant
...
**Designation:** EA-TDS-03
**DOI:** 10.5281/zenodo.19317139
**DOI:** 10.5281/zenodo.19317139
...
**Identity across states.** The instrument is physically identical in the SIGN and BLOT states. Same ink, same tip, same barrel, same gesture. The instrument does not change. The operation changes.

- 


**Relation-defined operation.** The state is determined by the relation between the mark and the substrate, not by any property of the instrument. If the substrate is unmarked → σ_SIGN. If the substrate carries an unauthorized claim → σ_SH. The substrate determines the operation.

- 


**Permanence symmetry.** Both σ_SIGN and σ_SH are irreversible. The signature cannot be removed without destroying the substrate. The blot cannot be removed without destroying the substrate. The correction is as permanent as the extraction.

- 


**Composition law.** σ_SH ∘ σ_SIGN = ρ (restoration). The composition of signing and blotting returns the substrate to its commons state — not physically (both marks remain) but functionally (the personal claim is negated, the commons character is reasserted).

- 


**Democratic access threshold.** The counter-instrument costs $1.49. The extraction instrument was claimed to cost $1,000 (ceremonial pen) or $5 (custom Sharpie). The counter-operation is maximally distributed: available at any drugstore, gas station, or dollar store.

- 


**Lenticular multiperspectivality.** The same blotted object reveals three readings depending on viewing angle: executive (branding failure), commons (restoration), forensic (evidence of contested provenance). All three readings are present simultaneously.

- 


**Self-referential provenance.** The counter-instrument was chosen by the target. Trump selected the Sharpie as his signing instrument, narrated its origin story, displayed it at a Cabinet meeting. The counter-operation does not introduce a foreign tool. It returns the target's own instrument against his own mark.
...
Ceremonial signing pen (pre-Sharpie)
$1,000 (claimed)
White House only
σ_SIGN (executive)


Custom White House Sharpie
$5 (claimed)
White House only
σ_SIGN (executive)


Standard retail Sharpie
$1.49
Universal
σ_SH (democratic)
...
**Image 2: THE UNCAPPING**
The same fragment, now with a Sharpie entering the frame from the right edge. The cap is being removed. The felt tip is visible. The ink has not yet touched the paper. The moment of commitment — the transition from carrying to deploying.


**Image 3: THE BLOT**
The same fragment, now with a thick black rectangle over the presidential signature. The blot is deliberate, clean-edged, and complete. The Secretary's signature is untouched. The serial number area (implied, not reproduced) is untouched. The denomination is legible. The bill is functional. Only the personal claim has been negated.


**Image 4: THE THOUSAND DOLLAR SHARPIE**
The Sharpie itself, alone. No currency. The cap is off. The felt tip is exposed. The barrel is the standard black plastic of a retail Sharpie — not the custom White House model with gold logo, but the $1.49 instrument available at any drugstore. Below the image, in the style of a museum placard:
...
σ_SIGN (personal mark on commons substrate)
Attribution stripping (claiming commons work as proprietary)
Unauthorized provenance capture


σ_SH (blot negates the claim)
Automatic termination clause (license revokes on violation)
Counter-operation restores commons


ρ (restoration: substrate retains both marks but claim is negated)
Commons retention (work stays open; violator loses rights, not the commons)
The substrate survives the contest


Irreversibility (blot is permanent)
Irrevocability (CC license cannot be un-granted to compliant users)
The commons, once asserted, persists


Democratic access ($1.49)
Zero cost to license (CC is free to apply)
Anti-enclosure by design
...
*Self-contained lexicon for: THE THOUSAND DOLLAR SHARPIE: IMAGE SERIES AND SHARPIE PHYSICS The Sharpie as Semantic Object*

### Other terms attributed to this deposit

**Composition law** — σ_SH ∘ σ_SIGN = ρ (restoration). The composition of signing and blotting returns the substrate to its commons state — not physically (both marks remain) but functionally (the perso

**Democratic access threshold** — The counter-instrument costs $1.49. The extraction instrument was claimed to cost $1,000 (ceremonial pen) or $5 (custom Sharpie). The counter-operation is maximally distributed: av

**Identity across states** — The instrument is physically identical in the SIGN and BLOT states. Same ink, same tip, same barrel, same gesture. The instrument does not change. The operation changes.

**Lenticular multiperspectivality** — The same blotted object reveals three readings depending on viewing angle: executive (branding failure), commons (restoration), forensic (evidence of contested provenance). All thr

**Permanence symmetry** — Both σ_SIGN and σ_SH are irreversible. The signature cannot be removed without destroying the substrate. The blot cannot be removed without destroying the substrate. The correction

**Relation-defined operation** — The state is determined by the relation between the mark and the substrate, not by any property of the instrument. If the substrate is unmarked → σ_SIGN. If the substrate carries a

**Self-referential provenance** — The counter-instrument was chosen by the target. Trump selected the Sharpie as his signing instrument, narrated its origin story, displayed it at a Cabinet meeting. The counter-ope

**Series: The Thousand Dollar Sharpie (EA-TDS)** — *Sparrow Wells, Rex Fraction, Ayanna Vox & Lee Sharks*

**Sharpiegate (September 2019)** — Trump used a Sharpie to alter a NOAA weather map, extending Hurricane Dorian's projected path into Alabama to support a false social media claim. NOAA issued an unsigned statement

**Signing instrument** — Trump has used Sharpies to sign executive orders, proclamations, bills, autographs, and personalized notes for decades. The thick black ink is a visual trademark. The custom White

**Structural relationship — the hand and the triptych** — The MSMRM is a hand — five documents that built the theory of portrait authority (DOIs: 10.5281/zenodo.18745216, .18745236, .18745250, .18745259, .18745265). The Thousand Dollar Sh

**Three holdings (the triptych)** — (1) **EA-TDS-01** "The Thousand Dollar Sharpie" — CENTER PANEL — forensic analysis, compressed portraiture thesis, CC convergence (DOI: 10.5281/zenodo.19317102) (DOI: 10.5281/zenod
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18736175*. DOI: [10.5281/zenodo.18736175](https://doi.org/10.5281/zenodo.18736175) — *Cross-referenced work (DOI recovered)*
