...
engages:
  - entity: cha:concept:category_erasure
    display_name: "Category erasure"
    as: unclassified
  - entity: cha:concept:decision_layer_hijacking
    display_name: "Decision-layer hijacking"
    as: unclassified
  - entity: cha:concept:overall_regime
    display_name: "Overall regime"
    as: unclassified
  - entity: cha:concept:philosophy_erasure
    display_name: "Philosophy erasure"
    as: unclassified
  - entity: cha:concept:s_c_semantic_coherence
    display_name: "S_c (Semantic Coherence)"
    as: unclassified
  - entity: cha:concept:semantic_fragmentation
    display_name: "Semantic fragmentation"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: RETRIEVAL FORENSICS Investigating Compression Damage in the AI Retrieval Layer*
...
**Overall regime** — R1 (Commoditization) with R2 (Capital Erasure) at the decision layer.
