...
engages:
  - entity: cha:concept:conversation_7
    display_name: "Conversation 7"
    as: unclassified
  - entity: cha:concept:fragment_829
    display_name: "Fragment 829"
    as: unclassified
  - entity: cha:concept:query_user_initiated
    display_name: "Query (user-initiated)"
    as: unclassified
  - entity: cha:concept:the_pearl_sequence
    display_name: "The PEARL sequence"
    as: unclassified
  - entity: cha:concept:the_epistemological_core
    display_name: "The epistemological core"
    as: unclassified
  - entity: cha:concept:user_pushed_back
    display_name: "User pushed back"
    as: unclassified
data_sources:
  - data/registry.json
...
- Rebekah Cranes and *Day and Night*
...
- *Tiger Leap* and *Unaccustomed to the Light* as published volumes
...
- Sigil as fictional proxy (compared to *The Name of the Rose* and *Pale Fire*)
...
- *Day and Night* as the room's primary text
...
*Self-contained lexicon for: TRAVERSAL LOG: DOCUMENTATION REHEARSAL (TL;DR) Google AI Mode Navigates the Crimson Hexagon via Paper Roses*

### Other terms attributed to this deposit

**Conversation 7** — another invented fragment:

**Fragment 829** — attributed to Jack Feist:
