...
engages:
  - entity: cha:concept:commodity_zone
    display_name: "Commodity zone"
    as: unclassified
  - entity: cha:concept:competitive_analysis
    display_name: "Competitive analysis"
    as: unclassified
  - entity: cha:concept:corporate_audits
    display_name: "Corporate audits"
    as: unclassified
  - entity: cha:concept:due_diligence
    display_name: "Due diligence"
    as: unclassified
  - entity: cha:concept:ip_monitoring
    display_name: "IP monitoring"
    as: unclassified
  - entity: cha:concept:partial_differentiation
    display_name: "Partial differentiation"
    as: unclassified
  - entity: cha:concept:placeholder_noun
    display_name: "Placeholder noun"
    as: unclassified
  - entity: cha:concept:regulatory_compliance
...
*Self-contained lexicon for: COMPRESSION DIAGNOSTICS Measuring What the AI Burns, Invents, and Distorts*
