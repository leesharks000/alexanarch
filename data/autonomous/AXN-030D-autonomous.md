---
node_id: cha:node:deposit:0799
deposit_number: 799
hex: "030D"
axn: "AXN:030D.ARCHIVAL.⊗🕖📌▽📝🐚"
...
Who pays? Every semiotic operation has a cost. Composition costs labor. Retrieval costs attention. Compression costs fidelity. TOS treats these costs as invisible — the operator acts, the transformation occurs, the cost is external. Operative semiotics makes cost the central variable through the Three Compressions thermodynamics: fuel source (C_b), ledger structure (L), and commons effect (δ-C).

Who controls the summarizer? Pearson's framework assumes a sign process between a source interpreter (I_S) and a target interpreter (I_T), mediated by a sign. In 2026, the dominant mediator is not a sign but a summarizer layer — a machine system that compresses, recombines, and re-presents signs to downstream interpreters. The summarizer is not a neutral operator; it is an economic actor that determines which signs survive, which are merged, and which are erased. TOS has no model of this layer.
...
Operational Semiotics formalizes the operator. Operative Semiotics analyzes the operation's world.
...
Pearson, C. (1994). "Tense and Proposition in Music: An Application of the USST and the TOS to Nonlinguistic Sign Systems." *American Journal of Semiotics*.

Sharks, L. / Assembly Chorus (2026, March 16). *The Three Compressions: Lossy, Predatory, and Witness*. EA-SEI-THREECOMPRESSIONS v3.1. Zenodo. https://doi.org/10.5281/zenodo.19053469

Sharks, L. (2026, March 24). *Operative Semiotics: A Grundrisse*. Zenodo. https://doi.org/10.5281/zenodo.19202401
...
*Self-contained lexicon for: From Operator Strings to Semantic Economy A Semantic-Economic Critique of Pearson's Theory of Operational Semiotics EA-O*
