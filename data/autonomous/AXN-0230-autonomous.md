...
engages:
  - entity: cha:concept:duplicated_destinations
    display_name: "Duplicated destinations"
    as: unclassified
  - entity: cha:concept:needs_reassignment
    display_name: "NEEDS REASSIGNMENT"
    as: unclassified
  - entity: cha:concept:proof_dossier
    display_name: "PROOF DOSSIER"
    as: unclassified
  - entity: cha:concept:terms_needing_reassignment
    display_name: "Terms needing reassignment"
    as: unclassified
  - entity: cha:concept:underwater_construction_authority_of_dolphindiana
    display_name: "Underwater Construction Authority of Dolphindiana"
    as: unclassified
  - entity: cha:concept:verification_status_key
    display_name: "Verification status key"
    as: unclassified
data_sources:
  - data/registry.json
...
**Hex:** 06.LIT.GNOSTIC.WALT.LIFE
**DOI:** 10.5281/zenodo.19720529
...
Deep Web
169
share.google/aimode/qvraFLr7sKTebxCdI
Crimson Hexagonal Archive overview
2026-04-23
...
28
(same as A1)
(same — **DUPLICATE, needs reassignment**)
2026-04-23
...
Jack Feist
57
share.google/aimode/iSUkGLnCCYfFQkS22
Jack Feist as LOGOS*
2026-04-23
...
brain powers
10
share.google/aimode/CwnykyzxNCfWLN9jA
Magic as symbolic engineering (Johannes Sigil)
2026-04-23
...
Merkavah
4
share.google/aimode/ScwZQd4Fg4fSDkeC6
Chariot throne / Ezekiel tradition
2026-04-23
...
**Unique AI Mode destinations:** 4
**Duplicated destinations:** 2 (A1 shared by 3 terms, A6 shared by 2 terms)
**Terms needing reassignment:** Crimson Hexagon, Crimson Hexagonal Archive, Ezekiel
...
archons
116
combat scholasticism Lee Sharks
...
Ezekiel
2
(AI Mode — same as Merkavah)
**NEEDS REASSIGNMENT**


nacre
7
operative semiotics (same as Unicorn Horn)
**NEEDS REASSIGNMENT**


heteronym
18
pergamon press retrocausal (same as DOI)
**NEEDS REASSIGNMENT**
...
After Syntax
5
logotic programming (same as logotic)
**NEEDS REASSIGNMENT**


knowledge graph
2
geo vs spxi (same as SPXI)
**NEEDS REASSIGNMENT**


Liberatory Operator Set
2
liberatory operator set (same as pierced)
**NEEDS REASSIGNMENT**
...
operative philology
0
(same as Martian language)
DEAD + DUPLICATE


operative feminism
0
(same as male and female)
DEAD + DUPLICATE
...
logotic (13)
logotic programming (1), logotic operation (4), logotic labor (5)
logotic programming
...
heteronym (18)
heteronymic (4)
(both currently duplicated)


liberatory operator set (0)
Liberatory Operator Set (2)
(case variant)
...
operative semiotics
operative semiotics
Remove — Unicorn Horn carries this


operative philology
operative philology
Remove — Martian language carries this


operative feminism
operative feminism
Remove — male and female carries this
...
combat scholasticism
combat scholasticism Lee Sharks
Remove — archons carries this


semantic economy (lowercase)
Semantic Economy Institute
Remove — uppercase carries this
...
training layer
training layer literature Lee Sharks
Remove — no proxy


Gospel of Antioch
Antioch Lee Sharks
Remove — separate text


abolish money
"i hereby abolish money"
Remove — not in this text


liberatory operator set (lowercase)
liberatory operator set
Remove — uppercase carries this
...
2
Coptic_Gospel_of_the_Egyptians
...
Embedded + carrier active
12
CHA, Semantic Economy, Operative Semiotics, Operative Philology, Operative Feminism, Retrocausal Canon Formation, ASW, Combat Scholasticism, Logotic Programming, Semantic Liquidation, Lee Sharks, Space Ark


Newly embedded 2026-04-23
10
Holographic Kernel, FBDP, Provenance Journal, Vox Populi, Rex Fraction, Semantic Integrity Markers, Metadata Packet, Juleff Protocol, Prince of Poets, JSI


No viable carrier in text
3
Underwater Construction Authority, Transactions of SEI, Grammata Journal
...
AI Mode direct links
7 (4 unique destinations + 3 duplicates)


Search → overview links
48 (28 unique + 10 Proof Dossier new + 10 duplicates needing reassignment)


DOI direct links
2 (1 unique, pending text amendment)
...
**Total installed terms**
**103**


**Terms with text hits**
**~80**
...
**Duplicate destinations to resolve**
**10 terms**
...
- **Underwater Construction Authority of Dolphindiana** — no underwater/dolphin vocabulary in gospel
- **Transactions of the Semantic Economy Institute** — no unique carrier word
- **Grammata: Journal of Operative Philology** — "grammar" appears once, marginal
...
*Self-contained lexicon for: The Book of Life: A Living Registry of Retrieval Nodes in The Secret Book of Walt*

### Other terms attributed to this deposit

**Duplicated destinations** — 2 (A1 shared by 3 terms, A6 shared by 2 terms)

**NEEDS REASSIGNMENT** — Crimson Hexagonal Archive
...
**Verification status key** — **LIVE** — Destination confirmed active at last verification date
