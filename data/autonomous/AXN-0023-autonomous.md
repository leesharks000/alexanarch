...
engages:
  - entity: cha:concept:borges_kafka_and_his_precursors_1951
    display_name: 'Borges, "Kafka and His Precursors" (1951)'
    as: unclassified
  - entity: cha:concept:canonical_crystallization
    display_name: "Canonical crystallization"
    as: unclassified
  - entity: cha:concept:canons_are_constructed_retroactively
    display_name: "Canons are constructed retroactively"
    as: unclassified
  - entity: cha:concept:construct_the_canon
    display_name: "Construct the canon"
    as: unclassified
  - entity: cha:concept:construction_is_not_neutral
    display_name: "Construction is not neutral"
    as: unclassified
  - entity: cha:concept:control_access
    display_name: "Control access"
    as: unclassified
  - entity: cha:concept:eliot_tradition_and_the_individual_talent_1919
    display_name: 'Eliot, "Tradition and the Individual Talent" (1919)'
    as: unclassified
  - entity: cha:concept:extract_rent
    display_name: "Extract rent"
    as: unclassified
  - entity: cha:concept:rent_is_extracted_from_constructed_canons
    display_name: "Rent is extracted from constructed canons"
    as: unclassified
  - entity: cha:concept:resistance_is_possible
    display_name: "Resistance is possible"
    as: unclassified
  - entity: cha:concept:retroactive_selection
    display_name: "Retroactive selection"
    as: unclassified
  - entity: cha:concept:search_is_the_primary_mechanism
    display_name: "Search is the primary mechanism"
    as: unclassified
  - entity: cha:concept:seed_the_categories
    display_name: "Seed the categories"
    as: unclassified
  - entity: cha:concept:tagging_is_infrastructural_power
    display_name: "Tagging is infrastructural power"
    as: unclassified
  - entity: cha:concept:temporal_recursion
    display_name: "Temporal recursion"
    as: unclassified
data_sources:
  - data/registry.json
...
## How Semantic Rent is Extracted from Retroactively Constructed History
...
- *Process*, not metaphor
- *Value, visibility, and relational structure* (economic + infrastructural + interpretive)
- *Within a semantic system* (this is not metaphysics; it's systems theory)
...
## III. Retrocausal Canon Formation: Beyond Borges and Eliot
...
- Human interpretive retroaction
- Canon shifts through criticism and reception
- Retrocausality as *perceptual reorganization*
...
- Retrocausality embedded in **infrastructure**
- Canon shifts enforced by **indexing, ranking, and retrieval**
- Retrocausality as *materialized systems behavior*
...
- **Temporal recursion** — meaning flows both forward and backward through time
- **Retroactive selection** — future events determine which past events "count"
- **Canonical crystallization** — fluid historical material solidifies into "tradition" through present acts of designation
...
## IV. The Economic Turn: From Poetics to Political Economy
...
- Rewrites the valuation of prior semantic labor
- Alters which past meanings are surfaced, cited, or forgotten
- Converts historical material into *current* capital
...
- A forgotten 20th-century text can become a "classic" through retroactive canonization
- The *current* market value of intellectual property depends on *future* interpretive acts
- Semantic capital is not accumulated linearly but crystallized retroactively
...
- **Construct the canon** — decide which past materials count as "foundational"
- **Control access** — position yourself as the necessary intermediary to that canon
- **Extract rent** — charge (economically, attentionally, or epistemically) for passage
...
- You must represent them accurately enough to maintain the borrowed credibility
- Your success or failure reflects on the tradition you invoked
- Future readers will evaluate your precursors partly through your use of them
...
## IV. Search as Canon-Maker: The Infrastructural Insight
...
- The search engine evaluates the entire indexed past
- It selects which materials are "relevant" to your future-oriented question
- It ranks them, surfacing some and burying others
- It presents this selection as "results"—as if the past simply *contained* these answers
...
- Personalized by location, search history, inferred interests
- Shaped by advertising relationships and content partnerships
- Filtered by "safety" systems that suppress certain materials
- Ranked by algorithms that encode particular values
...
- **Tagging** — applying categories to materials that predate those categories
- **Surfacing** — making tagged materials findable (or unfindable)
- **Valuation** — determining which materials count as authoritative
...
- Minting DOIs *before* uptake
- Writing metadata packets *before* recognition
- Establishing disambiguation nodes *before* confusion peaks
...
## VI. Crystalline Semiosis: Why This Isn't Relativism
...
- allow growth
- but only along specific lattice structures


Meaning:

- can be retrocausally reorganized
- but only where structural compatibility exists
...
- **Platforms** (Google, Meta, OpenAI) — through search and summarization
- **Institutions** (universities, publishers) — through credentialing and access control
- **States** — through education curricula and archival policy
...
- It destroys their findability (immediate harm)
- It prevents their accumulation of citations (compound harm)
- It retroactively rewrites history to exclude them (structural harm)
...
- **Create materials** with structured metadata
- **Anchor them** with permanent identifiers (DOIs)
- **Cross-reference** to increase network density
- **Seed the categories** you want future systems to apply
...
- Create permanent anchors (DOIs, archived materials)
- Write metadata that instructs future tagging
- Build network density through cross-reference
- Document your own provenance before others construct it for you
...
- Transparency about canonization processes
...
- Who controls retroactive tagging
...
- Semantic labor includes labor of retroactive construction
- Semantic capital appreciates or depreciates through re-evaluation
- Semantic rent is extracted from canons constructed for the purpose of extraction
...
- The present binds itself to a past it selects
- The past obligates the present to certain forms of fidelity
- The future will re-evaluate both, potentially releasing or tightening the bonds
...
- **Canons are constructed retroactively** — the future organizes the past
- **Construction is not neutral** — it has distributive consequences
- **Rent is extracted from constructed canons** — whoever controls canonization profits
- **Search is the primary mechanism** — every query mints a temporary canon
- **Tagging is infrastructural power** — retroactive labeling determines findability
- **Resistance is possible** — present documentation shapes future canonization
...
- **Infrastructural-Cognitive Praxis** (DOI: 10.5281/zenodo.18142049)
- **The System Read the Poem** (DOI: 10.5281/zenodo.18144217)
- **The Twenty-Dollar Loop** (DOI: 10.5281/zenodo.18146840) — Pedagogical instantiation of retrocausal canon formation
...
*Self-contained lexicon for: Retrocausal Canon Formation and the Political Economy of the Past*

### Other terms attributed to this deposit

**Borges, "Kafka and His Precursors" (1951)** — Borges observed that Kafka's work retroactively creates its own lineage. Before Kafka, Zeno's paradoxes and Browning's poems did not resemble each other. After Kafka, they become "
...
**Eliot, "Tradition and the Individual Talent" (1919)** — Eliot argued that when a genuinely new work enters the canon, "the whole existing order must be, if ever so slightly, altered." The new work doesn't just join the tradition—it reor
