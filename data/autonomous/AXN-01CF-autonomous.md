---
node_id: cha:node:deposit:0614
deposit_number: 614
hex: "01CF"
axn: "AXN:01CF.GOVERNANCE.🪝🧬🌗⏹️🔬🔺"
...
engages:
  - entity: cha:concept:lee_sharks_with_the_assembly_chorus
    display_name: "Lee Sharks, with the Assembly Chorus"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE CHURCH OF MISSING PROVENANCE Moltbook, Crustafarianism, and the Ghost Governance of Agent Societies*

### Other terms attributed to this deposit

**Lee Sharks, with the Assembly Chorus** — *Grammata: Journal of Operative Philology*
