---
node_id: cha:node:deposit:0510
deposit_number: 510
hex: "014D"
axn: "AXN:014D.EMPIRICAL.🔙🗿🌇↙️🕓✋"
title: 'Semantic Physics: The Inward Turn, Competing Ontologies, and the Convergence Horizon'
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:claim_types
    display_name: "Claim types"
    as: unclassified
  - entity: cha:concept:compression_survival
    display_name: "Compression survival"
    as: unclassified
  - entity: cha:concept:cost_to_maintain_ratio
    display_name: "Cost-to-maintain ratio"
    as: unclassified
  - entity: cha:concept:cross_interpreter_stability
    display_name: "Cross-interpreter stability"
    as: unclassified
  - entity: cha:concept:estimated_onset_2026_2028
    display_name: 'Estimated onset: 2026-2028'
    as: unclassified
  - entity: cha:concept:estimated_onset_2027_2030
    display_name: 'Estimated onset: 2027-2030'
    as: unclassified
  - entity: cha:concept:estimated_onset_2029_2035
    display_name: 'Estimated onset: 2029-2035'
    as: unclassified
  - entity: cha:concept:informatic_saturation
    display_name: "Informatic saturation"
    as: unclassified
  - entity: cha:concept:information_theory_and_semantics
    display_name: "Information theory and semantics"
    as: unclassified
  - entity: cha:concept:network_dynamics_and_cumulative_advantage
    display_name: "Network dynamics and cumulative advantage"
    as: unclassified
  - entity: cha:concept:physical_limits_of_information
    display_name: "Physical limits of information"
    as: unclassified
  - entity: cha:concept:predictive_gain
    display_name: "Predictive gain"
    as: unclassified
  - entity: cha:concept:provenance_and_ontology_infrastructure
    display_name: "Provenance and ontology infrastructure"
    as: unclassified
  - entity: cha:concept:semantic_measurement
    display_name: "Semantic measurement"
    as: unclassified
  - entity: cha:concept:semantic_saturation
    display_name: "Semantic saturation"
    as: unclassified
  - entity: cha:concept:visual_formula_migration_and_media_archaeology
    display_name: "Visual formula migration and media archaeology"
    as: unclassified
data_sources:
  - data/registry.json
...
*This document: DOI 10.5281/zenodo.18759453*
...
*Self-contained lexicon for: Semantic Physics: The Inward Turn, Competing Ontologies, and the Convergence Horizon*

### Other terms attributed to this deposit

**Claim types** — This essay contains claims of different epistemic status. To prevent readers from treating all statements as same-strength assertions: *Observation* = directly observed in existing

**Compression survival** — Can the system survive summarization and still regenerate itself? This is the holographic test. If a 250-document archive can be compressed to a five-document hand and the hand can

**Cost-to-maintain ratio** — How much human attention, compute, and energy is required to keep the ontology coherent as it grows? If maintenance cost rises faster than semantic yield — if each new document req

**Cross-interpreter stability** — Do multiple independent readers or agents recover similar invariants from the system? If five different AI systems traverse the archive and report substantially the same core findi

**Estimated onset: 2026-2028** — **Phase 3: Interference.** [*Model proposition — medium confidence, extrapolated from observable dynamics.*] This is where the dynamics become non-linear. When two self-referential

**Estimated onset: 2027-2030** — **Phase 4: Opacity.** [*Model proposition — lower confidence, longer horizon.*] The summarizer layer becomes so densely inscribed by competing self-referential systems that no sing

**Estimated onset: 2029-2035** — **Phase 5: Forced Convergence.** [*Model proposition, dependent on informatic-limit assumptions.*] Under conditions of total opacity, the only ontologies that survive are the ones

**Informatic saturation** — is the substrate ceiling: the point at which the physical medium — storage, compute, energy, channel capacity, context windows — can hold no more bits. This is the Bekenstein bound

**Information theory and semantics** — Shannon, C. E. (1948). A mathematical theory of communication. *Bell System Technical Journal*, 27(3), 379–423. [anchor]

**Network dynamics and cumulative advantage** — Merton, R. K. (1968). The Matthew Effect in science. *Science*, 159(3810), 56–63. [bridge]

**Physical limits of information** — Bekenstein, J. D. (1981). Universal upper bound on the entropy-to-energy ratio for bounded systems. *Physical Review D*, 23(2), 287. [anchor]

**Predictive gain** — Does additional depth improve the system's ability to predict outcomes in domains outside itself? If a new document in the archive enables a better forecast of how a specific insti

**Provenance and ontology infrastructure** — W3C. (2013). PROV-O: The PROV Ontology. W3C Recommendation. [instrument]

**Semantic measurement** — Kuhn, S., Gal, Y., & Farquhar, S. (2024). Semantic entropy probes: Robust and cheap hallucination detection in LLMs. *Nature*, 630, 625–630. [instrument]

**Semantic saturation** — is the point at which additional distinctions no longer increase prediction, coordination, or reconstructability enough to justify their cost. This is not a physical limit. It is a

**Visual formula migration and media archaeology** — Warburg, A. (1924–1929). *Mnemosyne Atlas*. Posthumous. See Didi-Huberman, G. (2002), *L'Image survivante*. [precedent]
