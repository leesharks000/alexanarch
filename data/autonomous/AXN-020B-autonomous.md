---
node_id: cha:node:deposit:0660
deposit_number: 660
hex: "020B"
axn: "AXN:020B.GOVERNANCE.🟤🌄🪨🪝🧲✊"
...
engages:
  - entity: cha:concept:boundary_conditions
    display_name: "Boundary conditions"
    as: unclassified
  - entity: cha:concept:boundary_instruction
    display_name: "Boundary instruction"
    as: unclassified
  - entity: cha:concept:description_instruction
    display_name: "Description instruction"
    as: unclassified
  - entity: cha:concept:diagnosticity
    display_name: "Diagnosticity"
    as: unclassified
  - entity: cha:concept:encyclotron
    display_name: "Encyclotron"
    as: unclassified
  - entity: cha:concept:negative_tags
    display_name: "Negative tags"
    as: unclassified
  - entity: cha:concept:positive_definitions
    display_name: "Positive definitions"
    as: unclassified
  - entity: cha:concept:post_deployment_april_2026
    display_name: "Post-deployment (April 2026)"
    as: unclassified
  - entity: cha:concept:pre_deployment_january_2025
    display_name: "Pre-deployment (January 2025)"
    as: unclassified
data_sources:
  - data/registry.json
...
entity_type
string
Classification: person, organization, concept, framework, product, event, publication


description
string
A concise, factual description (≤300 words)
...
doi_references
array[URI]
List of DOI-anchored deposits that define or substantiate the entity
...
alternate_names
array[string]
Aliases, abbreviations, former names


parent_entity
string
The entity or institution this entity belongs to


related_entities
array[string]
Entities with which this entity has a defined relationship


domain
string
The field or industry the entity operates in
...
relation
Relationship to the entity: defines, extends, measures, applies
...
Zenodo
Full packet + JSON-LD
Canonical DOI anchor


Entity domain
Landing page with structured data
Web-crawlable reference


GitHub
JSON-LD schemas + specification repo
Technical credibility


Medium / blog
Executive summary + SIMs
...
**Mechanism**
Keywords, backlinks, schema
Definition-lead sentences, fact density, FAQ markup
DOI-anchored deposits, JSON-LD entity definitions, disambiguation matrices, SIMs
...
Ongoing optimization required
Permanent (DOI-anchored on institutional infrastructure)


**Model dependency**
Google-specific ranking signals
Summarizer-specific extraction patterns
Model-agnostic (structured data standards)


**Verifiability**
Indirect (ranking position)
Indirect (inclusion in AI Overview)
Direct (DOI resolution, SIM presence)


**Entity construction**
No
No
Yes — constructs the entity in the knowledge graph from scratch
...
EA-SPXI-01
06.SEI.SPXI.01
SPXI — A Formal Specification
This document


EA-SPXI-02
06.SEI.SPXI.02
SPXI Executive Summary
Forthcoming
...
EA-SPXI-08
06.SEI.SPXI.08
SPXI Case Study — Semantic Economy Institute
Forthcoming


EA-SPXI-09
06.SEI.SPXI.09
SPXI Is Not GEO — A Technical Distinction
Forthcoming
...
Instrument
Encyclotron (https://github.com/leesharks000/encyclotron)
...
*Self-contained lexicon for: EA-SPXI-01: SPXI — A Formal Specification Semantic Packet for eXchange & Indexing (SPXI): Protocol for Durable Entity In*
...
**Encyclotron** — The measurement instrument for SPXI deployment. The Encyclotron audits how a retrieval system represents an entity before and after SPXI packet installation, measuring accuracy, at
