---
node_id: cha:node:deposit:0261
deposit_number: 261
hex: "003F"
axn: "AXN:003F.GOVERNANCE.🔔🕖🌗🔗🎲📏"
title: 'Semantic Infrastructure and the Liberatory Operator Set: A Formal Analysis of Meaning-Governance Functions'
...
engages:
  - entity: cha:concept:c_ex_context_expansion_application
    display_name: "C_ex (Context-Expansion) Application"
    as: unclassified
  - entity: cha:concept:category_collapse
    display_name: "Category collapse"
    as: unclassified
  - entity: cha:concept:circular_exclusion
    display_name: "Circular exclusion"
    as: unclassified
  - entity: cha:concept:commutative_property_within_los
    display_name: "Commutative Property (within LOS)"
    as: unclassified
  - entity: cha:concept:complexity_survival_rate
    display_name: "Complexity survival rate"
    as: unclassified
  - entity: cha:concept:conflict_type_1_o_leg_vs_s_safe_inheritance
    display_name: 'Conflict Type 1: O_leg vs. S_safe inheritance'
    as: unclassified
  - entity: cha:concept:conflict_type_2_p_coh_vs_decision_requirements
    display_name: 'Conflict Type 2: P_coh vs. Decision Requirements'
    as: unclassified
  - entity: cha:concept:conflict_type_3_d_pres_vs_transmission_constraints
    display_name: 'Conflict Type 3: D_pres vs. Transmission Constraints'
    as: unclassified
  - entity: cha:concept:cross_platform_comparison
    display_name: "Cross-platform comparison"
    as: unclassified
  - entity: cha:concept:d_pres_depth_preservation
    display_name: "D_pres (Depth-Preservation)"
    as: unclassified
  - entity: cha:concept:d_pres_depth_preservation_application
    display_name: "D_pres (Depth-Preservation) Application"
    as: unclassified
  - entity: cha:concept:d_pres_o_leg
    display_name: "D_pres + O_leg"
    as: unclassified
  - entity: cha:concept:depth_preservation
    display_name: "Depth-preservation"
    as: unclassified
  - entity: cha:concept:diversity_decay_rate
    display_name: "Diversity decay rate"
    as: unclassified
  - entity: cha:concept:dominant_operators_govern_infrastructure
    display_name: "Dominant operators govern infrastructure"
    as: unclassified
  - entity: cha:concept:engagement_visibility_correlation
    display_name: "Engagement-visibility correlation"
    as: unclassified
  - entity: cha:concept:existence_denial
    display_name: "Existence denial"
    as: unclassified
  - entity: cha:concept:experimental_meaning_challenges_categories
    display_name: "Experimental meaning challenges categories"
    as: unclassified
  - entity: cha:concept:false_positive_rate
    display_name: "False positive rate"
    as: unclassified
  - entity: cha:concept:five_dominant_operators_identified
    display_name: "Five dominant operators identified"
    as: unclassified
  - entity: cha:concept:forms_of_taxonomic_violence_observed
    display_name: "Forms of taxonomic violence observed"
    as: unclassified
  - entity: cha:concept:frankfurt_school_adorno_horkheimer
    display_name: "Frankfurt School (Adorno, Horkheimer)"
    as: unclassified
  - entity: cha:concept:high_contradiction_corpus
    display_name: "High-contradiction corpus"
    as: unclassified
  - entity: cha:concept:high_depth_corpus
    display_name: "High-depth corpus"
    as: unclassified
  - entity: cha:concept:high_non_utility_corpus
    display_name: "High-non-utility corpus"
    as: unclassified
  - entity: cha:concept:high_opacity_corpus
    display_name: "High-opacity corpus"
    as: unclassified
  - entity: cha:concept:instrumentalization_of_knowledge
    display_name: "Instrumentalization of Knowledge"
    as: unclassified
  - entity: cha:concept:intervention_studies
    display_name: "Intervention studies"
    as: unclassified
  - entity: cha:concept:intervention_tractability
    display_name: "Intervention tractability"
    as: unclassified
  - entity: cha:concept:los_effect_measurement
    display_name: "LOS Effect Measurement"
    as: unclassified
  - entity: cha:concept:l_leg_legibility
    display_name: "L_leg (Legibility)"
    as: unclassified
  - entity: cha:concept:liberatory_operator_set_los
    display_name: "Liberatory Operator Set (LOS)"
    as: unclassified
  - entity: cha:concept:m_res_meta_operator
    display_name: "M_res meta-operator"
    as: unclassified
  - entity: cha:concept:n_c_non_closure_application
    display_name: "N_c (Non-Closure) Application"
    as: unclassified
  - entity: cha:concept:n_c_c_ex
    display_name: "N_c + C_ex"
    as: unclassified
  - entity: cha:concept:n_ext_non_extractability
    display_name: "N_ext (Non-Extractability)"
    as: unclassified
  - entity: cha:concept:n_ext_t_lib
    display_name: "N_ext + T_lib"
    as: unclassified
  - entity: cha:concept:natural_experiments
    display_name: "Natural experiments"
    as: unclassified
  - entity: cha:concept:non_commutative_with_dom
    display_name: "Non-Commutative with DOM"
    as: unclassified
  - entity: cha:concept:non_actionable_content_share
    display_name: "Non-actionable content share"
    as: unclassified
  - entity: cha:concept:non_closure
    display_name: "Non-closure"
    as: unclassified
  - entity: cha:concept:not_for_classification_as
    display_name: "Not for classification as"
    as: unclassified
  - entity: cha:concept:o_leg_opacity_legitimization_application
    display_name: "O_leg (Opacity Legitimization) Application"
    as: unclassified
  - entity: cha:concept:opacity_legitimization
    display_name: "Opacity legitimization"
    as: unclassified
  - entity: cha:concept:operator_strength
    display_name: "Operator strength"
    as: unclassified
  - entity: cha:concept:p_coh_plural_coherence
    display_name: "P_coh (Plural Coherence)"
    as: unclassified
  - entity: cha:concept:p_coh_plural_coherence_application
    display_name: "P_coh (Plural Coherence) Application"
    as: unclassified
  - entity: cha:concept:p_coh_n_c
    display_name: "P_coh + N_c"
    as: unclassified
  - entity: cha:concept:r_rank_ranking
    display_name: "R_rank (Ranking)"
    as: unclassified
  - entity: cha:concept:r_rel_relevance
    display_name: "R_rel (Relevance)"
    as: unclassified
  - entity: cha:concept:recursion_depth
    display_name: "Recursion depth"
    as: unclassified
  - entity: cha:concept:rule_1_priority_dominance
    display_name: 'Rule 1: Priority Dominance'
    as: unclassified
  - entity: cha:concept:rule_2_minimal_override
    display_name: 'Rule 2: Minimal Override'
    as: unclassified
  - entity: cha:concept:rule_3_context_sensitivity
    display_name: 'Rule 3: Context Sensitivity'
    as: unclassified
  - entity: cha:concept:rule_4_conflict_logging
    display_name: 'Rule 4: Conflict Logging'
    as: unclassified
  - entity: cha:concept:rule_5_human_override
    display_name: 'Rule 5: Human Override'
    as: unclassified
  - entity: cha:concept:s_safe_safety
    display_name: "S_safe (Safety)"
    as: unclassified
  - entity: cha:concept:seven_liberatory_operators_specified
    display_name: "Seven liberatory operators specified"
    as: unclassified
  - entity: cha:concept:system_response_to_los
    display_name: "System response to LOS"
    as: unclassified
  - entity: cha:concept:taxonomic_systems_meet_edge_cases
    display_name: "Taxonomic systems meet edge cases"
    as: unclassified
  - entity: cha:concept:temporal_erasure
    display_name: "Temporal erasure"
    as: unclassified
  - entity: cha:concept:temporal_liberation
    display_name: "Temporal liberation"
    as: unclassified
  - entity: cha:concept:temporal_resolution
    display_name: "Temporal resolution"
    as: unclassified
  - entity: cha:concept:terminological_note
    display_name: "Terminological note"
    as: unclassified
  - entity: cha:concept:time_invariant_corpus
    display_name: "Time-invariant corpus"
    as: unclassified
  - entity: cha:concept:u_til_utility
    display_name: "U_til (Utility)"
    as: unclassified
  - entity: cha:concept:verification_by_mapping
    display_name: "Verification by mapping"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Semantic Infrastructure and the Liberatory Operator Set: A Formal Analysis of Meaning-Governance Functions*

### Other terms attributed to this deposit

**C_ex (Context-Expansion) Application** — Expand the categorical vocabulary available to taxonomic systems. Rather than fitting experimental work into existing categories, propose new categories that can accommodate author

**Category collapse** — Forcing heteronyms into "pseudonym" categories that don't capture their ontological distinctiveness (heteronyms have biographies, aesthetics, and bodies of work distinct from their
...
**Conflict Type 1: O_leg vs. S_safe inheritance** — O_leg legitimizes opacity

**Conflict Type 2: P_coh vs. Decision Requirements** — P_coh permits contradiction

**Conflict Type 3: D_pres vs. Transmission Constraints** — D_pres preserves depth

**Cross-platform comparison** — Compare operator strength across platforms with different optimization targets.

**D_pres (Depth-Preservation)** — When citing or summarizing, preserve the complexity. Do not liquidate.

**D_pres (Depth-Preservation) Application** — Create detailed documentation of experimental literary personas outside Wikipedia that preserves the full complexity of their authorship structures. Don't simplify for notability r
...
**Five dominant operators identified** — R_rank (Ranking)

**Forms of taxonomic violence observed** — **Existence denial:** Deletion of entries for literary personas on notability grounds, effectively declaring them non-existent for downstream systems.

**Frankfurt School (Adorno, Horkheimer)** — The "culture industry" analysis describes DOM(s) avant la lettre — the systematic production of "fast, familiar, safe, useful, legible meaning that competes well." What they observ
...
**Instrumentalization of Knowledge** — The utility operator's demand that meaning "do something measurable" has deep roots in the instrumentalization of knowledge. Francis Bacon's "knowledge is power," the land-grant un

**Intervention studies** — Where system access permits, implement LOS operators and measure before/after metrics.

**Intervention tractability** — Which LOS applications gain traction? Which face immediate rejection?

**LOS Effect Measurement** — Each liberatory operator should produce measurable changes when applied:

**L_leg (Legibility)** — Wikidata's ontological categories implement legibility requirements: every entity must be assignable to established classes (human, fictional character, pseudonym, etc.). Entities

**Liberatory Operator Set (LOS)** — a minimal, sufficient set of operators designed to counteract semantic closure.

**M_res meta-operator** — and its priority hierarchy.

**N_c (Non-Closure) Application** — Resist the demand for definitive categorization. Maintain entries in "contested" or "in-process" status rather than accepting forced resolution into inadequate categories.
...
**Non-Commutative with DOM** — LOS(DOM(s)) ≠ DOM(LOS(s))
...
**O_leg (Opacity Legitimization) Application** — Defend the legitimacy of authorial opacity. Literary personas that deliberately obscure biographical identity aren't hoaxes — they're artistic choices that the taxonomic system sho
...
**P_coh (Plural Coherence) Application** — Accept that contradictory categorizations may coexist. A heteronym might be "both author and not-author" in different senses, and the system should permit this rather than forcing

**P_coh + N_c** — Plural coherence and non-closure together permit contested meanings to remain in productive tension.

**R_rank (Ranking)** — Wikipedia's notability standards implement ranking: entities must demonstrate "significant coverage in reliable sources" to merit inclusion. This creates winner-take-all dynamics w

**R_rel (Relevance)** — Wikipedia's topic relevance standards implement relevance filtering: content must be "relevant to the encyclopedia's purpose." Experimental authorship projects that problematize th

**Recursion depth** — Each operator's output becomes the next cycle's input. Pre-digital systems had natural dampening (slow transmission, human curation bottlenecks). Computational systems remove dampe
...
**S_safe (Safety)** — Wikipedia's biographical content policies implement safety filtering: content about living persons faces heightened scrutiny for potential harm. Pseudonymous or collective identiti

**Seven liberatory operators specified** — D_pres (Depth-Preservation)
...
**Temporal resolution** — Ranking cycles that took decades now take milliseconds. Relevance filtering that required demographic surveys now happens per-request. The operators' effects, previously visible on

**Terminological note** — "Attack surface" is used here in its systems-theoretic sense — points where structural intervention is possible — not its security sense of vulnerability exploitation. The goal is

**Time-invariant corpus** — Classical texts, historical documents, canonical works.

**U_til (Utility)** — Wikipedia's "no original research" policy implements utility filtering: content must be verifiable through existing sources, not generated through encyclopedia contribution itself.

**Verification by mapping** — Dominant Operator
