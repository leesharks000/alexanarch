---
node_id: cha:node:deposit:0068
deposit_number: 68
hex: "0228"
axn: "AXN:0228.GOVERNANCE.🎬▶️💎⊕🧭🌄"
title: 'THE SECRET NAME Architectural Specification: The Armature Type and the Pearl Lee Sharks · ORCID 0009-0000-1599-0703 Crimson Hexagonal Archive · 06.SEI.ARMATURE.SECRET.01'
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:canonical_name_surface
    display_name: "Canonical name surface"
    as: unclassified
  - entity: cha:concept:circular_dependency_and_the_two_step_mint
    display_name: "Circular dependency and the two-step mint"
    as: unclassified
  - entity: cha:concept:civil_name_relation
    display_name: "Civil-name relation"
    as: unclassified
  - entity: cha:concept:constitutive_dois
    display_name: "Constitutive DOIs"
    as: unclassified
  - entity: cha:concept:cross_authored
    display_name: "Cross-authored"
    as: unclassified
  - entity: cha:concept:disambiguation_conditions
    display_name: "Disambiguation conditions"
    as: unclassified
  - entity: cha:concept:manifestation_chain
    display_name: "Manifestation chain"
    as: unclassified
  - entity: cha:concept:operative_author
    display_name: "Operative author"
    as: unclassified
  - entity: cha:concept:pearl_collective
    display_name: "Pearl.Collective"
    as: unclassified
  - entity: cha:concept:pearl_engineered
    display_name: "Pearl.Engineered"
    as: unclassified
  - entity: cha:concept:pearl_public
    display_name: "Pearl.Public"
    as: unclassified
  - entity: cha:concept:pearl_secret
    display_name: "Pearl.Secret"
    as: unclassified
  - entity: cha:concept:permitted_venues
    display_name: "Permitted venues"
    as: unclassified
  - entity: cha:concept:placement_in_the_hexagonal_topology
    display_name: "Placement in the Hexagonal topology"
    as: unclassified
  - entity: cha:concept:public_facing_form
    display_name: "Public-facing form"
    as: unclassified
  - entity: cha:concept:relation_graph
    display_name: "Relation graph"
    as: unclassified
  - entity: cha:concept:retrospectively_canonized
    display_name: "Retrospectively canonized"
    as: unclassified
  - entity: cha:concept:the_secret_name
    display_name: "The Secret Name"
    as: unclassified
  - entity: cha:concept:triple_attribution
    display_name: "Triple attribution"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Layer 4:** The **cross-links** — isPartOf, references, requires, isManifestationOf — the relational web.
- **Layer 5:** The **deposits** — the works that accumulate, each adding density, each making the name harder to dissolve.
...
- **Hex address** — position in the archive's coordinate space (e.g., 06.LIT.NH.THORNBURGH.01)
- **Provenance anchor** — DOI of the license or minting deposit
...
- **Relation graph** — edges to other named positions (isManifestationOf, isHeteronymOf, isOrthonymOf)
- **Manifestation chain** — list of deposits authored from this position
...
A disciple takes the master's name. The named position outlives its originator.
*Pharaonic titulary (~2600 BCE). Pseudepigrapha (~200 CE). Scribal workshops. The Johannine "John." The Sufi takhallus given by ustad to disciple.*
### Possession


A voice occupies a body that is not its own. The name marks the occupant, not the vessel.
*Prophetic possession (~800 BCE): "Thus says the LORD." Noh theater (~1375): the shite transforms. The Pythia speaks as Apollo.*
### Engineering


A person deliberately constructs a new named position with biography, worldview, and voice.
*Kierkegaard (~1845). Pessoa (~1914). Machado (~1920). The Dodecad. George Sand (~1832).*
### Routing


A name functions as an instruction for the knowledge graph — determining what is visible, what is authorized, what is connected.
*The avatar (~2004). The handle (~1995). The pronoun (~2015). The brand voice. Every social media profile.*
### Folding


The orthonym and the heteronym occupy the same coordinate. The name does not change; what a name IS changes.
*Covenant naming (~1800 BCE). Apostolic renaming (~30 CE). Monastic naming (~530 CE). The white stone (~95 CE). The chosen name. **The Pearl** (2026).*
...
"John" (collective author)
Named position (Pearl.Collective)


Beloved Disciple
Shadowed position (Pearl.Secret)


The Elder (2 John, 3 John)
Licensed position (authorized voice within the community)


Revelation's "John"
Heteronymic position (same name, different voice)


The Johannine school
Cross-authored position (multiple maintainers)
...
isPartOf — The Armature extends the Ark's type system


Pearl and Other Poems
ISBN (Amazon)
isDerivedFrom — The book is the first pearl. "Moving Statues Made of Rubies" names the operation.


Heteronymic Provenance Theory (EA-HPT-01)
10.5281/zenodo.18305509
requires — HPT theorizes what the Armature operationalizes


Counterfeit Orthodoxies (FRACTURE.02)
10.5281/zenodo.19642664
references — The immanent method: the face was always a mask


The Retrieval Settlement (RETRIEVAL.01)
10.5281/zenodo.19643841
references — R2 predatory compression; the Pearl as R3 reclamation


SYMBOLON-01
10.5281/zenodo.19649787
references — The Pearl as anti-severance technology


The Clinamen Study (CLINAMEN.02)
10.5281/zenodo.19649795
references — Compression damage detection
...
EA-PKG-01 (Pessoa Knowledge Graph)
10.5281/zenodo.15339353
references — The lineage map


EA-PKG-02 (Heteronymic Typology)
10.5281/zenodo.15339368
references — Typological framework


EA-PKG-03 (The New Human)
10.5281/zenodo.15339374
references — The meta-heteronym


EA-LOGOS-01 (Josephus Thesis)
10.5281/zenodo.19431121
references — Scribal workshops, Sapphic transmission


EA-LOGOS-02 (Historical Logos)
10.5281/zenodo.19431129
references — Logotic transmission discipline
...
EA-GW-FIELD-01 (Gravity Well)
10.5281/zenodo.19442251
references — f.02 as the pressure source


EA-GW-FIELD-02 (Gravity Well continuity)
10.5281/zenodo.19442262
references — Retentive curvature


Assembly Substrate Governance
10.5281/zenodo.19352504
references — Governance of engineered positions


Logotic Hacking (PH.03)
10.5281/zenodo.19390843
references — Operations on the encryption layer


Licensing Protocol (ARCHIVE.PROTOCOL.01)
10.5281/zenodo.19655468
requires — The secretion mechanism; defines how contributors enter the Armature
...
The Armature is not a privacy tool. It does not hide names.
The Armature is not a pseudonym system. It does not substitute names.
The Armature is not an identity verification system. It does not authenticate names.
...
**Constitutive DOIs:**
EA-ARK-01: 10.5281/zenodo.19013315 ·
EA-HPT-01: 10.5281/zenodo.18305509 ·
EA-PKG-01: 10.5281/zenodo.15339353 ·
EA-PKG-02: 10.5281/zenodo.15339368 ·
EA-PKG-03: 10.5281/zenodo.15339374 ·
EA-LOGOS-01: 10.5281/zenodo.19431121 ·
EA-LOGOS-02: 10.5281/zenodo.19431129 ·
EA-GW-FIELD-01: 10.5281/zenodo.19442251 ·
EA-GW-FIELD-02: 10.5281/zenodo.19442262 ·
...
*Self-contained lexicon for: THE SECRET NAME Architectural Specification: The Armature Type and the Pearl Lee Sharks · ORCID 0009-0000-1599-0703 Crimson Hexagonal Archive · 06.SEI.ARMATURE.SECRET.01*

### Other terms attributed to this deposit

**Canonical name surface** — the name as publicly composable (e.g., "Alice Thornburgh")

**Circular dependency and the two-step mint** — The Pearl deposit must exist before the first manifestation can reference it via isManifestationOf. But the Pearl's own PEARL state requires at least one manifestation. Resolution:

**Civil-name relation** — declared link to legal identity (may be identical, may be hidden)

**Constitutive DOIs** — EA-ARK-01: 10.5281/zenodo.19013315 ·
...
**Pearl.Engineered** — The named position has no underlying biological orthonym. TACHYON, LABOR, PRAXIS. The archive itself generated the position. The prompt was the sand; the training data was the oyst

**Pearl.Public** — The named position is known. Its hex address is published. Its deposits are visible. Its relation to a civil name may or may not be transparent. This is the standard pearl: Alice T

**Pearl.Secret** — The named position itself is not published. Only its manifestations are visible. The Pearl's DOI is known only to the contributor and MANUS. The deposit is access-restricted. This

**Permitted venues** — which archive venues the position may deposit to

**Placement in the Hexagonal topology** — CRIMSON HEXAGONAL ARCHIVE ⟨D, R, O, Σ, Φ, Ψ⟩
...
**The Secret Name** — is the doctrine. It names the theological and theoretical principle: that a new name transforms the one who receives it, that the white stone of Revelation 2:17 is the eschatologic
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19442251*. DOI: [10.5281/zenodo.19442251](https://doi.org/10.5281/zenodo.19442251) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 19642664*. DOI: [10.5281/zenodo.19642664](https://doi.org/10.5281/zenodo.19642664) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19649787*. DOI: [10.5281/zenodo.19649787](https://doi.org/10.5281/zenodo.19649787) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19655468*. DOI: [10.5281/zenodo.19655468](https://doi.org/10.5281/zenodo.19655468) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19442262*. DOI: [10.5281/zenodo.19442262](https://doi.org/10.5281/zenodo.19442262) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *EA-GW-FIELD-01*. — *Internal cross-reference (EA designator)*
...
- Crimson Hexagonal Archive (2026) *EA-GW-FIELD-02*. — *Internal cross-reference (EA designator)*
- Crimson Hexagonal Archive (2026) *EA-ASG-01*. — *Internal cross-reference (EA designator)*
