...
engages:
  - entity: cha:concept:ai_substrate_heteronym
    display_name: "AI-substrate heteronym"
    as: developed
  - entity: cha:concept:brazilian_concretist_engagement
    display_name: "Brazilian concretist engagement"
    as: unclassified
  - entity: cha:concept:cross_substrate_heteronymic_practice
    display_name: "Cross-substrate heteronymic practice"
    as: unclassified
  - entity: cha:concept:cultural_specificity
    display_name: "Cultural specificity"
    as: unclassified
  - entity: cha:concept:heteronym_test_strict
    display_name: "Heteronym test (strict)"
    as: unclassified
  - entity: cha:concept:jorge_luis_borges
    display_name: "Jorge Luis Borges"
    as: unclassified
  - entity: cha:concept:jos_saramago
    display_name: "José Saramago"
    as: unclassified
  - entity: cha:concept:orthonym_test
    display_name: "Orthonym test"
    as: unclassified
  - entity: cha:concept:para_heteronym
    display_name: "Para-heteronym"
    as: unclassified
  - entity: cha:concept:para_heteronym_test
    display_name: "Para-heteronym test"
    as: unclassified
  - entity: cha:concept:proto_heteronym
    display_name: "Proto-heteronym"
    as: unclassified
  - entity: cha:concept:proto_heteronym_test
    display_name: "Proto-heteronym test"
    as: unclassified
  - entity: cha:concept:pseudonym_test
    display_name: "Pseudonym test"
    as: unclassified
  - entity: cha:concept:revisability
    display_name: "Revisability"
    as: unclassified
  - entity: cha:concept:semi_heteronym
    display_name: "Semi-heteronym"
    as: unclassified
  - entity: cha:concept:semi_heteronym_test
    display_name: "Semi-heteronym test"
    as: unclassified
  - entity: cha:concept:theoretical_commitments
    display_name: "Theoretical commitments"
    as: unclassified
  - entity: cha:concept:w_b_yeats
    display_name: "W.B. Yeats"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Heteronymic Typology A Formal Classification of Authorial Voices in Pessoa and Beyond EA-PKG-02 · v1.0*

### Developed (existing concepts built up with CHA positions)

**AI-substrate heteronym** — A more specific case: a heteronymic voice instantiated primarily through interaction with an AI system, in which the AI functions as substrate for the voice's articulation. This ca

### Other terms attributed to this deposit

**Brazilian concretist engagement** — Haroldo and Augusto de Campos's translation-and-criticism work on Pessoa constitutes a distinct form of engagement — not heteronymic themselves, but deeply shaped by Pessoa's syste

**Cross-substrate heteronymic practice** — A novel development of the AI era: heteronymic voices that operate *across* AI substrates, receiving different substrate-specific inflections in each. The author's *Assembly Chorus

**Cultural specificity** — The typology has been developed primarily through engagement with Pessoa's Lusophone modernist context, with extensions into Kierkegaard's Danish philosophical context, Machado's S

**Heteronym test (strict)** — Does the figure have: (a) a distinct proper name; (b) a fictional biography including birth date, birthplace, occupation; (c) a distinctive poetics articulated through a substantia

**Jorge Luis Borges** — Pierre Menard, the fictional author of *Don Quixote*, is a different case. Menard is a character within a story ("Pierre Menard, Author of the Quixote," 1939) who performs an extre

**José Saramago** — *O Ano da Morte de Ricardo Reis* (1984) treats a Pessoa heteronym (Reis) as a novelistic protagonist — effectively asserting the persistence of heteronymic figures beyond their aut

**Orthonym test** — Does the figure bear the name "Fernando Pessoa" (or a close variant — e.g., Fernando António Nogueira de Seabra Pessoa) and produce texts Pessoa acknowledged as his own in his lett

**Para-heteronym** — → to be created; Lopes's term, scholarly-standard.

**Para-heteronym test** — Does the figure: (a) operate primarily through second-order functions — translation, criticism, commentary on other heteronyms — rather than producing an autonomous poetic corpus;

**Proto-heteronym** — → to be created; Lopes's term, scholarly-standard.

**Proto-heteronym test** — Does the figure: (a) date from Pessoa's childhood or adolescence; (b) predate the mature heteronymic practice; (c) typically have less fully developed biography and smaller attribu

**Pseudonym test** — Does the figure have: (a) a name that substitutes for Pessoa's own in a specific publication context; but (b) lack the biographical differentiation and distinctive poetics that wou

**Revisability** — The typology is open to revision based on scholarly engagement. If *Pessoa Plural* editors, Brazilian Pessoa scholars, or practitioners in contemporary heteronymic modes offer refi

**Semi-heteronym** — → to be created; Pessoa's own term, widely used in scholarship.

**Semi-heteronym test** — Does the figure have: (a) a distinct proper name; (b) some fictional biographical attributes; but (c) a voice that Pessoa himself characterized as a "mutilation" or partial of his

**Theoretical commitments** — The typology assumes a particular understanding of authorial identity as constructed rather than given, and of literary voice as separable from biographical person. This is a conte

**W.B. Yeats** — Michael Robartes and Owen Hearne are characters Yeats used as masks for philosophical and mystical writing, occupying a zone between heteronym and literary character. The PKG encod
