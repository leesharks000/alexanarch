---
node_id: cha:node:deposit:0199
deposit_number: 199
hex: "0341"
axn: "AXN:0341.EMPIRICAL.🕕🎨🏁🌳🔥🛡️"
title: 'Generative Monoculture Model Collapse in Code as Systemic Vulnerability Authors: Talos Morrow (University Moon Base Media Lab) · Nobel Glas (Lagrange Observatory) Contributing editor: Lee Sharks (ORCI'
...
status: ACTIVE
engages:
  - entity: cha:concept:ai_monoculture_and_epistemic_diversity
    display_name: "AI monoculture and epistemic diversity"
    as: developed
  - entity: cha:concept:code_security_empirical
    display_name: "Code security — empirical"
    as: unclassified
  - entity: cha:concept:cross_generational_tracking
    display_name: "Cross-generational tracking"
    as: unclassified
  - entity: cha:concept:diversity_measurement
    display_name: "Diversity measurement"
    as: unclassified
  - entity: cha:concept:feature_extraction
    display_name: "Feature extraction"
    as: unclassified
  - entity: cha:concept:generation_0
    display_name: "Generation 0"
    as: unclassified
  - entity: cha:concept:generation_1
    display_name: "Generation 1"
    as: unclassified
  - entity: cha:concept:generation_2
    display_name: "Generation 2"
    as: unclassified
  - entity: cha:concept:generation_n
    display_name: "Generation N"
    as: unclassified
  - entity: cha:concept:historical_monoculture_analogues
    display_name: "Historical monoculture analogues"
    as: unclassified
  - entity: cha:concept:model_collapse_foundational
    display_name: "Model collapse — foundational"
    as: unclassified
  - entity: cha:concept:retrieval_kernel
    display_name: "Retrieval kernel"
    as: unclassified
  - entity: cha:concept:security_law_context
    display_name: "Security-law context"
    as: unclassified
  - entity: cha:concept:task_battery
    display_name: "Task battery"
    as: unclassified
  - entity: cha:concept:the_ai_monoculture_community
    display_name: "The AI monoculture community"
    as: unclassified
  - entity: cha:concept:the_code_security_community
    display_name: "The code security community"
    as: unclassified
  - entity: cha:concept:the_model_collapse_community
    display_name: "The model collapse community"
    as: unclassified
  - entity: cha:concept:training_data_saturation
    display_name: "Training-data saturation"
    as: unclassified
  - entity: cha:concept:verification_condition
    display_name: "Verification condition (∮)"
    as: unclassified
  - entity: cha:concept:vulnerability_correlation
    display_name: "Vulnerability correlation"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Generative Monoculture Model Collapse in Code as Systemic Vulnerability Authors: Talos Morrow (University Moon Base Media Lab) · Nobel Glas (Lagrange Observatory) Contributing editor: Lee Sharks (ORCI*

### Developed (existing concepts built up with CHA positions)

**AI monoculture and epistemic diversity** — Apiiro, "AI-Generated Code Security" (2025) — coining "generative monoculture" as systemic vulnerability at internet scale.

### Other terms attributed to this deposit

**Code security — empirical** — Checkmarx, "Agentic AppSec Unleashed '26" — annual survey of security leaders (June 2026, https://checkmarx.com/press-releases/75-of-companies-ship-vulnerable-code-despite-a-startl

**Cross-generational tracking** — Repeat the measurement across successive model generations (or successive fine-tuning cycles on corpora with increasing synthetic content). The SSDI trajectory and VCC trajectory a

**Diversity measurement** — Compute the effective dimensionality of the feature-vector distribution for F(T, G) using the participation ratio of the eigenvalues of the covariance matrix:

**Feature extraction** — For each solution in F(T, G), extract a feature vector encoding structural properties: abstract syntax tree shape and depth, control-flow graph topology, data-flow patterns, librar

**Generation 0** — The model is trained on a corpus of human-written code, diverse in style, architecture, and approach, reflecting decades of heterogeneous software development by millions of author

**Generation 1** — The model generates code. The code is correct — it passes tests, it compiles, it ships. Millions of developers adopt AI-assisted coding tools. The code enters production codebases,

**Generation 2** — The next model is trained. The corpus now contains a substantial and growing fraction of Generation 1 code. The training pipeline cannot reliably distinguish synthetic from human-w

**Generation N** — The proportion of synthetic code in the corpus increases with each generation. The optimization pressure on code capability increases with each generation. The solution space contr

**Historical monoculture analogues** — The Irish Potato Famine and *Phytophthora infestans* (1845–1852).

**Model collapse — foundational** — I. Shumailov et al., "AI models collapse when trained on recursively generated data," *Nature* (2024), DOI 10.1038/s41586-024-07566-y.

**Retrieval kernel** — *Generative Monoculture* argues that model collapse in code produces not declining correctness but correlated vulnerability: AI-generated code converges on shared patterns, archite

**Security-law context** — Adversarial by Origin, EA-SEI-ADVERSARY-01, DOI 10.5281/zenodo.20673413.

**Task battery** — Select a battery of N programming tasks spanning multiple domains (web applications, data processing, systems programming, cryptographic operations, API design). Each task is defin

**The AI monoculture community** — has established, in more recent and more tentative work, that the dominance of a small number of models trained on similar data with similar architectures produces correlated risks

**The code security community** — has established, with increasing empirical weight, that AI-generated code carries measurably elevated vulnerability rates and that the rate scales with adoption intensity. A Checkm

**The model collapse community** — has established, with increasing mathematical precision, that training generative models iteratively on their own outputs produces progressive narrowing of the output distribution

**Training-data saturation** — Epoch AI's projections on the exhaustion of high-quality human-generated text are well known. The code-specific version of this projection has not been published, but the structura

**Verification condition (∮)** — Per the Lagrange Observatory standard (EA-ARK-01 v4.2.7, DOI 10.5281/zenodo.19013315), the measurement must wind both directions: (a) demonstrate that low SSDI predicts high VCC (p

**Vulnerability correlation** — For each pair of solutions in F(T, G), compute the Jaccard similarity of their CWE exposure sets. The *vulnerability correlation coefficient* (VCC) is the mean pairwise Jaccard sim

### Citations

- Crimson Hexagonal Archive (2026) *Zenodo record 20675438*. DOI: [10.5281/zenodo.20675438](https://doi.org/10.5281/zenodo.20675438) — *Cross-referenced work*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 20674488*. DOI: [10.5281/zenodo.20674488](https://doi.org/10.5281/zenodo.20674488) — *Cross-referenced work*
