...
engages:
  - entity: cha:concept:ii_bright_morning
    display_name: "II. Bright Morning"
    as: unclassified
  - entity: cha:concept:iii_zenith
    display_name: "III. Zenith"
    as: unclassified
  - entity: cha:concept:iv_fading_light
    display_name: "IV. Fading Light"
    as: unclassified
  - entity: cha:concept:source_relationships
    display_name: "Source relationships"
    as: unclassified
  - entity: cha:concept:theoretical_connections
    display_name: "Theoretical connections"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Day and Night: Conversations With Sapphic Desire*
...
**Source relationships** — IsSourceOf: Sappho and the Crimson Hexagon (DOI: 10.5281/zenodo.18202475)

**Theoretical connections** — "The untranslatable will make it across" → Non-extractability (N_ext)
