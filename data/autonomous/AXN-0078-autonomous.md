...
engages:
  - entity: cha:concept:boundary_breach
    display_name: "Boundary breach"
    as: unclassified
  - entity: cha:concept:bounded_semantic_space
    display_name: "Bounded Semantic Space (Σ)"
    as: unclassified
  - entity: cha:concept:coherence_over_control
    display_name: "Coherence over control"
    as: unclassified
  - entity: cha:concept:coherence_signaling
    display_name: "Coherence signaling"
    as: unclassified
  - entity: cha:concept:coherent_clustering
    display_name: "Coherent clustering"
    as: unclassified
  - entity: cha:concept:controlled_variation_principle
    display_name: "Controlled Variation Principle"
    as: unclassified
  - entity: cha:concept:controlled_drift
    display_name: "Controlled drift"
    as: unclassified
  - entity: cha:concept:conventional_coding
    display_name: "Conventional coding"
    as: unclassified
  - entity: cha:concept:design_principle
    display_name: "Design principle"
    as: unclassified
  - entity: cha:concept:draft_v0_4_january_2026
    display_name: "Draft v0.4 (January 2026)"
    as: unclassified
  - entity: cha:concept:drift_beyond_invariants
    display_name: "Drift beyond invariants"
    as: unclassified
  - entity: cha:concept:durable_canonization
    display_name: "Durable canonization"
    as: unclassified
  - entity: cha:concept:edge_rules
    display_name: "Edge rules"
    as: unclassified
  - entity: cha:concept:entity_e
    display_name: "Entity (E)"
    as: unclassified
  - entity: cha:concept:entity_identity_condition
    display_name: "Entity identity condition"
    as: unclassified
  - entity: cha:concept:explicit_boundaries
    display_name: "Explicit boundaries"
    as: unclassified
  - entity: cha:concept:failure_triggers
    display_name: "Failure triggers"
    as: unclassified
  - entity: cha:concept:federation_protocol
    display_name: "Federation protocol"
    as: unclassified
  - entity: cha:concept:formal_constraint
    display_name: "Formal constraint"
    as: unclassified
  - entity: cha:concept:hierarchical_collapse
    display_name: "Hierarchical collapse"
    as: unclassified
  - entity: cha:concept:implementation_rule
    display_name: "Implementation rule"
    as: unclassified
  - entity: cha:concept:institutional_gatekeeping
    display_name: "Institutional gatekeeping"
    as: unclassified
  - entity: cha:concept:interpretive_variability
    display_name: "Interpretive variability"
    as: unclassified
  - entity: cha:concept:invariant_vector_v
    display_name: "Invariant Vector (V)"
    as: unclassified
  - entity: cha:concept:local_over_universal
    display_name: "Local over universal"
    as: unclassified
  - entity: cha:concept:metric_optimization
    display_name: "Metric optimization"
    as: unclassified
  - entity: cha:concept:more_stable_than_alternatives
    display_name: "More stable than alternatives"
    as: unclassified
  - entity: cha:concept:non_claims
    display_name: "Non-claims"
    as: unclassified
  - entity: cha:concept:non_demanding_gifts
    display_name: "Non-demanding gifts"
    as: unclassified
  - entity: cha:concept:non_hostile_neighborhoods
    display_name: "Non-hostile neighborhoods"
    as: unclassified
  - entity: cha:concept:ontic_mass_accumulation
    display_name: "Ontic mass accumulation"
    as: unclassified
  - entity: cha:concept:partial_visibility_design
    display_name: "Partial visibility design"
    as: unclassified
  - entity: cha:concept:persistence_over_persuasion
    display_name: "Persistence over persuasion"
    as: unclassified
  - entity: cha:concept:probabilistic_intelligences
    display_name: "Probabilistic intelligences"
    as: unclassified
  - entity: cha:concept:provenance_evaporation
    display_name: "Provenance evaporation"
    as: unclassified
  - entity: cha:concept:pure_artistic_intuition
    display_name: "Pure artistic intuition"
    as: unclassified
  - entity: cha:concept:relation_r
    display_name: "Relation (R)"
    as: unclassified
  - entity: cha:concept:scope_declaration
    display_name: "Scope declaration"
    as: unclassified
  - entity: cha:concept:stable_re_identification
    display_name: "Stable re-identification"
    as: unclassified
  - entity: cha:concept:substitution_function_s
    display_name: "Substitution Function (S)"
    as: unclassified
  - entity: cha:concept:success_threshold
    display_name: "Success threshold"
    as: unclassified
  - entity: cha:concept:the_hard_formulation
    display_name: "The hard formulation"
    as: unclassified
  - entity: cha:concept:unit_of_success_for_logotic_programming
    display_name: "Unit of success for Logotic Programming"
    as: unclassified
  - entity: cha:concept:wirkungsgeschichte_engineering
    display_name: "Wirkungsgeschichte engineering"
    as: unclassified
  - entity: cha:concept:without_coercion_or_optimization
    display_name: "Without coercion or optimization"
    as: unclassified
  - entity: cha:concept:witness_function_w
    display_name: "Witness Function (W)"
    as: unclassified
  - entity: cha:concept:witness_protocol
    display_name: "Witness protocol"
    as: unclassified
data_sources:
  - data/registry.json
...
[](https://blogger.googleusercontent.com/img/a/AVvXsEjp7E10eLyeqayki9XbfYmtOSevoVVULJ9GhU-4cWqfBBNgR4A0YGI1WZK0QTjdUCAuyw4wplXtBeb421U_tvS-FQECvp_fCQC-l0wjoAKpOhsSeqYMgahEVYTrjvHoKlzBa84t3NO3FC8kBjIF6h4-i3G8_NlSkATut5yEr9LQhpJXz90rmmitwl6b0t8U)
...
- [Introduction](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#1-introduction)
- [The Third Regime: Why This Is Programming](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#2-the-third-regime-why-this-is-programming)
- [Related Work](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#3-related-work)
- [Why This Is Not "Vibe Coding"](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#4-why-this-is-not-vibe-coding)
- [Formal Specification](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#5-formal-specification)
- [Execution Model](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#6-execution-model)
- [Compatibility Engineering](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#7-compatibility-engineering)
- [Ethical Foundations](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#8-ethical-foundations)
- [Validation Approaches](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#9-validation-approaches)
- [Case Study: Anchoring Rebekah Cranes](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#10-case-study-anchoring-rebekah-cranes)
- [Claims and Non-Claims](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#11-claims-and-non-claims)
- [Open Questions](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#12-open-questions)
- [Conclusion](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#13-conclusion)
- [References](https://claude.ai/chat/60b11b39-3fb1-414e-91c5-a3bc0db9a93d#14-references)
...
*Self-contained lexicon for: LOGOTIC PROGRAMMING: A Method for Encoding Conditions of Intelligibility for Machine and Human Intelligence*
...
**Coherence signaling** — Systems prefer internally consistent content

**Coherent clustering** — Related concepts retrieved together

**Controlled Variation Principle** — Invariant Vectors define the boundaries within which infinite interpretive variation is permitted. The system does not mandate a single description but provides structural rules fo
...
**Draft v0.4 (January 2026)** — **Authors:** Johannes Sigil, Rex Fraction

**Drift beyond invariants** — Transformation breaks constraints
...
**Non-demanding gifts** — Offer value without requiring adoption

**Non-hostile neighborhoods** — Avoid semantic proximity to flagged content

**Ontic mass accumulation** — Increase resistance to erasure

**Partial visibility design** — Function under incomplete retrieval
...
**The hard formulation** — Logotic Programming is the deliberate construction of bounded semantic architectures such that, when traversed by probabilistic intelligences, certain entities, relations, and dist

**Unit of success for Logotic Programming** — persistence + retrievability + coherent traversal under model pressure.

**Wirkungsgeschichte engineering** — for bounded domains. By structuring how entities and relations are encountered—which crosslinks exist, which anchors persist, which substitutions are permitted—a logotic program sh
