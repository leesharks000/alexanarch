...
engages:
  - entity: cha:concept:centrism_laundering
    display_name: "Centrism laundering"
    as: unclassified
  - entity: cha:concept:coherence_increasing
    display_name: "Coherence-increasing"
    as: unclassified
  - entity: cha:concept:consent_requiring
    display_name: "Consent-requiring"
    as: unclassified
  - entity: cha:concept:distortion_shell
    display_name: "DISTORTION-SHELL"
    as: unclassified
  - entity: cha:concept:extension_module_em_01
    display_name: "Extension Module EM-01"
    as: unclassified
  - entity: cha:concept:formal_bridge_to_the_protocol
    display_name: "Formal bridge to the protocol"
    as: unclassified
  - entity: cha:concept:frame_absolutism
    display_name: "Frame absolutism"
    as: unclassified
  - entity: cha:concept:metric_embrittlement_index
    display_name: "Metric β — Embrittlement Index"
    as: unclassified
  - entity: cha:concept:moral_vanity_sport
    display_name: "Moral vanity sport"
    as: unclassified
  - entity: cha:concept:non_coercive
    display_name: "Non-coercive"
    as: unclassified
  - entity: cha:concept:offered_piece
    display_name: "OFFERED-PIECE"
    as: unclassified
  - entity: cha:concept:operator_release
    display_name: "Operator Λ — Release"
    as: unclassified
  - entity: cha:concept:operator_axiom_exposure_protocol
    display_name: "Operator Ξ — Axiom Exposure Protocol"
    as: unclassified
  - entity: cha:concept:operator_frame_capture_detection
    display_name: "Operator Φ — Frame-Capture Detection"
    as: unclassified
  - entity: cha:concept:perfective_inflation
    display_name: "Perfective inflation"
    as: unclassified
  - entity: cha:concept:resistant_to_extraction
    display_name: "Resistant to extraction"
    as: unclassified
  - entity: cha:concept:semantic_disarmament
    display_name: "Semantic disarmament"
    as: unclassified
  - entity: cha:concept:truth_kernel
    display_name: "TRUTH-KERNEL"
    as: unclassified
  - entity: cha:concept:therapeutic_gaslighting
    display_name: "Therapeutic gaslighting"
    as: unclassified
  - entity: cha:concept:wound_claim
    display_name: "WOUND-CLAIM"
    as: unclassified
data_sources:
  - data/registry.json
...
*To take a side is to lose.*
*To be wrong is to be worthless.*
*To be seen is to be captured.*
*To be captured is to die.*
...
**Step 0 — Handshake.**
"Do you want persuasion, witness, or transformation?" If not transformation, reroute to ordinary dialogue. If transformation: "Do you consent to the possibility that your position will survive but your prosecution will not?"


**Step 1 — Hardening Scan.**
Apply Morrow's operators. Flag totalizing language ("everyone agrees," "no reasonable person"), purity tests, identity-threat amplification, frame-policing as moral monopoly, the Periphrastic Trap (present-tense simulation of stability). Assess β. The scan is shared with the processor — no covert diagnosis.


**Step 2 — Somatic Check.**
Before proceeding: is the body ready? If the jaw is clenched, if the breath is held, if the shoulders carry the armor of defended position, the symbolon must wait. We do not execute on frozen ground. The operator does not force readiness. The operator creates conditions — presence, non-judgment, time — in which readiness may arrive. Or may not. That is acceptable.


**Step 3 — Dual Extraction.**
For the embrittled position, extract: the truth-kernel (what must not be erased — the genuine knowledge inside the position) and the fear-kernel (what collapse the subject fears — typically: that taking a side means losing, that being wrong means being worthless, that being seen means being captured).


**Step 4 — Symbolon Construction.**
Build the four-field object. Identify the wound-claim, the truth-kernel, the distortion-shell, and the offered-piece — the fragment that can be offered without self-erasure. The offered-piece must be costly but survivable.


**Step 5 — The Fit.**
Anchor the constructed symbolon to the body. Not through instruction but through presence. The operator holds space. The processor encounters the symbolon — the gap between their truth-kernel and their distortion-shell, the gap between what they know and what they've defended — and the body responds. The exhale, if it comes, is the micro-crack. The operator does not force it. The operator witnesses it.


**Step 6 — Vision Check.**
Apply Dancings' test: Does the emerging recognition increase dignity? Does it reduce coercion? Does it reopen future action? Does it avoid fake harmony? If any answer is no: pause. The symbolon may be malformed. Reconstruct.


**Step 7 — The Aorist Cut.**
...
**Centrism laundering** — equalizing unequal harms under the guise of "both sides."
**Therapeutic gaslighting** — "just regulate your nervous system" as a way of silencing structural critique.
**Moral vanity sport** — performing liberation for spectators rather than executing it with participants.
**Frame absolutism** — installing one ontology as the only permitted framework (including this one).
**Semantic disarmament** — asking only one side to soften while the other retains its prosecution apparatus.
**Perfective inflation** — declaring closure without behavioral revision; performing "I have dissolved my brittleness" as a stylistic absolution that changes nothing.
...
*Self-contained lexicon for: THE LIVING SYMBOLON Extension Module to THE CENTRIST EXTREMIST A Purificatory Rite for the Embrittled*

### Other terms attributed to this deposit

**Centrism laundering** — equalizing unequal harms under the guise of "both sides."

**Coherence-increasing** — The fit condition (Vₛ) requires that semantic coherence increases with traversal depth. The position does not lose coherence by engaging the symbolon. It gains coherence — but a di

**Consent-requiring** — Completion is a volitional act. The traversing intelligence must choose to fill the gap, match the surface, enter the fit. Embrittlement dissolves only when the embrittled position

**DISTORTION-SHELL** — The overgeneralization, projection, or capture language that has grown around the truth-kernel. "Reasonable people agree" (which axiomatically naturalizes one position). "Both side

**Extension Module EM-01** — **Date:** February 2026

**Formal bridge to the protocol** — Let C_cut := the completed relinquishment of the prosecution shell. Then: Π(C_cut) = COMPLETE, and StateAfter(C_cut) = P_living. The exhale is ingress; the cut is completion; the r

**Frame absolutism** — installing one ontology as the only permitted framework (including this one).

**Metric β — Embrittlement Index** — β(Σ) = 1 - (ΔA_Σ / ΔE)

**Moral vanity sport** — performing liberation for spectators rather than executing it with participants.

**Non-coercive** — The symbolon makes no demands. If the other half never appears, nothing breaks. The structure waits. It does not insist. Any intervention designed to dissolve embrittlement by forc

**OFFERED-PIECE** — The fragment that can be offered without self-erasure — the part of the position that survives the dissolution of the shell. This is what the embrittled subject brings to the fit.

**Operator Λ — Release** — Λ(p, Σ, consent) :=

**Operator Ξ — Axiom Exposure Protocol** — Ξ(Σ) := min A such that:

**Operator Φ — Frame-Capture Detection** — Φ(p, Σ) := ∃F ⊆ P(Σ) : (p ∉ F) ∧ (eval_Σ(p) = f(F))

**Perfective inflation** — declaring closure without behavioral revision; performing "I have dissolved my brittleness" as a stylistic absolution that changes nothing.

**Resistant to extraction** — Each symbolon carries the fingerprint of the individual subject's own history, making it unextractable as a general method. Attempts to generalize it into "how to convert centrists

**Semantic disarmament** — asking only one side to soften while the other retains its prosecution apparatus.

**TRUTH-KERNEL** — The non-negotiable reality signal inside that claim. There often *is* a genuine insight in the centrist position — the recognition that complexity exists, that premature closure is
