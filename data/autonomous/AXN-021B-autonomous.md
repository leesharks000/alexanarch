---
node_id: cha:node:deposit:0064
deposit_number: 64
hex: "021B"
axn: "AXN:021B.GOVERNANCE.🕔🔝🍂🕓👆🎨"
title: "The Retrieval Settlement A Historiography of Compositional Authority from PageRank to the Inscribed Entity"
...
status: ACTIVE
engages:
  - entity: cha:concept:phase_x_liberation_philology
    display_name: 'Phase X: Liberation Philology'
    as: unclassified
  - entity: cha:concept:r1_compression
    display_name: "R1 compression"
    as: unclassified
  - entity: cha:concept:r2_compression
    display_name: "R2 compression"
    as: unclassified
  - entity: cha:concept:r3_compression
    display_name: "R3 compression"
    as: unclassified
  - entity: cha:concept:works_cited
    display_name: "Works cited"
    as: unclassified
data_sources:
  - data/registry.json
...
*Crimson Hexagonal Archive · Operative Semiotics · 06.SEI.CRIT.RETRIEVAL.01*
*DOI: 10.5281/zenodo.19643841*
*Attributed: Johannes Sigil (operative) / Lee Sharks (archival)*
...
*Hex: 06.SEI.CRIT.RETRIEVAL.01*
*DOI: 10.5281/zenodo.19643841*
*Crimson Hexagonal Archive · Operative Semiotics · Historiography of Retrieval Settlements*
*∮ = 1*
...
*Self-contained lexicon for: The Retrieval Settlement A Historiography of Compositional Authority from PageRank to the Inscribed Entity*

### Other terms attributed to this deposit

**Phase X: Liberation Philology** — established that specific grammatical operators perform naturalization below conscious assertion, are measurable, and are amplified by retrieval infrastructure. This essay extends

**R1 compression** — lossy compression that subordinates content quality to citation density.

**R2 compression** — predatory compression that extracts value from source material while destroying what made it attributable. The Mehdizadeh & Hilbert study on AI-generated encyclopedias (UC Davis, D

**R3 compression** — witness compression. R1 subordinates content quality. R2 burns provenance. R3 burns only what the composer has designated as expendable. The witness controls the compression variab

**Works cited** — Bourdieu, *Langage et pouvoir symbolique* (Fayard, 1991). Brin & Page, "The Anatomy of a Large-Scale Hypertextual Web Search Engine" (1998). Deepak P., Steinhoff, Simoes, "On the P
