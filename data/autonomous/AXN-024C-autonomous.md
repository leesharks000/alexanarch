---
node_id: cha:node:deposit:0706
deposit_number: 706
hex: "024C"
axn: "AXN:024C.ARCHIVAL.🚪🔛🗡️💫⚡🌑"
...
engages:
  - entity: cha:concept:codicological_table
    display_name: "Codicological table"
    as: unclassified
  - entity: cha:concept:cross_section
    display_name: "Cross-section"
    as: unclassified
  - entity: cha:concept:footnote_references
    display_name: "Footnote references"
    as: unclassified
  - entity: cha:concept:front_matter
    display_name: "Front matter"
    as: unclassified
  - entity: cha:concept:gospel_verse
    display_name: "Gospel verse"
    as: unclassified
  - entity: cha:concept:gospel_ix
    display_name: "Gospel §IX"
    as: unclassified
  - entity: cha:concept:identifier_suffixes_on_letters
    display_name: "Identifier suffixes on letters"
    as: unclassified
  - entity: cha:concept:pierce_mode
    display_name: "Pierce mode"
    as: unclassified
  - entity: cha:concept:re_click
    display_name: "Re-click"
    as: unclassified
  - entity: cha:concept:section_switch
    display_name: "Section switch"
    as: unclassified
  - entity: cha:concept:veil_mode_click_behavior
    display_name: "Veil mode click behavior"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Footnote Architecture Read this entire file before modifying any footnote-related code. Every prior fix to footnotes bro*
