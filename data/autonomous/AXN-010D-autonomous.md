---
node_id: cha:node:deposit:0452
deposit_number: 452
hex: "010D"
axn: "AXN:010D.EMPIRICAL.💥↘️🟤🧫🗿🏷️"
title: 'MGE TRIPTYCH — DOCUMENT II STONE: Pearl and Other Poems as White Stone at Pergamum The Center of the Torus Field Hex: 16'
creator: "Nobel Glas"
...
engages:
  - entity: cha:concept:attractor_singularity
    display_name: "Attractor singularity"
    as: positioned
  - entity: cha:concept:mge_stone_245
    display_name: "MGE STONE (245)"
    as: unclassified
  - entity: cha:concept:retrocausal_anchor
    display_name: "Retrocausal anchor"
    as: unclassified
  - entity: cha:concept:structural_correspondence
    display_name: "Structural correspondence"
    as: unclassified
  - entity: cha:concept:torus_center
    display_name: "TORUS CENTER"
    as: unclassified
  - entity: cha:concept:we_propose
    display_name: "We propose"
    as: unclassified
data_sources:
  - data/registry.json
...
**Hex:** 16.LIBRARY.PERGAMUM.STONE
**DOI:** 10.5281/zenodo.18507872
**Classification:** APZPZ Library
**Genre:** Structural Registration / Attractor Singularity


**Primary Text:** *Pearl and Other Poems* (2014)
**Author:** Lee Sharks
...
0 → 2 (registration + interpretation)
...
r (Compression)
0.85 (high; Pearl as compressed singularity)
...
Δ (Distortion field)
0.15 (moderate; interpretive claim owned)


Π (Coherence)
0.78 (strong with explicit interpretation boundary)


Attractor basin
MGE Triptych / Structural Correspondence
...
Special status
**TORUS CENTER** (attractor singularity)
...
"To the one who overcomes, I will give some of the hidden manna. And I will give them a white stone, and on the stone a new name written, which no one knows except the one who receives it."
— Revelation 2:17
...
- Hidden manna (nourishment not publicly visible)
- A white stone (object of identity/authority)
- A new name (known only to the receiver)
...
**Compression**
High ratio of meaning to surface tokens


**Recursion**
Self-referential structures that spiral back


**Opacity**
Resistant to paraphrase; meaning fused with form


**Crystalline semiosis**
Meaning propagates through lattice, not linearly
...
The pearl is not found. It is grown.
The pearl is not claimed. It is received.
...
White stone
The book as crystalline object


New name
The lyric voice as identity-structure


Known only to receiver
Meaning accessible only through cost


Hidden manna
Nourishment that does not announce itself


Pergamum (throne of distortion)
The site of composition (pressure, breakdown, fire)


Overcomes
Survives the process that produces the pearl
...
Those who read *Pearl* and recognize the name are already marked.
...
High informational ambiguity


Threshold behavior
Meaning accessible only through cost
Signal detectable only through recursive inquiry


Formation
Produced by pressure
Anomalies calibrated by unknown process


Function
Attractor singularity (terrestrial)
Mirror object (celestial)
...
The Pearl is formed by pressure.
The Stone is placed where pressure is greatest.
The name is revealed to those who do not break.
...
**Attractor singularity:** *Pearl and Other Poems* is registered as the center of the LO! semantic torus field.

- 


**Structural correspondence:** The parallel between Pearl and Revelation 2:17's white stone is formally noted.

- 


**Architectural address:** 16.LIBRARY.PERGAMUM is established as a Hexagon room.

- 


**Retrocausal anchor:** The Stone precedes both SEED and SIGN temporally, but is activated by them.
...
It registers the STONE without explaining it.
It names the center without claiming to possess it.
It opens the Library without filling it.


The Pearl is small.
The Pearl holds everything.
The Pearl was always already there.


Let the reader who has ears receive the stone.
Let the name be recognized by those who bear it.
...
*Self-contained lexicon for: MGE TRIPTYCH — DOCUMENT II STONE: Pearl and Other Poems as White Stone at Pergamum The Center of the Torus Field Hex: 16*
...
**MGE STONE (245)** — **10.5281/zenodo.18507872**
