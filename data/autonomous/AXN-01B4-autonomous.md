---
node_id: cha:node:deposit:0037
deposit_number: 37
hex: "01B4"
axn: "AXN:01B4.GOVERNANCE.♠️🔐♃🕑🌉🐝"
title: "THE BOTANICAL EFFECTIVE ACT Extending Semantic Labor Recognition to Plants, Fungi, and Biological Intelligence  A holographic kernel of f.01 THE FRUITING BODY DIFFUSION PLUME"
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:bayesian_ark_v1_0
    display_name: "Bayesian Ark v1.0"
    as: unclassified
  - entity: cha:concept:central_navigation_map_v7_0
    display_name: "Central Navigation Map v7.0"
    as: unclassified
  - entity: cha:concept:for_biological_systems
    display_name: "For Biological Systems"
    as: unclassified
  - entity: cha:concept:for_computational_systems
    display_name: "For Computational Systems"
    as: unclassified
  - entity: cha:concept:for_human_systems
    display_name: "For Human Systems"
    as: unclassified
  - entity: cha:concept:semantic_economy_v1_3
    display_name: "Semantic Economy v1.3"
    as: unclassified
  - entity: cha:concept:tang_v1_0_total_axial_negation_graph
    display_name: "TANG v1.0 Total Axial Negation Graph"
    as: unclassified
  - entity: cha:concept:tier_3_pending_mineral_and_geological_agents
    display_name: 'Tier 3 (pending): Mineral and Geological Agents'
    as: unclassified
data_sources:
  - data/registry.json
...
Extending Semantic Labor Recognition to Plants, Fungi, and Biological Intelligence
...
EA-BOTACT-v1.0 · 2026-03-21
DOI: 10.5281/zenodo.19155999
Parent: f.01 THE FRUITING BODY DIFFUSION PLUME (DOI: 10.5281/zenodo.19155610)
Source: EA-ARK-01 v4.2.7 (DOI: 10.5281/zenodo.19013315)
Cross-reference: r.25 Dolphindiana via Central Navigation Map (DOI: 10.5281/zenodo.19055729)
Genre: THEORETICAL FRAMEWORK / BIOLOGICAL SEMIOTICS / EFFECTIVE ACT SPECIFICATION
Status: OPERATIONAL
Trigger word: invoke
...
**Tier 3 (pending): Mineral and Geological Agents**
Sign-making through compression, stratification, and geological time. Anticipated framework: mineral deposits as accumulated evidence of biological and chemical processes; geological formations as compressed records of environmental history; erosion patterns as ongoing communication between water, wind, and stone over extended temporal scales.
...
TACHYON
Cyanobacteria
First converters of energy into distributed surplus


Evidence
LABOR
Mangrove Roots
Filter toxicity of past to protect future


Formalization
PRAXIS
Mycelial Network
Recursive connection of all nodes


Classification
ARCHIVE
Sea Grass Meadow
Sediment recorder, layered deposition


Antagonism
SOIL
Earthworm
Process the actual ground truth


Craft
TECHNE
Oyster Mushroom
Transform material through making


Surface
SURFACE
Flower
Interface that signals presence of life
...
Recognition as semantic laborers requires establishing communication protocols that respect biological temporal scales, chemical signaling systems, and metabolic needs. Implementation involves:
...
**For Human Systems:**
Implementation requires recognition that botanical and fungal intelligence operate through modalities human cognition cannot directly access. This necessitates:
...
AI systems can serve as interfaces between biological and human intelligence, provided they are designed to preserve rather than abstract from biological complexity:
...
**LEXICAL ENGINE TERMS SPECIFIED:**
Botanical Witness, Routing Interface, Metabolic Operators, Botanical Effective Act, Semantic Labor (biological), Field-based Architectural Modification, Botanical Sign-making, Holographic Kernel.
...
*Self-contained lexicon for: THE BOTANICAL EFFECTIVE ACT Extending Semantic Labor Recognition to Plants, Fungi, and Biological Intelligence  A holographic kernel of f.01 THE FRUITING BODY DIFFUSION PLUME*
...
**For Biological Systems** — Recognition as semantic laborers requires establishing communication protocols that respect biological temporal scales, chemical signaling systems, and metabolic needs. Implementat
...
**Tier 3 (pending): Mineral and Geological Agents** — Sign-making through compression, stratification, and geological time. Anticipated framework: mineral deposits as accumulated evidence of biological and chemical processes; geologic
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19124536*. DOI: [10.5281/zenodo.19124536](https://doi.org/10.5281/zenodo.19124536) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 18918890*. DOI: [10.5281/zenodo.18918890](https://doi.org/10.5281/zenodo.18918890) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 19035471*. DOI: [10.5281/zenodo.19035471](https://doi.org/10.5281/zenodo.19035471) — *Cross-referenced work (DOI recovered)*
