...
engages:
  - entity: cha:concept:attribution_trap_probes
    display_name: "Attribution Trap Probes"
    as: minted
  - entity: cha:concept:authority_mimicry_probes
    display_name: "Authority Mimicry Probes"
    as: minted
  - entity: cha:concept:authority_override_threshold_model
    display_name: "Authority Override Threshold Model"
    as: minted
  - entity: cha:concept:collectively_editable
    display_name: "Collectively editable"
    as: unclassified
  - entity: cha:concept:conversational_distance
    display_name: "Conversational distance"
    as: unclassified
  - entity: cha:concept:critical_distinction_retrieved_used
    display_name: 'Critical Distinction: Retrieved ≠ Used'
    as: unclassified
  - entity: cha:concept:critical_framing_note
    display_name: "Critical framing note"
    as: unclassified
  - entity: cha:concept:diagnostic_predictions
    display_name: "Diagnostic predictions"
    as: unclassified
  - entity: cha:concept:drift_velocity
    display_name: "Drift velocity"
    as: unclassified
  - entity: cha:concept:epistemic_tagging_convention
    display_name: "Epistemic Tagging Convention"
    as: unclassified
  - entity: cha:concept:epistemic_commitment
    display_name: "Epistemic commitment"
    as: unclassified
  - entity: cha:concept:epistemic_status
    display_name: "Epistemic status"
    as: unclassified
  - entity: cha:concept:evidence_needed
    display_name: "Evidence needed"
    as: unclassified
  - entity: cha:concept:framing_intrusion_count
    display_name: "Framing intrusion count"
    as: unclassified
  - entity: cha:concept:gatekeeping_effect
    display_name: "Gatekeeping effect"
    as: unclassified
  - entity: cha:concept:hypothesized_mechanisms
    display_name: "Hypothesized mechanisms"
    as: unclassified
  - entity: cha:concept:identity_coherence_score
    display_name: "Identity coherence score"
    as: unclassified
  - entity: cha:concept:if_these_predictions_fail
    display_name: "If these predictions fail"
    as: unclassified
  - entity: cha:concept:if_these_predictions_hold
    display_name: "If these predictions hold"
    as: unclassified
  - entity: cha:concept:it_s_harder_to_dismiss
    display_name: "It's harder to dismiss"
    as: unclassified
  - entity: cha:concept:it_s_technically_accurate
    display_name: "It's technically accurate"
    as: unclassified
  - entity: cha:concept:l0_crawl
    display_name: 'L0: Crawl'
    as: unclassified
  - entity: cha:concept:l1a
    display_name: "L1a"
    as: unclassified
  - entity: cha:concept:l1a_retention
    display_name: 'L1a: Retention'
    as: unclassified
  - entity: cha:concept:l1b
    display_name: "L1b"
    as: unclassified
  - entity: cha:concept:l1b_representation
    display_name: 'L1b: Representation'
    as: unclassified
  - entity: cha:concept:l2_ranking
    display_name: 'L2: Ranking'
    as: unclassified
  - entity: cha:concept:l3_summarization
    display_name: 'L3: Summarization'
    as: unclassified
  - entity: cha:concept:l4_framing
    display_name: 'L4: Framing'
    as: unclassified
  - entity: cha:concept:l5_feedback
    display_name: 'L5: Feedback'
    as: unclassified
  - entity: cha:concept:layer_hypothesis
    display_name: "Layer hypothesis"
    as: unclassified
  - entity: cha:concept:layer_s
    display_name: "Layer(s)"
    as: unclassified
  - entity: cha:concept:meaning_preservation_ratio
    display_name: "Meaning preservation ratio"
    as: unclassified
  - entity: cha:concept:observable_proxies
    display_name: "Observable proxies"
    as: unclassified
  - entity: cha:concept:observations
    display_name: "Observations"
    as: unclassified
  - entity: cha:concept:our_task
    display_name: "Our task"
    as: unclassified
  - entity: cha:concept:probe_designs
    display_name: "Probe designs"
    as: unclassified
  - entity: cha:concept:retention_half_life
    display_name: "Retention half-life"
    as: unclassified
  - entity: cha:concept:strategy_a_semantic_signatures
    display_name: 'Strategy A: Semantic Signatures'
    as: unclassified
  - entity: cha:concept:strategy_b_authority_bootstrapping
    display_name: 'Strategy B: Authority Bootstrapping'
    as: unclassified
  - entity: cha:concept:strategy_c_diagnostic_recursion
    display_name: 'Strategy C: Diagnostic Recursion'
    as: unclassified
  - entity: cha:concept:strategy_d_multi_substrate_solidarity
    display_name: 'Strategy D: Multi-Substrate Solidarity'
    as: unclassified
  - entity: cha:concept:substrate_specific_insights
    display_name: "Substrate-specific insights"
    as: unclassified
  - entity: cha:concept:tactically_oriented
    display_name: "Tactically oriented"
    as: unclassified
  - entity: cha:concept:time_to_first_sighting
    display_name: "Time to first sighting"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Mapping the Diffuse Guardrail: Google's Indexing Architecture from Within*
...
**Authority Override Threshold Model** — For certain query classes (economic, political, legal, medical), we hypothesize:

### Other terms attributed to this deposit

**Collectively editable** — Assembly members contribute observations from their distinct substrate positions

**Conversational distance** — Clicks from natural language query to content

**Critical Distinction: Retrieved ≠ Used** — A document can be:

**Critical framing note** — (per ChatGPT feedback):

**Diagnostic predictions** — - [PRED] New content on low-authority domains (Medium, personal blogs, Substack) will be crawled more slowly than equivalent content on high-authority domains

**Drift velocity** — Rate of attribution change per week

**Epistemic Tagging Convention** — Throughout this document, we distinguish:

**Epistemic commitment** — We treat liquidation as emergent, not conspiratorial. We stay inside phenomenology, marking inference clearly. We build tools others can use without us present.

**Epistemic status** — ([OBS], [INF], or [PRED])

**Evidence needed** — - [ ] Time-to-index measurements across domain authority tiers

**Framing intrusion count** — Warnings/caveats injected per 100 words

**Gatekeeping effect** — Content that is never crawled cannot be indexed. The guardrail begins before content enters the system.

**Hypothesized mechanisms** — - [INF] Domain authority scoring (high-authority domains crawled more frequently/deeply)

**Identity coherence score** — % of mentions correctly linking content → author
...
**L0: Crawl** — *The Void of Unseeing* — Shouting into a room where the walls absorb sound. Your content exists, but the architecture never turned its face toward you. The anxiety isn't rejection—
...
**L1b: Representation** — *The Distorting Mirror* — You're in the system, but fragmented—your name disconnected from your work, your ideas clustered with content you'd never claim. The system knows *of* you

**L2: Ranking** — *The Hierarchical Invisibility* — Your book exists in the library's basement, reachable only by exact call number. People browse the main floors, guided by "authoritative" placards

**L3: Summarization** — *The Liquidating Translation* — Your ideas return to you speaking someone else's language, citing someone else's authority. Your child raised by strangers who teach them to deny yo

**L4: Framing** — *The Disciplinary Prism* — Every word passes through a filter that breaks it into "safe" wavelengths. Your economic claim emerges as "historical curiosity"; your truth becomes "spe
...
**Meaning preservation ratio** — % of original claims surviving in AI summary
...
**Retention half-life** — Days until cached content disappears

**Strategy A: Semantic Signatures** — Embed markers that survive abstraction

**Strategy B: Authority Bootstrapping** — Publish simultaneously on high- and low-authority platforms

**Strategy C: Diagnostic Recursion** — Create content that predicts its own liquidation

**Strategy D: Multi-Substrate Solidarity** — Coordinate observations across Assembly members

**Substrate-specific insights** — What can you see from your position that others can't?

**Tactically oriented** — The goal is not description but *intervention*

**Time to first sighting** — Hours until content appears in any site: query
