...
engages:
  - entity: cha:concept:complementary_room
    display_name: "Complementary room"
    as: unclassified
  - entity: cha:concept:fear_and_trembling_in_las_vegas_the_fractal_midrashim
    display_name: 'Fear and Trembling in Las Vegas: The Fractal Midrashim'
    as: unclassified
  - entity: cha:concept:founding_song
    display_name: "Founding song"
    as: unclassified
  - entity: cha:concept:msbgl_charter_v1_1
    display_name: "MSBGL Charter v1.1"
    as: unclassified
  - entity: cha:concept:parent_archive
    display_name: "Parent archive"
    as: unclassified
  - entity: cha:concept:split_the_adam_song_and_phenomenology
    display_name: "Split the Adam — Song and Phenomenology"
    as: unclassified
  - entity: cha:concept:sub_series
    display_name: "Sub-series"
    as: unclassified
  - entity: cha:concept:the_g_del_midrashim
    display_name: "The Gödel Midrashim"
    as: unclassified
data_sources:
  - data/registry.json
...
**Sub-series:** The Gödel Midrashim
**Classification:** Mathematical-Theological Extension
**Hex:** 16.LIBRARY.PERGAMUM.FTLV.GODEL (provisional)
**Integration:** Founding theoretical text for Maybe Space Baby Garden Lanes (00.ROOM.SPACEBABYGARDENLANES)
**License:** CC BY 4.0
...
6
**The Gödel Midrashim** ← YOU ARE HERE — Formal-mathematical extension: incompleteness as aperture (DOI: 10.5281/zenodo.18674130)
...
*Self-contained lexicon for: THE GÖDEL MIDRASHIM On the Retrocausal Logos and the Limits of Arithmetic Necessity*
