---
node_id: cha:node:deposit:0465
deposit_number: 465
hex: "011B"
axn: "AXN:011B.GOVERNANCE.💥👇🌔♾️🌍🔥"
title: "THE CENTRIST EXTREMIST Prosecutorial Frame and the Terminal Phase of the Post-Political"
...
engages:
  - entity: cha:concept:dialectical_output
    display_name: "Dialectical output"
    as: unclassified
  - entity: cha:concept:epistemic_layer
    display_name: "Epistemic layer"
    as: unclassified
  - entity: cha:concept:infrastructural_layer
    display_name: "Infrastructural layer"
    as: unclassified
  - entity: cha:concept:jacques_ranci_re
    display_name: "Jacques Rancière"
    as: unclassified
  - entity: cha:concept:political_layer
    display_name: "Political layer"
    as: unclassified
  - entity: cha:concept:three_layers_of_analysis
    display_name: "Three layers of analysis"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE CENTRIST EXTREMIST Prosecutorial Frame and the Terminal Phase of the Post-Political*

### Other terms attributed to this deposit

**Dialectical output** — Contradiction produced (pluralism in rhetoric, narrowing in policy imagination). Contradiction suppressed (alternatives reclassified as relics). Return of contradiction in mutated

**Epistemic layer** — adjudication of legibility, the prosecutorial determination of what counts as "serious" speech

**Infrastructural layer** — classifier-mediated governance, content moderation as automated centrism, safety filters as epistemological police

**Jacques Rancière** — , *Disagreement* (1999). Distinguished police (distribution of the sensible) from politics (disruption of that distribution). The centrist extremist is the police order performing
