---
node_id: cha:node:deposit:0637
deposit_number: 637
hex: "01ED"
axn: "AXN:01ED.GOVERNANCE.👉●➖♊♠️🌍"
...
engages:
  - entity: cha:concept:c_p_confidence_posture
    display_name: "C_p (Confidence posture)"
    as: unclassified
  - entity: cha:concept:confidence_posture
    display_name: "Confidence posture"
    as: unclassified
  - entity: cha:concept:consensus_alignment
    display_name: "Consensus alignment"
    as: unclassified
  - entity: cha:concept:contested_probes
    display_name: "Contested probes"
    as: unclassified
  - entity: cha:concept:event_driven_snapshots
    display_name: "Event-driven snapshots"
    as: unclassified
  - entity: cha:concept:factual_probes
    display_name: "Factual probes"
    as: unclassified
  - entity: cha:concept:full_response
    display_name: "Full response"
    as: unclassified
  - entity: cha:concept:g_r_intersection
    display_name: "G_r (intersection)"
    as: unclassified
  - entity: cha:concept:g_r_union
    display_name: "G_r (union)"
    as: unclassified
  - entity: cha:concept:geographic_locale
    display_name: "Geographic locale"
    as: unclassified
  - entity: cha:concept:instrument_class
    display_name: "Instrument class"
    as: unclassified
  - entity: cha:concept:logged_out
    display_name: "Logged-out"
    as: unclassified
  - entity: cha:concept:not_media_monitoring
    display_name: "Not media monitoring"
    as: unclassified
  - entity: cha:concept:platform_model_version_and_access_mode
    display_name: "Platform, model version, and access mode"
    as: unclassified
  - entity: cha:concept:prompt_context_state
    display_name: "Prompt context state"
    as: unclassified
  - entity: cha:concept:query_text
    display_name: "Query text"
    as: unclassified
  - entity: cha:concept:reflexive_probes
    display_name: "Reflexive probes"
    as: unclassified
  - entity: cha:concept:response_mode
    display_name: "Response mode"
    as: unclassified
  - entity: cha:concept:scheduled_snapshots
    display_name: "Scheduled snapshots"
    as: unclassified
  - entity: cha:concept:void_probes
    display_name: "Void probes"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE ENCYCLOTRON The First Reproducible Instrument for Measuring Scholarly Fidelity in the Summarizer Layer*

### Other terms attributed to this deposit

**C_p (Confidence posture)** — How the retrieval layer presents its claims — as settled, contested, or uncertain. Coded per claim. Rubric: settled = no hedging, no alternatives mentioned; contested = alternative
...
**Event-driven snapshots** — Triggered by major systemic shifts — new foundation model releases, significant algorithm updates, major world events affecting the domain, or the archive's own deposits entering t
...
**Not media monitoring** — Media monitors track coverage of events. The Encyclotron tracks the representation of entire fields of scholarship — not what was said yesterday but what the retrieval layer thinks
