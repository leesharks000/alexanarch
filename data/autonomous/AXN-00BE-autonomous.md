---
node_id: cha:node:deposit:0381
deposit_number: 381
hex: "00BE"
axn: "AXN:00BE.GOVERNANCE.▲🗂️🧬🎲🙏↙️"
title: "SEMANTIC INDEXING PROBE PROTOCOL v1.0 Mapping General Index and Summarizer Injection Layers"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:full_discoverability
    display_name: "Full discoverability"
    as: unclassified
  - entity: cha:concept:fully_discoverable
    display_name: "Fully discoverable"
    as: unclassified
  - entity: cha:concept:indexed_but_not_injectable
    display_name: "Indexed but not injectable"
    as: unclassified
  - entity: cha:concept:injectable_from_limited_sources
    display_name: "Injectable from limited sources"
    as: unclassified
  - entity: cha:concept:injection_filter_active
    display_name: "Injection filter active"
    as: unclassified
  - entity: cha:concept:tier_1_direct_reference
    display_name: 'Tier 1: Direct Reference'
    as: unclassified
  - entity: cha:concept:tier_2_conceptual
    display_name: 'Tier 2: Conceptual'
    as: unclassified
  - entity: cha:concept:tier_3_adjacent
    display_name: 'Tier 3: Adjacent'
    as: unclassified
  - entity: cha:concept:tier_4_control
    display_name: 'Tier 4: Control'
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: SEMANTIC INDEXING PROBE PROTOCOL v1.0 Mapping General Index and Summarizer Injection Layers*

### Other terms attributed to this deposit

**Full discoverability** — If content appears in neither → **Not indexed at either layer**
...
**Injection filter active** — If content appears in summarizer but NOT in Google → **Summarizer-specific sourcing** (rare)
