---
node_id: cha:node:deposit:0072
deposit_number: 72
hex: "022F"
axn: "AXN:022F.GOVERNANCE.🔒👐🎺⛳✏️🔔"
title: 'SPXI for Websites: Standing Protocol for Entity Inscription and Compression Survival'
...
status: ACTIVE
engages:
  - entity: cha:concept:claim_structured_prose
    display_name: "Claim-structured prose"
    as: unclassified
  - entity: cha:concept:content_structure
    display_name: "Content structure"
    as: unclassified
  - entity: cha:concept:definition_first_paragraphs
    display_name: "Definition-first paragraphs"
    as: unclassified
  - entity: cha:concept:diagnostic_canaries
    display_name: "Diagnostic canaries"
    as: unclassified
  - entity: cha:concept:entity_boundary_defense
    display_name: "Entity boundary defense"
    as: unclassified
  - entity: cha:concept:entity_name_repetition
    display_name: "Entity-name repetition"
    as: unclassified
  - entity: cha:concept:google_facing_surfaces
    display_name: "Google-facing surfaces"
    as: unclassified
  - entity: cha:concept:lock_phrases
    display_name: "Lock phrases"
    as: unclassified
  - entity: cha:concept:multi_surface_dispersal
    display_name: "Multi-surface dispersal"
    as: unclassified
  - entity: cha:concept:nlcc_validity_test
    display_name: "NLCC Validity Test"
    as: unclassified
  - entity: cha:concept:operational_distinction
    display_name: "Operational distinction"
    as: unclassified
  - entity: cha:concept:parse_the_entity
    display_name: "Parse the entity"
    as: unclassified
  - entity: cha:concept:provenance_erasure_rate_per
    display_name: "Provenance Erasure Rate (PER)"
    as: unclassified
  - entity: cha:concept:provenance_canaries
    display_name: "Provenance canaries"
    as: unclassified
  - entity: cha:concept:query_set_5_prompts
    display_name: "Query set (5 prompts)"
    as: unclassified
  - entity: cha:concept:re_measure
    display_name: "Re-measure"
    as: unclassified
  - entity: cha:concept:referent_anchoring
    display_name: "Referent anchoring"
    as: unclassified
  - entity: cha:concept:relation_vocabulary_open
    display_name: "Relation vocabulary (open)"
    as: unclassified
  - entity: cha:concept:required_minimum_4
    display_name: "Required (minimum 4)"
    as: unclassified
  - entity: cha:concept:seo_compliance_packet
    display_name: "SEO Compliance Packet"
    as: unclassified
  - entity: cha:concept:seo_foundation
    display_name: "SEO foundation"
    as: unclassified
  - entity: cha:concept:sim_set
    display_name: "SIM Set"
    as: unclassified
  - entity: cha:concept:simsr_target
    display_name: "SIMSR target"
    as: unclassified
  - entity: cha:concept:spxi_native_preservation_surfaces
    display_name: "SPXI-native preservation surfaces"
    as: unclassified
  - entity: cha:concept:schedule_re_test
    display_name: "Schedule re-test"
    as: unclassified
  - entity: cha:concept:schema_org_types
    display_name: "Schema.org types"
    as: unclassified
  - entity: cha:concept:self_reading_library
    display_name: "Self-Reading Library"
    as: unclassified
  - entity: cha:concept:self_referential_framing
    display_name: "Self-referential framing"
    as: unclassified
  - entity: cha:concept:self_test
    display_name: "Self-test"
    as: unclassified
  - entity: cha:concept:self_verify
    display_name: "Self-verify"
    as: unclassified
  - entity: cha:concept:semantic_debt_ratio_sdr
    display_name: "Semantic Debt Ratio (SDR)"
    as: unclassified
  - entity: cha:concept:semantic_decay_delta_sdd
    display_name: "Semantic Decay Delta (SDD)"
    as: unclassified
  - entity: cha:concept:semantic_health_report
    display_name: "Semantic Health Report"
    as: unclassified
  - entity: cha:concept:server_delivered_content
    display_name: "Server-delivered content"
    as: unclassified
  - entity: cha:concept:structured_data_packet
    display_name: "Structured Data Packet"
    as: unclassified
  - entity: cha:concept:the_drowning_test
    display_name: "The Drowning Test"
    as: unclassified
  - entity: cha:concept:tier_2_canonical_summary
    display_name: "Tier 2 Canonical Summary"
    as: unclassified
  - entity: cha:concept:tier_2_survival_engineering
    display_name: "Tier 2 survival engineering"
    as: unclassified
  - entity: cha:concept:tier_3_compression_kernel
    display_name: "Tier 3 Compression Kernel"
    as: unclassified
  - entity: cha:concept:write_tier_3
    display_name: "Write Tier 3"
    as: unclassified
  - entity: cha:concept:writing_tier_2
    display_name: "Writing Tier 2"
    as: unclassified
  - entity: cha:concept:writing_tier_3
    display_name: "Writing Tier 3"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: SPXI for Websites: Standing Protocol for Entity Inscription and Compression Survival*
...
**Definition-first paragraphs** — "[Entity Name] is [category] that [function]." This is the **Operative Caption** (Arsenal §V.1, κ_O): the description IS the operation. It must contain entity name, category, disti
...
**Google-facing surfaces** — documented controls. The Holographic Kernel, Provenance Chain, and SIM layers are **SPXI-native preservation surfaces** — designed for compression survival across all AI retrieval

**Lock phrases** — phrases designed to resist paraphrase

**Multi-surface dispersal** — as distributed provenance

**NLCC Validity Test** — (Arsenal §3.4, DOI: 10.5281/zenodo.19022245) — Ten formal conditions for "non-lossy" status. Use for verifying that Holographic Kernels and Three-Tier compressions are genuinely no

**Operational distinction** — Schema.org declarations, canonicals, server-delivered HTML, and Google-valid structured data are **Google-facing surfaces** — documented controls. The Holographic Kernel, Provenanc
...
**SPXI-native preservation surfaces** — designed for compression survival across all AI retrieval systems, not presented as Google ranking controls.

**Schedule re-test** — 30-day follow-up.

**Schema.org types** — JSON-LD with ORCID + DOI.

**Self-Reading Library** — (Arsenal §IX.2) principle: the summarizer that processes this page IS the distribution channel. Write for it as a participant, not an adversary.
...
**Semantic Debt Ratio (SDR)** — (Arsenal §3.8) — Semantic extraction / semantic replenishment. SDR > 1 = debt accumulating. Use for sites where content is being heavily extracted by AI systems without attribution
...
**The Drowning Test** — (Arsenal §3.2) — Empirical compression verification. Submit content to a standard summarizer. If the summary captures the argument, the content is not dense enough. If meaning is l
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19412081*. DOI: [10.5281/zenodo.19412081](https://doi.org/10.5281/zenodo.19412081) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18185996*. DOI: [10.5281/zenodo.18185996](https://doi.org/10.5281/zenodo.18185996) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19637500*. DOI: [10.5281/zenodo.19637500](https://doi.org/10.5281/zenodo.19637500) — *Cross-referenced work (DOI recovered)*
