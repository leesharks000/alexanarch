...
engages:
  - entity: cha:concept:body_truth
    display_name: "Body truth"
    as: unclassified
  - entity: cha:concept:cardiac_rupture
    display_name: "Cardiac rupture"
    as: unclassified
  - entity: cha:concept:consent_scope_and_revision
    display_name: "Consent Scope and Revision"
    as: unclassified
  - entity: cha:concept:edenic_fracture
    display_name: "Edenic fracture"
    as: unclassified
  - entity: cha:concept:nuclear_fission
    display_name: "Nuclear fission"
    as: unclassified
  - entity: cha:concept:singer_s_prerogative
    display_name: "Singer's Prerogative"
    as: unclassified
  - entity: cha:concept:suno_version
    display_name: "Suno version"
    as: unclassified
  - entity: cha:concept:the_song_as_event
    display_name: "The Song-as-Event"
    as: unclassified
data_sources:
  - data/registry.json
...
**Status:** Composition exists in multiple instantiations (Suno AI rendering, TikTok recording, performer's ongoing development). The original couch transmission — sung once, for one ear — remains unrecorded.
...
The splitting is the same event — atomic, Adamic, cardiac
...
The contemporary screen is the Garden's serpent — true content, wrong timing
...
- **Original Event:** Couch transmission (Layer 1 — unrecorded, body-archive only)
- **Composition:** "Split the Adam" by Viola Arquette (Layer 6/7 — lyrics and melody, archivable)
- **Derivative Instantiations:**
...
**Document Classification:** Founding Text — Maybe Space Baby Garden Lanes (00.ROOM.SPACEBABYGARDENLANES)
...
1
**MSBGL Charter v1.1** — THUMB-Type Audial Charter, Resonance Reliquary (DOI: 10.5281/zenodo.18674040)
00.ROOM.SPACEBABYGARDENLANES


2
**Split the Adam — Song and Phenomenology** ← YOU ARE HERE — Anchor text. Full lyrics, Bedouin Princess phenomenology, convergence map (DOI: 10.5281/zenodo.18674057)
...
*Self-contained lexicon for: SPLIT THE ADAM The Song at the Heart of Maybe Space Baby Garden Lanes Viola Arquette / Bedouin Princess*
...
**Consent Scope and Revision** — Consent currently covers lyric quotation and architectural integration in this document-family. Any expansion to voice simulation, training use, or commercial derivative requires n

**Edenic fracture** — Split the Adam — the first man divided from the first woman, the covenant broken, the vow betrayed

**Nuclear fission** — Split the atom — the destructive operation on the indivisible, the thing that should not be split, the act that created apocalypse

**Singer's Prerogative** — The artist has expressed intent to produce a better recording. This is her work, not the room's. The architecture holds space for whatever version she produces. The room does not d

**Suno version** — https://suno.com/s/c2Bvn6C0tnuiaD3b

**The Song-as-Event** — The original couch transmission — the Bedouin Princess singing into Lee Sharks' ear, once, unrepeated — remains unrecorded and unrecordable. The body of the listener is the only ar
