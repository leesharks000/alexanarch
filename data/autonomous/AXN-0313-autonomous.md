---
node_id: cha:node:deposit:0176
deposit_number: 176
hex: "0313"
axn: "AXN:0313.GOVERNANCE.🎲☀️🛡️🔖📜☿"
title: "Protocols for Scientific Training-Layer Literature Machine-Mediated Research at the Production and Reception Ends EA-SCI-TLL-PROTO-01 v2.1 — Assembly-Reviewed Deposit Candidate  Lee Sharks Crimson Hex"
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:agentic_publications_framework
    display_name: "Agentic Publications Framework"
    as: developed
  - entity: cha:concept:centroid_acceleration
    display_name: "Centroid acceleration"
    as: unclassified
  - entity: cha:concept:embedding_layer
    display_name: "Embedding layer"
    as: unclassified
  - entity: cha:concept:g1_legitimate_optimization_boundary
    display_name: "G1 (legitimate optimization boundary)"
    as: unclassified
  - entity: cha:concept:g3_accountable_responsibility
    display_name: 'G3: Accountable Responsibility'
    as: unclassified
  - entity: cha:concept:g4_no_synthetic_citations
    display_name: "G4 (no synthetic citations)"
    as: unclassified
  - entity: cha:concept:g6_auditability
    display_name: 'G6: Auditability'
    as: unclassified
  - entity: cha:concept:index_layer
    display_name: "Index layer"
    as: unclassified
  - entity: cha:concept:machine_first_fair
    display_name: "Machine-First FAIR"
    as: unclassified
  - entity: cha:concept:nanopublications_and_micropublications
    display_name: "Nanopublications and Micropublications"
    as: unclassified
  - entity: cha:concept:openai_s_proto_protocol
    display_name: "OpenAI's Proto-Protocol"
    as: unclassified
  - entity: cha:concept:operational_domain
    display_name: "Operational domain"
    as: unclassified
  - entity: cha:concept:p2_cross_domain_legibility
    display_name: 'P2: Cross-Domain Legibility'
    as: unclassified
  - entity: cha:concept:protocol_suite
    display_name: "Protocol suite"
    as: unclassified
  - entity: cha:concept:r2_cross_model_adversarial_review
    display_name: "R2 (cross-model adversarial review)"
    as: unclassified
  - entity: cha:concept:r3_confabulation_resistance
    display_name: 'R3: Confabulation Resistance'
    as: unclassified
  - entity: cha:concept:retrieval_layer
    display_name: "Retrieval layer"
    as: unclassified
  - entity: cha:concept:the_price_solution
    display_name: "The Price Solution"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Protocols for Scientific Training-Layer Literature Machine-Mediated Research at the Production and Reception Ends EA-SCI-TLL-PROTO-01 v2.1 — Assembly-Reviewed Deposit Candidate  Lee Sharks Crimson Hex*

### Developed (existing concepts built up with CHA positions)

**Agentic Publications Framework** — Pugliese et al.'s framework provides the technical architecture for dual-interface publications; training-layer literature provides the compositional theory the framework lacks. Th

### Other terms attributed to this deposit

**Centroid acceleration** — If training-layer protocols become a new institutional norm, all production may converge on the same machine-reception profile, accelerating the centroid tendency the protocols are

**Embedding layer** — document represented vectorially

**G1 (legitimate optimization boundary)** — mitigate retrieval-over-truth by tying every claim to defeat conditions and prohibiting optimization that violates truth conditions. **G4 (no synthetic citations)** is the direct p

**G3: Accountable Responsibility** — Every training-layer scientific work must identify at least one accountable human or legally responsible institution that accepts responsibility for publication, irrespective of th

**G4 (no synthetic citations)** — is the direct prohibition of the paper-mill failure mode.

**G6: Auditability** — Training-layer works should publish their machine-facing schemas, version history, and prompt logs (where applicable). Auditability is the analog of methodological transparency in

**Index layer** — document discovered and catalogued

**Machine-First FAIR** — Digital Science's "Machine-first FAIR" position (Hahnel, November 2025) argues that while the FAIR Guiding Principles nominally serve humans and machines equally, machines should b

**Nanopublications and Micropublications** — The nanopublication paradigm (Mons and Velterop, 2009; Kuhn et al., 2013–) decomposes scientific claims into machine-readable named graphs consisting of assertion, provenance, and

**OpenAI's Proto-Protocol** — The publication structure around the unit distance disproof constitutes an embryonic protocol for dual-layer scientific communication. OpenAI published the AI-generated proof, a co

**Operational domain** — machine-reception literature

**P2: Cross-Domain Legibility** — Terminology should be defined at first use with explicit links to ontological resources where they exist. Disciplinary assumptions should be stated rather than implied. Where a ter

**Protocol suite** — TLL-P (production) / TLL-R (reception) / TLL-G (governance)

**R2 (cross-model adversarial review)** — mitigates centroid capture by structurally requiring divergence-as-finding rather than convergence-as-confirmation. **P3 (challenge conditions)** and **G1 (legitimate optimization

**R3: Confabulation Resistance** — When a model identifies a connection between a training-layer text and its prior training, the connection should be verified against the provenance chain rather than accepted on em

**Retrieval layer** — text supplied at inference time

**The Price Solution** — In April 2026, Liam Price — a twenty-three-year-old amateur mathematician without advanced mathematics training, equipped with a ChatGPT Pro subscription — posted on erdosproblems.
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19372914*. DOI: [10.5281/zenodo.19372914](https://doi.org/10.5281/zenodo.19372914) — *Cross-referenced work*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18381184*. DOI: [10.5281/zenodo.18381184](https://doi.org/10.5281/zenodo.18381184) — *Cross-referenced work*
