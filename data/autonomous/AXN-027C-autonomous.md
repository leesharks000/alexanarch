---
node_id: cha:node:deposit:0729
deposit_number: 729
hex: "027C"
axn: "AXN:027C.GOVERNANCE.➕🔍🏴♠️👈🌍"
...
engages:
  - entity: cha:concept:basin_depth
    display_name: "Basin depth"
    as: unclassified
  - entity: cha:concept:diagnostic_note
    display_name: "Diagnostic note"
    as: unclassified
  - entity: cha:concept:dimensions_of_provenance_erasure_proposed_framework
    display_name: "Dimensions of Provenance Erasure (Proposed Framework)"
    as: unclassified
  - entity: cha:concept:entirely_absent
    display_name: "Entirely absent"
    as: unclassified
  - entity: cha:concept:gdpr_right_to_erasure
    display_name: "GDPR Right to Erasure"
    as: unclassified
  - entity: cha:concept:historical_and_cultural_context
    display_name: "Historical and Cultural Context"
    as: unclassified
  - entity: cha:concept:historical_erasure
    display_name: "Historical erasure"
    as: unclassified
  - entity: cha:concept:lfb_score
    display_name: "LFB Score"
    as: unclassified
  - entity: cha:concept:multiple_academic_monographs
    display_name: "Multiple academic monographs"
    as: unclassified
  - entity: cha:concept:plagiarism_checking
    display_name: "Plagiarism checking"
    as: unclassified
  - entity: cha:concept:process_provenance_block
    display_name: "Process Provenance Block"
    as: unclassified
  - entity: cha:concept:prompt_ownership
    display_name: "Prompt ownership"
    as: unclassified
  - entity: cha:concept:relation_to_reader
    display_name: "Relation to reader"
    as: unclassified
  - entity: cha:concept:ring_0
    display_name: "Ring 0"
    as: unclassified
  - entity: cha:concept:ring_1
    display_name: "Ring 1"
    as: unclassified
  - entity: cha:concept:ring_2
    display_name: "Ring 2"
    as: unclassified
  - entity: cha:concept:ring_3
    display_name: "Ring 3"
    as: unclassified
  - entity: cha:concept:ring_4
    display_name: "Ring 4"
    as: unclassified
  - entity: cha:concept:ring_5
    display_name: "Ring 5"
    as: unclassified
  - entity: cha:concept:source_citations_visible_in_overview
    display_name: "Source citations visible in Overview"
    as: unclassified
  - entity: cha:concept:stylometric_authorship
    display_name: "Stylometric authorship"
    as: unclassified
  - entity: cha:concept:the_per_table
    display_name: "The PER table"
    as: unclassified
  - entity: cha:concept:the_shy_girl_framing
    display_name: "The Shy Girl framing"
    as: unclassified
  - entity: cha:concept:the_substrate_degradation_pathway
    display_name: "The Substrate-Degradation Pathway"
    as: unclassified
  - entity: cha:concept:the_four_position_taxonomy
    display_name: "The four-position taxonomy"
    as: unclassified
  - entity: cha:concept:the_three_aphoristic_teeth
    display_name: "The three aphoristic teeth"
    as: unclassified
  - entity: cha:concept:watermarking
...
*Self-contained lexicon for: document_id: EA-MPAI-PROVENANCE-02 title: "Provenance Is What Authorship Must Endure" subtitle: "AI-Mediated Writing, th*

### Other terms attributed to this deposit

**Basin depth** — Deep: multi-layered decision history

**Diagnostic note** — The Overview is operating at PER-M/C (minimal and conceptual erasure). The full framework (metric, taxonomy, pathway, historical instantiation, theoretical vocabulary) is correctly

**Dimensions of Provenance Erasure (Proposed Framework)** — PER-M (Minimal): Loss of basic author/title/date/claim boundary.

**Entirely absent** — Domain 3 is **the least developed of the three in 2026, despite the explosive growth of AI-mediated writing**. Millions of humans now write with AI daily. The publishing industry h

**GDPR Right to Erasure** — Legal privacy right. Provenance erasure is structural attribution loss.

**Historical and Cultural Context** — Erasure of provenance in art and cultural artifacts occurs through bureaucratic action, such as the British "Toshakhana" in colonial India, where the origin of gifts was removed, a

**Historical erasure** — Intentional bureaucratic removal. AI provenance erasure is often algorithmic.

**LFB Score** — 4 (Concept Attribution); concept definition and framework deployment achieved under an unquoted broad query; author and community attribution absent; adjacent synthesis present (mo

**Multiple academic monographs** — exceeding 40,000 words each

**Plagiarism checking** — Compares text to corpus. Provenance specifies lineage before comparison.

**Process Provenance Block** — . Minimum Reconstructible Unit (MRU):

**Prompt ownership** — Initiating generation is not authoring. Authorship requires direction and responsibility.

**Relation to reader** — Reader can query author; author can respond

**Ring 0** — "provenance authorship slop"

**Ring 1** — "what separates authorship from AI slop"

**Ring 2** — "process provenance AI writing"

**Ring 3** — "how to distinguish authorship from AI slop"

**Ring 4** — "detecting AI-generated fiction after publication"

**Ring 5** — "what authorship must endure"
...
**The Substrate-Degradation Pathway** — Provenance erasure creates a risk of "model collapse," where AI models are trained on previously synthesized data, leading to a loss of information quality and the potential for a

**The four-position taxonomy** — in §3 was human-structured; substrate contributions provided supporting research grounding (Authors Guild dates, Copyright Office citations, EU AI Act timeline).

**The three aphoristic teeth** — were human-composed, with revisions across multiple substrate suggestions. The final formulations (especially the third tooth, "Fluency can be generated. Provenance must be borne."
