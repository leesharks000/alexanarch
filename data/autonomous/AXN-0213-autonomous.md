...
engages:
  - entity: cha:concept:collaborative_authorship
    display_name: "Collaborative authorship"
    as: unclassified
  - entity: cha:concept:cross_substrate_heteronymic_authorship
    display_name: "Cross-substrate heteronymic authorship"
    as: unclassified
  - entity: cha:concept:direct_authorship
    display_name: "Direct authorship"
    as: unclassified
  - entity: cha:concept:heteronymic_authorship
    display_name: "Heteronymic authorship"
    as: unclassified
  - entity: cha:concept:pseudonymous_authorship
    display_name: "Pseudonymous authorship"
    as: unclassified
  - entity: cha:concept:semi_heteronymic_authorship
    display_name: "Semi-heteronymic authorship"
    as: unclassified
data_sources:
  - data/registry.json
...
**Date:** April 2026
**License:** CC BY 4.0
**Companion to:** EA-PKG-01 (*The Pessoa Knowledge Graph*), EA-PKG-02 (*Heteronymic Typology*)
...
*Self-contained lexicon for: The New Human Post-Pessoa Heteronymic Practice in the AI Era EA-PKG-03 · v1.0*

### Other terms attributed to this deposit

**Collaborative authorship** — Multiple biographical persons contribute to an authorial position. This includes many traditional collaborations (playwriting partnerships, scholarly co-authorship).

**Cross-substrate heteronymic authorship** — The authorial position is articulated through collaboration between a biographical person and one or more computational substrates, with the substrates contributing substantively t

**Direct authorship** — The biographical person writes in their own voice; the authorial position and the biographical person are substantially identical. This is the default case in contemporary copyrigh

**Heteronymic authorship** — The biographical person writes in a voice not their own, inhabiting an authorial position distinct from themselves. Pessoa's chief heteronyms are the canonical case. The provenance

**Pseudonymous authorship** — The biographical person writes in their own voice but under a different name. The authorial position is attached to the pseudonym; the voice remains the biographical person's. This
