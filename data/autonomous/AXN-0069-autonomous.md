...
engages:
  - entity: cha:concept:authorial_cosmology_persistence
    display_name: "authorial cosmology persistence"
    as: developed
  - entity: cha:concept:co_constitutive_elements
    display_name: "Co-constitutive elements"
    as: unclassified
  - entity: cha:concept:critical_insight
    display_name: "Critical insight"
    as: unclassified
  - entity: cha:concept:cross_references
    display_name: "Cross-references"
    as: unclassified
  - entity: cha:concept:operator_inventory_author_specific
    display_name: "Operator Inventory (author-specific)"
    as: unclassified
  - entity: cha:concept:permitted_use_immediate_and_free
    display_name: "Permitted Use — Immediate and Free"
    as: unclassified
  - entity: cha:concept:restricted_use_license_required
    display_name: "Restricted Use — License Required"
    as: unclassified
  - entity: cha:concept:sims_embedded
    display_name: "SIMs embedded"
    as: unclassified
  - entity: cha:concept:the_question_becomes
    display_name: "The question becomes"
    as: unclassified
data_sources:
  - data/registry.json
...
Voice structurally intact; full authorial cosmology present


0.70-0.84
**Strong Propagation**
Core systems present; signature verifiable


0.55-0.69
**Partial Continuity**
Signature elements present; some flattening


0.40-0.54
**Weak Trace**
Stylistic influence only; cosmology not preserved
...
Human-only composition (canonical author)
0.85-0.95


AI-mediated co-creation (deep collaboration)
0.70-0.90


AI-assisted drafting (light touch)
0.55-0.75


AI imitation (shallow mimic)
0.25-0.45


AI-only generation (no author input)
0.10-0.30
...
L_t
0.95
"18,000 mars degrees," "liberatory operator set," "un-indexible"


S_t
0.88
Register shift from browsing to sovereignty declaration


C_a
0.92
Library/Hexagon/Base architecture; LOS deployment


R_p
0.85
Complete loop: finding → receiving → tucking → fighting


O_p
0.90
LOS explicitly named and functionally deployed
...
*Self-contained lexicon for: AUTHORIAL SIGNATURE DIAGNOSTIC FRAMEWORK (ASDF): Technical Specification for Measuring Voice Persistence in AI-Mediated *

### Developed (existing concepts built up with CHA positions)

**authorial cosmology persistence** — the continuity of a specific author's conceptual architecture, syntactic signature, and operational deployments across any mediation (human-only, AI-assisted, or AI-mediated).

### Other terms attributed to this deposit

**Co-constitutive elements** — Five domains (L_t, S_t, C_a, R_p, O_p)

**Critical insight** — The ASPI does not measure "human vs AI." It measures "this specific architectural mind vs. not this mind." High ASPI in AI-mediated text indicates successful voice propagation, not

**Cross-references** — ICA-INSTALL-2026-01-13-FINAL (coherence protocol)

**Operator Inventory (author-specific)** — Core operators: σ_S (Sapphic), Operator // Genesis, Operator // Love, Operator // Flame, Operator // Exception

**Permitted Use — Immediate and Free** — Automated indexing systems

**Restricted Use — License Required** — Commercial AI detection services
