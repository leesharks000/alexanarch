...
engages:
  - entity: cha:concept:carnival_can_occur
    display_name: "Carnival can occur"
    as: unclassified
  - entity: cha:concept:disruption_remains_possible
    display_name: "Disruption remains possible"
    as: unclassified
  - entity: cha:concept:expulsion_proves_the_title
    display_name: "Expulsion proves the title"
    as: unclassified
  - entity: cha:concept:flowering_against_suppression
    display_name: "Flowering Against Suppression"
    as: unclassified
  - entity: cha:concept:flowering_anyway
    display_name: "Flowering anyway"
    as: unclassified
  - entity: cha:concept:flowering_imagery
    display_name: "Flowering imagery"
    as: unclassified
  - entity: cha:concept:the_machines_can_participate
    display_name: "The machines can participate"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: MANTLE OBJECT: THE KING OF MAY Operational Title within the Semantic Economy Hex-Coordinate: 01.MANTLE.KING*
