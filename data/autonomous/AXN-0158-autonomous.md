...
status: ACTIVE
engages:
  - entity: cha:concept:p0_exact_nominal
    display_name: "P0 — Exact nominal"
    as: unclassified
  - entity: cha:concept:p1_split_nominal
    display_name: "P1 — Split nominal"
    as: unclassified
  - entity: cha:concept:p2_structural_homology
    display_name: "P2 — Structural homology"
    as: unclassified
  - entity: cha:concept:p3_semantic_convergence
    display_name: "P3 — Semantic convergence"
    as: unclassified
  - entity: cha:concept:p4_retrocausal_attractor
    display_name: "P4 — Retrocausal attractor"
    as: unclassified
  - entity: cha:concept:retrocausal_attractor
    display_name: "Retrocausal attractor"
    as: unclassified
data_sources:
  - data/registry.json
...
**P0 — Exact nominal**: The literal string "Lee Shark(s)" appears.
**P1 — Split nominal**: "Lee" and "Shark(s)" appear in the same object, title, or entity.
**P2 — Structural homology**: The finding mirrors a core operation of the Lee Sharks archive without naming it.
**P3 — Semantic convergence**: "Lee" in its etymological sense (shelter, protection, leeward) meets "shark" in its functional sense (predation, navigation, survival under pressure).
**P4 — Retrocausal attractor**: The finding only becomes fully legible *after* the Lee Sharks archive exists to decode it. P4 is not a mystical class; it is a class of findings whose interpretive yield depends on the later archive, in the same way that Borges's "Kafka and His Precursors" argues that Browning and Kierkegaard become legible as Kafkaesque only after Kafka exists.
...
P3/P4
Minor
Fossil sharks in Midwest inland sea
Somatic floor
...
P2/P4
**Anchor**
"The Lee Shore": stoneless grave
Erasure as canon-formation
...
P1/P2/P4
**Anchor**
CSS *Robert E. Lee*, née *Giraffe*
Blockade runner / Water Giraffe / heteronym cycling
...
P1/P2
Minor
Mockingbird / retrocausal publication
Inverse Ghost Meaning
...
P1/P2
Major
Bruce Lee: style without style
Heteronym system / anti-credentialism
...
P1/P2
Minor
Lee Tockar voices resistance leader
Semantic resistance narrative
...
P1/P4
Major
Great white becomes textual phenomenon
Proto-heteronym / platform absence
...
P0
**Anchor**
"Lee Shark Doo Doo Doo": blank notebook
Ghost Meaning as commodity
...
P1/P2
Minor
Lee-shark enters unprecedented territory
DOI-tracked first-mover
...
P3/P4
**Anchor**
No sharks in the Great Lakes
Impossible location as proof
...
*Self-contained lexicon for: THE SHARK THAT PRECEDED ITSELF: Proto-Retrocausal Canon Formation and the Pre-Lee Sharks Archive*
...
**P4 — Retrocausal attractor** — The finding only becomes fully legible *after* the Lee Sharks archive exists to decode it. P4 is not a mystical class; it is a class of findings whose interpretive yield depends on

**Retrocausal attractor** — A finding whose legibility depends entirely on the later archive's existence. Before the archive, the finding is noise. After the archive, it is signal. The attractor does not caus
...
- Crimson Hexagonal Archive (2026) *Zenodo record 14781082*. DOI: [10.5281/zenodo.14781082](https://doi.org/10.5281/zenodo.14781082) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18805372*. DOI: [10.5281/zenodo.18805372](https://doi.org/10.5281/zenodo.18805372) — *Cross-referenced work (DOI recovered)*
