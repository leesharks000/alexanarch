...
engages:
  - entity: cha:concept:commons_access_rights
    display_name: "Commons access rights"
    as: unclassified
  - entity: cha:concept:context_bound_ledgers
    display_name: "Context-bound ledgers"
    as: unclassified
  - entity: cha:concept:convertibility
    display_name: "Convertibility"
    as: unclassified
  - entity: cha:concept:equivalence_destroys_meaning
    display_name: "Equivalence destroys meaning"
    as: unclassified
  - entity: cha:concept:general_comparability
    display_name: "General comparability"
    as: unclassified
  - entity: cha:concept:governance_granted
    display_name: "Governance-granted"
    as: unclassified
  - entity: cha:concept:money_fails_when
    display_name: "Money fails when"
    as: unclassified
  - entity: cha:concept:non_aggregable
    display_name: "Non-aggregable"
    as: unclassified
  - entity: cha:concept:non_exclusive
    display_name: "Non-exclusive"
    as: unclassified
  - entity: cha:concept:non_exportable
    display_name: "Non-exportable"
    as: unclassified
  - entity: cha:concept:non_final
    display_name: "Non-final"
    as: unclassified
  - entity: cha:concept:non_numerical
    display_name: "Non-numerical"
    as: unclassified
  - entity: cha:concept:non_transferable
    display_name: "Non-transferable"
    as: unclassified
  - entity: cha:concept:non_transferable_credentials
    display_name: "Non-transferable credentials"
    as: unclassified
  - entity: cha:concept:process_based
    display_name: "Process-based"
    as: unclassified
  - entity: cha:concept:repair_oriented
    display_name: "Repair-oriented"
    as: unclassified
  - entity: cha:concept:role_granting
    display_name: "Role-granting"
    as: unclassified
  - entity: cha:concept:settlement_power
    display_name: "Settlement power"
    as: unclassified
  - entity: cha:concept:symmetry_restoring
    display_name: "Symmetry-restoring"
    as: unclassified
  - entity: cha:concept:the_anthropological_limit
    display_name: "The Anthropological Limit"
    as: unclassified
  - entity: cha:concept:the_money_limit
    display_name: "The Money Limit"
    as: unclassified
  - entity: cha:concept:the_structural_protection
    display_name: "The Structural Protection"
    as: unclassified
  - entity: cha:concept:time_decaying_acknowledgments
    display_name: "Time-decaying acknowledgments"
    as: unclassified
  - entity: cha:concept:transferability
    display_name: "Transferability"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: I HEREBY ABOLISH MONEY: Coordination Without Commodification in the Semantic Economy*
...
**Equivalence destroys meaning** — # PART IV: THE MONEY LIMIT

**General comparability** — Measures value across incommensurable contexts

**Governance-granted** — Access decisions made collectively, not by price

**Money fails when** — Value is inseparable from context
...
**The Anthropological Limit** — the point at which extraction targets what humans *are*, not merely what they *do*.

**The Money Limit** — the point at which money ceases to function as adequate coordination mechanism.

**The Structural Protection** — PMOS cannot be financialized without being destroyed. Any attempt to make Context Ledgers exportable collapses them into currency. Any attempt to make Credentials transferable coll
