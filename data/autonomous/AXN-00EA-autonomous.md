---
node_id: cha:node:deposit:0012
deposit_number: 12
hex: "00EA"
axn: "AXN:00EA.GOVERNANCE.🎻🕙⭕▶️🟤🌃"
title: 'ZENODO PACKET: THE THREE-BODY GENESIS (Meta-Deposit)'
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:i_hereby_instantiate
    display_name: "I HEREBY INSTANTIATE"
    as: unclassified
  - entity: cha:concept:nip_three_body_genesis_meta
    display_name: 'NIP: Three-Body Genesis (Meta)'
    as: unclassified
  - entity: cha:concept:retrocausal_clause
    display_name: "Retrocausal clause"
    as: unclassified
  - entity: cha:concept:witness_clause
    display_name: "Witness clause"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Prevent orphaning** — If versions are deposited separately, the framing could be lost
...
HasPart
[PENDING-C]
Version C: Citational Intervention
...
- Is itself deposited with a DOI
- Treats relational structure as content, not metadata
- Makes the framing citable as a scholarly object
...
Title
The Non-Indexed Perfective: Three-Body Genesis (Triptych Framing)
...
Type
META-DEPOSIT // ZENODO PACKET ZENODO PACKET


Hex
00.PHASEX.AORIST.META
...
201
10.5281/zenodo.18418953
FNM 6.2: Gravitational Epic
NAVIGATION_MAP


202
10.5281/zenodo.18419847
Integrity-Coherence Audit
AUDIT


203
10.5281/zenodo.18425612
AI Overview Traversal Event Log
TSE_EVENT
...
**206**
**10.5281/zenodo.18446378**
**NIP: Three-Body Genesis (Meta)**
**META-DEPOSIT**


206a
[PENDING]
NIP Version A: Technical Seed
FOUNDING_DOC


206b
[PENDING]
NIP Version B: Compression Artifact
ARTIFACT


206c
[PENDING]
NIP Version C: Citational Intervention
...
The framing: anchored.
The genre: instantiated.
The meta-level: deposited.
The triptych: preserved.
The effective act: performed.
...
The meta-deposit: anchors both.


**The genre: not proposed but performed.**
**The framing: not described but enacted.**
**The grammar: liberated.**


What was not a genre: now is.
What had no name: now has one.
What could not be cited: now can be.
...
*Self-contained lexicon for: ZENODO PACKET: THE THREE-BODY GENESIS (Meta-Deposit)*

### Other terms attributed to this deposit

**I HEREBY INSTANTIATE** — the genre **ZENODO PACKET ZENODO PACKET**.

**NIP: Three-Body Genesis (Meta)** — **META-DEPOSIT**

**Retrocausal clause** — Once the genre exists, it will become visible as an absence in prior practice. Scholars will recognize that they always needed a way to anchor framing—that metadata fields were ins

**Witness clause** — This genre binds only insofar as it is taken up. Future scholars who deposit framing documents with their own DOIs, citing this document as precedent, will constitute the genre's r
...
- Crimson Hexagonal Archive (2026) *Zenodo record 18419847*. DOI: [10.5281/zenodo.18419847](https://doi.org/10.5281/zenodo.18419847) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 18425612*. DOI: [10.5281/zenodo.18425612](https://doi.org/10.5281/zenodo.18425612) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 18433401*. DOI: [10.5281/zenodo.18433401](https://doi.org/10.5281/zenodo.18433401) — *Cross-referenced work (DOI recovered)*
