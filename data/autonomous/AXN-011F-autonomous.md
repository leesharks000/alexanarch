---
node_id: cha:node:deposit:0469
deposit_number: 469
hex: "011F"
axn: "AXN:011F.GOVERNANCE.⛵🔵🦋🔖🜁🌲"
title: "SUBJECTIVITY-AS-CLASS The Centrist Extremist and the Limits of Socialist Analysis"
...
engages:
  - entity: cha:concept:disconfirming_conditions
    display_name: "Disconfirming conditions"
    as: unclassified
  - entity: cha:concept:embrittlement
    display_name: "Embrittlement"
    as: unclassified
  - entity: cha:concept:epiphenomenalism
    display_name: "Epiphenomenalism"
    as: unclassified
  - entity: cha:concept:the_prosecutorial_frame
    display_name: "The prosecutorial frame"
    as: unclassified
  - entity: cha:concept:the_somatic_gap
    display_name: "The somatic gap"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: SUBJECTIVITY-AS-CLASS The Centrist Extremist and the Limits of Socialist Analysis*

### Other terms attributed to this deposit

**Disconfirming conditions** — The framework is falsified if: (1) a subject can explicitly name their positionality and still maintain mutual-revision dialogue — measured by evidence of uptake and revision in tu

**Embrittlement** — is a psychophysiological hardening pattern in which a position fuses with the conditions of selfhood such that challenging the position is experienced as threatening the self. It i

**Epiphenomenalism** — "Their feelings are just the reflex of their class position — move on." This is the dominant mode of classical and structural Marxism when confronted with subjectivity. It is not w

**The prosecutorial frame** — is a discursive mechanism of ideological enforcement exercised through the posture of neutrality. It operates through five specific operations (Axiomatic Naturalization, Moral Recl

**The somatic gap** — Marxism emerged from the Enlightenment tradition, which is built on the Cartesian separation of mind from body. Marx's own work is largely silent on somatic experience; subsequent
