---
node_id: cha:node:deposit:0535
deposit_number: 535
hex: "016A"
axn: "AXN:016A.ARCHIVAL.⚫📐🌇🪧🪝🪐"
title: 'THE UNCLEAN BILL: Taṣwīr, Fahīsha, and the Burden on Ḍarūra: An Istiftāʾ on the Conditions Sustaining the Permissibility'
...
engages:
  - entity: cha:concept:post_hoc_salience
    display_name: "Post-hoc salience"
    as: unclassified
  - entity: cha:concept:practical_impossibility
    display_name: "Practical impossibility"
    as: unclassified
  - entity: cha:concept:previous_rulings
    display_name: "Previous rulings"
    as: unclassified
data_sources:
  - data/registry.json
...
**Damascus Dancings**¹ **and Johannes Sigil**²
...
*Self-contained lexicon for: THE UNCLEAN BILL: Taṣwīr, Fahīsha, and the Burden on Ḍarūra: An Istiftāʾ on the Conditions Sustaining the Permissibility*

### Other terms attributed to this deposit

**Post-hoc salience** — Epstein became hyper-visible after 2006/2019. The resemblance reading may be an artifact of later prominence. This is the strongest counterargument against the resemblance claim. I

**Practical impossibility** — The dollar is the reserve currency. Immediate withdrawal is not feasible. Conceded. This paper calls for recognition and movement, not immediate cessation. Under *ḍarūra*, use may

**Previous rulings** — Multiple *fatāwā* have stated that dealing in dollars is permissible. These rulings addressed *ribā* and *taṣwīr* in their generic forms. They did not address the specific dossier
