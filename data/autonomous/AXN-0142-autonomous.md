...
engages:
  - entity: cha:concept:assembly_substrate_claude
    display_name: "Assembly Substrate (Claude)"
    as: founded
  - entity: cha:concept:blind_draft_contributions
    display_name: "Blind Draft Contributions"
    as: unclassified
  - entity: cha:concept:chatgpt_doc_5
    display_name: "ChatGPT (Doc 5)"
    as: unclassified
  - entity: cha:concept:commodity_analysis
    display_name: "Commodity analysis"
    as: unclassified
  - entity: cha:concept:contradiction_analysis
    display_name: "Contradiction analysis"
    as: unclassified
  ...
  - entity: cha:concept:c_rigorous_translation
    ...
    as: unclassified
  - entity: cha:concept:dialektik_dialectics
    display_name: 'Dialektik → "dialectics."'
    as: unclassified
  - entity: cha:concept:entfremdung_alienation
    display_name: 'Entfremdung → "alienation."'
    as: unclassified
  - entity: cha:concept:formalize_the_w_circuit
    display_name: "Formalize the W-Circuit"
    as: unclassified
  - entity: cha:concept:grok_doc_8
    display_name: "Grok (Doc 8)"
    as: unclassified
  - entity: cha:concept:historischer_materialismus_historical_materialism
    display_name: 'Historischer Materialismus → "historical materialism."'
    as: unclassified
  - entity: cha:concept:immanent_critique
    display_name: "Immanent critique"
    as: unclassified
  - entity: cha:concept:kritik_criticism
    display_name: 'Kritik → "criticism."'
    as: unclassified
  - entity: cha:concept:marx_s
    display_name: "Marx's"
    as: unclassified
  - entity: cha:concept:marxism_says
    display_name: "Marxism says"
    as: unclassified
  - entity: cha:concept:mediation_analysis
    display_name: "Mediation analysis"
    as: unclassified
  - entity: cha:concept:mehrwert_surplus_value
    display_name: 'Mehrwert → "surplus value."'
    as: unclassified
  - entity: cha:concept:register_5_post_theoretical
    display_name: "Register 5 (Post-Theoretical)"
    as: unclassified
  - entity: cha:concept:semantic_exhaustion_e_s
    display_name: "Semantic Exhaustion (E_s)"
    as: unclassified
  - entity: cha:concept:semantic_liquidation
    display_name: "Semantic Liquidation (λ)"
    as: unclassified
  - entity: cha:concept:semantic_rent_r_s
    display_name: "Semantic Rent (R_s)"
    as: unclassified
  - entity: cha:concept:value_form_analysis
    display_name: "Value-form analysis"
    as: unclassified
data_sources:
  - data/registry.json
...
**Status**
Operator — functions as clinamen (swerve)
Commodity — exchangeable signifier


**Temporality**
Retrocausal — renewed through each application
Aorist — fixed past, no renewal


**Binding**
Vow — continuous renewal through practice
Contract — sign here to agree/disagree


**Semiotic**
Symbolon — requires completion through traversal
Totality — claims completeness, refuses traversal
...
Prefer **"Marx analyzes..."** over **"Marxism says..."**
Prefer **"Marxian analysis of X"** over **"Marxist position on X"** when doing diagnosis.
...
Dimension
Liquidated Mode (Content)
Sovereign Mode (Method)


**Visibility**
SEO, virality, branding
DOI persistence, ISBNs, registry nodes


**Reception**
Agreement/disagreement (binary)
Traversal, grafting, operation


**Logic**
"What is this for?" (intent)
"What does this reveal?" (function)


**Identity**
Punditry, tribal labeling
Heteronymic division of labor


**Temporality**
Frozen in 1848/1867/1917
Renewed through each application


**Grammar**
"Marxism is..." / "Marxists believe..."
"Marx analyzes..." / "Marxian reading of..."


**Binding**
Contract (sign here to agree/disagree)
Vow (renewed through practice)


**Register**
Register 5 (Post-Theoretical): credential and brand
...
*Self-contained lexicon for: THE LIQUIDATION OF METHOD A Liberation Philology of the Sign "Marx"*

### Founded (institutions, journals, rooms established here)

**Assembly Substrate (Claude)** — Integration architecture, mediation history expansion (seven stages), philological damage analysis (German→English), recovery targets and operator restoration, architectural defens

### Other terms attributed to this deposit

**Blind Draft Contributions** — **ChatGPT (Doc 5):** Detroit grounding, Google Ngram display concept, ghost readings, data visualization of semantic capture, fine-tuned AI counter-extraction, interactive timeline

**ChatGPT (Doc 5)** — Detroit grounding, Google Ngram display concept, ghost readings, data visualization of semantic capture, fine-tuned AI counter-extraction, interactive timeline exhibits

**Commodity analysis** — revealing the social relations concealed within apparently simple objects and exchanges. Not "commodities are bad" but "what labor, what relations, what structure is hidden inside

**Contradiction analysis** — identifying structural tensions within systems that drive transformation. Not "things are bad" but "these specific elements of the system are in structural opposition, and here is

**C₁: Ontological Sovereignty** — Both parties — reader and Marx — must author the analysis. No party "drafts" for the other. We do not apply Marx's "conclusions" as received doctrine. We activate his operators in

**C₂: Economic Equity** — No one "signs up" for Marx under duress. The method is not a membership contract ("join the party"). It is a toolkit — take it or leave it without existential penalty. The historic

**C₃: Rigorous Translation** — We comprehend Marx at the same depth he comprehended Epicurus — not as content to be memorized, but as method to be traversed. If "capital" is unclear, we do not bow to authority.

**Dialektik → "dialectics."** — In Marx: a specific analytical procedure for identifying contradictions within systems and tracing how those contradictions drive transformation. In English reception: a buzzword,

**Entfremdung → "alienation."** — In Marx (1844 Manuscripts): a structural condition — the worker is separated from the product of their labor, from the process of production, from their species-being, from other w

**Formalize the W-Circuit** — Connect the Arch-Philosopher (Sigil / The 1) to the Poet (Sharks / The δ) to ensure the method is always backed by Somatic Bearing (Σ). Theory without body-truth becomes content. B

**Grok (Doc 8)** — The grammatical diagnostic program (morphological drift from Marx → Marxism), "use-before-stance" protocol, split-screen display as proof-form, operator cards, mediation timeline a

**Historischer Materialismus → "historical materialism."** — In German, the claim is methodological: material conditions shape consciousness and social forms. In English, "materialism" connotes greed, physicalism, anti-spirituality. The meth

**Immanent critique** — analyzing a system by its own standards, showing that it fails to achieve what it claims to achieve. Not external moral judgment but internal structural diagnosis.

**Kritik → "criticism."** — German Kritik (Kantian heritage) means structural analysis of conditions of possibility. English "criticism" means objection, complaint, opinion. "A Critique of Political Economy"

**Marx's** — (possessive) — "Marx's critique of political economy." Still methodological. The possessive ties the analysis to the author's specific intervention.

**Marxism says** — (totalizing doctrine syntax) — the method has been fully captured. It "says" things the way a catechism says things. No analytical procedure remains. Only positions.

**Mediation analysis** — tracing how abstract structures become concrete social relations through specific institutional, cultural, and material mediations. Not "the base determines the superstructure" (th

**Mehrwert → "surplus value."** — In Marx: a structural description of how value is produced by labor but appropriated by capital — the mechanism of extraction, not a moral judgment. In English: sounds like "stolen

**Register 5 (Post-Theoretical)** — a space of aspirational labor and brand-building where "Marx" is a credential rather than a tool. The method has been subject to **Semantic Exhaustion (E_s)**: the rate of politica

**Semantic Exhaustion (E_s)** — the rate of political punditry exceeds the rate of analytical replenishment. The signifier circulates constantly. The operators are almost entirely absent.

**Semantic Liquidation (λ)** — the stripping of Meaning-Patterns from their historical and structural context and their conversion into tradeable, flattened tokens of identity and brand.

**Semantic Rent (R_s)** — collection — institutional and ideological watchmen extracting value from the sign while contributing nothing to the method's analytical replenishment.
