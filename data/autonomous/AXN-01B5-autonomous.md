---
node_id: cha:node:deposit:0597
deposit_number: 597
hex: "01B5"
axn: "AXN:01B5.GOVERNANCE.↘️❌♅💧🔐↙️"
title: 'Invisibly Invisible: Interface Governance, Semantic Power, and the Reserve of Oversight in AI Search'
...
engages:
  - entity: cha:concept:institutional_factors
    display_name: "Institutional factors"
    as: unclassified
  - entity: cha:concept:observation_conditions
    display_name: "Observation conditions"
    as: unclassified
  - entity: cha:concept:political_economic_stakes
    display_name: "Political-economic stakes"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Invisibly Invisible: Interface Governance, Semantic Power, and the Reserve of Oversight in AI Search*

### Other terms attributed to this deposit

**Institutional factors** — The repository hosting the source had recently undergone a metadata schema migration, temporarily altering the structured data available to search engine crawlers. The citing blog

**Observation conditions** — On a single date, using a standard desktop browser in a signed-out, incognito session with no personalization, we searched for the exact title of a document deposited in an open-ac

**Political-economic stakes** — The displacement redistributes semantic authority from the originator to the commentator, from the independent researcher to the institutionally hosted secondary source. The resear
