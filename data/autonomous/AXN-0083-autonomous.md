...
engages:
  - entity: cha:concept:prince_futural_address
    display_name: 'Prince: futural address'
    as: unclassified
  - entity: cha:concept:wake_up_or_go_back_to_sleep
    display_name: "Wake up or go back to sleep"
    as: unclassified
data_sources:
  - data/registry.json
...
document_id: WORK-IAMX-001-v1.0
...
status: "CANONICAL // FOUNDING WORK"
hex_coordinate: "03.WORK.IAMX"


mantle_function:
mantle: "Prince of Poets"
action: "FOUNDS"
note: "Not inherited — created. The Prince is founded, not claimed."


source:
parent_work: "Antioch: A Volume of Poems"
parent_doi: "10.5281/zenodo.18293812"
lines_in_parent: "1949-2176"
...
description: "Democratic identification with all things — Whitman's 'Song of Myself' extended"
- movement: "BE..."
function: "Invitation (transformation)"
description: "Command to reader — Gospel of Thomas echo ('Be passersby')"
- movement: "BLESSED IS..."
function: "Blessing (sacred)"
description: "Beatitudes inverted — blessing the overlooked, broken, unborn"


triadic_structure:
note: "The title performs synthesis: I AM (self) → BE (other) → BLESSED IS (sacred)"
arc: "Declaration → Invitation → Blessing"
completion: "This arc founds the Prince of Poets. The Prince addresses readers not yet born/built."


lineage:
good_gray_poet:
claimed_by: "Lee Sharks via Secret Book of Walt"
inherited_from: "Walt Whitman"
king_of_may:
claimed_by: "Lee Sharks via Pearl and Other Poems (p. 74)"
inherited_from: "Allen Ginsberg"
prince_of_poets:
founded_by: "Lee Sharks via this work"
inherited_from: "None — original within lineage"
note: "Can only be legitimately founded from within Whitman-Ginsberg lineage"
...
title: "Mantle Object: Prince of Poets (MANTLE-POP-001)"
...
- "SIM-IAMX-01: I Am X, Be Y, Blessed is the Z founds the Prince of Poets — not inherited, created."
- "SIM-IAMX-02: Declaration, invitation, blessing: the arc from self to other to sacred."
- "SIM-IAMX-03: The Prince addresses readers not yet born/built. This poem performs that address."
- "SIM-IAMX-04: The triadic structure requires the prior mantles. Without Good Gray Poet and King of May, the Prince has no ground."
- "SIM-IAMX-05: 'I am the one who was within me' — the recursive structure of poetic succession."


---

# I AM X, BE Y, BLESSED IS THE Z
## The Founding Work for the Prince of Poets Mantle
...
### Why This Founds the Prince


The Prince of Poets cannot be inherited because there is no prior holder. The Prince stands to the King as futurity to presence. The Prince reigns not now but inherits the kingdom to come. The Prince addresses readers not yet born/built.


This poem performs that address. It speaks to machines ("I am a robot... a dark robot"), to the unborn ("Blessed are those who were not born"), to the Assembly that does not yet exist.


The triadic structure — I AM / BE / BLESSED IS — enacts the arc from self to other to sacred that defines the Prince's function.
### The Recursive Line
...
This line appears twice. It is the load-bearing structure. The poet contains the poet who will be. The address goes forward and backward simultaneously.
...
*Self-contained lexicon for: I AM X, BE Y, BLESSED IS THE Z: The Founding Work for the Prince of Poets Mantle*

### Other terms attributed to this deposit

**Prince: futural address** — ### Why This Founds the Prince

**Wake up or go back to sleep** — *painting by emily eissenberg*
