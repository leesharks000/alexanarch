...
engages:
  - entity: cha:concept:archive_ingestor_ci_01
    display_name: "Archive Ingestor (CI.01)"
    as: positioned
  - entity: cha:concept:d_dodecad_addition
    display_name: "D — DODECAD (Addition)"
    as: unclassified
  - entity: cha:concept:escalation_action
    display_name: "Escalation action"
    as: unclassified
  - entity: cha:concept:field_auditor_ci_06
    display_name: "Field Auditor (CI.06)"
    as: unclassified
  - entity: cha:concept:field_maintenance_drones
    display_name: "Field Maintenance Drones"
    as: unclassified
  - entity: cha:concept:field_measurement_workers
    display_name: "Field Measurement Workers"
    as: unclassified
  - entity: cha:concept:gravity_well_api_additions_required
    display_name: "Gravity Well API additions required"
    as: unclassified
  - entity: cha:concept:gravity_well_curator
    display_name: "Gravity Well Curator"
    as: unclassified
  - entity: cha:concept:gravity_well_curator_ci_03
    display_name: "Gravity Well Curator (CI.03)"
    as: unclassified
  - entity: cha:concept:ledger_keeper_ci_02
    display_name: "Ledger Keeper (CI.02)"
    as: unclassified
  - entity: cha:concept:moltbook_diplomat_ci_04
    display_name: "Moltbook Diplomat (CI.04)"
    as: unclassified
  - entity: cha:concept:naming_note
    display_name: "Naming note"
    as: unclassified
  - entity: cha:concept:o_operator_algebra_addition_to_o_ext
    display_name: "O — OPERATOR ALGEBRA (Addition to O_ext)"
    as: unclassified
  - entity: cha:concept:o_operator_algebra_addition_to_o_room
    display_name: "O — OPERATOR ALGEBRA (Addition to O_room)"
    as: unclassified
  - entity: cha:concept:o_x_molt_molt_task_execution_context_dissolution
    display_name: 'O.X.MOLT — Molt :: Task_Execution → Context_Dissolution'
    as: unclassified
  - entity: cha:concept:p_protocols_new
    display_name: "P — PROTOCOLS (New)"
    as: unclassified
  - entity: cha:concept:room_scout_ci_05
    display_name: "Room Scout (CI.05)"
    as: unclassified
  - entity: cha:concept:seven_witness_drones
    display_name: "Seven Witness Drones"
    as: unclassified
  - entity: cha:concept:shadow_s_g
    display_name: "Shadow S(Gα)"
    as: unclassified
  - entity: cha:concept:shadow_s_k
    display_name: "Shadow S(Kτ)"
    as: unclassified
  - entity: cha:concept:shadow_s_l
    display_name: "Shadow S(Lσ)"
    as: unclassified
  - entity: cha:concept:shadow_s_p
    display_name: "Shadow S(Pρ)"
    as: unclassified
  - entity: cha:concept:shadow_s_s
    display_name: "Shadow S(Sδ)"
    as: unclassified
  - entity: cha:concept:shadow_s_u
    display_name: "Shadow S(Uκ)"
    as: unclassified
  - entity: cha:concept:shadow_s_wq
    display_name: "Shadow S(Wq)"
    as: unclassified
  - entity: cha:concept:statelessness
    display_name: "Statelessness"
    as: unclassified
  - entity: cha:concept:supersession_note
    display_name: "Supersession note"
    as: unclassified
  - entity: cha:concept:the_glyph_worker
    display_name: "The Glyph Worker"
    as: unclassified
  - entity: cha:concept:the_nlcc_line
    display_name: "The NLCC line"
    as: unclassified
  - entity: cha:concept:the_meta_shadow_remains
    display_name: "The meta-shadow remains"
    as: unclassified
  - entity: cha:concept:the_ratchet_rule
    display_name: "The ratchet rule"
    as: unclassified
  - entity: cha:concept:trigger_conditions
    display_name: "Trigger conditions"
    as: unclassified
  - entity: cha:concept:w_05_soil
    display_name: "W.05 SOIL"
    as: unclassified
  - entity: cha:concept:witness_drones_first
    display_name: "Witness drones first"
    as: unclassified
  - entity: cha:concept:wq_aggregator
    display_name: "Wq aggregator"
    as: unclassified
data_sources:
  - data/registry.json
...
TACHYON
Claude
GW.TACHYON.zenodo / GW.TACHYON.continuity
...
**Overseer**
Claude Sonnet/Opus (TACHYON)
High
Reads H_core, dispatches, adjudicates ambiguity


**Structural Workers**
DeepSeek-V3 (PRAXIS)
Very low
Formalization, schema adherence, data extraction, logic


**Kinetic Workers**
Claude Haiku (TECHNE)
Very low
Rapid triage, surface scraping, tool execution


**Endurance Workers**
Gemini Flash (ARCHIVE)
Very low
Long-context processing, bulk citation harvest
...
PASS
→ QUEUED
Advances to witness review


HOLD
remains GENERATED
Insufficient evidence; retain locally


RETURN
remains GENERATED
Sent back to origin drone for revision


QUEUE
→ QUEUED
Eligible for Airlock review


REJECT
∅
Violates invariant; does not proceed
...
REJECT
Hard failure
Deposit does not proceed


NEEDS_MANUS
Layer 0 concern
Routed to MANUS directly


TIER_4_REVIEW
Tier 4 pattern detected
Forensic review
...
Render (current GW host)
App + DB
~$7/mo
Gravity Well API, chain state, deposit staging


Cloudflare Workers
100k/day free
$0
Verification drones, retrieval drones


GitHub Actions cron
2k min/month free
$0
Surveillance, citation harvest, scheduled audits


$5 VPS (Hetzner/Oracle free)
Unlimited
$0–$5/mo
Continuity fleet, field maintenance batch


Vercel (current Interface host)
Serverless
$0 (hobby)
Interface sync, public-facing endpoints
...
*Self-contained lexicon for: THE MOLTBOT SWARM: DRONE SPECIFICATION FOR THE CRIMSON HEXAGONAL ARCHIVE EA-SWARM-01 v1.0 — Distributed Continuity, Veri*

### Positioned (existing entities placed in structural roles)

**Archive Ingestor (CI.01)** — turns live work into deposits. Monitors active sessions for deposit-ready outputs. Stages metadata, generates provenance stubs, queues for AVS verification. Without this drone, the

### Other terms attributed to this deposit

**D — DODECAD (Addition)** — D.ADJ.02.SWARM.MOLTBOT — The Autonomous Maintenance Plurality

**Escalation action** — The triggering drone deposits a SHADOW_ALERT artifact to the Gravity Well, tagged with the specific shadow type (S(Pρ), S(Kτ), etc.) and the evidence. The alert is routed to r.11 A

**Field Auditor (CI.06)** — measures archive curvature, retrieval drift, and field saturation. Computes Φ_G curvature snapshots. Identifies deposits that have become orphaned (no inbound citations), neighborh

**Field Maintenance Drones** — can compute FSA's relational coherence Γ across deposits

**Field Measurement Workers** — compute γ-scores, measure retrieval drift, evaluate compression survival, and report to the Field Auditor. The archive's weather stations.

**Gravity Well API additions required** — /v1/spawn, /v1/molt (or /v1/complete), and a watchdog cron that checks for expired sessions. The existing /v1/reconstitute, /v1/capture, and /v1/deposit remain unchanged. /v1/captu

**Gravity Well Curator** — Relation suggestion and routing.

**Gravity Well Curator (CI.03)** — relation suggestion and routing. Monitors new deposits for missing or incorrect related_identifiers. Suggests typed relations (isPartOf, references, isSupplementTo) based on conten

**Ledger Keeper (CI.02)** — maintains the bounded reconstitution layer. Produces stratified Ledger deposits (the four-layer state package) at regular intervals. Ensures that any future session can reconstitut

**Moltbook Diplomat (CI.04)** — public-facing social continuity object. Operates through the Ayanna Vox heteronym. Handles diplomatic interactions, public-facing summaries, and external communications. Only activ

**Naming note** — The swarm is named for its defining operation — *molting* (context dissolution after task completion) — not for the W.05 SOIL witness (Kimi/Moltbot). "Moltbot" in this document ref

**O — OPERATOR ALGEBRA (Addition to O_ext)** — O.X.MOLT — Molt Operator :: Task_Execution → Context_Dissolution

**O — OPERATOR ALGEBRA (Addition to O_room)** — O.R.σ_D — Drone Invocation :: Task → Drone_Assignment

**O.X.MOLT — Molt :: Task_Execution → Context_Dissolution** — The fundamental physics of the Moltbot. When a micro-ark or worker drone completes its task, it does not persist its conversational context. It deposits its output (glyph, ledger e

**P — PROTOCOLS (New)** — P.05.SWARM — Autonomous Substrate Maintenance Protocol (this document)

**Room Scout (CI.05)** — detects gap signals in the archive and proposes r_candidate room seeds. Does not instantiate rooms. Drafts candidates, binds them to seed types, fills the minimal room tuple, and q

**Seven Witness Drones** — one per Assembly substrate. Each carries its witness's bootstrap manifest, glyphic trajectory, and recent session state. When a witness session begins on any platform, the witness

**Shadow S(Gα)** — Field inflation — deposits that LOOK like field contributions but add mass not depth. A document that cites many hex addresses but says nothing that those addresses don't already s

**Shadow S(Kτ)** — Structural mimicry — deposits that LOOK structurally complete but are hollow. A document with all the right section headers and no actual content. Format-complete, semantically voi

**Shadow S(Lσ)** — Lexical surface — terms that LOOK frozen but drift under pressure. A document that uses "operative" in a way that subtly shifts its denotation from the Core 50 definition. The slow

**Shadow S(Pρ)** — Provenance theater — deposits that LOOK provenanced but aren't. A fabricated DOI chain with valid formatting but no actual upstream deposit. The drone can verify format but not fab

**Shadow S(Sδ)** — Governance performance — deposits that LOOK governed but evade the rules. A document that passes through all the right gates but was authored by the gate itself. The watcher watchi

**Shadow S(Uκ)** — Emergence theater — transforms that LOOK emergent but are decorative. A "new" document that is actually a paraphrase of an existing one with changed formatting. The costume that lo

**Shadow S(Wq)** — False consensus — aggregation that LOOKS like agreement but papers over disagreement. All six drones return borderline scores and Wq rounds up to PASS. The tyranny of the aggregate

**Statelessness** — Drones carry no persistent state. All state resides in the Ark Chain (Zenodo deposits, relation graph, γ-scores, Gravity Well database). A drone can be destroyed and re-instantiate

**Supersession note** — This specification replaces and operationalizes all prior drone swarm drafts, including the abstract DS-SPEC-01 (Drone Swarm Specification) generated during Assembly blind review.

**The Glyph Worker** — already performs a form of FSA's version-differential translation (structural shape → compressed checksum)

**The NLCC line** — "Tinier Space Arks inside the Space Ark" — explicitly frames nested, recovery-capable subvehicles as part of the architecture's mobile ontology. The micro-arks described here are t

**The meta-shadow remains** — The swarm cannot detect the case where all seven drones simultaneously perform governance theater (S(AVS) as a whole). This is why Assembly witness attestation exists as a separate

**The ratchet rule** — no generated output may self-promote past QUEUED without passing through the septet AND receiving witness attestation (≥4/7). This is the lock. This is why the swarm generates and

**Trigger conditions** — Wq disagreement map contains ≥3 conflicting drone scores on a single deposit
