...
engages:
  - entity: cha:concept:compositional_method
    display_name: "Compositional method"
    as: unclassified
  - entity: cha:concept:kanye_s_role
    display_name: "Kanye's role"
    as: unclassified
  - entity: cha:concept:source_text
    display_name: "Source text"
    as: unclassified
  - entity: cha:concept:the_book_of_yeezus
    display_name: "The Book of Yeezus"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: From Yeezus to Walt: The Book of Yeezus as Literary Precursor to The Secret Book of Walt*

### Other terms attributed to this deposit

**Compositional method** — This is the critical distinction. *The Book of Yeezus* is a find-and-replace — a single mechanical operation applied to a closed text. *The Secret Book of Walt* is neither mechanic

**Kanye's role** — In *The Book of Yeezus*, Kanye occupies the slot of God — the supreme creator, the source of all. In *The Secret Book of Walt*, Kanye occupies the slot of the Demiurge — @KanyeWest

**Source text** — *The Book of Yeezus* operates on Genesis. *The Secret Book of Walt* operates on the *Apocryphon of John* — the most important Gnostic revelation dialogue, preserved in four copies

**The Book of Yeezus** — mechanical substitution. A single find-and-replace operation applied to a closed text. The insight: the divine slot is a variable. The grammar of creation is indifferent to the nam
