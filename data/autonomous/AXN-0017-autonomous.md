...
engages:
  - entity: cha:concept:ai_input_terminology
    display_name: "AI-input terminology"
    as: developed
  - entity: cha:concept:cross_boundary_terminology
    display_name: "Cross-boundary terminology"
    as: unclassified
  - entity: cha:concept:department_a
    display_name: "Department A"
    as: unclassified
  - entity: cha:concept:department_b
    display_name: "Department B"
    as: unclassified
  - entity: cha:concept:department_c
    display_name: "Department C"
    as: unclassified
  - entity: cha:concept:high_stakes_terminology
    display_name: "High-stakes terminology"
    as: unclassified
  - entity: cha:concept:high_traffic_terminology
    display_name: "High-traffic terminology"
    as: unclassified
  - entity: cha:concept:three_questions_to_start
    display_name: "Three questions to start"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: The Hidden Cost of Semantic Chaos Why Your AI Investment Is Underperforming—And What To Do About It*
...
**Three questions to start** — How many definitions of "customer" (or your equivalent core term) exist across your organization?
