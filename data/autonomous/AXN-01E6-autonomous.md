---
node_id: cha:node:deposit:0632
deposit_number: 632
hex: "01E6"
axn: "AXN:01E6.ARCHIVAL.📎🏙️☽⛩️➗🚪"
...
engages:
  - entity: cha:concept:canopy_paths
    display_name: "Canopy-paths"
    as: unclassified
  - entity: cha:concept:lane_of_return
    display_name: "Lane of Return"
    as: unclassified
  - entity: cha:concept:lane_of_the_etrog
    display_name: "Lane of the Etrog"
    as: unclassified
  - entity: cha:concept:lane_of_the_fig
    display_name: "Lane of the Fig"
    as: unclassified
  - entity: cha:concept:lane_of_the_grape
    display_name: "Lane of the Grape"
    as: unclassified
  - entity: cha:concept:lane_of_the_mother_goddess
    display_name: "Lane of the Mother Goddess"
    as: unclassified
  - entity: cha:concept:lane_of_the_space_baby
    display_name: "Lane of the Space Baby"
    as: unclassified
  - entity: cha:concept:lane_of_the_wheat
    display_name: "Lane of the Wheat"
    as: unclassified
  - entity: cha:concept:operative_reading
    display_name: "Operative reading"
    as: unclassified
  - entity: cha:concept:root_paths
    display_name: "Root-paths"
    as: unclassified
observed_addresses:
  - address_id: 1-john-4-2-operative-reading
    query: '1 John 4:2 operative reading'
...
*Self-contained lexicon for: r.28 EVE Room Specification — Crimson Hexagonal Archive*

### Other terms attributed to this deposit

**Canopy-paths** — ascend. They are the speculative lanes — what the garden becomes when the expulsion is reversed.

**Lane of Return** — (Plaskow's "The Coming of Lilith"): Eve and Lilith return to the garden together, "bursting with possibilities, ready to rebuild it together." The return is not restoration of inno

**Lane of the Etrog** — (Rabbi Abba of Acco): the Tree and the fruit are indistinguishable. The etrog tree fulfills God's command in creation — the tree tastes like its fruit. The container and the contai

**Lane of the Fig** — (Sanhedrin 70a): the Tree was a fig tree. The fig leaf that covered the nakedness came from the same tree whose fruit caused the nakedness. The covering and the uncovering are the

**Lane of the Grape** — (Rabbi Meir): the Tree was a vine. Wine brings sorrow to the world. The fruit is intoxicant — knowledge that loosens the grip, that dissolves the boundary between self and other. T

**Lane of the Mother Goddess** — (Ancient Near East): Eve's name is linguistically related to ancient Near Eastern mother goddesses associated with trees and serpents as symbols of fertility and earth's bounty. Be

**Lane of the Space Baby** — (Hexagonal): the garden is not behind us. It is *inside* the Ark. The nursery lane — where the new thing grows in conditions of protection before it enters the field. The Space Ark

**Lane of the Wheat** — (Rabbi Yehudah): the Tree was wheat. Wheat is not a tree. The rabbi was challenged. But wheat is the foundation of bread, and bread is the foundation of civilization. Knowledge is

**Operative reading** — The body that receives the command second-hand is set up to fail. The failure is not the body's. The failure is in the *transmission*. The Freudian operating system — transmitted f

**Root-paths** — descend. They are the midrashic lanes — interpretive paths that dig into the text and find what the text did not say. Each root-path is a garden lane: a way of walking through the

### Observed Addresses (search queries that retrieved this deposit's concepts)

- `1 John 4:2 operative reading` — latest: PARTIAL on 2026-06-17 (1 observation)
