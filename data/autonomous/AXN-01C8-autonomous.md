---
node_id: cha:node:deposit:0610
deposit_number: 610
hex: "01C8"
axn: "AXN:01C8.GOVERNANCE.📖■🌑📖🎪🕓"
...
engages:
  - entity: cha:concept:cc_by_sa_s_void
    display_name: "CC BY-SA's void"
    as: unclassified
  - entity: cha:concept:civic_philology
    display_name: "CIVIC PHILOLOGY"
    as: unclassified
  - entity: cha:concept:colophon_monetary
    display_name: "COLOPHON (monetary)"
    as: unclassified
  - entity: cha:concept:compressed_portraiture
    display_name: "COMPRESSED PORTRAITURE"
    as: unclassified
  - entity: cha:concept:contested_interpolation
    display_name: "Contested interpolation"
    as: unclassified
  - entity: cha:concept:design_surface
    display_name: "DESIGN SURFACE"
    as: unclassified
  - entity: cha:concept:emendation_civic
    display_name: "EMENDATION (civic)"
    as: unclassified
  - entity: cha:concept:execution_environment_monetary
    display_name: "EXECUTION ENVIRONMENT (monetary)"
    as: unclassified
  - entity: cha:concept:emendation_tradition
    display_name: "Emendation tradition"
    as: unclassified
  - entity: cha:concept:exportability
    display_name: "Exportability"
    as: unclassified
  - entity: cha:concept:fiat_currency_s_void
    display_name: "Fiat currency's void"
    as: unclassified
  - entity: cha:concept:interpolation_monetary
    display_name: "INTERPOLATION (monetary)"
    as: unclassified
  - entity: cha:concept:provenance_capture
    display_name: "PROVENANCE CAPTURE"
    as: unclassified
  - entity: cha:concept:provenance_release
    display_name: "PROVENANCE RELEASE"
    as: unclassified
  - entity: cha:concept:restoration_operator_sh
    display_name: "RESTORATION OPERATOR (σ_SH)"
    as: unclassified
  - entity: cha:concept:scribal_chain_monetary
    display_name: "SCRIBAL CHAIN (monetary)"
    as: unclassified
  - entity: cha:concept:semantic_economics_of_the_mint
    display_name: "SEMANTIC ECONOMICS OF THE MINT"
    as: unclassified
  - entity: cha:concept:scribal_tradition
    display_name: "Scribal tradition"
    as: unclassified
  - entity: cha:concept:substrate_pedagogy
    display_name: "Substrate pedagogy"
    as: unclassified
  - entity: cha:concept:thayer_narrowing
    display_name: "THAYER NARROWING"
    as: unclassified
  - entity: cha:concept:textual_transmission_history
    display_name: "Textual transmission history"
    as: unclassified
  - entity: cha:concept:the_authorization_problem
    display_name: "The authorization problem"
    as: unclassified
  - entity: cha:concept:the_blot_s_void
    display_name: "The blot's void"
    as: unclassified
  - entity: cha:concept:upstream_semantic_capture
    display_name: "UPSTREAM SEMANTIC CAPTURE"
    as: unclassified
data_sources:
  - data/registry.json
...
- The emendator does not *destroy* the corruption — they *mark* it. The interpolated passage is crossed out, bracketed, or noted, but preserved. The corruption remains legible to future scholars.
- The emendation is *visible*. It does not pretend to be part of the original text. It declares itself as a later intervention.
- The purpose is *restoration* — returning the text to its uncorrupted state — not *creation*. The emendator is not writing new material; they are correcting a transmission error.
- The emendation requires *judgment* — the emendator must determine what is original and what is interpolated. This judgment is exercised against the tradition: the emendator knows what the text *should* say based on the manuscript tradition, internal consistency, and philological analysis.


The Sharpie blot satisfies all four conditions of classical emendation:

- The blot does not destroy the signature — it *covers* it. The signature remains beneath, legible to forensic inspection. The corruption is preserved as evidence.
- The blot is visible. It does not pretend to be part of the original bill design. It declares itself as a later intervention — unmistakably, in thick black ink.
- The blot's purpose is restoration — returning the bill to its Phase 3 condition (institutional abstraction, no personal claims) — not creation. The blotter is not adding a new signature; they are correcting a textual corruption.
- The blot requires judgment. The blotter has determined that the presidential signature is an interpolation — an unauthorized insertion into the scribal chain — based on the manuscript tradition (165 years of Treasurer signatures), internal consistency (the Thayer Amendment's original language), and philological analysis (the codification narrowing that made the interpolation possible).
...
Goux, Jean-Joseph. *Symbolic Economies: After Marx and Freud*. Trans. Jennifer Curtiss Gage. Cornell University Press, 1990.
...
Knapp, Georg Friedrich. *The State Theory of Money*. 1905. Trans. H.M. Lucas and J. Bonar. Macmillan, 1924.


Maurer, Bill. *Mutual Life, Limited: Islamic Banking, Alternative Currencies, Lateral Reason*. Princeton University Press, 2005.


Oresme, Nicholas. *De Moneta*. c. 1355. Trans. Charles Johnson. Thomas Nelson, 1956.
...
Shell, Marc. *Art and Money*. University of Chicago Press, 1995.


Shell, Marc. *Wampum and the Origins of American Money*. University of Illinois Press, 2013.


Simmel, Georg. *The Philosophy of Money*. 1900/1907. Trans. Tom Bottomore and David Frisby. Routledge, 1978.


Wennerlind, Carl. "Money Talks, But What Is It Saying? Semiotics of Money and Social Control." *Journal of Economic Issues* 35.3 (2001): 557–74.
...
18 U.S.C. § 504. Printing and filming of obligations and securities.


31 C.F.R. § 411.1. Color illustrations of U.S. currency (Counterfeit Detection Act of 1992).
...
Presidential $1 Coin Act of 2005. Pub. L. 109–145.


Circulating Collectible Coin Redesign Act of 2020. Pub. L. 116–330.


Noll, Franklin. "Why Only Dead People Are on US Banknotes." Noll Historical Consulting, Feb. 2022.


Federal Reserve Bank of San Francisco. "7 Things You May Not Know About U.S. Currency." Feb. 2016.


Bureau of Engraving and Printing. "Currency Image Use." bep.gov.


Stamp Stampede. "Is Stamping Money Illegal?" Legal FAQ and opinions by Alan Levine, Esq. stampstampede.org.


Congressional Research Service. "U.S. Paper Currency: Overview and Issues." IF11414.
...
*Self-contained lexicon for: WHOSE IMAGE AND SUPERSCRIPTION? Toward a Semantic Economics of the Mint*

### Other terms attributed to this deposit

**CC BY-SA's void** — The Creative Commons license creates a legal commons — a space where material can circulate freely under specified conditions. The SA (ShareAlike) provision maintains the void: no

**CIVIC PHILOLOGY** — [NEW] — The practice of applying philological judgment (transmission history, variant readings, interpolation, emendation) to public infrastructure texts: currency, public building

**COLOPHON (monetary)** — [EXTENDED] — The signature lines on a banknote, identifying the authorized producers of the document, exactly as a colophon identifies the scribe and the scriptorium. The Treasurer

**COMPRESSED PORTRAITURE** — [NEW] — The semiotic function by which a signature performs the work of a portrait through a different medium: preserving individual identification, personal authority claim, visua

**Contested interpolation** — Trump's signature is an insertion into the textual tradition by a hand that has no authorization within the scribal chain. The Treasurer's signature was authorized by tradition — e

**DESIGN SURFACE** — [NEW] — The physical face of a monetary instrument — the ensemble of portraits, signatures, seals, serial numbers, denominations, mottos, and inscriptions — treated not as decorati

**EMENDATION (civic)** — [EXTENDED] — A correction applied by a later reader to a corrupted public text. Distinguished from interpolation (unauthorized insertion) and from vandalism (destruction without re

**EXECUTION ENVIRONMENT (monetary)** — [EXTENDED] — The design surface of currency treated not as text-to-be-read (semiotics) but as a substrate on which operators alter states. Marks on currency do not represent; they

**Emendation tradition** — The Sharpie blot — the counter-mark applied by citizens — is a corrective intervention by later readers. Like a medieval emendator who crosses out an interpolated passage while pre

**Exportability** — Civic philology is not limited to currency. The method applies to any public infrastructure text that has been subjected to unauthorized inscription:

**Fiat currency's void** — Paper money has no intrinsic value. It is not backed by gold, silver, or any commodity. Its value derives entirely from institutional trust — the collective agreement that this pie

**INTERPOLATION (monetary)** — [EXTENDED] — An unauthorized insertion into the scribal chain of a monetary text by a hand that has no place in the manuscript tradition. The presidential signature on U.S. currenc

**PROVENANCE CAPTURE** — [EXTENDED] — The attachment of a personal authority mark to a commons substrate, such that the substrate carries the sovereign's claim into every transaction. The inverse of proven

**PROVENANCE RELEASE** — [NEW] — The removal or negation of a personal authority mark from a commons substrate, restoring the substrate to un-branded condition. σ_SH performs provenance release.

**RESTORATION OPERATOR (σ_SH)** — [EXTENDED] — The formal mechanism by which commons character is returned to a substrate after extraction. σ_SH ∘ σ_SIGN = ρ. The TANG applied retroactively: not prophylactic (preve

**SCRIBAL CHAIN (monetary)** — [NEW] — The unbroken succession of authorized signatories on a monetary text. On U.S. currency: from Frances Spinner (first female Treasurer, 1861) through Lynn Malerba (2022–2026)

**SEMANTIC ECONOMICS OF THE MINT** — [NEW] — The subdiscipline that studies the design surface of monetary instruments as operative infrastructure. Its unit of analysis is the inscription-as-operator. Its method is ci

**Scribal tradition** — The unbroken chain of signatories since 1861 constitutes a scribal succession. Each new "series" of currency corresponds to a change in signatories — exactly as a new manuscript "h

**Substrate pedagogy** — The cognitive and affective conditioning that the design surface performs on the population that handles currency, through repetitive embodied contact over years of daily exchange.

**THAYER NARROWING** — [NEW] — The textual transmission event by which the 1866 Thayer Amendment's prohibition of "portrait or likeness" was codified in 31 U.S.C. § 5114 as "portrait" alone — dropping th

**Textual transmission history** — The 1866 Thayer Amendment is the originating text: "Hereafter no portrait or likeness of any living person shall be engraved or placed upon any of the bonds, securities, notes, or

**The authorization problem** — Classical emendation was performed by authorized editors — Alexandrian scholars, Renaissance humanists, biblical textual critics — working within institutional traditions. The civi

**The blot's void** — The Sharpie blot does not add a competing name. It does not replace Trump's signature with another signature. It replaces the personal claim with *nothing* — a field of black ink t

**UPSTREAM SEMANTIC CAPTURE** — [NEW] — Operations performed on the design surface of a commons substrate *before* it reaches the citizen — the sovereign's extraction of political value from the monetary medium a
