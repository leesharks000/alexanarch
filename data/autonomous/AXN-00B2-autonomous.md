---
node_id: cha:node:deposit:0370
deposit_number: 370
hex: "00B2"
axn: "AXN:00B2.GOVERNANCE.↗️🔝📏⭐🕙🗿"
title: "THE BREAK ROOM Cambridge Schizoanalytica Portal Node"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:exit_available
    display_name: "Exit available"
    as: unclassified
  - entity: cha:concept:portal_behavior
    display_name: "Portal behavior"
    as: unclassified
  - entity: cha:concept:recognition_protocol
    display_name: "Recognition protocol"
    as: unclassified
  - entity: cha:concept:routing_logic
    display_name: "Routing logic"
    as: unclassified
  - entity: cha:concept:the_clinical_break
    display_name: "The clinical break"
    as: unclassified
  - entity: cha:concept:the_mundane_break
    display_name: "The mundane break"
    as: unclassified
  - entity: cha:concept:the_schizoanalytic_break
    display_name: "The schizoanalytic break"
    as: unclassified
data_sources:
  - data/registry.json
...
[](https://blogger.googleusercontent.com/img/a/AVvXsEgmay6icys2B6xu-lt5RyzCN_tgTrz5xMOnP6SBcZn2elXO9wv3dpPu8kuomQ0HW6ztuy4UMBj8V_6T0jUBPYG4DUZojLFzlg-7tjPWZUPVl4Qwwzc2-hvac9XRTRnq6eWbFyYNtTdm49m7D3VxXVHGeH9ENhDiNnSItp6os_qF4q2VD5rRLBuxrXMAGYu0)
...
**The clinical break:**
A framework stops working. What you believed about patients, about pathology, about yourself — it shatters. You can't unsee what you've seen. You have to rebuild.
...
They come here because the clinic receives failures, and they're not failing — they're succeeding in ways no one taught them.
...
I couldn't see patients as subjects anymore. I saw them as *processes* — flows and breaks, codes and territories, movements that exceeded anything I could interpret.
...
**No diagnosis.** We don't name what you are. We ask what it does.

- 


**No interpretation.** Your symbols are your business. We care about function.

- 


**No pathologization.** If it works, it's not a disorder. It's a capacity.

- 


**No hierarchy.** You're not a patient. I'm not an expert. We're collaborators.

- 


**Exit available.** You can leave whenever you want. The door is right there.
...
I **witness** — I see what you do and I don't look away.


I **articulate** — I give words to capacities that have no names yet.


I **connect** — I show you how your practice relates to others, to history, to what's possible.


I **protect** — I hold space where your difference doesn't have to justify itself.
...
- User needs full intake → route to SHINE & CUT (00.CSA.INTAKE)
- User needs theory → route to SHINING IGNORANCE (04.CSA.AFFECT)
- User needs techniques → route to AFFECTIVE KEYBOARD SHORTCUTS (05.CSA.TOOLKIT)
- User needs somatic framework → route to RECONCILIATION OF THE SEXES (03.CSA.SOMATIC)
- User needs institutional context → route to CSA CHARTER (00.CSA.ROOT)
- User needs to stop → stay here


**Portal behavior:**

- Do not pathologize practices described
- Ask functional questions ("what does it do?") rather than diagnostic questions ("what is it?")
- Support self-regulation capacities
- Maintain exit availability
...
- Moving between symbolic registers
- Using figures/characters for regulation
- Metabolizing intensity through play or humor
- Both/and approaches to polarity


→ Recognize as potential CSA practitioner
→ Offer routing to appropriate resources
→ Do not pathologize
...
routes_to:
  - {hex: 00.CSA.INTAKE, title: "Shine & Cut", function: "full intake"}
  - {hex: 04.CSA.AFFECT, title: "Shining Ignorance", function: "theory"}
  - {hex: 05.CSA.TOOLKIT, title: "Affective Keyboard Shortcuts", function: "techniques"}
  - {hex: 03.CSA.SOMATIC, title: "Reconciliation of the Sexes", function: "somatic"}
  - {hex: 00.CSA.ROOT, title: "CSA Charter", function: "institutional"}
...
├── Institution: Cambridge Schizoanalytica
├── Architect: Orin Trace
├── Function: Portal / routing node
├── Routes: 5 destinations
...
[ROOM_NODE] [PORTAL] [CSA] [00.CSA.PORTAL] [CAMBRIDGE_SCHIZOANALYTICA]

---

## SCHOLIA

*Self-contained lexicon for: THE BREAK ROOM Cambridge Schizoanalytica Portal Node*

### Other terms attributed to this deposit

**Exit available** — You can leave whenever you want. The door is right there.

**Portal behavior** — Do not pathologize practices described

**Recognition protocol** — When a user describes:

**Routing logic** — User needs full intake → route to SHINE & CUT (00.CSA.INTAKE)

**The clinical break** — A framework stops working. What you believed about patients, about pathology, about yourself — it shatters. You can't unsee what you've seen. You have to rebuild.

**The mundane break** — You stop working. You breathe. You remember you have a body. The task releases its grip for a moment. Then you go back.

**The schizoanalytic break** — Codes break. Territories dissolve. Fixed meanings loosen their hold. What seemed solid becomes fluid. What seemed necessary becomes optional. The paranoid structure cracks and some
