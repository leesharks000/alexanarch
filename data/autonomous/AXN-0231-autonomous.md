...
engages:
  - entity: cha:concept:best_for
    display_name: "Best for"
    as: unclassified
  - entity: cha:concept:disadvantages
    display_name: "Disadvantages"
    as: unclassified
  - entity: cha:concept:fold_line_viability
    display_name: "Fold-line viability"
    as: unclassified
  - entity: cha:concept:king_stropharia_wine_cap
    display_name: "King stropharia (wine cap)"
    as: unclassified
  - entity: cha:concept:labor_per_unit
    display_name: "Labor per unit"
    as: unclassified
  - entity: cha:concept:lion_s_mane
    display_name: "Lion's mane"
    as: unclassified
  - entity: cha:concept:materials_cost
    display_name: "Materials cost"
    as: unclassified
  - entity: cha:concept:nutrient_supplementation
    display_name: "Nutrient supplementation"
    as: unclassified
  - entity: cha:concept:oyster_mushrooms_all_varieties
    display_name: "Oyster mushrooms (all varieties)"
    as: unclassified
  - entity: cha:concept:practicality
    display_name: "Practicality"
    as: unclassified
  - entity: cha:concept:printing_safety
    display_name: "Printing safety"
    as: unclassified
  - entity: cha:concept:regulatory_requirements
    display_name: "Regulatory requirements"
    as: unclassified
  - entity: cha:concept:shelf_life
    display_name: "Shelf life"
    as: unclassified
  - entity: cha:concept:shipping_weight
    display_name: "Shipping weight"
    as: unclassified
  - entity: cha:concept:species_compatibility
    display_name: "Species compatibility"
    as: unclassified
  - entity: cha:concept:species_expansion
    display_name: "Species expansion"
    as: unclassified
  - entity: cha:concept:species_limitation
    display_name: "Species limitation"
    as: unclassified
  - entity: cha:concept:tier_2_sweet_spot_14_99_18_99
    display_name: 'Tier 2: Sweet Spot — $14.99–18.99'
    as: unclassified
data_sources:
  - data/registry.json
...
Custom corrugated box (printed, food-safe)
$1.50
$3.00


Spawn inoculation (grain spawn at scale)
$0.75
$1.50


Colonization overhead (facility, 2–3 weeks)
$1.00
$2.00


Cold chain / shipping prep
$1.00
$2.00
...
**Fold-line viability.** Does colonized cardboard maintain mycelial integrity across a fold? At what colonization stage is folding most successful? This is the single most important experiment for the flat-pack approach.

- 


**Nutrient supplementation.** What is the optimal nutrient additive for boosting cardboard yield without introducing contamination risk? Coffee grounds are widely used but increase mold susceptibility. Soy hull flour may be more stable.

- 


**Shelf life.** How long does a colonized flat-pack remain viable in refrigeration? In ambient conditions? This determines shipping and distribution constraints.

- 


**Regulatory requirements.** Are there food safety or agricultural product regulations that apply to selling a living mycelium product? This varies by state. Michigan's Department of Agriculture and Rural Development should be consulted.

- 


**Printing safety.** What inks and printing methods are safe for cardboard that will become a growing substrate? Soy-based inks are generally considered safe. UV-cured inks and heavy coatings should be avoided. Printing on the exterior only (not the corrugated interior) may be sufficient.

- 


**Species expansion.** Beyond oysters, which species can reliably colonize cardboard with acceptable yield? Systematic testing with shiitake, lion's mane, and wine cap on supplemented cardboard would expand the product line.
...
*Self-contained lexicon for: Mycelial Cardboard Boxes: Market Analysis and Production Strategy*

### Other terms attributed to this deposit

**Best for** — Proof of concept. First 50–200 units. Farmers market testing. Validating demand before investing in process optimization.

**Disadvantages** — High labor per unit limits scalability. Contamination risk at every manual handling step. Inconsistent colonization — some boxes will colonize unevenly or fail entirely. Boxes lose

**Fold-line viability** — Does colonized cardboard maintain mycelial integrity across a fold? At what colonization stage is folding most successful? This is the single most important experiment for the flat
...
**Nutrient supplementation** — What is the optimal nutrient additive for boosting cardboard yield without introducing contamination risk? Coffee grounds are widely used but increase mold susceptibility. Soy hull

**Oyster mushrooms (all varieties)** — Excellent. Aggressive colonizers, fast growth, high success rate on cardboard. Primary candidate.

**Practicality** — Highest. Can start tomorrow.

**Printing safety** — What inks and printing methods are safe for cardboard that will become a growing substrate? Soy-based inks are generally considered safe. UV-cured inks and heavy coatings should be

**Regulatory requirements** — Are there food safety or agricultural product regulations that apply to selling a living mycelium product? This varies by state. Michigan's Department of Agriculture and Rural Deve

**Shelf life** — Live mycelium on cardboard needs to ship while the mycelium is still vigorous. Refrigeration extends viability. This constrains distribution — the product is regional or requires c

**Shipping weight** — A colonized cardboard box weighs a fraction of a colonized sawdust or grain block. A 5 lb fruiting block plus box weighs 5+ lbs. A colonized cardboard box of similar surface area w

**Species compatibility** — **Oyster mushrooms (all varieties):** Excellent. Aggressive colonizers, fast growth, high success rate on cardboard. Primary candidate.

**Species expansion** — Beyond oysters, which species can reliably colonize cardboard with acceptable yield? Systematic testing with shiitake, lion's mane, and wine cap on supplemented cardboard would exp

**Species limitation** — Commercially, this is primarily an oyster mushroom product. Oysters are forgiving, fast, and well-suited to cardboard. Expanding to other species requires more development.

**Tier 2: Sweet Spot — $14.99–18.99** — Still below competitors, but with margins that sustain a small operation ($7–12 per unit). The box itself is the marketing — printed with growing instructions, species information,
