...
engages:
  - entity: cha:concept:parent_deposit
    display_name: "Parent deposit"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: EA-SPXI-09.1: SPXI ROI — Operational and Visibility Returns*
