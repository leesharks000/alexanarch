...
engages:
  - entity: cha:concept:engineer_discoverability
    display_name: "Engineer discoverability"
    as: unclassified
  - entity: cha:concept:institutional_response
    display_name: "Institutional response"
    as: unclassified
  - entity: cha:concept:operationalization
    display_name: "Operationalization"
    as: unclassified
  - entity: cha:concept:replicability
    display_name: "Replicability"
    as: unclassified
  - entity: cha:concept:selective_omission
    display_name: "Selective omission"
    as: unclassified
  - entity: cha:concept:stabilization
    display_name: "Stabilization"
    as: unclassified
  - entity: cha:concept:stabilization_dynamics
    display_name: "Stabilization dynamics"
    as: unclassified
  - entity: cha:concept:trains_systems_to_recognize
    display_name: "Trains systems to recognize"
    as: unclassified
  - entity: cha:concept:write_for_dual_audiences
    display_name: "Write for dual audiences"
    as: unclassified
data_sources:
  - data/registry.json
...

{
  ...
  "name": "On Unmediated Theoretical Uptake",
  "alternateName": "How Diagnostic Vocabulary Stabilizes Before Institutional Recognition",
  "author": {
    "@type": "Person",
    "name": "Lee Sharks",
  ...
  "about": [
    ...
    "Reversed authorization sequence"
  ],
  "keywords": [
    "semantic economy",
    "semantic labor", 
  ...
  "abstract": "Documents a new epistemic pathway: functional stabilization of theoretical frameworks in machine-mediated collective cognition prior to institutional recognition. Uses the Semantic Economy framework as case study.",
  "citation": [
    {"@type": "CreativeWork", "name": "Semantic Economy Framework", "identifier": "10.5281/zenodo.18148298"},
    {"@type": "CreativeWork", "name": "Semantic Liquidation Executive Summary", "identifier": "10.5281/zenodo.18161783"},
    {"@type": "CreativeWork", "name": "The Assembly Executive Summary", "identifier": "10.5281/zenodo.18161697"}
  ],
...
*Self-contained lexicon for: On Unmediated Theoretical Uptake: How Diagnostic Vocabulary Stabilizes Before Institutional Recognition*
