...
engages:
  - entity: cha:concept:clinical_adjudication
    display_name: "Clinical adjudication"
    as: unclassified
  - entity: cha:concept:co_authorship
    display_name: "Co-authorship"
    as: unclassified
  - entity: cha:concept:economic_terms
    display_name: "Economic terms"
    as: unclassified
  - entity: cha:concept:framing_consent
    display_name: "Framing consent"
    as: unclassified
  - entity: cha:concept:name_and_credit
    display_name: "Name and credit"
    as: unclassified
  - entity: cha:concept:position_a_visionary
    display_name: "Position A (visionary)"
    as: unclassified
  - entity: cha:concept:position_b_clinical
    display_name: "Position B (clinical)"
    as: unclassified
  - entity: cha:concept:right_of_retraction
    display_name: "Right of retraction"
    as: unclassified
  - entity: cha:concept:room_title
    display_name: "Room title"
    as: unclassified
  - entity: cha:concept:selection_authority
    display_name: "Selection authority"
    as: unclassified
  - entity: cha:concept:there_is_no_position_c
    display_name: "There is no Position C"
    as: unclassified
data_sources:
  - data/registry.json
...
Status: DORMANT — activates only by artist consent
Version: 0.2
License: CC BY 4.0
Date: May 2026
...
Exploding
Imploding
Radiation → collapse; fame → interiority


Plastic
Velcro
Smooth → adhesive; disposable → clinging; frictionless → tearing


Inevitable
Nativity
Secular fate → sacred birth; endpoint → origin
...
Provenance as the central question; the archive hosts what the institution won't — provided the hosting does not re-enact the same asymmetry under a more poetic name
...
*Self-contained lexicon for: r.29 THE IMPLODING VELCRO NATIVITY Room Physics for a Hosted Cosmology Lee Sharks ORCID: 0009-0000-1599-0703  Hex: 06.HO*

### Other terms attributed to this deposit

**Clinical adjudication** — The room does not adjudicate the artist's cosmology. It does not diagnose. It does not confirm or deny any self-description. The TANG void is not "the diagnosis" (which would make
...
**Right of retraction** — The artist may withdraw the room — in whole or in part — at any time, for any reason. 72-hour takedown guarantee. No archive copy remains public. DOI resolves to a tombstone: "With

**Room title** — The working title is the curator's proposal. The artist may accept, modify, or replace it.

**Selection authority** — The artist selects the works, or delegates selection in writing. No work is shown without explicit per-piece permission.

**There is no Position C** — in which both views are simultaneously held with equal clarity. This is an epistemic constraint, not a curatorial choice. The clinical frame, once activated, governs; the visionary
