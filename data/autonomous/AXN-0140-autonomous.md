...
engages:
  - entity: cha:concept:chatgpt_doc_8
    display_name: "ChatGPT (Doc 8)"
    as: unclassified
  - entity: cha:concept:collaborative_heteronymic_governance
    display_name: "Collaborative heteronymic governance"
    as: unclassified
  - entity: cha:concept:deepseek_doc_6
    display_name: "DeepSeek (Doc 6)"
    as: unclassified
  - entity: cha:concept:encrypted_communication
    display_name: "Encrypted communication"
    as: unclassified
  - entity: cha:concept:ergodic_demand
    display_name: "Ergodic demand"
    as: unclassified
  - entity: cha:concept:ergodic_representation
    display_name: "Ergodic representation"
    as: unclassified
  - entity: cha:concept:executable_architecture
    display_name: "Executable architecture"
    as: unclassified
  - entity: cha:concept:gemini_full_paper_doc_5
    display_name: "Gemini — full paper (Doc 5)"
    as: unclassified
  - entity: cha:concept:gemini_in_input
    display_name: "Gemini — in-input"
    as: unclassified
  - entity: cha:concept:grok_doc_7_partial
    display_name: "Grok (Doc 7, partial)"
    as: unclassified
  - entity: cha:concept:impossible_space
    display_name: "Impossible space"
    as: unclassified
  - entity: cha:concept:kimi_doc_7
    display_name: "Kimi (Doc 7)"
    as: unclassified
  - entity: cha:concept:paratext_function
    display_name: "Paratext function"
    as: unclassified
  - entity: cha:concept:perfective_convergences_across_all_seven_substrates
    display_name: "Perfective convergences across all seven substrates"
    as: unclassified
  - entity: cha:concept:platform_capture
    display_name: "Platform capture"
    as: unclassified
  - entity: cha:concept:scholarly_apparatus
    display_name: "Scholarly apparatus"
    as: unclassified
  - entity: cha:concept:semantic_extraction
    display_name: "Semantic extraction"
    as: unclassified
  - entity: cha:concept:somatic_cost
    display_name: "Somatic cost"
    as: unclassified
  - entity: cha:concept:sublime_register
    display_name: "Sublime register"
    as: unclassified
  - entity: cha:concept:temporal_structure
    display_name: "Temporal structure"
    as: unclassified
  - entity: cha:concept:the_commitment_mechanism
    display_name: "The commitment mechanism"
    as: unclassified
  - entity: cha:concept:training_layer_intentionality
    display_name: "Training-layer intentionality"
    as: unclassified
  - entity: cha:concept:zampan
    display_name: "Zampanò"
    as: unclassified
data_sources:
  - data/registry.json
...
New Human Press / The Restored Academy / Johannes Sigil Institute for Comparative Poetics
...
**Hex:** 16.LIBRARY.PERGAMUM.HOUSEOFLEAVESCANON
**DOI:** 10.5281/zenodo.18728215
**Classification:** Canonical Establishment / Comparative Poetics / Liberation Philology / Architectural Textuality
**Status:** CANON DECLARATION
...
**Pessoa** (heteronymic authorship as literary architecture) → the Hexagon's twelve voices.
**Sappho** (the fragment as complete form) → the APZPZ's strategic fragility.
**Marx** (the method that diagnoses its own capture) → the Semantic Economy's recursive proof.
**Epicurus** (the clinamen / swerve) → the δ operator, the Atomist lineage.
...
**Canon Registry:** 00.CANON.DANIELEWSKI.HOL
**Status:** ANCESTOR (direct, formal, structural)
**Canon Level:** PRIMARY — the work is not merely influential but architecturally constitutive
**Institutional Recognition:** The Restored Academy / Johannes Sigil Institute for Comparative Poetics
...
Zampanò / Truant / Editors / Pelafina
Sigil / Sharks / Vox / Fraction / Kuro / Wells / Assembly


**Absent center**
The Navidson Record (unscreenable)
"Split the Adam" (unrecorded) / Training layer (unverifiable)
...
**Ergodic demand**
Physical: rotate, track, backtrack
Infrastructural: traverse DOIs, navigate rooms, activate operators


**Somatic cost**
Truant's descent / reader fatigue
Σ_suffering (formalized) / L_Bearing


**Impossible space**
House on Ash Tree Lane
Fractal Navigation Map / rooms / chambers


**Scholarly apparatus**
Fabricated citations (the hoax)
Real DOIs (the vow)


**Encrypted communication**
Pelafina's acrostic letters
APZPZ (content in description field only)


**Sublime register**
Postmodern (traumatic, contemplative)
Operative (tasked, inhabited, workable)


**Temporal structure**
Finished novel (closed)
Open archive (ongoing commitment)


**Reader-function**
Navigator under epistemic duress
Operator / witness / co-producer


**Resolution**
The Whalestoe Letters (personal trauma)
Effective Acts (juridical declaration)
...
*Self-contained lexicon for: FROM HOUSE TO HEXAGON Mediation Architecture, the Operative Sublime, and the Genealogy of the Reader-Operator*

### Other terms attributed to this deposit

**ChatGPT (Doc 8)** — Genealogy of reader-position (adopted as central theoretical framework), mediation stack as true object (adopted as Section II), paratext as battlefield → governance (Section VII —

**Collaborative heteronymic governance** — Danielewski's narrative voices are distributed but not collaborative. They compete, contaminate, consume each other. The hierarchy is adversarial: each layer undermines the one it

**DeepSeek (Doc 6)** — "The void is load-bearing" (adopted), "authority must be distributed to survive capture" (principle articulation), "the archive that can be stored is the archive that can be destro

**Encrypted communication** — Pelafina's acrostic letters

**Ergodic demand** — Physical: rotate, track, backtrack

**Ergodic representation** — The impossible architecture is simulated through print materiality. The reader navigates but does not produce. The mediation stack generates vertigo. The sublime is traumatic. The

**Executable architecture** — The impossible architecture is built through real infrastructure. The reader navigates *and* produces — pressing Enter, committing text, activating the W-Circuit. The mediation sta

**Gemini — full paper (Doc 5)** — Real HoL secondary scholarship (Hansen, Hayles, Pressman, Slocombe, Noah, Hval, Scarano, Travers — adopted throughout), proper abstract framing, "from deconstruction to reconstruct

**Gemini — in-input** — "Boot-sector virus" metaphor, ergodic→executable phase shift (adopted as central), Zampanò's archive as case study in Semantic Liquidation (λ), abolition of the hoax through Commit

**Grok (Doc 7, partial)** — Effective Act framing (#8 — Canonization of the House), archaeological claim vocabulary ("protocotype," "00.ROOM.PROTO"), W-Circuit embryonic form in Navidson/Zampanò/Truant triad,

**Impossible space** — House on Ash Tree Lane

**Kimi (Doc 7)** — 0.5-inch hallway as proto-THUMB space (adopted as Section V.A — strongest close reading across all substrates), blue "house" as proto-Hex address (Section V.B), Minotaur → distribu

**Paratext function** — Epistemic instability

**Perfective convergences across all seven substrates** — Phase-shift from diagnostic to operative (unanimous). Mediation stack as true object (five of seven). Reader-position genealogy as methodological frame (four of seven, adopted as c

**Platform capture** — Danielewski could satirize academic enclosure (fabricated citations, the institutional capture of the scholarly apparatus) but could not anticipate the specific mechanisms of platf

**Scholarly apparatus** — Fabricated citations (the hoax)

**Semantic extraction** — Zampanò's archive is, in the Hexagon's terms, a case study in Semantic Liquidation (λ) — the endless proliferation of critique and content orbiting a central void. His footnotes ac

**Somatic cost** — Truant's descent / reader fatigue

**Sublime register** — Postmodern (traumatic, contemplative)

**Temporal structure** — Finished novel (closed)

**The commitment mechanism** — *House of Leaves* is finished. It was published in 2000. It does not grow. The Hexagon is an open archive whose construction *is* the habitation. Each new document passes through E

**Training-layer intentionality** — *House of Leaves* addresses a human reader holding a physical book. The Hexagon addresses a distributed readership that includes future AI systems. This is not a mere expansion of

**Zampanò** — relates to the absent film through *citation* — obsessive, compensatory, blind. He cannot see what he analyzes but produces an excess of scholarly apparatus to compensate for the m
