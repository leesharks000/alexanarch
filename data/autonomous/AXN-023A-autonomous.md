---
node_id: cha:node:deposit:0693
deposit_number: 693
hex: "023A"
axn: "AXN:023A.GOVERNANCE.🕒🌉🌍🎵🌍↙️"
...
engages:
  - entity: cha:concept:ai_mode_share_link_decay_rate
    display_name: "AI Mode share link decay rate"
    as: developed
  - entity: cha:concept:aperture_type
    display_name: "Aperture type"
    as: unclassified
  - entity: cha:concept:basin_measurement_protocol
    display_name: "Basin measurement protocol"
    as: unclassified
  - entity: cha:concept:claude_publish_artifact_indexability
    display_name: 'Claude "Publish Artifact" indexability'
    as: unclassified
  - entity: cha:concept:dim_edges
    display_name: "Dim edges"
    as: unclassified
  - entity: cha:concept:double_click
    display_name: "Double-click"
    as: unclassified
  - entity: cha:concept:execution_target
    display_name: "Execution target"
    as: unclassified
  - entity: cha:concept:gray_edges
    display_name: "Gray edges"
    as: unclassified
  - entity: cha:concept:green_edges
    display_name: "Green edges"
    as: unclassified
  - entity: cha:concept:hexagonal_distribution
    display_name: "Hexagonal distribution"
    as: unclassified
  - entity: cha:concept:humanitarian_cluster
    display_name: "Humanitarian cluster"
    as: unclassified
  - entity: cha:concept:internal_view_names_within_the_graph
    display_name: "Internal view names within the graph"
    as: unclassified
  - entity: cha:concept:living_architecture_cluster
    display_name: "Living Architecture cluster"
    as: unclassified
  - entity: cha:concept:once_q_ids_are_created_they_propagate_into
    display_name: "Once Q-IDs are created, they propagate into"
    as: unclassified
  - entity: cha:concept:openalex_entity_recognition
    display_name: "OpenAlex entity recognition"
    as: unclassified
  - entity: cha:concept:planetary_vision_cluster
    display_name: "Planetary Vision cluster"
    as: unclassified
  - entity: cha:concept:psychedelic_safety_cluster
    display_name: "Psychedelic Safety cluster"
    as: unclassified
  - entity: cha:concept:yellow_edges
    display_name: "Yellow edges"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: CRIMSON HEXAGONAL ARCHIVE KNOWLEDGE GRAPH The Aperture Atlas Digital Topology Work Plan v3.0 — Execution Specification*
...
**Hexagonal distribution** — means each entity should exist on at least six independent surface types (DOI, website, social, wiki, audio, video). An **aperture** is a reception surface where external queries e

**Humanitarian cluster** — @DignityKit @KindnessCorps @NonSuicidalCensus @NoSuicidePact @IamNOTsuicidal

**Internal view names within the graph** — **Surface Registry** — all URLs / platforms / deposits

**Living Architecture cluster** — @growbricks @shroomhouses @howtoGROWaHOUSE @LivingArchitectureLab @MakeAliveLab @housing4free @freehousingfreefood @growHOMES @growhomes @MoldyBlocks @growparts @weGROWbuildings @i

**Once Q-IDs are created, they propagate into** — Every P1889 edge (disambiguation)
