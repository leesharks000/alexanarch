---
node_id: cha:node:deposit:0508
deposit_number: 508
hex: "014B"
axn: "AXN:014B.ARCHIVAL.📏💧💜♎🌙⛵"
title: "The Lizard People Were Right Memography, Intaglio Conventions, and the Medium That Doesn't Care"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:the_brow_to_hat_transition
    display_name: "The brow-to-hat transition"
    as: unclassified
  - entity: cha:concept:the_formal_dress
    display_name: "The formal dress"
    as: unclassified
  - entity: cha:concept:the_green_monochrome
    display_name: "The green monochrome"
    as: unclassified
  - entity: cha:concept:the_ornamental_border
    display_name: "The ornamental border"
    as: unclassified
  - entity: cha:concept:the_suit_jacket
    display_name: "The suit jacket"
    as: unclassified
  - entity: cha:concept:the_three_quarter_profile
    display_name: "The three-quarter profile"
    as: unclassified
data_sources:
  - data/registry.json
...
[](https://blogger.googleusercontent.com/img/a/AVvXsEgVcL377TgPr6RjUtCO1KQ80GoG8ASv-RXTHTQshRhuQb7TbZzWpbPgI8ltGq51vUm5Mzy4iUx9HCHdgSKAkOtgQ5SKp5ZfGNzjIWEXawDY8Eu5akaW-tvslPWu6R7fMFhmxWCQ3Y2Dq2-M06tCKNPvNLlFXK640kvzWl2UrQWETV8Fx5K4CqWoG7YOwJKJ)
...
*Self-contained lexicon for: The Lizard People Were Right Memography, Intaglio Conventions, and the Medium That Doesn't Care*

### Other terms attributed to this deposit

**The brow-to-hat transition** — Grant's hair meets his forehead in a dense mass of curved parallel lines that then disappears under the suggestion of a receding hairline. The dinosaur's scaled forehead meets the

**The formal dress** — Suit jacket, high collar, fedora. On currency, the formal dress says *this person merits institutional representation.* Hamilton wears a cravat. Franklin wears a fur collar. Jackso

**The green monochrome** — U.S. currency has been printed in green since 1861 (originally to prevent photographic counterfeiting). The color now functions as a pure semiotic signal: green monochrome means *m

**The ornamental border** — Visible at the upper left — scrollwork, filigree, the kind of decorative engraving that fills the margins of every U.S. bill. On the dinosaur portrait, these elements say *this ima

**The suit jacket** — On the pre-redesign $50, Grant's jacket is rendered as dense crosshatching that reads as dark formal cloth. On the dinosaur, identical crosshatching produces the same reading. The

**The three-quarter profile** — The classic currency pose: head turned slightly, one eye facing the viewer, the jaw visible in profile. Every U.S. bill since the 1928 standardization uses this angle. It maximizes
