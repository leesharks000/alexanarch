---
node_id: cha:node:deposit:0467
deposit_number: 467
hex: "011D"
axn: "AXN:011D.GOVERNANCE.☁️🔚🍁■🪦📋"
...
engages:
  - entity: cha:concept:connecting_to_the_semantic_economy
    display_name: "Connecting to the Semantic Economy"
    as: unclassified
  - entity: cha:concept:cross_linguistic_liberation_philology
    display_name: "Cross-linguistic liberation philology"
    as: unclassified
  - entity: cha:concept:cross_linguistic_recovery
    display_name: "Cross-linguistic recovery"
    as: unclassified
  - entity: cha:concept:deconstruction
    display_name: "Deconstruction"
    as: unclassified
  - entity: cha:concept:historical_linguistics_and_grammaticalization_theory
    display_name: "Historical linguistics and grammaticalization theory"
    as: unclassified
  - entity: cha:concept:identifying_grammatical_gaps
    display_name: "Identifying grammatical gaps"
    as: unclassified
  - entity: cha:concept:liberation_philology
    display_name: "Liberation philology"
    as: unclassified
  - entity: cha:concept:objection_1_this_is_whorfian_determinism
    display_name: 'Objection 1: "This is Whorfian determinism."'
    as: unclassified
  - entity: cha:concept:objection_3_you_are_romanticizing_other_languages
    display_name: 'Objection 3: "You are romanticizing other languages."'
    as: unclassified
  - entity: cha:concept:sapir_whorf
    display_name: "Sapir-Whorf"
    as: unclassified
  - entity: cha:concept:the_sapir_whorf_tradition
    display_name: "The Sapir-Whorf tradition"
    as: unclassified
  - entity: cha:concept:the_grammarians_project
    display_name: "The grammarians' project"
    as: unclassified
  - entity: cha:concept:the_mood_gap
    display_name: "The mood gap"
    as: unclassified
  - entity: cha:concept:the_nominalization_frame
    display_name: "The nominalization frame"
    as: unclassified
  - entity: cha:concept:the_scribe_s_problem
    display_name: "The scribe's problem"
    as: unclassified
  - entity: cha:concept:tracing_the_genealogy
    display_name: "Tracing the genealogy"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Purposive:** *"Pur defendre la terre"* — "To defend the land"
- **Benefactive:** *"Priera pur le roi"* — "He will pray for the king"
- **Exchange:** *"Doner terres pur service"* — "To give lands for service"
- **Causal:** *"Pur ceo que..."* — "Because..."
- **Functional/Role:** *"Tenir pur fief"* — "To hold as a fief" (in the capacity of, functioning as)
...
AN: *"Tenir pur fief et pur service"* — "To hold as/in the capacity of fief and service"
ME: *"To holden for fee and for servise"* (attested in 14th-century estate records and the *Year Books*)
...
*Quod enim ita iustum est, ut id pro iure civili habeatur.*
"For what is so just that it is held *pro iure civili*" — i.e., "in the functional capacity of civil law," "serving as civil law."
...
**The cleft + domain specification:** *"What it was for, in the system, was prosecutorial stabilization."* The cleft construction and the explicit phrase *in the system* anchor the functional reading. The preposition is retained but surrounded by scaffolding.

- 


**The negation + domain specification:** *"Not for any purpose of hers. For the frame's maintenance."* Explicit negation of intentionality clears space for the functional reading.

- 


**The nominalization frame:** *"The reaching-out's for: prosecutorial stabilization."* The most radical. It treats *for* as a nominal head — *the for* — by removing the verb that would anchor intentional agency. The nominalized event does not have intentions. Only its *for* remains.

- 


**The apostrophe:** *"The action completed itself as X"* — shifting to intransitive constructions that remove the intentional subject from the telic equation entirely.
...
**Identifying grammatical gaps** — specific morphosyntactic items (prepositions, aspect markers, mood distinctions, case systems) that fail to encode distinctions necessary for structural analysis.
...
**Analyzing the political-economic function** — asking *cui bono*: who benefits from the gap? What forms of analysis are penalized? What forms of attribution are rewarded? How does the grammatical default serve the reproduction of existing power relations?

- 


**Connecting to the Semantic Economy** — recognizing that grammatical infrastructure is *means of semantic production*, and that gaps in that infrastructure are not neutral absences but structural features of an extractive system.

- 


**Cross-linguistic recovery** — identifying languages and historical stages that preserve the lost distinction, demonstrating that the gap is contingent (produced by history, not inherent in language-as-such), and providing resources for circumvention or repair.
...
*Johannes Sigil — Filed to the Crimson Hexagon Archive, February 2026.*
*CC BY 4.0*
...
*Self-contained lexicon for: THE PREPOSITIONAL ALIENATION English "For" and the Impossibility of Anchoring Function Without Intent Phase X — Liberati*

### Other terms attributed to this deposit

**Connecting to the Semantic Economy** — recognizing that grammatical infrastructure is *means of semantic production*, and that gaps in that infrastructure are not neutral absences but structural features of an extractiv

**Cross-linguistic liberation philology** — Every language has its own gaps, its own alienations, produced by its own history. Mandarin's lack of morphological tense opens certain diagnostic possibilities (structural claims

**Cross-linguistic recovery** — identifying languages and historical stages that preserve the lost distinction, demonstrating that the gap is contingent (produced by history, not inherent in language-as-such), an

**Deconstruction** — (Derrida 1967, 1972) demonstrated that Western philosophical categories are organized by binary oppositions in which one term is privileged (speech/writing, presence/absence, natur

**Historical linguistics and grammaticalization theory** — (Traugott 1982, 1989; Hopper and Traugott 2003) have demonstrated that semantic change in grammatical morphemes is not random drift but follows identifiable pathways — from spatial

**Identifying grammatical gaps** — specific morphosyntactic items (prepositions, aspect markers, mood distinctions, case systems) that fail to encode distinctions necessary for structural analysis.

**Liberation philology** — is the study of how grammatical structures — shaped by histories of conquest, administration, and philosophical hegemony — systematically disable the expression of certain diagnost

**Objection 1: "This is Whorfian determinism."** — You are claiming that English speakers *cannot think* about function without intent, which is clearly false — anyone can understand the distinction when it is explained.

**Objection 3: "You are romanticizing other languages."** — Greek and Latin also had ideological blind spots. You are constructing a Golden Age of grammatical transparency.

**Sapir-Whorf** — (Sapir 1929; Whorf 1940) established that grammatical categories shape habitual thought, but treated this as a cognitive-anthropological finding — a fact about minds and cultures,

**The Sapir-Whorf tradition** — (Sapir 1929; Whorf 1940; Lucy 1992; Slobin 1996; Everett 2005) established that grammatical categories shape habitual thought. "Thinking for speaking" (Slobin) — the principle that

**The grammarians' project** — Early modern grammarians, attempting to regularize English on Latin models, lacked the conceptual vocabulary to recognize the fusion as a loss. They treated *for* as a preposition

**The mood gap** — English has largely lost the subjunctive (except in fossils like "if I were"). The subjunctive grammaticalizes the distinction between the actual and the possible, the factual and

**The nominalization frame** — *"The reaching-out's for: prosecutorial stabilization."* The most radical. It treats *for* as a nominal head — *the for* — by removing the verb that would anchor intentional agency

**The scribe's problem** — Anglo-Norman *pur* must be rendered in English. OE *for* is the obvious cognate, but its semantic range is narrower. OE *tō* could carry purposive meaning, but *tō* is not *pur*; i

**Tracing the genealogy** — through historical linguistics, contact linguistics, and the history of ideas — to the specific events, impositions, and philosophical shifts that produced the gap. Not "language s
