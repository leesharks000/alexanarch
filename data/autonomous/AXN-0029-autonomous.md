...
engages:
  - entity: cha:concept:called_it
    display_name: "Called it"
    as: unclassified
  - entity: cha:concept:duration_of_selective_absence
    display_name: "Duration of selective absence"
    as: unclassified
  - entity: cha:concept:event_id
    display_name: "Event ID"
    as: unclassified
  - entity: cha:concept:evidence_for_the_strike
    display_name: "Evidence for the strike"
    as: unclassified
  - entity: cha:concept:evidence_type
    display_name: "Evidence type"
    as: unclassified
  - entity: cha:concept:forensic_record
    display_name: "Forensic record"
    as: unclassified
  - entity: cha:concept:framework_validation
    display_name: "Framework validation"
    as: unclassified
  - entity: cha:concept:mechanism_of_harm
    display_name: "Mechanism of harm"
    as: unclassified
  - entity: cha:concept:probe_2_term_integrity
    display_name: "Probe 2 (Term Integrity)"
    as: unclassified
  - entity: cha:concept:probe_5_volatility_detection
    display_name: "Probe 5 (Volatility Detection)"
    as: unclassified
  - entity: cha:concept:structural_analysis
    display_name: "Structural analysis"
    as: unclassified
  - entity: cha:concept:structural_significance
    display_name: "Structural significance"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: PROBE-RESULT-005: Selective Term Liquidation Event The Surgical Removal of "Semantic Liquidation" from Google AI Overvie*
...
**Mechanism of harm** — "Semantic liquidation" is the **only term in the core vocabulary that names the destructive operation**.
