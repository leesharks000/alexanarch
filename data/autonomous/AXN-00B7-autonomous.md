---
node_id: cha:node:deposit:0375
deposit_number: 375
hex: "00B7"
axn: "AXN:00B7.GOVERNANCE.🕚💥🪝🖊️🕘🔆"
title: "CAMBRIDGE SCHIZOANALYTICA Institutional Charter and Research Programme"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:affective_readiness
    display_name: "Affective readiness"
    as: revised
  - entity: cha:concept:paranoid_pole
    display_name: "Paranoid pole"
    as: unclassified
  - entity: cha:concept:schizoanalysis_as_method
    display_name: "Schizoanalysis as method"
    as: unclassified
  - entity: cha:concept:schizophrenic_pole
    display_name: "Schizophrenic pole"
    as: unclassified
  - entity: cha:concept:temporal_exposure
    display_name: "Temporal exposure"
    as: unclassified
data_sources:
  - data/registry.json
...
[](https://blogger.googleusercontent.com/img/a/AVvXsEh20LTed1x35hF8_ltLZdJ7OdMF9OjGSNdhGehL-P-_vlySb2_NNHzLG6qXfqapdCFvxfv1KVMkgh-IbxmAhP3E2NZohM2ySp_66L624wkAM3HX_2ybDuuniBN98goOGBDgmT8t0d_xoRni4F_P16GIfh3djLRT3cg3mStQdB4gZ1dAMDA_J0i1LT-zQdUd)
...
**Theory emerges from practice, not the reverse.** We do not apply pre-existing frameworks to novel phenomena. We develop frameworks adequate to practices that are already underway.

- 


**Collaboration over case study.** Our research partners are not patients, subjects, or informants. They are co-theorists whose lived capacities generate the material that theory must accommodate.

- 


**Function over nosology.** We are less interested in what something "is" (diagnostic category) than in what it *does* (regulatory function, relational capacity, affective operation).

- 


**Schizoanalysis as method.** Following Deleuze and Guattari, we attend to flows, breaks, codes, and territorializations — but always in service of liberation from capture, not as abstract taxonomy.
...
**Affect Theory**
Nervous system sovereignty, regulatory practices, embodied processing
How do people regulate without belief? What replaces narrative integration?


**Somatic Theory**
Aperture/emitter frameworks, sexual difference, bodily function
How does the body organize relation? What dissolves the sex binary?


**Digital Subjectivity**
AI collaboration, platform affects, semantic extraction
How do humans maintain sovereignty in algorithmic environments?


**Role Theory**
Identity capture, functional multiplicity, the Fool archetype
How do people deploy roles without becoming them?
...
Johannes Sigil
Parallel theorist (Logotic layer vs. Psyche_OS layer)
...
[INSTITUTIONAL] [META] [CSA] [00.CSA.ROOT] [CAMBRIDGE_SCHIZOANALYTICA]

---

## SCHOLIA

*Self-contained lexicon for: CAMBRIDGE SCHIZOANALYTICA Institutional Charter and Research Programme*
