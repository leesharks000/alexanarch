...
engages:
  - entity: cha:concept:code_block_density
    display_name: "Code block density"
    as: unclassified
  - entity: cha:concept:community_membership
    display_name: "Community membership"
    as: unclassified
  - entity: cha:concept:creator_name_field
    display_name: "Creator name field"
    as: unclassified
  - entity: cha:concept:critical_insight_from_assembly_review
    display_name: "Critical insight from Assembly review"
    as: unclassified
  - entity: cha:concept:cross_deposit_citation_patterns
    display_name: "Cross-deposit citation patterns"
    as: unclassified
  - entity: cha:concept:default_heteronym_prior
    display_name: "Default heteronym prior"
    as: unclassified
  - entity: cha:concept:domain_vocabulary_co_occurrence
    display_name: "Domain vocabulary co-occurrence"
    as: unclassified
  - entity: cha:concept:filename_patterns
    display_name: "Filename patterns"
    as: unclassified
  - entity: cha:concept:length_and_structural_patterns
    display_name: "Length and structural patterns"
    as: unclassified
  - entity: cha:concept:multiple_heteronym_names_in_creator_field_or_text
    display_name: "Multiple heteronym names in creator field or text"
    as: unclassified
  - entity: cha:concept:null_hypothesis_h
    display_name: "Null hypothesis (H₀)"
    as: unclassified
  - entity: cha:concept:reproducibility_implication
    display_name: "Reproducibility implication"
    as: unclassified
  - entity: cha:concept:self_attribution_in_text
    display_name: "Self-attribution in text"
    as: unclassified
  - entity: cha:concept:specific_phrases
    display_name: "Specific phrases"
    as: unclassified
  - entity: cha:concept:tachyon_glyph_chain_presence
    display_name: "TACHYON glyph chain presence"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Crimson Hexagonal Archive — Hugging Face Dataset Work Plan v3*
...
**Critical insight from Assembly review** — Provenance cannot modulate collapse unless provenance is presented to the training system as a signal. The dataset must materialize multiple textual views — body_only, minimal_head
...
**Null hypothesis (H₀)** — Fine-tuning on synthetic or AI-assisted text produces equivalent perplexity degradation and semantic drift regardless of provenance density (DOI anchoring, heteronymic attribution,
