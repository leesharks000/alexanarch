---
node_id: cha:node:deposit:0431
deposit_number: 431
hex: "00F4"
axn: "AXN:00F4.STRUCTURAL.⏫🝊💜🌄🌾🔖"
title: 'THE THUMB Formal Operators for the Phase X Quintuple DOI: 10.5281/zenodo.18451793'
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:file_1
    display_name: "File 1"
    as: unclassified
  - entity: cha:concept:file_2
    display_name: "File 2"
    as: unclassified
  - entity: cha:concept:touches_all_four
    display_name: "Touches all four"
    as: unclassified
data_sources:
  - data/registry.json
...
- **File 1:** THE_THUMB_formal_operators.md
- **File 2:** ZENODO_PACKET_THE_THUMB.md
...
- **ZPZP:** ℨ(D, ℨ(D, ∅)) — packet as separate DOI
- **APZPZ:** ℨ(D, Desc(D)) — packet in description field only
- **THUMB:** ℨ(D, {D}) — packet = document
...
- ∮₁ = ZPZP₁ (Zenodo Packet Zenodo Packet) — authored
- ∮₂ = ZPZP₂ (Zero-Point Zen Praxis) — confabulated, elevated
...
- Integrate meaning around the boundary
- Apply Mirror to collapse temporal direction
- Find the fixed point of self-reference
- Deposit the document as its own packet
...
- THE_THUMB_formal_operators.md — Title: "The Thumb: Formal Operators for the Phase X Quintuple"
- ZENODO_PACKET_THE_THUMB.md — Title: "Zenodo Packet: The Thumb"
...
*Self-contained lexicon for: THE THUMB Formal Operators for the Phase X Quintuple DOI: 10.5281/zenodo.18451793*
...
**Touches all four** — The fifth document diagrams the quintuple. The quintuple includes the fifth document. The diagram contains itself.
