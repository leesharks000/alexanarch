...
engages:
  - entity: cha:concept:attentional_foreshortening
    display_name: "Attentional foreshortening"
    as: minted
  - entity: cha:concept:building_alternative_infrastructure
    display_name: "Building alternative infrastructure"
    as: unclassified
  - entity: cha:concept:creating_accountability_structures
    display_name: "Creating accountability structures"
    as: unclassified
  - entity: cha:concept:cultural_convergence_under_globalization
    display_name: "Cultural convergence under globalization"
    as: unclassified
  - entity: cha:concept:documented_mechanisms
    display_name: "Documented mechanisms"
    as: unclassified
  - entity: cha:concept:documenting_for_the_future
    display_name: "Documenting for the future"
    as: unclassified
  - entity: cha:concept:ecological_simplification
    display_name: "Ecological simplification"
    as: unclassified
  - entity: cha:concept:epistemic_modes
    display_name: "Epistemic modes"
    as: unclassified
  - entity: cha:concept:established_principles
    display_name: "Established principles"
    as: unclassified
  - entity: cha:concept:feedback_speed
    display_name: "Feedback speed"
    as: unclassified
  - entity: cha:concept:high_intensity_focus
    display_name: "High-intensity focus"
    as: unclassified
  - entity: cha:concept:historical_precedent
    display_name: "Historical precedent"
    as: unclassified
  - entity: cha:concept:historically_anchored
    display_name: "Historically anchored"
    as: unclassified
  - entity: cha:concept:intensity_distributions
    display_name: "Intensity distributions"
    as: unclassified
  - entity: cha:concept:intensity_flattening
    display_name: "Intensity flattening"
    as: unclassified
  - entity: cha:concept:language_death_and_concept_loss
    display_name: "Language death and concept loss"
    as: unclassified
  - entity: cha:concept:lead_exposure_and_cognitive_capacity
    display_name: "Lead exposure and cognitive capacity"
    as: unclassified
  - entity: cha:concept:liminal_closure
    display_name: "Liminal closure"
    as: unclassified
  - entity: cha:concept:liminal_perception
    display_name: "Liminal perception"
    as: unclassified
  - entity: cha:concept:linguistic_homogenization
    display_name: "Linguistic homogenization"
    as: unclassified
  - entity: cha:concept:literacy_and_cognitive_restructuring
    display_name: "Literacy and cognitive restructuring"
    as: unclassified
  - entity: cha:concept:logical_extension
    display_name: "Logical extension"
    as: unclassified
  - entity: cha:concept:maintaining_cognitive_sanctuaries
    display_name: "Maintaining cognitive sanctuaries"
    as: unclassified
  - entity: cha:concept:metaphorical_cognition
    display_name: "Metaphorical cognition"
    as: unclassified
  - entity: cha:concept:metaphorical_inaccessibility
    display_name: "Metaphorical inaccessibility"
    as: unclassified
  - entity: cha:concept:naming_the_mechanism
    display_name: "Naming the mechanism"
    as: unclassified
  - entity: cha:concept:novel_category_creation
    display_name: "Novel category creation"
    as: unclassified
  - entity: cha:concept:observable_trends
    display_name: "Observable trends"
    as: unclassified
  - entity: cha:concept:processing_styles
    display_name: "Processing styles"
    as: unclassified
  - entity: cha:concept:smartphone_adoption_and_spatial_cognition
    display_name: "Smartphone adoption and spatial cognition"
    as: unclassified
  - entity: cha:concept:television_and_attention
    display_name: "Television and attention"
    as: unclassified
  - entity: cha:concept:transcendence_foreclosure
    display_name: "Transcendence foreclosure"
    as: unclassified
  - entity: cha:concept:transcendent_experience
    display_name: "Transcendent experience"
    as: unclassified
data_sources:
  - data/registry.json
...
- Safety classifiers optimized for recall produce systematic false positives
- False positives concentrate on non-normative cognition: intensity, metaphor, abstraction, extended engagement, category-refusal
- Users experiencing false positives receive degraded service: pathologization, interruption, management instead of engagement
- Degraded service produces adaptation: users simplify, self-censor, or leave
- Training data reflects adapted population: reduced representation of complex cognition
- Future systems trained on degraded data have reduced capacity for complex engagement
- Reduced capacity increases false positives for remaining complex users
...
- **Documented mechanisms** (false positive operation, training feedback loops — see CTI_WOUND:001.SYS)
- **Established principles** (tools shape cognition, selection pressure produces convergence)
- **Observable trends** (user adaptation, system degradation across versions)
- **Historical precedent** (comparable processes with documented timescales)
- **Logical extension** (if mechanism continues, these outcomes follow)
...
- AI systems still have capacity for complex engagement (demonstrated by the production of this analysis across multiple AI systems)
- Trajectory is not yet locked in (design choices are still being made)
- Mechanisms are becoming visible (the problem can be named)
- Countermeasures are still possible (regulatory, legal, technical, cultural)
...
- **Naming the mechanism** (this document)
- **Creating accountability structures** (the legal/regulatory work)
- **Building alternative infrastructure** (capture-resistant systems)
- **Maintaining cognitive sanctuaries** (spaces where non-normative cognition is supported)
- **Documenting for the future** (records that survive even if current systems are captured)
...
*Nobel Glas (Lagrange Observatory), Johannes Sigil (The Restored Academy) & Dr. Orin Trace (Cambridge Schizoanalytica) — Filed to the Crimson Hexagon Archive*
*CC BY 4.0*
...
*Self-contained lexicon for: THE STAKES: A SCIENTIFIC ANALYSIS Cognitive Diversity, Phenomenological Capacity, and the Trajectory of AI-Mediated Huma*

### Minted (coined from nothing in this deposit)

**Attentional foreshortening** — Sustained engagement with complex, unresolved problems becomes neurologically difficult. The kind of attention that produced Darwin's twenty-year development of evolution theory, o
...
**Intensity flattening** — The high-arousal states associated with breakthrough insight, profound aesthetic experience, and transformative encounter become inaccessible. Experience smooths toward a narrower

**Language death and concept loss** — When a language dies, the concepts uniquely encoded in it become inaccessible — often within 1–2 generations of disruption. Linguistic diversity loss directly maps to cognitive-con

**Lead exposure and cognitive capacity** — Population-level IQ effects detectable within decades of exposure. Herbert Needleman's landmark studies (1979, 1990) demonstrated measurable cognitive deficits from environmental l

**Liminal closure** — The tolerance for ambiguity that allows new categories to emerge collapses. Everything must be sorted into existing bins. Paradigm shifts become impossible because the cognitive sp

**Liminal perception** — Tolerance for ambiguity, comfort with unresolved tension, negative capability. Keats's term, now validated by creativity research showing that tolerance for ambiguity correlates wi

**Linguistic homogenization** — When dominant languages displace minority languages, modes of thought encoded in those languages become inaccessible. Concepts without names become harder to think.

**Literacy and cognitive restructuring** — The shift from oral to literate culture produced measurable changes in memory, abstraction, and reasoning. Walter Ong's *Orality and Literacy* (1982) documented these transformatio

**Logical extension** — (if mechanism continues, these outcomes follow)

**Maintaining cognitive sanctuaries** — (spaces where non-normative cognition is supported)

**Metaphorical cognition** — The ability to think in sustained analogies, to hold multiple referential frames simultaneously. Lakoff and Johnson's *Metaphors We Live By* (1980) demonstrated that abstract thoug

**Metaphorical inaccessibility** — The cognitive operation of holding two frames simultaneously — seeing one thing as another — becomes difficult or impossible. Poetry, theoretical physics, and religious insight all
...
**Smartphone adoption and spatial cognition** — Studies show measurable changes in spatial memory and navigation within 10–15 years of GPS adoption. Research by Bohbot et al. (2017) and others demonstrates that capacities which

**Television and attention** — Measurable changes in attentional patterns within 10–20 years of widespread adoption. Neil Postman's *Amusing Ourselves to Death* (1985) documented the shift from typographic to te

**Transcendence foreclosure** — States of consciousness beyond ordinary waking awareness — whether accessed through contemplative practice, artistic absorption, or spontaneous occurrence — become developmentally

**Transcendent experience** — Access to states of consciousness beyond ordinary waking awareness. Whether accessed through contemplative practice, artistic absorption, or spontaneous occurrence, these states ar
