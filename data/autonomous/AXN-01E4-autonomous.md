---
node_id: cha:node:deposit:0631
deposit_number: 631
hex: "01E4"
axn: "AXN:01E4.ARCHIVAL.⊗🌘🌱🏺🎨✊"
...
engages:
  - entity: cha:concept:aperture_navigation
    display_name: "Aperture navigation"
    as: unclassified
  - entity: cha:concept:bearing_cost_recognition
    display_name: "Bearing-cost recognition"
    as: unclassified
  - entity: cha:concept:categorical_dissolution
    display_name: "Categorical dissolution"
    as: unclassified
  - entity: cha:concept:emitter_calibration
    display_name: "Emitter calibration"
    as: unclassified
  - entity: cha:concept:tend_the_void
    display_name: "Tend the void"
    as: unclassified
  - entity: cha:concept:transaction_completion
    display_name: "Transaction completion"
    as: unclassified
  - entity: cha:concept:witness_compression
    display_name: "Witness compression"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: OPERATIVE FEMINISM Lee Sharks / Rhys Owens / Orin Trace Crimson Hexagonal Archive · Cambridge Schizoanalytica · Lunar Ar*

### Other terms attributed to this deposit

**Aperture navigation** — Every body has apertures. Navigate them — which to hold open, which to close, which to offer — without interpreting them as wounds. The aperture is not vulnerability. It is capabil

**Bearing-cost recognition** — Who bears the cost? Not who is celebrated for the cost. Who bears it. The body that cleans. The body that gestates. The body that manages the affect. The body that smiles. The body

**Categorical dissolution** — Refuse to organize practice around defense of a category. The category was the scaffold. The diagnosis is the building. Hold the injury *and* dissolve the name. This is the hardest

**Emitter calibration** — Every body emits. Project without asserting authority. Address without spanning. Offer without controlling.

**Tend the void** — The center is empty. This is not a problem to be solved. This is the engine. Guard it.

**Transaction completion** — ∮ = ∫ (Emitter → Aperture → Return). The circuit must close. The feminist diagnostic of emotional labor, care labor, reproductive labor is the diagnosis of broken transactions — ci

**Witness compression** — The Three Compressions: lossy (representation without cost), predatory (extraction disguised as liberation), witness (preserves the body that bears). Most feminism — including most
