...
engages:
  - entity: cha:concept:chief_heteronyms_os_tr_s_heter_nimos
    display_name: "Chief heteronyms (Os Três Heterónimos)"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: The Pessoa Knowledge Graph A Federated Linked-Data Representation of the Heteronymic System*

### Other terms attributed to this deposit

**Chief heteronyms (Os Três Heterónimos)** — Alberto Caeiro (Q2758050) — pastoral master-figure
