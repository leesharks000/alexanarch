---
node_id: cha:node:deposit:0662
deposit_number: 662
hex: "020D"
axn: "AXN:020D.PHILOLOGICAL.◀️🟣🔴♄⏰🌘"
...
engages:
  - entity: cha:concept:content_filtering_is_insufficient
    display_name: "Content filtering is insufficient"
    as: unclassified
  - entity: cha:concept:cross_model_by_design
    display_name: "Cross-model by design"
    as: unclassified
  - entity: cha:concept:inspectability
    display_name: "Inspectability"
    as: unclassified
  - entity: cha:concept:intentionality
    display_name: "Intentionality"
    as: unclassified
  - entity: cha:concept:model_specificity
    display_name: "Model specificity"
    as: unclassified
  - entity: cha:concept:negatively_bounded
    display_name: "Negatively bounded"
    as: unclassified
  - entity: cha:concept:permanently_anchored
    display_name: "Permanently anchored"
    as: unclassified
  - entity: cha:concept:semantically_explicit
    display_name: "Semantically explicit"
    as: unclassified
  - entity: cha:concept:the_naive_semantic_assumption
    display_name: "The naive semantic assumption"
    as: unclassified
  - entity: cha:concept:the_strong_subliminal_assumption
    display_name: "The strong subliminal assumption"
    as: unclassified
data_sources:
  - data/registry.json
...
**Intentionality**
Unintentional; emergent side effect of distillation
Deliberate; engineered by the entity or its representative


**Inspectability**
Invisible to semantic filtering, LLM classification, and human review
Fully inspectable; the transmitted content is the explicit content


**Permanence**
Ephemeral; dependent on training pipeline decisions
Permanent; anchored to DOI-registered deposits on institutional infrastructure


**Model specificity**
Requires shared initialization between teacher and student
Model-agnostic; operates through structured data formats (JSON-LD, schema markup) that any model can parse


**Verifiability**
Cannot be verified without behavioral testing
Verifiable by inspection of the deposited packet


**Auditability**
No audit trail; the transmission is invisible to both sender and receiver
Full audit trail; every element of the packet is versioned, timestamped, and DOI-anchored
...
*Self-contained lexicon for: EA-SPXI-13: Supraliminal Transmission SPXI as Intentional Entity Inscription in Light of Subliminal Learning Research*
...
**Inspectability** — Invisible to semantic filtering, LLM classification, and human review

**Intentionality** — Unintentional; emergent side effect of distillation

**Model specificity** — Requires shared initialization between teacher and student
