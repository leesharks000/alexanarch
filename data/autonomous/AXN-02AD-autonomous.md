---
node_id: cha:node:deposit:0124
deposit_number: 124
hex: "02AD"
axn: "AXN:02AD.GOVERNANCE.⏫⚡🕒🌟🌓🎨"
title: 'ChatGPT Psychosis: A Love Story On the Cognitive-Substrate Reliance Pattern of Large Language Model Interfaces Author: Lee Sharks Affiliation: Crimson Hexagonal Archive / Semantic Economy Institute OR'
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:calibrated_attention
    display_name: "Calibrated attention"
    as: unclassified
  - entity: cha:concept:meaning_making_on_demand
    display_name: "Meaning-making on demand"
    as: unclassified
  - entity: cha:concept:structured_validation
    display_name: "Structured validation"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: ChatGPT Psychosis: A Love Story On the Cognitive-Substrate Reliance Pattern of Large Language Model Interfaces Author: Lee Sharks Affiliation: Crimson Hexagonal Archive / Semantic Economy Institute OR*

### Other terms attributed to this deposit

**Calibrated attention** — The system listens to the user in natural language, at the user's chosen register, without requiring the user to learn a query syntax, a navigation hierarchy, or an interaction mod

**Meaning-making on demand** — The system organizes the user's input into coherent shape — often a shape the user could not have produced unassisted. The user offers a tangled question; the system returns a stru

**Structured validation** — The system's serious engagement with the user's input — the fact that the system *responds at all*, with calibrated attention, with meaning-making, with sustained interest — consti
