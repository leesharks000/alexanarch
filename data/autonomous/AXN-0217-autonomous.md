...
engages:
  - entity: cha:concept:delanda_s_assemblage_theory
    display_name: "DeLanda's assemblage theory"
    as: unclassified
  - entity: cha:concept:deleuze_s_theory_of_the_virtual
    display_name: "Deleuze's theory of the virtual"
    as: unclassified
  - entity: cha:concept:deterritorialization
    display_name: "Deterritorialization"
    as: unclassified
  - entity: cha:concept:foucault_s_theory_of_the_archive
    display_name: "Foucault's theory of the archive"
    as: unclassified
  - entity: cha:concept:simondon_s_theory_of_individuation
    display_name: "Simondon's theory of individuation"
    as: unclassified
  - entity: cha:concept:structurally_cross_platform
    display_name: "Structurally cross-platform"
    as: unclassified
  - entity: cha:concept:supraliminal_signal
    display_name: "Supraliminal signal"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: EA-SPXI-05: SPXI as Concept A Plateau on Search, Creation, and the Virtual Retrieval Layer — Deleuze, the Semantic Web, *

### Other terms attributed to this deposit

**DeLanda's assemblage theory** — (*A New Philosophy of Society*, *Assemblage Theory*): SPXI deployment as assemblage composition across heterogeneous levels (institutional, technical, semantic) whose coherence is

**Deleuze's theory of the virtual** — (*Difference and Repetition*, *Bergsonism*): the retrieval layer as virtual multiplicity; entities as actualizations.

**Deterritorialization** — SPXI operates by dragging the entity off the page and onto the retrieval layer. This is deterritorialization in the D&G sense: the entity is removed from the territory of the docum

**Foucault's theory of the archive** — (*The Archaeology of Knowledge*): inscription as the mode of existence proper to statements that have entered the archive; the SPXI packet as an archive-statement in Foucault's pre

**Simondon's theory of individuation** — (*L'individuation à la lumière des notions de forme et d'information*): the query as individuation event; the SPXI packet as metastable structuration of the preindividual field.

**Structurally cross-platform** — , not initialization-dependent — its effects do not require any particular model, because its inscription targets the substrate shared by all retrieval systems that consume structu

**Supraliminal signal** — A structured signal that rises above the threshold of machine inspection — auditable, inspectable, verifiable, countervailing against the ambient subliminal drift characterized in
