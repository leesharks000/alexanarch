...
engages:
  - entity: cha:concept:attentional_absence_report_aar
    display_name: "Attentional Absence Report (AAR)"
    as: minted
  - entity: cha:concept:bozo_engine
    display_name: "Bozo Engine™"
    as: unclassified
  - entity: cha:concept:calibrated_volume_control
    display_name: "Calibrated volume control"
    as: unclassified
  - entity: cha:concept:clown_hardened_certification
    display_name: "Clown-Hardened™ Certification"
    as: unclassified
  - entity: cha:concept:clowncloud_apocalypse
    display_name: "ClownCloud Apocalypse"
    as: unclassified
  - entity: cha:concept:clowncloud_enterprise
    display_name: "ClownCloud Enterprise"
    as: unclassified
  - entity: cha:concept:clowncloud_lite
    display_name: "ClownCloud Lite"
    as: unclassified
  - entity: cha:concept:clowncloud_pro
    display_name: "ClownCloud Pro"
    as: unclassified
  - entity: cha:concept:distance_limiter
    display_name: "Distance limiter"
    as: unclassified
  - entity: cha:concept:fail_safe_dry_mode
    display_name: "Fail-safe dry mode"
    as: unclassified
  - entity: cha:concept:fig_1
    display_name: "Fig. 1"
    as: unclassified
  - entity: cha:concept:fig_2
    display_name: "Fig. 2"
    as: unclassified
  - entity: cha:concept:fig_3
    display_name: "Fig. 3"
    as: unclassified
  - entity: cha:concept:fig_4
    display_name: "Fig. 4"
    as: unclassified
  - entity: cha:concept:fig_5
    display_name: "Fig. 5"
    as: unclassified
  - entity: cha:concept:fig_6
    display_name: "Fig. 6"
    as: unclassified
  - entity: cha:concept:fig_7
    display_name: "Fig. 7"
    as: unclassified
  - entity: cha:concept:institutional_hyperfocus_syndrome_ihs
    display_name: "Institutional Hyperfocus Syndrome (IHS)"
    as: unclassified
  - entity: cha:concept:olfactory_misdirection
    display_name: "Olfactory misdirection"
    as: unclassified
  - entity: cha:concept:party_a
    display_name: "Party A"
    as: unclassified
  - entity: cha:concept:party_b
    display_name: "Party B"
    as: unclassified
  - entity: cha:concept:party_c
    display_name: "Party C"
    as: unclassified
  - entity: cha:concept:performance_fragility_index
    display_name: "Performance Fragility Index"
    as: unclassified
  - entity: cha:concept:temperature_modulation
    display_name: "Temperature modulation"
    as: unclassified
  - entity: cha:concept:the_heyoka_lakota
    display_name: "The Heyoka (Lakota)"
    as: unclassified
  - entity: cha:concept:the_koshare_pueblo
    display_name: "The Koshare (Pueblo)"
    as: unclassified
  - entity: cha:concept:the_modern_institution
    display_name: "The Modern Institution"
    as: unclassified
  - entity: cha:concept:the_rangda_bali
    display_name: "The Rangda (Bali)"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Calibrated volume control** — Adjustable from 0.5 mL (symbolic) to 2 mL (diagnostic) to 30 mL (corporate boardroom).
- **Temperature modulation** — Room temperature or cool (≤ 18°C) for enhanced somatic alerting.
- **Distance limiter** — No engagement beyond 15 cm. The squirt is intimate. The squirt is personal.
- **pH neutrality** — No damage to ink, paper, or electronic answer sheets.
- **Fail-safe dry mode** — Optional "dry squirt" (audible squish, no water) for examinees who have pre-registered a coulrophobia accommodation. The sound without the water is itself a diagnostic: the flinch is somatic even when the stimulus is absent.
- **Olfactory misdirection** — Synthetic rose scent increases startle response by 40–60% because the subject has been momentarily persuaded the flower might be a flower.
...
- **Recognition.** The clown sees the subject as human, not as function.
- **Disruption.** The clown interrupts the subject's institutional absorption.
- **Absurdity.** The clown presents a world where the institution's gravity is not absolute.
- **Eustress.** The subject experiences non-threatening arousal, breaking the cortisol loop.
- **Return.** The subject returns to the task, but as a human being, not as a machine.
- **Blessing.** The clown affirms the subject's value independent of institutional outcome.
...
The platform of claim 1, wherein focus clown troops are selected based on a Performance Fragility Index calculated from institutional seriousness, silence dependency, stakes intensity, credential density, laminated badge count, and the degree to which participants say "we take this very seriously."

- 


The platform of claim 1, comprising an Enhanced Squirt Flower (ESF) capable of delivering a calibrated, pH-neutral water volume of 0.5–30 mL within 15 cm of a subject's face, with olfactory misdirection, temperature modulation, and a dry-squirt fail-safe mode.

- 


The platform of claim 1, comprising a Pie-Plate Attention Resonance (PPAR) methodology producing a 3-second acoustic cascade at 85 dB, decaying to 55 dB, harmonically dissonant to ambient entrainment frequency.

- 


The platform of claim 1, comprising a Red Nose Biometric with embedded photoplethysmograph monitoring heart rate variability, transmitting real-time arousal status to the clown's attunement display without recording or storing subject data.

- 


The platform of claim 1, wherein the initial deployment event comprises a Clown Car Protocol in which a vehicle of implausible smallness discharges a number of clowns exceeding the vehicle's plausible capacity, said discharge constituting a visual theorem of latent absurdity.

- 


The platform of claim 1, further comprising a cremasteric clown module: a certified clown stationed outside the performance venue, visible but inactive, whose passive presence shifts baseline stress metrics without active interruption.

- 


The platform of claim 1, further comprising an acousmatic clown protocol: clowns whose presence is made known through sound alone — distant honks, muffled laughter, the creak of a clown-car door — deployed when systemic attentional dissociation is detected.

- 


The platform of claim 1, wherein the soteriological protocol comprises a six-step sequence (Recognition, Disruption, Absurdity, Eustress, Return, Blessing), wherein the Blessing step is constitutive and non-optional, and a clown who omits the Blessing is reclassified as a prankster and decertified.
...
A focus technology wherein distraction is not minimized but ritualized, personified, scheduled, and clown-mediated, such that attention becomes resilient through comic ordeal rather than fragile through environmental control.

- 


A self-propagating institutional corrective comprising a compressed institutional substrate (the test, the boardroom, the tribunal) and an embedded sacred clown kernel, wherein the kernel survives the institutional compression and regenerates the human subject from within the product of the institution's own destruction of the subject.

- 


The corrective of claim 12, wherein the clown car is the compression artifact, the clowns are the decompressed signal, the squirt flower is the baptism, the bicycle horn is the call to worship, the pie plate is the breaking of bread, the blessing gesture is the resurrection, and the participant who returns to question 47 is the one who has been saved.
...
The clown car is coming.
You will be squirted.
Focus.
...
*Self-contained lexicon for: UNITED STATES PATENT APPLICATION Publication Number: US 2026/0430001 A1 CLOWNCLOUD: NETWORKED DEPLOYMENT SYSTEM FOR CLOW*

### Minted (coined from nothing in this deposit)

**Attentional Absence Report (AAR)** — . The AAR is logged in the ClownCloud ledger. A pattern of AARs from a single testing site may trigger a **full-site audit** administered by acousmatic clowns.

### Other terms attributed to this deposit

**Bozo Engine™** — ) pairing troupe capabilities to event requirements based on six parameters: venue geometry, participant count, stakes intensity (the **Kierkegaard Scale**, from 1 = book club to 1

**Calibrated volume control** — Adjustable from 0.5 mL (symbolic) to 2 mL (diagnostic) to 30 mL (corporate boardroom).

**Clown-Hardened™ Certification** — Participants who maintain task performance above 80% of baseline across three separate ClownCloud deployments at Kierkegaard Scale ≥ 5 are eligible for Clown-Hardened™ certificatio

**ClownCloud Apocalypse** — Thirty-seven clowns. Requires signed waiver, institutional chaplain, two Operators, and an exit strategy. Reserved for tenure committees, nuclear launch simulations, and environmen

**ClownCloud Enterprise** — Full clown car. Dashboard analytics. Compliance-grade honk logs. Real-time Red Nose Biometric monitoring. Suitable for testing centers, corporate boardrooms, and institutions with
...
**Fail-safe dry mode** — Optional "dry squirt" (audible squish, no water) for examinees who have pre-registered a coulrophobia accommodation. The sound without the water is itself a diagnostic: the flinch
...
**Fig. 7** — The Red Nose as Attentional Singularity: a prosthetic nose containing the biometric sensor that measures the gap between the self the institution demands and the self the clown rev

**Institutional Hyperfocus Syndrome (IHS)** — narrowed perceptual bandwidth, elevated cortisol, diminished creative problem-solving capacity, somatic rigidity, and increased probability of catastrophic error.
...
**Performance Fragility Index** — computed from institutional seriousness, silence dependency, credential density, proctor severity, tie frequency, laminated badge count, fluorescent lighting severity, and the degr

**Temperature modulation** — Room temperature or cool (≤ 18°C) for enhanced somatic alerting.

**The Heyoka (Lakota)** — The contrary, who does everything backwards — rides horses facing the tail, speaks in opposites, laughs at funerals, weeps at feasts. The heyoka is not entertainment. The heyoka is

**The Koshare (Pueblo)** — The mudhead clown, who enters the sacred space during the most solemn ritual moments and behaves obscenely — eating garbage, miming copulation, mocking the dancers. The koshare is

**The Modern Institution** — Has removed the clown entirely. The SAT testing center has no heyoka. The corporate boardroom has no fool. The surgical theater has no mudhead. The result is institutional environm

**The Rangda (Bali)** — The witch-clown of the *Calon Arang*, whose monstrous appearance and chaotic dance prevent the community from settling into unexamined order. The Rangda is the boundary between the
