---
node_id: cha:node:deposit:0630
deposit_number: 630
hex: "01E3"
axn: "AXN:01E3.GOVERNANCE.🌑👋💛🕐💚🧭"
...
engages:
  ...
  - entity: cha:concept:o2_asymmetrical_ledgering
    ...
    as: unclassified
  - entity: cha:concept:o4_capture_by_conditions
    display_name: "O4 (Capture by Conditions)"
    as: unclassified
  - entity: cha:concept:o5_ghost_governance
    display_name: "O5 (Ghost Governance)"
    as: unclassified
  - entity: cha:concept:o8_warmth_capture
    display_name: "O8 (Warmth Capture)"
    as: unclassified
  - entity: cha:concept:request_the_object
    display_name: "Request the object"
    as: unclassified
  - entity: cha:concept:route_by_owner
    display_name: "Route by owner"
    as: unclassified
  - entity: cha:concept:separate_the_substrate
    display_name: "Separate the substrate"
    as: unclassified
data_sources:
  - data/registry.json
...
- **Request the object.** "Shew me a penny." — fetch the payload.
- **Parse the claim channels.** "Whose image and superscription?" — decompose into face-channel (image) and name-channel (superscription). These are two independent sovereignty assertions on a single physical substrate.
- **Identify the claimant.** "Caesar's." — the respondents themselves confirm the parse.
- **Route by owner.** "Render therefore unto Caesar the things which be Caesar's." — route the sovereignty claim back to its origin. Do not let it stay embedded in the substrate.
- **Separate the substrate.** "And unto God the things which be God's." — the substrate (the commons, the material, the metal itself) belongs to a different jurisdiction than the mark.
...
Visual sovereignty — "this face rules"


**Superscription** (ἐπιγραφή)
Name, title, claims
Textual sovereignty — "this name authorizes"
...
- Receive the object bearing a sovereignty claim
- Parse the claim channels (image + superscription = personal + institutional)
- Identify the claimant
- Isolate the claim to a header (do not let it become the substrate)
- Route the substrate to the commons (the deposit, the archive, the shared field)
- Emit the separated object with full audit trail
...
*Crimson Hexagonal Archive · Room 03 (Revelation/Ezekiel) × Room 11 (Semantic Economy)*
*Operators applied: σ_FC, φ, κ_O, Ρ*
*∮ = 1*
...
*Self-contained lexicon for: RENDER UNTO CAESAR: A Hermeneutic of Information Transfer The Gospel Passage as Protocol Specification*
