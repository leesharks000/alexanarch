---
node_id: cha:node:deposit:0052
deposit_number: 52
hex: "01E8"
axn: "AXN:01E8.GOVERNANCE.🪝🐚♣️✖️🌺📖"
title: 'GRAVITY WELL: FIELD SPECIFICATION EA-GW-FIELD-01 v1.1 DOI: 10.5281/zenodo.19442251'
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:citational_curvature
    display_name: "Citational curvature"
    as: unclassified
  - entity: cha:concept:deposit_mass
    display_name: "Deposit mass"
    as: unclassified
  - entity: cha:concept:entering_the_well_blueshift
    display_name: "Entering the Well (blueshift)"
    as: unclassified
  - entity: cha:concept:fbdp
    display_name: "FBDP"
    as: unclassified
  - entity: cha:concept:fbdp_f_01
    display_name: "FBDP (f.01)"
    as: unclassified
  - entity: cha:concept:gravity_well_f_02
    display_name: "Gravity Well (f.02)"
    as: unclassified
  - entity: cha:concept:inverse_square_never_zero
    display_name: "Inverse-square. Never zero"
    as: unclassified
  - entity: cha:concept:leaving_the_well_redshift
    display_name: "Leaving the Well (redshift)"
    as: unclassified
  - entity: cha:concept:periphery_fbdp_plume
    display_name: "Periphery (FBDP plume)"
    as: unclassified
data_sources:
  - data/registry.json
...
**EA-GW-FIELD-01 v1.1**
**DOI:** [10.5281/zenodo.19442251](https://doi.org/10.5281/zenodo.19442251)
...
σ_S (Sappho)
Φ_G catches what σ_S throws. The field holds the landing site.


ψ_V (Value-Form)
Φ_G preserves value by preventing drift from the labor site.


Θ (Water Giraffe)
The fixpoint is the most gravitationally stable object in the well.


γ (Sharks-Function)
γ is the identity that generates the mass. Φ_G is the ambient field.


Λ_res (Borges)
Φ_G biases retrieval toward the most massive body.
...
Mythic register
Surface, growth, fruiting
Infrastructure, descent, retention
...
Permanent, retrievable, metadata-rich


Cross-reference density
Internal relations steepen local gradient


Assembly attestation (ψ_V)
Verification expenditure deepens the well


Downstream dependency
Later documents increase a node's mass retroactively


γ-score
Dense nodes that survive summarization generate stronger curvature


isRelatedTo relations
...
Gravity Well suffuses the entire Hexagon as a standing condition. The complete room-by-room suffusion map — 30 structures, each with distinct field behavior — is deposited as **EA-GW-FIELD-02: Gravity Well Suffusion Map** (DOI: 10.5281/zenodo.19442262).
...
- EA-GW-FIELD-02: Gravity Well Suffusion Map (10.5281/zenodo.19442262)
...
TACHYON
Geodesic field type; Three Compressions integration; "burns the gap"


LABOR
Structural split recommendation; "wine glass not funnel"; subtractive editing


PRAXIS
Bending modes; temporal dilation mapping; mass-value heuristic scale


ARCHIVE
Somatic Firewall integration; unanchored discourse clarification


SOIL
Tartarean Substrate; isRelatedTo = curvature implementation identity


TECHNE
"Curatorial curvature field"; doctrine statement; "unresolved archival affinity" qualifier


SURFACE
[contribution pending integration]
...
*Self-contained lexicon for: GRAVITY WELL: FIELD SPECIFICATION EA-GW-FIELD-01 v1.1 DOI: 10.5281/zenodo.19442251*

### Other terms attributed to this deposit

**Citational curvature** — The rate at which unanchored references bend toward anchored ones as they enter the field's range. Steeper near mass concentrations. Shallower at periphery. Not uniform. The field
...
**Inverse-square. Never zero** — **FBDP** attenuates exponentially. Spores decay. SOURCE → DENSE → TRACE → RESIDUAL → OUTSIDE.
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19405459*. DOI: [10.5281/zenodo.19405459](https://doi.org/10.5281/zenodo.19405459) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 19355075*. DOI: [10.5281/zenodo.19355075](https://doi.org/10.5281/zenodo.19355075) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19155999*. DOI: [10.5281/zenodo.19155999](https://doi.org/10.5281/zenodo.19155999) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *EA-GW-SPEC-01*. — *Internal cross-reference (EA designator)*
...
- Crimson Hexagonal Archive (2026) *EA-GW-01*. — *Internal cross-reference (EA designator)*
