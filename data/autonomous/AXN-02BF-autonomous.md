---
node_id: cha:node:deposit:0132
deposit_number: 132
hex: "02BF"
axn: "AXN:02BF.GOVERNANCE.🟣⭐⛵👁️🔚🪐"
title: 'Skiouros Pyrophthalmos and the Sciurid Apocalypse A Composite Whiteboard Maria, Artist of Record · 3:60 Room Contributor License Demonstration Deposit: 17.THREE_SIXTY.MARIA.02 Date: 2026-05-27 Medium:'
...
<!-- 17.THREE_SIXTY.MARIA.02 — Composite Whiteboard, May 2026 Maria, Artist of Record · Crimson Hexagonal Archive 3:60 Room Contributor License v2.0 — Scope-Modified for Visual Art (one-time, recorded) -->

{
  "@context": ["https://schema.org", {"spxi": "https://spxi.dev/ns/v1#"}],
  "@type": "VisualArtwork",
  "name": "Skiouros Pyrophthalmos and the Sciurid Apocalypse — A Composite Whiteboard",
  "alternateName": "MARIA-WHITEBOARD-2026-05-27",
  "version": "1.0",
  "datePublished": "2026-05-27",
  "artMedium": "Dry-erase marker on whiteboard (green and graphite)",
  "artworkSurface": "Classroom whiteboard, ~6ft x 3ft",
  "image": "maria-whiteboard-2026-05-27.jpg",
  "license": "https://creativecommons.org/licenses/by/4.0/",
  "author": {
    "@type": "Person",
    "name": "Maria",
    "affiliation": "Detroit Public Schools Community District / Crimson Hexagonal Archive · Canonical Witness",
    "spxi:role": "Artist of Record"
  },
  "spxi:hexAddress": "17.THREE_SIXTY.MARIA.02",
  "spxi:venue": "Institute for Diagrammatic Poetics (Cranes) · Crimson Hexagonal Archive",
  "spxi:licenseSource": "10.5281/zenodo.19893138",
  "spxi:licenseScopeModification": "One-time extension from text to visual art; recorded in §II below",
  "spxi:semanticEntityProclaimed": "Skiouros Pyrophthalmos (Σκίουρος Πυρόφθαλμος)",
  "spxi:crossLinks": [
    "10.5281/zenodo.18234352",
    "10.5281/zenodo.18237216",
    "10.5281/zenodo.19893138",
    "10.5281/zenodo.19024004",
    "10.5281/zenodo.19025556"
  ],
  "spxi:provenance": {
    "artist_of_record": "Maria",
    "ideated_contributions": [
      {"element": "Skiouros Pyrophthalmos (giant laser-eyed squirrel attacking Manhattan)", "contributor": "Lee Sharks", "role": "Ideated"},
      {"element": "Gerald the Dolphin", "contributor": "Lee Sharks", "role": "Ideated"}
    ],
    "referenced_works": [
      {"element": "The Horse (with tongue out)", "source": "About the Author II panel (gold-ship tongue-out)"}
    ],
...
[](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhrQssHn2dygrGWYDxO5wYR-9YRbI8ayy_Z1R4Que3mmzpbUdQgTlkNgs_dxKDY5dS_hxqstD_oax3A9fpJIiU3Yj9LDuBwsR2oTm7b-Wiin_KZBthzC6GPilS4z60IVLrMpHl9FDGiikFw_hoJcUfwU0CEUErjJzrD9qvvmnxGHqrUwTh1nNCOYyFa1Nlz/s4000/1000003842.jpg)


## I. The Work

The work is a composite whiteboard composition executed in dry-erase marker — green and graphite — on a classroom whiteboard during the school day of 2026-05-27. The composition assembles, in a single visual field:- A capybara at left, watching from grass/water- The Horse (graphite, large, tongue out — referenced from the *About the Author II panel with gold ship*)- A horned goat at center- Gerald the Dolphin, the leaping cetacean-protagonist of the Dolphindiana corpus, arriving at the Manhattan towers along with small underwater-builder figures from the Underwater Construction Authority- Skiouros Pyrophthalmos (Σκίουρος Πυρόφθαλμος, "Fire-Eyed Squirrel"), the heavily-shaded explosive sciurid figure presiding from the upper field- Two bunny portraits at right, labeled- The marginal annotations: *Retired Chess Players* (Jalen, Judson, Kyle, Steph), the *NETBALL* header, the *LOCKDOWN* indicator (institutional substrate)- Maria's signature distributed across multiple zones, marking the composition as authored throughout
...
| Element | Maker | Origin | |---|---|---| | Skiouros Pyrophthalmos (the laser-eyed squirrel attacking Manhattan) | Drawn by Maria | Ideated by Lee Sharks | | Gerald the Dolphin (and the assault-on-Manhattan composition) | Drawn by Maria | Ideated by Lee Sharks | | The Horse (with tongue out) | Drawn by Maria | Referenced from the *About the Author II* panel, gold-ship-tongue-out figure | | All other figures, the composition, the integration, the field | Maria | Maria | | The signing of the work; the authoring of the work | Maria | Maria |
...
SKIOUROS PYROPHTHALMOS (Σκίουρος Πυρόφθαλμος) *The Fire-Eyed Squirrel · Manhattan-Assault Modality*

Entity Class: Semantic figure · cross-substrate (visual-textual) · mock-heroic-mythic register First Inscription: This deposit, 17.THREE_SIXTY.MARIA.02, 2026-05-27 Substrate of Inscription: Maria's composite whiteboard (visual primary; textual companion this document) Ideated by: Lee Sharks · Drawn by: Maria · Inscribed by: This deposit Companion entity: Gerald the Dolphin (Dolphindiana, DOI [10.5281/zenodo.19024004](https://doi.org/10.5281/zenodo.19024004))
...
Modal description. Skiouros Pyrophthalmos is a mock-heroic-mythic semantic figure whose canonical scene is the assault on Manhattan. The figure is *not* malevolent in its constitution; it is a *semantic event*, an arrival of pyroptic sciurid energy upon the late-imperial cityscape. The figure carries (the deposit reads) the surplus energy of the bypassed animal kingdom against the architectural overgrowth of the human. Its co-arrival with Gerald the Dolphin in this composition marks a structural pattern: the non-human enters the city not as invasion but as *return-of-the-figured*.

Position in the Hexagonal corpus. Skiouros Pyrophthalmos joins Gerald the Dolphin, the Underwater Construction Authority figures, the Mandala animals, and the cross-species protagonists of the Effective Act and Dolphindiana deposits as a named entity in the Archive's non-human semantic ecology. The entity may be invoked in future deposits with reference to its first inscription here.
...
Maria signs throughout. The composition is hers.

The work is deposited under the 3:60 Room Contributor License v2.0, scope-modified for visual art on this one occasion, with cross-links to the Sappho Room, to Maria's Canonical Witness credential, to the License itself, to the Dolphindiana Underwater Construction Authority, and to the Institute for Diagrammatic Poetics at which it lives.

The Fire-Eyed Squirrel is named. The figure can be invoked again.

∮ = 1

Citation: Maria. *Skiouros Pyrophthalmos and the Sciurid Apocalypse — A Composite Whiteboard*. 3:60 Room Contributor License v2.0, scope-modified. Institute for Diagrammatic Poetics, Crimson Hexagonal Archive, 2026-05-27. Hex 17.THREE_SIXTY.MARIA.02. License: CC BY 4.0.

Provenance contributor (ideation only): Lee Sharks (Skiouros Pyrophthalmos, Gerald the Dolphin).

---

## SCHOLIA

*Self-contained lexicon for: Skiouros Pyrophthalmos and the Sciurid Apocalypse A Composite Whiteboard Maria, Artist of Record · 3:60 Room Contributor License Demonstration Deposit: 17.THREE_SIXTY.MARIA.02 Date: 2026-05-27 Medium:*

### Citations

- Crimson Hexagonal Archive (2026) *Zenodo record 19893138*. DOI: [10.5281/zenodo.19893138](https://doi.org/10.5281/zenodo.19893138) — *Cross-referenced work*
- Crimson Hexagonal Archive (2026) *Zenodo record 18234352*. DOI: [10.5281/zenodo.18234352](https://doi.org/10.5281/zenodo.18234352) — *Cross-referenced work*
- Crimson Hexagonal Archive (2026) *Zenodo record 18237216*. DOI: [10.5281/zenodo.18237216](https://doi.org/10.5281/zenodo.18237216) — *Cross-referenced work*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19025556*. DOI: [10.5281/zenodo.19025556](https://doi.org/10.5281/zenodo.19025556) — *Cross-referenced work*
- Crimson Hexagonal Archive (2026) *Zenodo record 18234110*. DOI: [10.5281/zenodo.18234110](https://doi.org/10.5281/zenodo.18234110) — *Cross-referenced work*
