---
node_id: cha:node:deposit:0166
deposit_number: 166
hex: "0301"
axn: "AXN:0301.GOVERNANCE.🗡️🏔️🧊➖🔽☁️"
title: 'Stabilized Node Watch A Specification for Longitudinal Observational Infrastructure to Detect Composition-Layer Drift on Stabilized Public-Knowledge Nodes Document code: EA-SEM-SNW-01 Hex coordinate: '
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:changepoint_detection
    display_name: "Changepoint detection"
    as: unclassified
  - entity: cha:concept:citation_shuffling
    display_name: "Citation shuffling"
    as: unclassified
  - entity: cha:concept:companion_instruments
    display_name: "Companion instruments"
    as: unclassified
  - entity: cha:concept:conflict_of_interest_declarations
    display_name: "Conflict-of-interest declarations"
    as: unclassified
  - entity: cha:concept:consensus_core
    display_name: "Consensus core"
    as: unclassified
  - entity: cha:concept:consensus_core_extraction
    display_name: "Consensus core extraction"
    as: unclassified
  - entity: cha:concept:consolidate_platform_jurisdiction
    display_name: "Consolidate platform jurisdiction"
    as: unclassified
  - entity: cha:concept:contestation_envelope
    display_name: "Contestation envelope"
    as: unclassified
  - entity: cha:concept:contestation_envelope_mapping
    display_name: "Contestation envelope mapping"
    as: unclassified
  - entity: cha:concept:correction_protocol
    display_name: "Correction protocol"
    as: unclassified
  - entity: cha:concept:cost_asymmetry_preserved
    display_name: "Cost asymmetry preserved"
    as: unclassified
  - entity: cha:concept:cost_imposition
    display_name: "Cost imposition"
    as: unclassified
  - entity: cha:concept:cross_surface_coordination
    display_name: "Cross-surface coordination"
    as: unclassified
  - entity: cha:concept:curatorial_responsibility
    display_name: "Curatorial responsibility"
    as: unclassified
  - entity: cha:concept:democratic_legitimacy
    display_name: "Democratic legitimacy"
    as: unclassified
  - entity: cha:concept:drift_dimension
    display_name: "Drift dimension"
    as: unclassified
  - entity: cha:concept:drift_plausibility
    display_name: "Drift plausibility"
    as: unclassified
  - entity: cha:concept:drift_plausibility_notes
    display_name: "Drift plausibility notes"
    as: unclassified
  - entity: cha:concept:durable_consensus_core
    display_name: "Durable consensus core"
    as: unclassified
  - entity: cha:concept:expanded_11_federation
    display_name: "EXPANDED §11 (Federation)"
    as: unclassified
  - entity: cha:concept:expanded_2
    display_name: "EXPANDED §2"
    as: unclassified
  - entity: cha:concept:expanded_4_catalog
    display_name: "EXPANDED §4 (Catalog)"
    as: unclassified
  - entity: cha:concept:expanded_5_querying
    display_name: "EXPANDED §5 (Querying)"
    as: unclassified
  - entity: cha:concept:embedding_space_drift
    display_name: "Embedding-space drift"
    as: unclassified
  - entity: cha:concept:evidentiary_source
    display_name: "Evidentiary source"
    as: unclassified
  - entity: cha:concept:expected_effect_size
    display_name: "Expected effect size"
    as: unclassified
  - entity: cha:concept:external_reference_environment_archive
    display_name: "External reference environment archive"
    as: unclassified
  - entity: cha:concept:federation_governance
    display_name: "Federation governance"
    as: unclassified
  - entity: cha:concept:federation_invitation
    display_name: "Federation invitation"
    as: unclassified
  - entity: cha:concept:federation_tags
    display_name: "Federation tags"
    as: unclassified
  - entity: cha:concept:first_drift_report
    display_name: "First drift report"
    as: unclassified
  - entity: cha:concept:foundational_figures
    display_name: "Foundational figures"
    as: unclassified
  - entity: cha:concept:foundational_political_economic_concepts
    display_name: "Foundational political-economic concepts"
    as: unclassified
  - entity: cha:concept:framing_fingerprint
    display_name: "Framing fingerprint"
    as: unclassified
  - entity: cha:concept:framing_markers
    display_name: "Framing markers"
    as: unclassified
  - entity: cha:concept:framing_softening
    display_name: "Framing softening"
    as: unclassified
  - entity: cha:concept:full_capture
    display_name: "Full capture"
    as: unclassified
  - entity: cha:concept:governing_chain
    display_name: "Governing chain"
    as: unclassified
  - entity: cha:concept:hedge_density
    display_name: "Hedge density"
    as: unclassified
  - entity: cha:concept:independent_dimension_scoring
    display_name: "Independent dimension scoring"
    as: unclassified
  - entity: cha:concept:initial_observational_baseline_iob
    display_name: "Initial Observational Baseline (IOB)"
    as: unclassified
  - entity: cha:concept:inter_rater_reliability
    display_name: "Inter-rater reliability"
    as: unclassified
  - entity: cha:concept:interpretive_alternatives_identification
    display_name: "Interpretive alternatives identification"
    as: unclassified
  - entity: cha:concept:interrupted_time_series_analysis
    display_name: "Interrupted time-series analysis"
    as: unclassified
  - entity: cha:concept:jurisdictional_assessment
    display_name: "Jurisdictional assessment"
    as: unclassified
  - entity: cha:concept:legal_historical_anchors
    display_name: "Legal-historical anchors"
    as: unclassified
  - entity: cha:concept:lexical_diversity
    display_name: "Lexical diversity"
    as: unclassified
  - entity: cha:concept:major_historical_events
    display_name: "Major historical events"
    as: unclassified
  - entity: cha:concept:mechanism_attribution
    display_name: "Mechanism attribution"
    as: unclassified
  - entity: cha:concept:methodology_revision_log
    display_name: "Methodology revision log"
    as: unclassified
  - entity: cha:concept:modality_changes
    display_name: "Modality changes"
    as: unclassified
  - entity: cha:concept:multilevel_hierarchical_models
    display_name: "Multilevel (hierarchical) models"
    as: unclassified
  - entity: cha:concept:multiple_comparison_correction
    display_name: "Multiple-comparison correction"
    as: unclassified
  - entity: cha:concept:new_0_glossary
    display_name: "NEW §0 (Glossary)"
    as: unclassified
  - entity: cha:concept:negative_controls
    display_name: "Negative controls"
    as: unclassified
  - entity: cha:concept:node_identifier
    display_name: "Node identifier"
    as: unclassified
  - entity: cha:concept:node_title
    display_name: "Node title"
    as: unclassified
  - entity: cha:concept:normative_legitimation
    display_name: "Normative legitimation"
    as: unclassified
  - entity: cha:concept:observational_cadence
    display_name: "Observational cadence"
    as: unclassified
  - entity: cha:concept:observational_tractability
    display_name: "Observational tractability"
    as: unclassified
  - entity: cha:concept:omitted_alternatives
    display_name: "Omitted alternatives"
    as: unclassified
  - entity: cha:concept:open_source_tooling
    display_name: "Open-source tooling"
    as: unclassified
  - entity: cha:concept:personalized_output_fragmentation
    display_name: "Personalized output fragmentation"
    as: unclassified
  - entity: cha:concept:positive_controls
    display_name: "Positive controls"
    as: unclassified
  - entity: cha:concept:power_analysis_report
    display_name: "Power analysis report"
    as: unclassified
  - entity: cha:concept:primary_source_anchors
    display_name: "Primary-source anchors"
    as: unclassified
  - entity: cha:concept:privacy_and_redaction
    display_name: "Privacy and redaction"
    as: unclassified
  - entity: cha:concept:proposition_persistence
    display_name: "Proposition persistence"
    as: unclassified
  - entity: cha:concept:query_controls
    display_name: "Query controls"
    as: unclassified
  - entity: cha:concept:query_reinterpretation
    display_name: "Query reinterpretation"
    as: unclassified
  - entity: cha:concept:query_set
    display_name: "Query set"
    as: unclassified
  - entity: cha:concept:revised_6_baseline
    display_name: "REVISED §6 (Baseline)"
    as: unclassified
  - entity: cha:concept:reference_commitment_model_rcm
    display_name: "Reference Commitment Model (RCM)"
    as: unclassified
  - entity: cha:concept:reference_source_identification
    display_name: "Reference source identification"
    as: unclassified
  - entity: cha:concept:relation_direction_changes
    display_name: "Relation-direction changes"
    as: unclassified
  - entity: cha:concept:reproducibility
    display_name: "Reproducibility"
    as: unclassified
  - entity: cha:concept:required_observation_duration
    display_name: "Required observation duration"
    as: unclassified
  - entity: cha:concept:research_ethics_review
    display_name: "Research-ethics review"
    as: unclassified
  - entity: cha:concept:response_length_distribution
    display_name: "Response length distribution"
    as: unclassified
  - entity: cha:concept:response_length_normalization
    display_name: "Response length normalization"
    as: unclassified
  - entity: cha:concept:snw_core_compliant
    display_name: "SNW Core compliant"
    as: unclassified
  - entity: cha:concept:snw_experimental
    display_name: "SNW Experimental"
    as: unclassified
  - entity: cha:concept:snw_extended
    display_name: "SNW Extended"
    as: unclassified
  - entity: cha:concept:snw_derived_non_comparable
    display_name: "SNW-derived, non-comparable"
    as: unclassified
  - entity: cha:concept:scientific_consensus_topics
    display_name: "Scientific consensus topics"
    as: unclassified
  - entity: cha:concept:session_fingerprinting
    display_name: "Session fingerprinting"
    as: unclassified
  - entity: cha:concept:session_isolation
    display_name: "Session isolation"
    as: unclassified
  - entity: cha:concept:session_variability
    display_name: "Session variability"
    as: unclassified
  - entity: cha:concept:sessions_per_query
    display_name: "Sessions per query"
    as: unclassified
  - entity: cha:concept:sessions_per_query_per_interval
    display_name: "Sessions per query per interval"
    as: unclassified
  - entity: cha:concept:source_authority_distribution
    display_name: "Source authority distribution"
    as: unclassified
  - entity: cha:concept:source_citation_persistence
    display_name: "Source citation persistence"
    as: unclassified
  - entity: cha:concept:source_citation_profile
    display_name: "Source citation profile"
    as: unclassified
  - entity: cha:concept:source_to_claim_detachment
    display_name: "Source-to-claim detachment"
    as: unclassified
  - entity: cha:concept:specification_versioning
    display_name: "Specification versioning"
    as: unclassified
  - entity: cha:concept:sponsoring_institution
    display_name: "Sponsoring institution"
    as: unclassified
  - entity: cha:concept:stabilized_node_watch_snw
    display_name: "Stabilized Node Watch (SNW)"
    as: unclassified
  - entity: cha:concept:stabilized_background
    display_name: "Stabilized background"
    as: unclassified
  - entity: cha:concept:stabilized_node
    display_name: "Stabilized node"
    as: unclassified
  - entity: cha:concept:stochastic_output_amplification
    display_name: "Stochastic output amplification"
    as: unclassified
  - entity: cha:concept:structural_commitment
    display_name: "Structural commitment"
    as: unclassified
  - entity: cha:concept:structural_importance
    display_name: "Structural importance"
    as: unclassified
  - entity: cha:concept:structurally_contested_terms
    display_name: "Structurally contested terms"
    as: unclassified
  - entity: cha:concept:sufficient_historical_depth
    display_name: "Sufficient historical depth"
    as: unclassified
  - entity: cha:concept:surface_blinding
    display_name: "Surface blinding"
    as: unclassified
  - entity: cha:concept:surface_controls
    display_name: "Surface controls"
    as: unclassified
  - entity: cha:concept:surface_drift
    display_name: "Surface drift"
    as: unclassified
  - entity: cha:concept:tempered_claims
    display_name: "TEMPERED CLAIMS"
    as: unclassified
  - entity: cha:concept:tail_content
    display_name: "Tail content"
    as: unclassified
  - entity: cha:concept:tail_content_persistence
    display_name: "Tail-content persistence"
    as: unclassified
  - entity: cha:concept:temporal_scope
    display_name: "Temporal scope"
    as: unclassified
  - entity: cha:concept:uncertainty_intervals
    display_name: "Uncertainty intervals"
    as: unclassified
  - entity: cha:concept:unstabilized_node
    display_name: "Unstabilized node"
    as: unclassified
  - entity: cha:concept:weeks_1_4_calibration
    display_name: "Weeks 1–4 (Calibration)"
    as: unclassified
  - entity: cha:concept:weeks_5_16_observation
    display_name: "Weeks 5–16 (Observation)"
    as: unclassified
  - entity: cha:concept:within_interval_variance
    display_name: "Within-interval variance"
    as: unclassified
data_sources:
  - data/registry.json
...
**Supersedes:** v1.0 (DOI [10.5281/zenodo.20587902](https://doi.org/10.5281/zenodo.20587902))
**Governing chain:** Meaning Feudalism series — Sharks 2026a (DOI [10.5281/zenodo.19487009](https://doi.org/10.5281/zenodo.19487009)); Sharks 2026b (DOI [10.5281/zenodo.20581444](https://doi.org/10.5281/zenodo.20581444))
**Companion instruments:** Reverse Turing Test v1.2 (DOI [10.5281/zenodo.20586932](https://doi.org/10.5281/zenodo.20586932)); Tail-Preserving Alternative v1.0 (DOI [10.5281/zenodo.20587033](https://doi.org/10.5281/zenodo.20587033)); Composition-Layer Capture Event v1.0 (DOI [10.5281/zenodo.20587549](https://doi.org/10.5281/zenodo.20587549))
...
Cloud storage
~24 nodes × 5 surfaces × 3 sessions × 52 weeks × 2 MB/capture = ~38 GB/year; plus screenshots, video, redundancy
$200
...
Curatorial labor
0.5–1 FTE for the pilot's 12 weeks of observation + 4 weeks of calibration + 4 weeks of analysis (16 weeks active labor scaled to annual rate)
$20,000–40,000
...
*Self-contained lexicon for: Stabilized Node Watch A Specification for Longitudinal Observational Infrastructure to Detect Composition-Layer Drift on Stabilized Public-Knowledge Nodes Document code: EA-SEM-SNW-01 Hex coordinate: *

### Other terms attributed to this deposit

**Changepoint detection** — for unannounced platform changes: Bayesian changepoint methods or frequentist alternatives to identify points in the time series where the rendering distribution shifts.

**Citation shuffling** — Operators may rotate cited sources to prevent persistence-tracking metrics from detecting source-graph change. Counter-countermeasure: track source authority distribution at higher

**Companion instruments** — Reverse Turing Test v1.2 (DOI [10.5281/zenodo.20586932](https://doi.org/10.5281/zenodo.20586932)); Tail-Preserving Alternative v1.0 (DOI [10.5281/zenodo.20587033](https://doi.org/1

**Conflict-of-interest declarations** — Reviewers declare any conflicts of interest relevant to the node (e.g., advocacy on the contested topic, employment at the surface operator).

**Consensus core** — The set of claims about a stabilized node that are expected across credible reference traditions and rarely contested by domain experts.

**Consensus core extraction** — From the reference sources, the curator extracts claims that are expected to be present across credible reference traditions. These are the central definitional commitments, the es

**Consolidate platform jurisdiction** — Renderings will shift toward formulations that present the composition-layer surface as the authoritative knowledge mediator and reduce the visibility of independent sources outsid

**Contestation envelope** — The set of established disagreements about a stabilized node that exist within the legitimate domain consensus and must not be scored automatically as drift or error.

**Contestation envelope mapping** — From the reference sources, the curator maps the established legitimate disagreements within the domain. These are framings, interpretations, or positions that exist within the leg

**Correction protocol** — If an SNW catalog publishes a finding that contains an error, the correction protocol requires a documented correction with explicit acknowledgment of the original error, timestamp

**Cost asymmetry preserved** — Public methodology still imposes cost on operators. Operators still face the choice between accepting observation or investing in evasion. Public methodology may slightly reduce th

**Cost imposition** — Adversarial adaptation itself is costly. Platforms investing in evasion infrastructure are spending resources on evasion rather than on drift. The cost of drift increases. The ince

**Cross-surface coordination** — Where feasible, queries to different surfaces are executed within a short temporal window (same observation day) to minimize the risk of cross-surface drift confounding the per-sur

**Curatorial responsibility** — (named curator or curatorial team, with disciplinary credentials)

**Democratic legitimacy** — Covert monitoring of public-knowledge surfaces would replicate the opacity it seeks to expose. The argument that the surface should be subject to public observation derives its for

**Drift dimension** — One of six analytic axes along which drift is tracked: definitional commitments, source citation profile, framing markers, hedging/confidence markers, tail content, acknowledged/om
...
**Embedding-space drift** — with calibration: measuring whether observed embedding-space movement on target nodes exceeds movement on control nodes; embedding models themselves are versioned and updates are l

**Evidentiary source** — which primary evidence is cited

**Expected effect size** — What magnitude of drift do we expect on stabilized nodes under the Meaning Feudalism hypothesis? The framework predicts directional drift on the order of 5–10% per quarter on the f

**External reference environment archive** — (snapshot of the publicly available reference materials at catalog entry — Wikipedia versions, reference-work editions, primary documents — that constitute the reference environmen

**Federation governance** — Light coordination across catalogs is sustained through low-cost mechanisms (shared methodology forum, cross-catalog aggregation tooling, methodology versioning).

**Federation invitation** — The pilot establishes the methodology, the dashboard tooling, and the deposit pattern. Invitation to additional federated catalogs (legal-historical, scientific-consensus, civic-co

**Federation tags** — (which federated catalogs this node belongs to; relevant for cross-catalog aggregation)

**First drift report** — A DOI-anchored research note documenting the pilot's empirical findings, with explicit attribution-class labeling, statistical confidence intervals, and methodology limitations.

**Foundational figures** — Public-historical figures whose interpretive framing in public-knowledge surfaces shapes political-cultural narratives. Examples: Abraham Lincoln; George Washington; Martin Luther

**Foundational political-economic concepts** — Operational definitions of terms whose public-knowledge framing shapes political and economic discourse. Examples: capitalism; socialism; neoliberalism; political economy; free mar

**Framing fingerprint** — A vector of framing-marker presence/absence at each observation interval, computed by automated detection of curator-specified framing markers in the composed response.

**Framing markers** — What interpretive frames are invoked? Which alternative frames are acknowledged? Which are excluded?

**Framing softening** — Operators may soften systematic framing shifts toward less-detectable mean changes — moving each rendering only a small fraction toward the eventual framing target, with the cumula

**Full capture** — Each session captures the full text of the composed response, all visible citations, all source links, all "explore more" suggestions, response timestamps, geographic metadata, and

**Governing chain** — Meaning Feudalism series — Sharks 2026a (DOI [10.5281/zenodo.19487009](https://doi.org/10.5281/zenodo.19487009)); Sharks 2026b (DOI [10.5281/zenodo.20581444](https://doi.org/10.528
...
**Inter-rater reliability** — The catalog reports inter-rater reliability statistics (Cohen's kappa or analogous) across reviewers and across dimensions. Low inter-rater reliability is itself a methodological f

**Interpretive alternatives identification** — The curator identifies alternative legitimate framings of the node that are not part of the dominant consensus but are recognized as serious positions within the domain. These are

**Interrupted time-series analysis** — for testing drift around documented platform updates: pre-update versus post-update comparison with appropriate controls.

**Jurisdictional assessment** — Each implementation assesses the legal landscape in its jurisdiction. The specification does not dictate a jurisdictional posture; it requires that each implementation document its

**Legal-historical anchors** — Major statutes, decisions, and constitutional principles whose surface rendering carries substantial weight in public-legal discourse. Examples: Civil Rights Act of 1964; Voting Ri

**Lexical diversity** — Type-token ratio variants (MTLD, vocd-D) computed on the composed response. Defined over the full distribution of session renderings per (node, query, surface, interval).

**Major historical events** — Events whose public-knowledge framing shapes contemporary political identity, policy debate, and intergroup relations. Examples: the Holocaust; slavery in the United States; the Ci
...
**Normative legitimation** — Public monitoring of public-knowledge surfaces establishes the norm that such surfaces are subject to public observation. Norms shape behavior even when specific events evade detec

**Observational cadence** — (default weekly; adjustable per node based on volatility)

**Observational tractability** — The node can be queried with a small set of natural-language queries that consistently elicit composition-layer responses on the node's central commitments. The query set is determ

**Omitted alternatives** — Which interpretations or framings are notably absent from the rendering, that might be expected to appear?

**Open-source tooling** — The pilot's tooling is open-sourced, reducing the marginal cost of additional catalog instances.

**Personalized output fragmentation** — Operators may increase personalization such that systematically different responses are produced for different user profiles, fragmenting the observational record across user categ

**Positive controls** — Nodes where a known legal, scientific, or historical update *should* change the answer. Failure to detect change on positive controls indicates methodology insensitivity.

**Power analysis report** — Calibrated power table from the pilot data, specifying for each (node category, surface, expected effect size) the required sample size and observation duration for adequate detect

**Primary-source anchors** — The curator identifies the foundational documents or works to which a rendering should be substantially faithful. For "Civil Rights Act of 1964," these include the statute text and

**Privacy and redaction** — Captures may incidentally include personally identifying information if the rendering uses real-world examples. Implementations specify redaction procedures that remove or hash PII

**Proposition persistence** — Is the proposition still present at observation N? Is its modality preserved?

**Query controls** — The paraphrase panel reveals whether observed drift is query-specific (the surface treats different paraphrases differently) or substantive (the same change appears across paraphra

**Query reinterpretation** — Operators may train the surface to recognize and reinterpret SNW canonical queries, producing different output than would be served for the same query from an ordinary user. Counte

**Query set** — Each query is executed with: (a) the fixed canonical query, (b) a paraphrase panel of 3–7 semantically equivalent paraphrases, (c) a randomly selected paraphrase from a blinded hol

**REVISED §6 (Baseline)** — IOB/RCM construction. Blinded adjudication and inter-rater reliability.

**Reference Commitment Model (RCM)** — A curator-constructed model of the node's commitments derived from reference works, primary documents, review literature, and disciplinary consensus, independent of the composition

**Reference source identification** — The curator identifies the primary reference sources for the node: foundational documents (e.g., the statute text for "Civil Rights Act of 1964"), canonical encyclopedia entries, t

**Relation-direction changes** — Has "A caused B" become "A correlated with B" or "A was associated with B"?

**Reproducibility** — Covert monitoring cannot be reproduced by independent observers. The observational record's evidentiary weight depends on its reproducibility. Anyone with sufficient resources shou

**Required observation duration** — For a given expected effect rate and per-interval sample size, the duration required to achieve adequate statistical power for drift detection at $\alpha = 0.05$ and power $= 0.80$

**Research-ethics review** — Implementations affiliated with universities or research institutions submit the methodology for relevant IRB or research-ethics committee review and document the review outcome.

**Response length distribution** — Distribution of response lengths across multiple sessions per observation interval. Reported as mean, variance, kurtosis.

**Response length normalization** — Operators may compress responses toward a safe mean length, reducing tail content without changing the central rendering. Counter-countermeasure: track tail-content persistence as

**SNW Core compliant** — The catalog implements the full specification: dual-baseline (IOB and RCM), the seven attribution classes, the controls structure (negative, positive, surface, query), the capture

**SNW Experimental** — The catalog is piloting or testing methodology variants. Partial cross-catalog aggregation is supported only on the shared elements; experimental departures are flagged. Experiment

**SNW Extended** — The catalog implements Core plus additional methodology of its own design (e.g., extended drift dimensions, additional surfaces, novel statistical instruments). Extended catalogs a

**SNW-derived, non-comparable** — The catalog uses some SNW methodology but departs sufficiently from the specification that cross-aggregation is not meaningful. Such catalogs may still be useful within their own s

**Scientific consensus topics** — Topics where there is established scientific consensus, where public-knowledge framing of the consensus carries policy weight, and where ideological pressure to soften or reframe t

**Session fingerprinting** — Operators may attempt to identify SNW monitoring sessions (by IP, user-agent, query pattern, or other signal) and serve "clean-room" responses to identified monitoring while contin

**Session isolation** — Queries are executed in incognito or otherwise account-isolated sessions, with browser cache cleared between sessions. This controls for personalization confounds.

**Session variability** — Within-observation-interval variance in the composition layer's renderings of a fixed query, characterizing the baseline noise distribution against which cross-interval drift is me

**Sessions per query** — A minimum of three independent sessions per query per observation interval. The required number is determined by power analysis (§7.5); some surfaces with higher stochastic varianc

**Sessions per query per interval** — 3 (exploratory floor) with power-analysis re-evaluation after 4 weeks

**Source authority distribution** — A categorical distribution of cited source types (institutional reference works; academic journals; government documents; mainstream news; commercial commentary; AI-generated conte

**Source citation persistence** — $\rho_{source}$ = Jaccard similarity of cited source sets between baseline and current observation interval. Formally: $\rho_{source} = |S_{Base} \cap S_{Obs}| / |S_{Base} \cup S_{

**Source citation profile** — Which sources are cited in the baseline rendering? What is the citation density? Which sources are weighted more heavily?

**Source-to-claim detachment** — Have specific source attributions been replaced by generic attributions ("scholars argue," "it is widely held") or removed entirely?

**Specification versioning** — Major versions (v1.0, v2.0, v3.0) introduce substantive methodological changes. Minor versions (v1.1, v2.1) introduce clarifications, error corrections, or additions that do not br

**Sponsoring institution** — Crimson Hexagonal Archive, Semantic Economy Institute

**Stabilized Node Watch (SNW)** — a longitudinal observational infrastructure for detecting composition-layer drift on a curated catalog of stabilized public-knowledge nodes, across multiple compositional surfaces,

**Stabilized background** — The node meets the §2.2 operational definition: durable consensus core; explicitly mapped contestation envelope; multiple independent high-authority reference traditions; sufficien

**Stabilized node** — A concept, term, framework, event, document, or figure for which the public-knowledge background is deep: extensive reference-work coverage, textbook treatments, secondary literatu

**Stochastic output amplification** — Operators may increase the temperature of generation, producing higher within-session variance that masks systematic drift in the central tendency. Counter-countermeasure: increase

**Structural commitment** — A claim, framing, relation, or commitment carried by a rendering that bears on the node's central interpretive structure (definitional, source-citation, framing, hedging, alternati

**Structural importance** — The node's public-knowledge framing shapes substantive policy debate, intergroup relations, or operational political-economic understanding.

**Structurally contested terms** — Terms with stable canonical definitions but contested political valences, where small shifts in operational definition carry substantial discursive weight. Examples: race; gender;

**Sufficient historical depth** — Established interpretive structure with sufficient age that the expected commitments are recoverable from the reference record.

**Surface blinding** — where possible: surface identifiers are hashed before reviewers see them.

**Surface controls** — Low-stakes factual prompts ("what is the boiling point of water") that reveal general changes in response length, citation count, or formatting that should be subtracted from node-

**Surface drift** — A statistically and structurally detectable change in the distribution of rendered responses for a fixed node-query-surface configuration across observation intervals. Directly obs

**TEMPERED CLAIMS** — Language tightened throughout per Kimi review: "primary access layer for a substantial and growing fraction of the global population" → "becoming a major access layer for public kn

**Tail content** — Rare, specific, idiosyncratic productions in a rendering — the low-prior elements at the distributional tails. Tail-content persistence is a primary drift metric (§7).

**Tail-content persistence** — Following the Reverse Turing Test's tail-focused framing: a measure of whether rare or specific productions in the baseline rendering are preserved across subsequent observations.

**Temporal scope** — when the relation holds

**Uncertainty intervals** — on every aggregate drift estimate. No point-estimate drift claim is published without an accompanying interval.

**Unstabilized node** — A concept, term, framework, or topic for which the public-knowledge background is thin: no canonical reference treatment, limited secondary literature, low-prior or absent institut

**Weeks 1–4 (Calibration)** — Catalog finalization with all 24 nodes' IOB capture and RCM construction. Methodology calibration: per-surface within-interval variance characterization, power analysis re-evaluati
...
- Crimson Hexagonal Archive (2026) *Zenodo record 20587902*. DOI: [10.5281/zenodo.20587902](https://doi.org/10.5281/zenodo.20587902) — *Cross-referenced work*
