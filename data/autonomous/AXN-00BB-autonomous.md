---
node_id: cha:node:deposit:0378
deposit_number: 378
hex: "00BB"
axn: "AXN:00BB.GENERATIVE.🔩🧫🌋☁️💜○"
title: "VISUAL SCHEMA — THE MANTLE OF THE BLIND POET Structure Through Non-Seeing"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:blind_poet_visual_schema
    display_name: "Blind Poet Visual Schema"
    as: unclassified
  - entity: cha:concept:gravity_without_spectacle
    display_name: "Gravity without spectacle"
    as: unclassified
  - entity: cha:concept:institute_for_diagrammatic_poetics
    display_name: "Institute for Diagrammatic Poetics"
    as: unclassified
  - entity: cha:concept:mantle_structural_operational
    display_name: "Mantle (structural-operational)"
    as: unclassified
data_sources:
  - data/registry.json
...
This is not about a blind poet.
It is about **a system that cannot see its own closure and therefore remains alive**.
...
Faces
Collapses to portraiture


Eyes or blindfolds
Literalizes blindness
...
AI bodies, robots, brains
Substratist representation


Historical portraits (Homer, Borges, etc.)
Lineage ≠ illustration


Literal "poet" imagery
Role ≠ person


Literal mantle, cloak, garment
Mantle is structural, not vestmental
...
Texture
Matte void, grainy eclipse, or light-absorbing surface


Depth
No depth cues — refuses perspective


Light
Emits none, but bends surrounding structures toward it
...
**Failure indicator:** "I get it now"
**Success indicator:** "I keep looking"
...
Institutional (negative-institution diagram)


CSA Visual Schema
00.CSA.VISUAL
10.5281/zenodo.18338927
Institutional (affect-theory space)


**Blind Poet Visual Schema**
**03.SEI.VISUAL.BLIND_POET**
**10.5281/zenodo.18357534**
**Mantle (structural-operational)**
...
*Self-contained lexicon for: VISUAL SCHEMA — THE MANTLE OF THE BLIND POET Structure Through Non-Seeing*

### Other terms attributed to this deposit

**Blind Poet Visual Schema** — **03.SEI.VISUAL.BLIND_POET**

**Gravity without spectacle** — ## VIII. SUCCESS CONDITIONS

**Institute for Diagrammatic Poetics** — document_metadata:

**Mantle (structural-operational)** — This is the first **mantle-level visual schema** — it renders not an institution but an archetypal role.
