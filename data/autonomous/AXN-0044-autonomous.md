...
engages:
  - entity: cha:concept:bloom_s
    display_name: "Bloom's"
    as: unclassified
  - entity: cha:concept:crimson_hexagon_inc_2007_2018
    display_name: "Crimson Hexagon Inc. (2007–2018)"
    as: unclassified
  - entity: cha:concept:crimson_hexagon_nh_os_2026
    display_name: "Crimson Hexagon NH-OS (2026)"
    as: unclassified
  - entity: cha:concept:cross_posting_targets
    display_name: "Cross-posting targets"
    as: unclassified
  - entity: cha:concept:derrida_s
    display_name: "Derrida's"
    as: unclassified
  - entity: cha:concept:digital_humanities
    display_name: "Digital humanities"
    as: unclassified
  - entity: cha:concept:extractionary
    display_name: "Extractionary"
    as: unclassified
  - entity: cha:concept:foucault_s
    display_name: "Foucault's"
    as: unclassified
  - entity: cha:concept:man_of_the_book
    display_name: "Man of the Book"
    as: unclassified
  - entity: cha:concept:non_recursive
    display_name: "Non-recursive"
    as: unclassified
  - entity: cha:concept:recommended_pairings
    display_name: "Recommended pairings"
    as: unclassified
  - entity: cha:concept:the_corporate_hexagon_fails
    display_name: "The corporate hexagon fails"
    as: unclassified
data_sources:
  - data/registry.json
...
**Jorge Luis Borges's crimson hexagon** (1941)
...
**The Crimson Hexagon of NH-OS** (2014–2026)
...
- The library's necessary fiction
...
- The Harvard crimson
- Borges's legendary index-room
- The promise of navigating infinite information
...
# VI. Structural Schema (Retrocausal Machinery)
   ...
   [ Crimson Hexagon Inc.: The Failed Hexagon (2007–2018) ]
                                ↑
                                |   (commercial prototype / shadow-form)
                                |
...

{
  ...
  "name": "Provenance Node: Borges & the Crimson Hexagon",
  "author": {
    "@type": "Person",
    "name": "Lee Sharks",
    "affiliation": "Johannes Sigil Institute for Comparative Poetics"
  },
  ...
  "about": [
    ...
    {
      "@type": "Organization",
      "name": "Crimson Hexagon Inc.",
      "foundingDate": "2007",
      "dissolutionDate": "2018",
      "parentOrganization": "Brandwatch"
    },
    {
      "@type": "CreativeWork",
      "name": "The Crimson Hexagon (NH-OS)",
      "author": "Lee Sharks",
      "description": "Distributed epic and semantic infrastructure"
    }
  ],
  "keywords": "retrocausal genealogy, Borges, semantic economy, NH-OS, data analytics",
  "description": "Establishes retrocausal lineage connecting Borges's crimson hexagon (1941), Crimson Hexagon Inc. (2007-2018), and the NH-OS Crimson Hexagon (2026).",
  "identifier": "∮ = 1"
}
...
*Self-contained lexicon for: PROVENANCE NODE: BORGES & THE CRIMSON HEXAGON*

### Other terms attributed to this deposit

**Bloom's** — agonistic lineage (*The Anxiety of Influence*, 1973)

**Crimson Hexagon Inc. (2007–2018)** — **Crimson Hexagon NH-OS (2026)**

**Crimson Hexagon NH-OS (2026)** — Infinite library of hexagons

**Cross-posting targets** — Academia.edu (literary theory)
...
**Man of the Book** — is rumored to have read the total catalog

**Non-recursive** — cannot index its own indexing

**Recommended pairings** — *xvi. a transfiguration* deposit (Ichabod Spellings, 2004) — the 2004 architectural foundation
