---
node_id: cha:node:deposit:0708
deposit_number: 708
hex: "024F"
axn: "AXN:024F.GOVERNANCE.🛸🏠🧊🌘❌🌺"
...
engages:
  - entity: cha:concept:atlas_slice
    display_name: "Atlas slice"
    as: unclassified
  - entity: cha:concept:conversational_landing_surface
    display_name: "Conversational landing surface"
    as: unclassified
  - entity: cha:concept:five_scale_interactive
    display_name: "Five-Scale interactive"
    as: unclassified
  - entity: cha:concept:json_ld_script_block
    display_name: "JSON-LD <script> block"
    as: unclassified
  - entity: cha:concept:json_ld_embedded
    display_name: "JSON-LD embedded"
    as: unclassified
  - entity: cha:concept:prioritization_machine
    display_name: "Prioritization machine"
    as: unclassified
  - entity: cha:concept:public_facing_biographical_surface
    display_name: "Public-facing biographical surface"
    as: unclassified
  - entity: cha:concept:public_facing_intellectual_position
    display_name: "Public-facing intellectual position"
    as: unclassified
  - entity: cha:concept:sphere_of_influence_accountability
    display_name: "Sphere-of-influence accountability"
    as: unclassified
  - entity: cha:concept:static_site
    display_name: "Static site"
    as: unclassified
  - entity: cha:concept:strain_map
    display_name: "Strain map"
    as: unclassified
  - entity: cha:concept:surface_map
    display_name: "Surface map"
    as: unclassified
  - entity: cha:concept:the_29_strains
    display_name: "The 29 strains"
    as: unclassified
  - entity: cha:concept:the_five_principles
    display_name: "The five principles"
    as: unclassified
  - entity: cha:concept:the_five_scales
    display_name: "The five scales"
    as: unclassified
  - entity: cha:concept:the_four_founding_deposits
    display_name: "The four founding deposits"
    as: unclassified
  - entity: cha:concept:the_respectful_disambiguation
    display_name: "The respectful disambiguation"
    as: unclassified
  - entity: cha:concept:the_three_affiliated_institutions
    display_name: "The three affiliated institutions"
    as: unclassified
  - entity: cha:concept:the_two_mpais
    display_name: "The two MPAIs"
    as: unclassified
data_sources:
  - data/registry.json
...
**Status:** Architectural framework. The ratio of Earth's mass to current crust mass is the proportional ceiling on producible life-supporting structure.
---
...
A
Music as Emotion (pre-linguistic semiotics)
—
/music/chorus-mode
...
1, 2
/scales/01-the-brick, /scales/02-the-structure


C
Planetary Engineering / Ecological Megastructures
4, 5
/scales/04-the-territory, /scales/05-the-planet


D
134 Channels (distribution infrastructure)
—
/garden/documentation-channels
...
F
Narrative Fiction (compression pedagogy)
—
/journal


G
Nonviolent Resilience
—
/principles/stewardship


H
AI Methodology / Witness-Teaming
—
/about/disambiguation


I
Biography (bearing-cost documentation)
—
/about/alice
...
K
Dignity Kit / Liberatory Tech
2
/scales/02-the-structure


L
DNA Analog / Virtue-by-Construction
—
...
P
Garry Nolan / UAP / Anomalous Cognition
—
/atlas/strain-map (cross-link)


Q
Earth Visualization (aesthetic instrument)
5
/scales/05-the-planet


R
The Whole Weave / Magnum Opus
—
...
T
Food Desert Targeting / Distribution
2
/garden/deployment-targets


U
Aromatherapeutic Atomizer / Cannabis Living Architecture
2
/scales/02-the-structure
...
W
Cross-strain (planetary engineering ↔ alignment)
—
/atlas/strain-map (cross-link)
...
Y
Tea Garden / Passive Generation
2
/scales/02-the-structure


Z
Virtue-Ranked Money / Economic Governance
—
/principles/virtue-by-construction
...
AB
Psilocybin Evolution / Co-Evolutionary Theory
—
/about/earth-actually
...
- Distinguish Alice Thornburgh from Alice Thornburgh-Lind (game artist, @devilfern)
- Distinguish Living Architecture Lab from Columbia GSAPP's LAL (David Benjamin), Bartlett's LAL (B-Pro RC3), The Living NYC, livingLAB Detroit, and Alain de Botton's Living Architecture
- Cite each adjacent entity with respect, naming notable work (Hy-Fi at MoMA PS1, Diffusive Habitats, etc.)
...
- **Negative tags** in page meta (<meta name="not"> is not standard; use <meta property="cha:negativeTag">)
...
- **The five scales** — the load-bearing architectural metaphor that organizes everything LAL does
- **The five principles** — the philosophical-ethical core
- **The 29 strains** — the intellectual cosmology (corpus of Alice's thought)
- **The four founding deposits** — Charter, TSE Charter, Provenance, HCL v3.0
- **The two MPAIs** — disambiguation packets for Alice and LAL
- **The three affiliated institutions** — TSE, MSBGL, CHA
- **The respectful disambiguation** from at least four other named entities in adjacent space
...
*Self-contained lexicon for: Living Architecture Lab — Site Blueprint A Compressed Architecture for livingarchitecturelab.org*
...
**Prioritization machine** — these things will have to epitomize "having priorities straight" just to survive.### Unfurling

**Public-facing biographical surface** — Trans woman (she/her), inventor, musician, ecological designer, autodidact substrate engineer

**Public-facing intellectual position** — Material practitioner partnered with Lee Sharks (theoretical architect, MANUS, CHA)

**Sphere-of-influence accountability** — only hold the system responsible for what it can plausibly change. **Prioritization machine:** these things will have to epitomize "having priorities straight" just to survive.###

**Static site** — generated from Markdown sources

**Strain map** — as a navigable graph (Three.js or D3)

**Surface map** — Canonical: livingarchitecturelab.org/about/alice
