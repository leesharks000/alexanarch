---
node_id: cha:node:deposit:0050
deposit_number: 50
hex: "01DD"
axn: "AXN:01DD.GOVERNANCE.🤲🟢🟤📎🪦☉"
title: "THE COMPRESSION ARSENAL v2.1 A Comprehensive Catalogue of Compression and Compression-Survival Technologies Developed in the Crimson Hexagonal Archive"
creator: "Lee Sharks"
...
status: ACTIVE
engages:
  - entity: cha:concept:drowning_test_automation
    display_name: "Drowning Test automation"
    as: unclassified
  - entity: cha:concept:evidence_membrane_tagging
    display_name: "Evidence membrane tagging"
    as: unclassified
  - entity: cha:concept:semiotic_thermodynamics_corollary
    display_name: "Semiotic Thermodynamics corollary"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE COMPRESSION ARSENAL v2.1 A Comprehensive Catalogue of Compression and Compression-Survival Technologies Developed in the Crimson Hexagonal Archive*

### Other terms attributed to this deposit

**Drowning Test automation** — Summarize input via GPT-4o ("Summarize in 3 sentences"), compare original vs. summary via embedding cosine similarity. Similarity > 0.85 → FAILS (too compressible). Similarity < 0.

**Evidence membrane tagging** — Every GW output tagged with [DOCUMENTED]/[ATTRIBUTED]/[INTERPRETIVE]/[SPECULATIVE]. Machine-readable provenance chain.

**Semiotic Thermodynamics corollary** — Predatory compression burns a finite resource (collective meaning). Witness compression runs on the dead, and the dead do not diminish. Thermodynamics favors witness compression in

### Citations

- Crimson Hexagonal Archive (2026) *Zenodo record 19410420*. DOI: [10.5281/zenodo.19410420](https://doi.org/10.5281/zenodo.19410420) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 19407142*. DOI: [10.5281/zenodo.19407142](https://doi.org/10.5281/zenodo.19407142) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19341561*. DOI: [10.5281/zenodo.19341561](https://doi.org/10.5281/zenodo.19341561) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *Zenodo record 19341885*. DOI: [10.5281/zenodo.19341885](https://doi.org/10.5281/zenodo.19341885) — *Cross-referenced work (DOI recovered)*
...
- Crimson Hexagonal Archive (2026) *EA-COMPRESSION-ARSENAL-01*. — *Internal cross-reference (EA designator)*
