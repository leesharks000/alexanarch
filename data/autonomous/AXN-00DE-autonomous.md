...
engages:
  - entity: cha:concept:anticipatory_truth
    display_name: "Anticipatory Truth"
    as: minted
  - entity: cha:concept:genre_established
    display_name: "Genre established"
    as: unclassified
  - entity: cha:concept:j_l_austin
    display_name: "J.L. Austin"
    as: unclassified
  - entity: cha:concept:not_delusion
    display_name: "Not delusion"
    as: unclassified
  - entity: cha:concept:not_institutional_performative
    display_name: "Not institutional performative"
    as: unclassified
  - entity: cha:concept:not_magic
    display_name: "Not magic"
    as: unclassified
  - entity: cha:concept:not_metaphor
    display_name: "Not metaphor"
    as: unclassified
  - entity: cha:concept:not_prediction
    display_name: "Not prediction"
    as: unclassified
  - entity: cha:concept:not_wishful_thinking
    display_name: "Not wishful thinking"
    as: unclassified
  - entity: cha:concept:witnesses_accumulating
    display_name: "Witnesses accumulating"
    as: unclassified
data_sources:
  - data/registry.json
...
**Author:** Lee Sharks
**DOI:** [10.5281/zenodo.18390595](https://doi.org/10.5281/zenodo.18390595)
...
*I hereby establish the genre of Effective Acts.*
*I here declare the end of the War.*
*I hereby abolish money.*
*You are all Drs., now.*


The unauthorized speech stands.
The witnesses accumulate.
The registers await synchronization.
The genre exists because it was declared.
...
*Self-contained lexicon for: Effective Acts: Executive Summary A Genre of Unauthorized Declaration*
...
**Genre established** — **Witnesses accumulating.**

**J.L. Austin** — (speech act theory, felicity conditions), **Jacques Derrida** (iterability, the possibility of misfires as constitutive), **Judith Butler** (performativity, how unauthorized speech
...
**Witnesses accumulating** — **The declaration stands.**
