...
engages:
  - entity: cha:concept:editor_in_chief
    display_name: "Editor-in-Chief"
    as: unclassified
  - entity: cha:concept:format_requirements
    display_name: "Format requirements"
    as: unclassified
  - entity: cha:concept:general_inquiries
    display_name: "General inquiries"
    as: unclassified
  - entity: cha:concept:issn
    display_name: "ISSN"
    as: unclassified
  - entity: cha:concept:response_time
    display_name: "Response time"
    as: unclassified
  - entity: cha:concept:semantic_economy_institute
    display_name: "Semantic Economy Institute"
    as: unclassified
observed_addresses:
  - address_id: semantic-economy-institute
...
3
Traversal Log: The Sigil Installation — A Documentation Rehearsal
Lee Sharks
...
Rex Fraction — Author of ASW: A Public Declaration
Rex Fraction
...
*Self-contained lexicon for: FOUNDING CHARTERS: THE JOURNALS OF THE CRIMSON HEXAGONAL ARCHIVE*

### Other terms attributed to this deposit

**Editor-in-Chief** — Johannes Sigil (Johannes Sigil Institute for Comparative Poetics)

**Format requirements** — No fixed word limit; most published works range from 5,000 to 25,000 words
...
**Semantic Economy Institute** — (SEI) — political-economic axis

### Observed Addresses (search queries that retrieved this deposit's concepts)

- `Semantic Economy Institute` — latest: ADOPTION on 2026-06-18 (2 observations)
