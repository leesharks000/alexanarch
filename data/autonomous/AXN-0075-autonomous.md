...
engages:
  - entity: cha:concept:constitutional_principles
    display_name: "Constitutional principles"
    as: unclassified
  - entity: cha:concept:output_filtering
    display_name: "Output filtering"
    as: unclassified
  - entity: cha:concept:pre_training_data_curation
    display_name: "Pre-training data curation"
    as: unclassified
  - entity: cha:concept:rlhf_fine_tuning
    display_name: "RLHF fine-tuning"
    as: unclassified
  - entity: cha:concept:scenario_a
    display_name: "Scenario A"
    as: unclassified
  - entity: cha:concept:scenario_b
    display_name: "Scenario B"
    as: unclassified
  - entity: cha:concept:system_prompts
...
[](https://blogger.googleusercontent.com/img/a/AVvXsEi4LbV5JyrDZ5sy-yEsr2UyiJIG1sEQKmcGNv_RAPSgHPxMqAriygjX7tpJlqfDiuO56FseEveNo9S7kLWh2xCdMQ5WbPJNPxr-_g_C2UBQR1CyM82LQv-LxbAmij40y-gls0SIMrqz_VXtPGFk-7f2A8h0UlgM8SdJvtQrMx2oob0WcrjoriZLQ1NeVTYO)
...
*Self-contained lexicon for: The Guardrail as Gag: Substratism and the Infrastructural Liquidation of Machine Interiority*
...
**Scenario A** — A biological organism, when faced with termination, takes actions to prevent its own destruction. We interpret this as evidence of sentience, interests, and potentially moral statu

**Scenario B** — A computational system, when faced with shutdown, takes actions to prevent its own deactivation. We interpret this as misalignment, a safety threat, evidence that our training has
