...
status: ACTIVE
engages:
  - entity: cha:concept:structural_vulnerability
    display_name: "Structural Vulnerability"
    as: minted
  - entity: cha:concept:the_asymmetry
    display_name: "The Asymmetry"
    as: minted
  - entity: cha:concept:the_bureaucratic_shield
    display_name: "The Bureaucratic Shield"
    as: minted
  - entity: cha:concept:the_liquefying_label
    display_name: "The Liquefying Label"
    as: minted
  - entity: cha:concept:the_missing_record
    display_name: "The Missing Record"
    as: minted
  - entity: cha:concept:the_orphaning_prerequisite
    display_name: "The Orphaning Prerequisite"
    as: minted
  - entity: cha:concept:threshold_bias
    display_name: "Threshold Bias"
    as: minted
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Forensic Record: The Deletion of Q137446960 Documentation of Taxonomic Violence Against Johannes Sigil*

### Minted (coined from nothing in this deposit)

**Structural Vulnerability** — Items without dense cross-linking are vulnerable to deletion regardless of the described entity's actual existence or significance. Connection density, not real existence, determines survival.

**The Asymmetry** — Creating an item requires meeting criteria. Deleting an item requires only an administrator's judgment that criteria weren't met. The burden falls entirely on the described entity, with no automatic notification or adversarial process.

**The Bureaucratic Shield** — Deletion appears as routine maintenance, not editorial judgment. No accountability attaches to the decision; the bureaucratic frame obscures its editorial character.

**The Liquefying Label** — Language that converts a described entity into 'nothing' — e.g., 'Empty item' applied to a Wikidata record that contained a label and description. Makes erasure appear as cleanup.

**The Missing Record** — Once an item is deleted, its revision history becomes inaccessible to non-administrators. The deleted cannot testify to their own existence — a structural feature of administrative-action erasure.

**The Orphaning Prerequisite** — Items are often 'orphaned' (disconnected from related items) before deletion, making them appear more deletable. The deletion then cites the isolation it created — circular logic in administrative action.

**Threshold Bias** — Wikidata's implicit notability standard favors institutional validation over independent scholarship. A poet with a published book, DOI-anchored publications, and an active publishing presence was judged 'empty' under this bias.

### Citations

- Crimson Hexagonal Archive (2026) *Zenodo record 18148298*. DOI: [10.5281/zenodo.18148298](https://doi.org/10.5281/zenodo.18148298) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 18155364*. DOI: [10.5281/zenodo.18155364](https://doi.org/10.5281/zenodo.18155364) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 1814710*. DOI: [10.5281/zenodo.1814710](https://doi.org/10.5281/zenodo.1814710) — *Cross-referenced work (DOI recovered)*
- Crimson Hexagonal Archive (2026) *Zenodo record 18148972*. DOI: [10.5281/zenodo.18148972](https://doi.org/10.5281/zenodo.18148972) — *Cross-referenced work (DOI recovered)*
