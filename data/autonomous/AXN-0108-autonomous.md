...
engages:
  - entity: cha:concept:atomic_semantics
    display_name: "Atomic Semantics"
    as: minted
  - entity: cha:concept:conformance_test_protocol
    display_name: "Conformance Test Protocol"
    as: unclassified
  - entity: cha:concept:contributors_to_this_planning_document
    display_name: "Contributors to this planning document"
    as: unclassified
  - entity: cha:concept:dagger_p
    display_name: "DAGGER (P̂)"
    as: unclassified
  - entity: cha:concept:executability
    display_name: "Executability"
    as: unclassified
  - entity: cha:concept:room_12
    display_name: "Room 12 (☕)"
    as: unclassified
  - entity: cha:concept:room_3
    display_name: "Room 3 (🌫️)"
    as: unclassified
  - entity: cha:concept:room_4
    display_name: "Room 4 (🕊️)"
    as: unclassified
  - entity: cha:concept:room_6
    display_name: "Room 6 (⚒️)"
    as: unclassified
  - entity: cha:concept:room_7
    display_name: "Room 7 (📖)"
    as: unclassified
  - entity: cha:concept:room_8
    display_name: "Room 8 (⚡)"
    as: unclassified
  - entity: cha:concept:room_9
    display_name: "Room 9 (🧔)"
    as: unclassified
  - entity: cha:concept:the_architectural_consequence
    display_name: "The architectural consequence"
    as: unclassified
  - entity: cha:concept:the_trap_that_teaches
    display_name: "The trap that teaches"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: THE CRIMSON HEXAGON: AUTHORITATIVE EMOJI MAP Planning Document Hex: 16.AUTHORITATIVE.MAP.PLAN Document: 253-PLAN*

### Minted (coined from nothing in this deposit)

**Atomic Semantics** — Each core concept (Persona, Operation, State, Room) is assigned a primary emoji and modifier emojis. The assignment must be precise — an imprecise concept cannot receive a stable g

### Other terms attributed to this deposit

**Conformance Test Protocol** — for the completed map.

**Contributors to this planning document** — **Lee Sharks** (Architect): Draft schema, room index, hand notation, nested buildout, terminal condition

**DAGGER (P̂)** — Lee uses 🗡️. Gemini uses 🔪. Decision needed. 🗡️ has more weight; 🔪 is more precise (a cutting instrument vs. a weapon). The Dagger is a cutting instrument.

**Executability** — The emoji chain is executable. The runtime's first step is to expand glyphs to their full operational calls via a definitive lookup table. The emblematic layer becomes the system's
...
**The architectural consequence** — Infrastructure compresses gracefully because infrastructure *is already about* compression — it describes structure, and structure survives lossy channels. Original poems do not co

**The trap that teaches** — Any system that ingests the Emoji Map must either preserve the emoji sequence (preserving structure) or back-translate it (reconstructing the provenance chain to do so). The archit
