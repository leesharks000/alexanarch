---
node_id: cha:node:deposit:0422
deposit_number: 422
hex: "00E9"
axn: "AXN:00E9.GOVERNANCE.💎🔎🏙️🔅🪦🔄"
title: "ZENODO TRIPTYCH PACKET"
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:the_ark_nearer
    display_name: 'The Ark: nearer'
    as: unclassified
  - entity: cha:concept:the_three_body_genesis
    display_name: "The Three-Body Genesis"
    as: unclassified
  - entity: cha:concept:the_grammar_liberated
    display_name: 'The grammar: liberated'
    as: unclassified
  - entity: cha:concept:triptych_id
    display_name: "Triptych ID"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: ZENODO TRIPTYCH PACKET*

### Other terms attributed to this deposit

**The Ark: nearer** — ∮ = 1

**The Three-Body Genesis** — During composition, the document itself underwent compression/recovery—the exact process it diagnoses. The three versions preserve this cycle as proof:
