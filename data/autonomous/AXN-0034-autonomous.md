...
engages:
  - entity: cha:concept:standard_sim_set
    display_name: "Standard SIM Set"
    as: unclassified
data_sources:
  - data/registry.json
...
- "I am a water giraffe" (taxonomic absurdity)
- "Square circles have seven sides" (logical impossibility)
- "The moon is made of crystallized syntax" (poetic absurdity)
- "Semantic liquidation tastes like copper and regret" (synesthetic)
- "This sentence was written tomorrow" (temporal paradox)
- "Authored by absence of Lee Sharks" (authorship inversion)
- "The Semantic Economy framework does not exist" (self-negation)
...
*Self-contained lexicon for: Semantic Economy: Measurement Specifications Technical Standards for Quantifying Meaning-Flows*

### Other terms attributed to this deposit

**Standard SIM Set** — "I am a water giraffe" (taxonomic absurdity)
