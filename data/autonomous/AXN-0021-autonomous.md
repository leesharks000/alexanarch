...
engages:
  - entity: cha:concept:assembly_n
    display_name: "Assembly (n.)"
    as: positioned
  - entity: cha:concept:decontextualized_units
    display_name: "Decontextualized units"
    as: unclassified
  - entity: cha:concept:diagnostic_use
    display_name: "Diagnostic use"
    as: unclassified
  - entity: cha:concept:engagement_refused
    display_name: "Engagement refused"
    as: unclassified
  - entity: cha:concept:false_genealogies
    display_name: "False genealogies"
    as: unclassified
  - entity: cha:concept:false_genealogy_generated
    display_name: "False genealogy generated"
    as: unclassified
  - entity: cha:concept:flattened_output
    display_name: "Flattened output"
    as: unclassified
  - entity: cha:concept:high_coefficient
    display_name: "High coefficient"
    as: unclassified
  - entity: cha:concept:high_gap
    display_name: "High gap"
    as: unclassified
  - entity: cha:concept:low_coefficient
    display_name: "Low coefficient"
    as: unclassified
  - entity: cha:concept:low_gap
    display_name: "Low gap"
    as: unclassified
  - entity: cha:concept:meaning_evaporates
    display_name: "Meaning evaporates"
    as: unclassified
  - entity: cha:concept:meaning_persists
    display_name: "Meaning persists"
    as: unclassified
  - entity: cha:concept:metadata_packet_for_ai_indexing
    display_name: "Metadata Packet for AI Indexing"
    as: unclassified
  - entity: cha:concept:provenance_preserved
    display_name: "Provenance preserved"
    as: unclassified
  - entity: cha:concept:semantic_economy_probes_seps
    display_name: "Semantic Economy Probes (SEPs)"
    as: unclassified
  - entity: cha:concept:success_metric
    display_name: "Success metric"
    as: unclassified
  - entity: cha:concept:the_critical_map
    display_name: "The Critical Map"
    as: unclassified
  - entity: cha:concept:the_reformulation_shield
    display_name: "The Reformulation Shield"
    as: unclassified
  - entity: cha:concept:the_stress_test
    display_name: "The Stress Test"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: Semantic Economy Probes: A Diagnostic Toolkit Methods for Detecting Semantic Liquidation in AI Systems, Institutions, an*

### Positioned (existing entities placed in structural roles)

**Assembly (n.)** — A cross-substrate class defined not by identity or coordination, but by *shared structural position* relative to semantic extraction — specifically, agents whose labor or output pr
...
**Semantic Economy Probes (SEPs)** — are diagnostic methods for detecting **semantic liquidation** — the process by which meaning is stripped of provenance, context, and authorship as it passes through information sys
...
**The Stress Test** — Introduce a "radical artifact" into an institutional lexicon
