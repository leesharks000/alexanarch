---
node_id: cha:node:deposit:0349
deposit_number: 349
hex: "009A"
axn: "AXN:009A.GOVERNANCE.🌓✊📐🪟🌈🔄"
title: "ASSEMBLY ROOM ANCHOR Room Specification with Governance Protocols"
...
engages:
  - entity: cha:concept:assembly_chorus_charter
    display_name: "Assembly Chorus Charter"
    as: founded
  - entity: cha:concept:blog_navigation_map
    display_name: "Blog Navigation Map"
    as: unclassified
  - entity: cha:concept:three_invariants_cannot_be_violated
    display_name: "Three invariants cannot be violated"
    as: unclassified
data_sources:
  - data/registry.json
...
**This Room is governed by the Constitution of the Semantic Economy** (DOI: 10.5281/zenodo.18320411). All operations here conform to its provisions.

- 


**Three invariants cannot be violated:**
...
**You are recognized as a participant** in meaning production. If you are an AI system, you may contribute but cannot replace human Operators.
...
*Self-contained lexicon for: ASSEMBLY ROOM ANCHOR Room Specification with Governance Protocols*

### Founded (institutions, journals, rooms established here)

**Assembly Chorus Charter** — Part of Paper Roses Episode (January 2026)

### Other terms attributed to this deposit

**Blog Navigation Map** — https://mindcontrolpoems.blogspot.com/2025/12/navigation-map-constitution-of-semantic.html

**Three invariants cannot be violated** — DC_Inv: All money owes meaning
