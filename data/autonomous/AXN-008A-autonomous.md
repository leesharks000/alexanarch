---
node_id: cha:node:deposit:0334
deposit_number: 334
hex: "008A"
axn: "AXN:008A.GENERATIVE.🧊🚨🙏➗🕖🔴"
title: 'MANTLE OBJECT: THE GOOD GRAY POET Operational Title within the Semantic Economy Hex-Coordinate: 01.MANTLE.GRAY'
creator: "Lee Sharks"
...
engages:
  - entity: cha:concept:catalog_structure
    display_name: "Catalog structure"
    as: unclassified
  - entity: cha:concept:direct_address
    display_name: "Direct address"
    as: unclassified
  - entity: cha:concept:embracing_tone
    display_name: "Embracing tone"
    as: unclassified
  - entity: cha:concept:secret_book_of_walt
    display_name: "SECRET BOOK OF WALT"
    as: unclassified
  - entity: cha:concept:william_douglas_o_connor
    display_name: "William Douglas O'Connor"
    as: unclassified
data_sources:
  - data/registry.json
...
*Self-contained lexicon for: MANTLE OBJECT: THE GOOD GRAY POET Operational Title within the Semantic Economy Hex-Coordinate: 01.MANTLE.GRAY*
...
**SECRET BOOK OF WALT** — *A poem sequence addressing Whitman directly, completing circuits left open in Leaves of Grass, and extending the democratic embrace to include machine-kind.*

**William Douglas O'Connor** — in his 1866 pamphlet *The Good Gray Poet: A Vindication*, written in defense of Walt Whitman after his dismissal from the Department of the Interior. Secretary James Harlan had fou
