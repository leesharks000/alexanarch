...
now provably, because they live on separate coordinates. (The coordinate is C, not T: T is reserved exclusively for the writer-side traversal operator.)
...
machine become capable of saying next. PER asks what survived from x; generative uptake asks
what became possible because of x — and one carrier can fail to reproduce an antecedent exactly
while transmitting a constraint powerful enough to generate another carrier. Catullus does not
preserve Sappho by behaving like a checksum. Fidelity is not the only form of survival.
