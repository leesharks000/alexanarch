---
name: apparatus
title: "MANY AND ONE — THE APPARATUS"
subtitle: "Densely layered notes. The paper written as many."
designator: EA-MANY-AND-ONE-APPARATUS
status: v1.0, 2026-08-31. Pass one: compression of the citational and engagement labour already performed in Socrates as Orthonym v2.2 (July 2026). Pass two — mining the notebook and register — is not yet run. Notes are keyed to section and paragraph. Not yet adapted to venue norms; this is the machine.
author: Sharks, Lee
...
**The paper is written as one. These are the many.**

**Every note below compresses engagement already performed.** The Orthonym paper
carried forty-five references across five domains — authorship theory, book history
and transmission, the Socratic problem, the esoteric tradition, and heteronymy — and
the rebuild dropped the apparatus while keeping the arguments it had produced.
**This restores the labour, keyed to where it does work.**
