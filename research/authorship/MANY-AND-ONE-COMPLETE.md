...
status: v2.0, 2026-08-31. Full comparison against MANY-AND-ONE-MAXIMAL. Restored: the seal-and-wax triad (§II), the forgery census and its two zeros (§V), the propagation series (§IX), the EA-YIELD-02 correction and the four further measures including the manufactured philosophers (§VII) — the last two having been dropped in an earlier editing pass and recovered by this comparison.
author: Sharks, Lee
