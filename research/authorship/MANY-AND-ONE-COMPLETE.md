...
status: v2.2, 2026-08-31. §VII.2 added — the object-conditioning result in full. Aristotle's within-domain dispersion 0.0571 against Plato's total 0.0570; the residual ordered by object-space, ethics tightest at the 0.5th percentile and logic loosest at the 88.5th. Presented as §II's formula measured at corpus scale, and as the middle term between the divided soul and the undivided God.
author: Sharks, Lee
...
> corpus that looked like several authors is **numerically indistinguishable from the
> corpus it is supposed to differ from.**
...
**11.** **The ordering is the object-space of each domain.** *Ethics has one object
...
## 3. AND THAT IS §§I–II PERFORMED, AT CORPUS SCALE

**13.** **§II gave the formula:** a living thing is **ἐντελεχείᾳ μὲν μία, δυνάμει δὲ
...
**14.** **§VII.2 is that formula measured.** **One corpus, in actuality. Many, in
...
**15.** ⭑ **AND THIS IS THE METHOD ITSELF, DOING WHAT §I SAYS IT DOES.** *Division cuts
...
term:**
    ...
    §II    the soul, one in actuality, many in potentiality      DOCTRINE
    §VII   the corpus, one when the object is held, many when
           it is divided by object — 0.0571 against 0.0570       MEASURED
    §I     God, where the terms division separates are not
...
**42.** **It is consistent with one maker and consistent with a school**, and §VIII
...
**45.** **Conceded in full at §23:** a school produces this. **And at §25:** the
