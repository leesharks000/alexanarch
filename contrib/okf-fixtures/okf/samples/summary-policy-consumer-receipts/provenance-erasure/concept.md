...
summary_policy:
  required_assertions:
    ...
    - id: persistent_identifier_present
      text: "The record carries its persistent identifier and canonical archive URL."
...
travels legibly with every derivative. Canonical record:
...
records now circulate as this case's bad-summary does: content intact,
provenance stripped. Public record of the apparatus and measurement:
